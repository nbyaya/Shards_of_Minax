...
{
    public class MonsterChestAB : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAB() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int androidCount = Utility.Random(1, 6);

            for (int i = 0; i < androidCount; i++)
                monsters.Add(new RetroAndroid()); // Use RetroAndroid instead of Pirate
        ...
        public MonsterChestAB(Serial serial) : base(serial)
        {
        }
