...
{
    public class MonsterChestAL : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAL() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int sorcererCount = Utility.Random(1, 6);

            for (int i = 0; i < sorcererCount; i++)
                monsters.Add(new CyberpunkSorcerer());
        ...
        public MonsterChestAL(Serial serial) : base(serial)
        {
        }
