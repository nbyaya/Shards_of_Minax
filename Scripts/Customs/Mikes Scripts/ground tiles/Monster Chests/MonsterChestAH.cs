...
{
    public class MonsterChestAH : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAH() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int gothicNovelistCount = Utility.Random(1, 6);

            for (int i = 0; i < gothicNovelistCount; i++)
                monsters.Add(new GothicNovelist());
        ...
        public MonsterChestAH(Serial serial) : base(serial)
        {
        }
