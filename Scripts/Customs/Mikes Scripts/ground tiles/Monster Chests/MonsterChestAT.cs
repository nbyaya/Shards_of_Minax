...
{
    public class MonsterChestAT : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAT() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int scientistCount = Utility.Random(1, 6);

            for (int i = 0; i < scientistCount; i++)
                monsters.Add(new CavemanScientist()); // Spawn CavemanScientists instead of Pirates
        ...
        public MonsterChestAT(Serial serial) : base(serial)
        {
        }
