...
{
    public class MonsterChestAK : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAK() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            // Spawn a NoirDetective
            monsters.Add(new NoirDetective());
        ...
        public MonsterChestAK(Serial serial) : base(serial)
        {
        }
