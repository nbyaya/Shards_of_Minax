...
{
    public class MonsterChestAU : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAU() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int samuraiCount = Utility.Random(1, 6);

            for (int i = 0; i < samuraiCount; i++)
                monsters.Add(new SteampunkSamurai()); // Use SteampunkSamurai instead of Pirate
        ...
        public MonsterChestAU(Serial serial) : base(serial)
        {
        }
