...
{
    public class MonsterChestAP : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAP() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int duelistPoetCount = Utility.Random(1, 6);

            for (int i = 0; i < duelistPoetCount; i++)
                monsters.Add(new DuelistPoet()); // Assuming DuelistPoet is a valid custom creature class.
        ...
        public MonsterChestAP(Serial serial) : base(serial)
        {
        }
