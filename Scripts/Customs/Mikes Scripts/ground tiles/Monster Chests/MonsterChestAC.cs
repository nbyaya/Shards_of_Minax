...
{
    public class MonsterChestAC : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAC() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int mageCount = Utility.Random(1, 6);

            for (int i = 0; i < mageCount; i++)
                monsters.Add(new GlamRockMage()); // Spawn GlamRockMage
        ...
        public MonsterChestAC(Serial serial) : base(serial)
        {
        }
