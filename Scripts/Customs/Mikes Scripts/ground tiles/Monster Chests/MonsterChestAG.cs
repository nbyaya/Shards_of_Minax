...
{
    public class MonsterChestAG : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAG() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int discoDruidCount = Utility.Random(1, 6);

            for (int i = 0; i < discoDruidCount; i++)
                monsters.Add(new DiscoDruid());
        ...
        public MonsterChestAG(Serial serial) : base(serial)
        {
        }
