...
{
    public class MonsterChestBL : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestBL() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            // You can adjust the number of ReggaeRunesmiths spawned here.
            int reggaeRunesmithCount = Utility.Random(1, 3);

            for (int i = 0; i < reggaeRunesmithCount; i++)
                monsters.Add(new ReggaeRunesmith());
        ...
        public MonsterChestBL(Serial serial) : base(serial)
        {
        }
