...
{
    public class MonsterChestAE : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAE() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int dinoRiderCount = Utility.Random(1, 6);

            for (int i = 0; i < dinoRiderCount; i++)
                monsters.Add(new DinoRider());
        ...
        public MonsterChestAE(Serial serial) : base(serial)
        {
        }
