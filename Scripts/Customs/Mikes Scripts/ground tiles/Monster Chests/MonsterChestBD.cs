...
{
    public class MonsterChestBD : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestBD() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int pandemoniumCount = Utility.Random(1, 6);

            for (int i = 0; i < pandemoniumCount; i++)
                monsters.Add(new PinupPandemonium()); // Spawn PinupPandemonium instead of Pirate
        ...
        public MonsterChestBD(Serial serial) : base(serial)
        {
        }
