...
{
    // ---------------------------------------------------
    // Oni Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Oni on hit
    // ---------------------------------------------------

    public class OniSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public OniSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Oni Materia";
        ...
        public OniSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Oni.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Oni", 99, 5.0));
                return true;
            }
            return false;
        }
