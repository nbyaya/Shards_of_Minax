...
{
    // ---------------------------------------------------
    // Sparkle Breath Materia
    // This materia, when socketed, allows the bearer to unleash a sparkle breath attack
    // ---------------------------------------------------

    public class SparkleBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public SparkleBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Sparkle Breath Materia";
        ...
        public SparkleBreathMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a sparkling breath attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Sparkle Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlSparkleBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
