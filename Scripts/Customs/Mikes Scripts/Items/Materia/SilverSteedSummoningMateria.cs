...
{
    // ---------------------------------------------------
    // Silver Steed Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Silver Steed on hit
    // ---------------------------------------------------

    public class SilverSteedSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public SilverSteedSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Silver Steed Materia";
        ...
        public SilverSteedSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Silver Steed.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("SilverSteed", 99, 5.0));
                return true;
            }
            return false;
        }
