...
{
    // ---------------------------------------------------
    // KazeKemono Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a KazeKemono on hit
    // ---------------------------------------------------

    public class KazeKemonoSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public KazeKemonoSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning KazeKemono Materia";
        ...
        public KazeKemonoSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a KazeKemono.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("KazeKemono", 99, 5.0));
                return true;
            }
            return false;
        }
