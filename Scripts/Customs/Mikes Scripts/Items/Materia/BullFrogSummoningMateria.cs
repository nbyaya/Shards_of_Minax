...
{
    // ---------------------------------------------------
    // BullFrog Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a BullFrog on hit
    // ---------------------------------------------------

    public class BullFrogSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public BullFrogSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning BullFrog Materia";
        ...
        public BullFrogSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a BullFrog.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("BullFrog", 99, 5.0));
                return true;
            }
            return false;
        }
