...
{
    // ---------------------------------------------------
    // Orc Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Orc on hit
    // ---------------------------------------------------

    public class OrcSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public OrcSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Orc Materia";
        ...
        public OrcSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Orc.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Orc", 99, 5.0));
                return true;
            }
            return false;
        }
