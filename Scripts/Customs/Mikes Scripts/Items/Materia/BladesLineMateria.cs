...
namespace Server.Items
{
    // ---------------------------------------------------
    // Blades Line Materia
    // This materia, when socketed, allows the bearer to unleash a blades line attack
    // ---------------------------------------------------

    public class BladesLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public BladesLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Blades Line Materia";
        ...
        public BladesLineMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful line attack with blades on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Blades Line effect with specified parameters (example: refractory 5 seconds, damage 20, range 8)
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlBladesLine(5.0, 20, 8));
                return true;
            }
            return false;
        }
