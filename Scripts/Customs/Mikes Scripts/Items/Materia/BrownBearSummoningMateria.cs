...
{
    // ---------------------------------------------------
    // Brown Bear Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Brown Bear on hit
    // ---------------------------------------------------

    public class BrownBearSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public BrownBearSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Brown Bear Materia";
        ...
        public BrownBearSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Brown Bear.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("BrownBear", 99, 5.0));
                return true;
            }
            return false;
        }
