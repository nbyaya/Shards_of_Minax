...
{
    // ---------------------------------------------------
    // Eagle Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Eagle on hit
    // ---------------------------------------------------

    public class EagleSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public EagleSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Eagle Materia";
        ...
        public EagleSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Eagle.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Eagle", 99, 5.0));
                return true;
            }
            return false;
        }
