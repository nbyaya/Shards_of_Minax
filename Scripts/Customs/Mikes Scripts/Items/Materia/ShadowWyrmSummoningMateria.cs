...
{
    // ---------------------------------------------------
    // ShadowWyrm Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a ShadowWyrm on hit
    // ---------------------------------------------------

    public class ShadowWyrmSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public ShadowWyrmSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning ShadowWyrm Materia";
        ...
        public ShadowWyrmSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a ShadowWyrm.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("ShadowWyrm", 99, 5.0));
                return true;
            }
            return false;
        }
