...
namespace Server.Items
{
    // ---------------------------------------------------
    // Rune Circle Materia
    // This materia, when socketed, allows the bearer to perform a powerful rune circle ability
    // ---------------------------------------------------

    public class RuneCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public RuneCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Rune Circle Materia";
        ...
        public RuneCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Allows the bearer to perform a powerful rune circle ability.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Rune Circle effect with specified parameters (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlRuneCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
