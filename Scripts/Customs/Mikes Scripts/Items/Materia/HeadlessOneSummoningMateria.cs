...
{
    // ---------------------------------------------------
    // HeadlessOne Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a HeadlessOne on hit
    // ---------------------------------------------------

    public class HeadlessOneSummoningMateria : BaseSocketAugmentation
    {
        private static readonly Random _random = new Random();

        [Constructable]
        public HeadlessOneSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning HeadlessOne Materia";
            Hue = _random.Next(1, 3001); // Random hue between 1 and 3000
        }
        ...
        public HeadlessOneSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a HeadlessOne.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("HeadlessOne", 99, 5.0));
                return true;
            }
            return false;
        }
