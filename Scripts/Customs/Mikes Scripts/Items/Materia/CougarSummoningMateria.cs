...
{
    // ---------------------------------------------------
    // Cougar Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Cougar on hit
    // ---------------------------------------------------

    public class CougarSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public CougarSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Cougar Materia";
        ...
        public CougarSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Cougar.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Cougar", 99, 5.0));
                return true;
            }
            return false;
        }
