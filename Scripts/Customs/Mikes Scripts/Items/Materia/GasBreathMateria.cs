...
namespace Server.Items
{
    // ---------------------------------------------------
    // Gas Breath Materia
    // This materia, when socketed, allows the bearer to unleash a gas breath attack
    // ---------------------------------------------------

    public class GasBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public GasBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Gas Breath Materia";
        ...
        public GasBreathMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a devastating gas breath attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Gas Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlGasBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
