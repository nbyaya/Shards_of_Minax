...
{
    // ---------------------------------------------------
    // ElderGazer Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an ElderGazer on hit
    // ---------------------------------------------------

    public class ElderGazerSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public ElderGazerSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning ElderGazer Materia";
        ...
        public ElderGazerSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an ElderGazer.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("ElderGazer", 99, 5.0));
                return true;
            }
            return false;
        }
