...
namespace Server.Items
{
    // ---------------------------------------------------
    // Trap Breath Materia
    // This materia, when socketed, allows the bearer to unleash a trap breath attack
    // ---------------------------------------------------

    public class TrapBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public TrapBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Trap Breath Materia";
        ...
        public TrapBreathMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Trap Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlTrapBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
