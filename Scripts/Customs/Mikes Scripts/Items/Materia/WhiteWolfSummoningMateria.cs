...
{
    // ---------------------------------------------------
    // WhiteWolf Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a WhiteWolf on hit
    // ---------------------------------------------------

    public class WhiteWolfSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public WhiteWolfSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning WhiteWolf Materia";
        ...
        public WhiteWolfSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a WhiteWolf.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("WhiteWolf", 99, 5.0));
                return true;
            }
            return false;
        }
