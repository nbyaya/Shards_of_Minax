...
{
    // ---------------------------------------------------
    // BoneDemon Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a BoneDemon on hit
    // ---------------------------------------------------

    public class BoneDemonSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public BoneDemonSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning BoneDemon Materia";
        ...
        public BoneDemonSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a BoneDemon.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("BoneDemon", 99, 5.0));
                return true;
            }
            return false;
        }
