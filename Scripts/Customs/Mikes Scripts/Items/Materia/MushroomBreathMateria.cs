...
{
    // ---------------------------------------------------
    // Mushroom Breath Materia
    // This materia, when socketed, allows the bearer to unleash a mushroom breath attack
    // ---------------------------------------------------

    public class MushroomBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public MushroomBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Mushroom Breath Materia";
        ...
        public MushroomBreathMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a devastating mushroom breath attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Mushroom Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlMushroomBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
