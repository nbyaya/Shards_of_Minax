...
{
    // ---------------------------------------------------
    // Revenant Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Revenant on hit
    // ---------------------------------------------------

    public class RevenantSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public RevenantSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Revenant Materia";
        ...
        public RevenantSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Revenant.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Revenant", 99, 5.0));
                return true;
            }
            return false;
        }
