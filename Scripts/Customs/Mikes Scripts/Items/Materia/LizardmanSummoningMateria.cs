...
{
    // ---------------------------------------------------
    // Lizardman Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Lizardman on hit
    // ---------------------------------------------------

    public class LizardmanSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public LizardmanSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Lizardman Materia";
        ...
        public LizardmanSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Lizardman.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Lizardman", 99, 5.0));
                return true;
            }
            return false;
        }
