...
{
    // ---------------------------------------------------
    // Ice Elemental Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Ice Elemental on hit
    // ---------------------------------------------------

    public class IceElementalSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public IceElementalSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Ice Elemental Materia";
        ...
        public IceElementalSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Ice Elemental.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("IceElemental", 99, 5.0));
                return true;
            }
            return false;
        }
