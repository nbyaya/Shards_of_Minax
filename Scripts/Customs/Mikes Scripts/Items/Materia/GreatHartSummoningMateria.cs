...
{
    // ---------------------------------------------------
    // GreatHart Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a GreatHart on hit
    // ---------------------------------------------------

    public class GreatHartSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public GreatHartSummoningMateria() : base(0x2809) // Change the item ID to match your materia graphic
        {
            Name = "Summoning GreatHart Materia";
        ...
        public GreatHartSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a GreatHart.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("GreatHart", 99, 5.0));
                return true;
            }
            return false;
        }
