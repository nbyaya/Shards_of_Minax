...
{
    // ---------------------------------------------------
    // Gaman Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Gaman on hit
    // ---------------------------------------------------

    public class GamanSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public GamanSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Gaman Materia";
        ...
        public GamanSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Gaman.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Gaman", 99, 5.0));
                return true;
            }
            return false;
        }
