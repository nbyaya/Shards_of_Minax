...
{
    // ---------------------------------------------------
    // Efreet Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Efreet on hit
    // ---------------------------------------------------

    public class EfreetSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public EfreetSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Efreet Materia";
        ...
        public EfreetSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Efreet.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Efreet", 99, 5.0));
                return true;
            }
            return false;
        }
