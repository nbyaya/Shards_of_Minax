...
{
    // ---------------------------------------------------
    // Nutcracker Line Materia
    // This materia, when socketed, allows the bearer to unleash a nutcracker line attack
    // ---------------------------------------------------

    public class NutcrackerLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public NutcrackerLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Nutcracker Line Materia";
        ...
        public NutcrackerLineMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful nutcracker line attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Nutcracker Line effect with specified parameters
                // Example: Nutcracker line effect with parameters (example: refractory 5 seconds, damage 20, range 8)
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlNutcrackerLine(5.0, 20, 8));
                return true;
            }
            return false;
        }
