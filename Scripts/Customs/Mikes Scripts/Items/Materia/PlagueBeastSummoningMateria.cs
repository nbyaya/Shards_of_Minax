...
{
    // ---------------------------------------------------
    // PlagueBeast Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a PlagueBeast on hit
    // ---------------------------------------------------

    public class PlagueBeastSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public PlagueBeastSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning PlagueBeast Materia";
        ...
        public PlagueBeastSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a PlagueBeast.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("PlagueBeast", 99, 5.0));
                return true;
            }
            return false;
        }
