...
{
    // ---------------------------------------------------
    // Stone Breath Materia
    // This materia, when socketed, allows the bearer to unleash a stone breath attack
    // ---------------------------------------------------

    public class StoneBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public StoneBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Stone Breath Materia";
        ...
        public StoneBreathMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a devastating stone breath attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Stone Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlStoneBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
