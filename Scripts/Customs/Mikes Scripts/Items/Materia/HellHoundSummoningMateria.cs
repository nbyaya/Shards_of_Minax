...
{
    // ---------------------------------------------------
    // HellHound Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a HellHound on hit
    // ---------------------------------------------------

    public class HellHoundSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public HellHoundSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning HellHound Materia";
        ...
        public HellHoundSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a HellHound.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("HellHound", 99, 5.0));
                return true;
            }
            return false;
        }
