...
{
    // ---------------------------------------------------
    // Pixie Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Pixie on hit
    // ---------------------------------------------------

    public class PixieSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public PixieSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Pixie Materia";
        ...
        public PixieSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Pixie.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Pixie", 99, 5.0));
                return true;
            }
            return false;
        }
