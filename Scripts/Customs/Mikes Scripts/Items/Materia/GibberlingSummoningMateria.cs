...
{
    // ---------------------------------------------------
    // Gibberling Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Gibberling on hit
    // ---------------------------------------------------

    public class GibberlingSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public GibberlingSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Gibberling Materia";
        ...
        public GibberlingSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Gibberling.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Gibberling", 99, 5.0));
                return true;
            }
            return false;
        }
