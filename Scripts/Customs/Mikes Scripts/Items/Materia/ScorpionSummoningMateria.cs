...
{
    // ---------------------------------------------------
    // Scorpion Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Scorpion on hit
    // ---------------------------------------------------

    public class ScorpionSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public ScorpionSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Scorpion Materia";
        ...
        public ScorpionSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Scorpion.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Scorpion", 99, 5.0));
                return true;
            }
            return false;
        }
