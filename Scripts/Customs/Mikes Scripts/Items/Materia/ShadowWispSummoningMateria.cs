...
{
    public class ShadowWispSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public ShadowWispSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning ShadowWisp Materia";
        ...
        public ShadowWispSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a ShadowWisp.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("ShadowWisp", 99, 5.0));
                return true;
            }
            return false;
        }
