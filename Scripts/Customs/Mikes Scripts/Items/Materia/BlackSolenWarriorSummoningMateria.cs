...
{
    // ---------------------------------------------------
    // Black Solen Warrior Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Black Solen Warrior on hit
    // ---------------------------------------------------

    public class BlackSolenWarriorSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public BlackSolenWarriorSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Black Solen Warrior Materia";
        ...
        public BlackSolenWarriorSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Black Solen Warrior.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("BlackSolenWarrior", 99, 5.0));
                return true;
            }
            return false;
        }
