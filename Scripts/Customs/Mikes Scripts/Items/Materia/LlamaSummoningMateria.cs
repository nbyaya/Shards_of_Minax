...
{
    public class LlamaSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public LlamaSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Llama Materia";
        ...
        public LlamaSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Llama.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Llama", 99, 5.0));
                return true;
            }
            return false;
        }
