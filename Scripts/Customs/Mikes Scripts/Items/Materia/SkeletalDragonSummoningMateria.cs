...
{
    // ---------------------------------------------------
    // Skeletal Dragon Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Skeletal Dragon on hit
    // ---------------------------------------------------

    public class SkeletalDragonSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public SkeletalDragonSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Skeletal Dragon Materia";
        ...
        public SkeletalDragonSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Skeletal Dragon.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("SkeletalDragon", 99, 5.0));
                return true;
            }
            return false;
        }
