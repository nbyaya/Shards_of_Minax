...
{
    // ---------------------------------------------------
    // Lesser Hiryu Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Lesser Hiryu on hit
    // ---------------------------------------------------

    public class LesserHiryuSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public LesserHiryuSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Lesser Hiryu Materia";
        ...
        public LesserHiryuSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Lesser Hiryu.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("LesserHiryu", 99, 5.0));
                return true;
            }
            return false;
        }
