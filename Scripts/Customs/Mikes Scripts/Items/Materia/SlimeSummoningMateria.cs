...
{
    // ---------------------------------------------------
    // Slime Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Slime on hit
    // ---------------------------------------------------

    public class SlimeSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public SlimeSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Slime Materia";
        ...
        public SlimeSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Slime.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Slime", 99, 5.0));
                return true;
            }
            return false;
        }
