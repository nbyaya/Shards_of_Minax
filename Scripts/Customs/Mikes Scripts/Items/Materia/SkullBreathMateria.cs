...
{
    // ---------------------------------------------------
    // Skull Breath Materia
    // This materia, when socketed, allows the bearer to unleash a skull breath attack
    // ---------------------------------------------------

    public class SkullBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public SkullBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Skull Breath Materia";
        ...
        public SkullBreathMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Skull Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlSkullBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
