...
{
    // ---------------------------------------------------
    // GiantBlackWidow Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a GiantBlackWidow on hit
    // ---------------------------------------------------

    public class GiantBlackWidowSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public GiantBlackWidowSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning GiantBlackWidow Materia";
        ...
        public GiantBlackWidowSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Giant Black Widow.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("GiantBlackWidow", 99, 5.0));
                return true;
            }
            return false;
        }
