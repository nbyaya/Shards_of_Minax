...
{
    public class BeeLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public BeeLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Bee Line Materia";
        ...
        public BeeLineMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful bee line attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Bee Line effect with specified parameters (example: refractory 5 seconds, damage 20, range 8)
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlBeeLine(5.0, 20, 8));
                return true;
            }
            return false;
        }
