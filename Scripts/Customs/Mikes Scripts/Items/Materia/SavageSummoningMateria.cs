...
{
    // ---------------------------------------------------
    // Savage Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Savage creature on hit
    // ---------------------------------------------------

    public class SavageSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public SavageSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Savage Materia";
        ...
        public SavageSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Savage creature.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("SavageCreature", 99, 5.0));
                return true;
            }
            return false;
        }
