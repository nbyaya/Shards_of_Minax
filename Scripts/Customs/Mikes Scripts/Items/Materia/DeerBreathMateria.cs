...
namespace Server.Items
{
    // ---------------------------------------------------
    // Deer Breath Materia
    // This materia, when socketed, allows the bearer to unleash a deer breath attack
    // ---------------------------------------------------

    public class DeerBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public DeerBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Deer Breath Materia";
        ...
        public DeerBreathMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a deer breath attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Deer Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlDeerBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
