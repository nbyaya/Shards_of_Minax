...
namespace Server.Items
{
    // ---------------------------------------------------
    // Skull Line Materia
    // This materia, when socketed, allows the bearer to unleash a skull line attack
    // ---------------------------------------------------

    public class SkullLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public SkullLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Skull Line Materia";
        ...
        public SkullLineMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful skull line attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Skull Line effect with specified parameters (example: refractory 5 seconds, damage 20, range 8)
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlSkullLine(5.0, 20, 8));
                return true;
            }
            return false;
        }
