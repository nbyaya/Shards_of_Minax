...
{
    // ---------------------------------------------------
    // Demon Knight Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Demon Knight on hit
    // ---------------------------------------------------

    public class DemonKnightSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public DemonKnightSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Demon Knight Materia";
        ...
        public DemonKnightSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Demon Knight.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("DemonKnight", 99, 5.0));
                return true;
            }
            return false;
        }
