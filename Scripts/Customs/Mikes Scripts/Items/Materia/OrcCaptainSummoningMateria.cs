...
{
    // ---------------------------------------------------
    // Orc Captain Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Orc Captain on hit
    // ---------------------------------------------------

    public class OrcCaptainSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public OrcCaptainSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Orc Captain Materia";
        ...
        public OrcCaptainSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Orc Captain.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("OrcCaptain", 99, 5.0));
                return true;
            }
            return false;
        }
