...
{
    // ---------------------------------------------------
    // Chicken Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Chicken on hit
    // ---------------------------------------------------

    public class ChickenSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public ChickenSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Chicken Materia";
        ...
        public ChickenSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Chicken.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Chicken", 99, 5.0));
                return true;
            }
            return false;
        }
