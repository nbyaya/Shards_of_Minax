...
namespace Server.Items
{
    // ---------------------------------------------------
    // Trap Line Materia
    // This materia, when socketed, allows the bearer to unleash a trap line attack
    // ---------------------------------------------------

    public class TrapLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public TrapLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Trap Line Materia";
        ...
        public TrapLineMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful trap line attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Trap Line effect with specified parameters (example: refractory 5 seconds, damage 20, range 8)
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlTrapLine(5.0, 20, 8));
                return true;
            }
            return false;
        }
