...
{
    // ---------------------------------------------------
    // FanDancer Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a FanDancer on hit
    // ---------------------------------------------------

    public class FanDancerSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public FanDancerSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning FanDancer Materia";
        ...
        public FanDancerSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a FanDancer.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("FanDancer", 99, 5.0));
                return true;
            }
            return false;
        }
