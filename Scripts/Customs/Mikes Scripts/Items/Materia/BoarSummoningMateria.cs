...
{
    // ---------------------------------------------------
    // Boar Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Boar on hit
    // ---------------------------------------------------

    public class BoarSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public BoarSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Boar Materia";
        ...
        public BoarSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Boar.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Boar", 99, 5.0));
                return true;
            }
            return false;
        }
