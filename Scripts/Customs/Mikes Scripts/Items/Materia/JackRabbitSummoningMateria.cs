...
{
    // ---------------------------------------------------
    // JackRabbit Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a JackRabbit on hit
    // ---------------------------------------------------

    public class JackRabbitSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public JackRabbitSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning JackRabbit Materia";
        ...
        public JackRabbitSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a JackRabbit.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("JackRabbit", 99, 5.0));
                return true;
            }
            return false;
        }
