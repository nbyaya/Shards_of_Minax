...
{
    // ---------------------------------------------------
    // Dolphin Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Dolphin on hit
    // ---------------------------------------------------

    public class DolphinSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public DolphinSummoningMateria() : base(0x2809) // Use the same graphic as Blood Elemental materia
        {
            Name = "Summoning Dolphin Materia";
        ...
        public DolphinSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Dolphin.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Dolphin", 99, 5.0));
                return true;
            }
            return false;
        }
