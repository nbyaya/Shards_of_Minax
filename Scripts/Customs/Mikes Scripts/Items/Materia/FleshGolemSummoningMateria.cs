...
{
    // ---------------------------------------------------
    // Flesh Golem Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Flesh Golem on hit
    // ---------------------------------------------------

    public class FleshGolemSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public FleshGolemSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Flesh Golem Materia";
        ...
        public FleshGolemSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Flesh Golem.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("FleshGolem", 99, 5.0));
                return true;
            }
            return false;
        }
