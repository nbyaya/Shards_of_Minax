...
{
    // ---------------------------------------------------
    // Chaos Dragoon Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Chaos Dragoon on hit
    // ---------------------------------------------------

    public class ChaosDragoonSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public ChaosDragoonSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Chaos Dragoon Materia";
        ...
        public ChaosDragoonSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Chaos Dragoon.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("ChaosDragoon", 99, 5.0));
                return true;
            }
            return false;
        }
