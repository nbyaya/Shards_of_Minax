...
{
    // ---------------------------------------------------
    // Bogle Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Bogle on hit
    // ---------------------------------------------------

    public class BogleSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public BogleSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Bogle Materia";
        ...
        public BogleSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Bogle.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Bogle", 99, 5.0));
                return true;
            }
            return false;
        }
