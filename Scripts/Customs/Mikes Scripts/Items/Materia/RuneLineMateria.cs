...
namespace Server.Items
{
    // ---------------------------------------------------
    // Rune Line Materia
    // This materia, when socketed, allows the bearer to unleash a rune line attack
    // ---------------------------------------------------

    public class RuneLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public RuneLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Rune Line Materia";
        ...
        public RuneLineMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful rune line attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Rune Line effect with specified parameters (example: refractory 5 seconds, damage 20, range 8)
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlRuneLine(5.0, 20, 8));
                return true;
            }
            return false;
        }
