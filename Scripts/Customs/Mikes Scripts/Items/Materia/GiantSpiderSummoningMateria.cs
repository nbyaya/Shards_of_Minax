...
{
    // ---------------------------------------------------
    // Giant Spider Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Giant Spider on hit
    // ---------------------------------------------------

    public class GiantSpiderSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public GiantSpiderSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Giant Spider Materia";
        ...
        public GiantSpiderSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Giant Spider.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("GiantSpider", 99, 5.0));
                return true;
            }
            return false;
        }
