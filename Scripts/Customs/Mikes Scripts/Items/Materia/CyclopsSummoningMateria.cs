...
{
    // ---------------------------------------------------
    // Cyclops Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Cyclops on hit
    // ---------------------------------------------------

    public class CyclopsSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public CyclopsSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Cyclops Materia";
        ...
        public CyclopsSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Cyclops.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Cyclops", 99, 5.0));
                return true;
            }
            return false;
        }
