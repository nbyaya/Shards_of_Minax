...
{
    // ---------------------------------------------------
    // Balron Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Balron on hit
    // ---------------------------------------------------

    public class BalronSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public BalronSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Balron Materia";
        ...
        public BalronSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Balron.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Balron", 99, 5.0));
                return true;
            }
            return false;
        }
