...
{
    // ---------------------------------------------------
    // Skeletal Knight Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Skeletal Knight on hit
    // ---------------------------------------------------

    public class SkeletalKnightSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public SkeletalKnightSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Skeletal Knight Materia";
        ...
        public SkeletalKnightSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Skeletal Knight.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("SkeletalKnight", 99, 5.0));
                return true;
            }
            return false;
        }
