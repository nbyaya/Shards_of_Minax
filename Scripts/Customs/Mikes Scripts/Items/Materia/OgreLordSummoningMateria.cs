...
{
    // ---------------------------------------------------
    // OgreLord Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an OgreLord on hit
    // ---------------------------------------------------

    public class OgreLordSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public OgreLordSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning OgreLord Materia";
        ...
        public OgreLordSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an OgreLord.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("OgreLord", 99, 5.0));
                return true;
            }
            return false;
        }
