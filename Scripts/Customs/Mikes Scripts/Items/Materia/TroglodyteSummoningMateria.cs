...
{
    // ---------------------------------------------------
    // Troglodyte Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Troglodyte on hit
    // ---------------------------------------------------

    public class TroglodyteSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public TroglodyteSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Troglodyte Materia";
            Hue = Utility.RandomMinMax(1, 3000); // Random hue value between 1 and 3000
        }
        ...
        public TroglodyteSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Troglodyte.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Troglodyte", 99, 5.0));
                return true;
            }
            return false;
        }
