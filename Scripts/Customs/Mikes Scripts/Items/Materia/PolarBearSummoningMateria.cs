...
{
    // ---------------------------------------------------
    // PolarBear Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a PolarBear on hit
    // ---------------------------------------------------

    public class PolarBearSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public PolarBearSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning PolarBear Materia";
        ...
        public PolarBearSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a PolarBear.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("PolarBear", 99, 5.0));
                return true;
            }
            return false;
        }
