...
{
    // ---------------------------------------------------
    // BogThing Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a BogThing on hit
    // ---------------------------------------------------

    public class BogThingSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public BogThingSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning BogThing Materia";
        ...
        public BogThingSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a BogThing.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("BogThing", 99, 5.0));
                return true;
            }
            return false;
        }
