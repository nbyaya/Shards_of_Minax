...
{
    // ---------------------------------------------------
    // Hiryu Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Hiryu on hit
    // ---------------------------------------------------

    public class HiryuSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public HiryuSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Hiryu Materia";
        ...
        public HiryuSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Hiryu.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Hiryu", 99, 5.0));
                return true;
            }
            return false;
        }
