...
namespace Server.Items
{
    // ---------------------------------------------------
    // Head Circle Materia
    // This materia, when socketed, allows the bearer to perform a powerful head circle attack
    // ---------------------------------------------------

    public class HeadCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public HeadCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Head Circle Materia";
        ...
        public HeadCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful head circle attack, damaging all foes within its radius.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Head Circle effect with specified parameters (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlHeadCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
