...
{
    // ---------------------------------------------------
    // Fire Gargoyle Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Fire Gargoyle on hit
    // ---------------------------------------------------

    public class FireGargoyleSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public FireGargoyleSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Fire Gargoyle Materia";
        ...
        public FireGargoyleSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Fire Gargoyle.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("FireGargoyle", 99, 5.0));
                return true;
            }
            return false;
        }
