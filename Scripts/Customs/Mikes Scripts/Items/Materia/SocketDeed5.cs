...
{
    public class SocketDeed5 : Item
    {
        [Constructable]
        public SocketDeed5() : base(0x14F0)
        {
            Weight = 1.0;
            Name = "a tier 5 socket deed";
            LootType = LootType.Blessed;
        }

        public SocketDeed5(Serial serial) : base(serial)
        {
        }
        ...
        {
            private SocketDeed5 m_Deed;

            public InternalTarget(SocketDeed5 deed) : base(1, false, TargetFlags.None)
            {
                m_Deed = deed;
            }
