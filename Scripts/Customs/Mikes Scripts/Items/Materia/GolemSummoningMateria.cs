...
{
    // ---------------------------------------------------
    // Golem Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Golem on hit
    // ---------------------------------------------------

    public class GolemSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public GolemSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Golem Materia";
        ...
        public GolemSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Golem.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Golem", 99, 5.0));
                return true;
            }
            return false;
        }
