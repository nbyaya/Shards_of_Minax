...
{
    // ---------------------------------------------------
    // Savage Shaman Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Savage Shaman on hit
    // ---------------------------------------------------

    public class SavageShamanSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public SavageShamanSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Savage Shaman Materia";
        ...
        public SavageShamanSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Savage Shaman.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("SavageShaman", 99, 5.0));
                return true;
            }
            return false;
        }
