...
{
    // ---------------------------------------------------
    // Bull Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Bull on hit
    // ---------------------------------------------------

    public class BullSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public BullSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Bull Materia";
        ...
        public BullSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Bull.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Bull", 99, 5.0));
                return true;
            }
            return false;
        }
