...
namespace Server.Items
{
    // ---------------------------------------------------
    // Gate Circle Materia
    // This materia, when socketed, allows the bearer to perform a powerful gate circle attack
    // ---------------------------------------------------

    public class GateCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public GateCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Gate Circle Materia";
        ...
        public GateCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful gate circle attack, damaging all foes within its radius.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Gate Circle effect with specified parameters (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlGateCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
