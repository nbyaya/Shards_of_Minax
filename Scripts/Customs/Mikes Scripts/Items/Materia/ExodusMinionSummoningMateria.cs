...
{
    // ---------------------------------------------------
    // Exodus Minion Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Exodus Minion on hit
    // ---------------------------------------------------

    public class ExodusMinionSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public ExodusMinionSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Exodus Minion Materia";
            // Choose a new hue between 1 and 3000 for your materia
        ...
        public ExodusMinionSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Exodus Minion.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("ExodusMinion", 99, 5.0));
                return true;
            }
            return false;
        }
