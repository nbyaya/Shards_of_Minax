...
{
    // ---------------------------------------------------
    // ArcaneDaemon Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an ArcaneDaemon on hit
    // ---------------------------------------------------

    public class ArcaneDaemonSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public ArcaneDaemonSummoningMateria() : base(0x2809) // Use the desired graphic ID for the materia (same as Blood Elemental materia)
        {
            Name = "Summoning ArcaneDaemon Materia";
        ...
        public ArcaneDaemonSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an ArcaneDaemon.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("ArcaneDaemon", 99, 5.0));
                return true;
            }
            return false;
        }
