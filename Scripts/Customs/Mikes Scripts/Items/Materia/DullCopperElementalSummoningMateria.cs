...
{
    // ---------------------------------------------------
    // Dull Copper Elemental Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Dull Copper Elemental on hit
    // ---------------------------------------------------

    public class DullCopperElementalSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public DullCopperElementalSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Dull Copper Elemental Materia";
        ...
        public DullCopperElementalSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Dull Copper Elemental.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("DullCopperElemental", 99, 5.0));
                return true;
            }
            return false;
        }
