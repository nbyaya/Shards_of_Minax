...
{
    // ---------------------------------------------------
    // DeepSeaSerpent Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a DeepSeaSerpent on hit
    // ---------------------------------------------------

    public class DeepSeaSerpentSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public DeepSeaSerpentSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning DeepSeaSerpent Materia";
        ...
        public DeepSeaSerpentSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a DeepSeaSerpent.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("DeepSeaSerpent", 99, 5.0));
                return true;
            }
            return false;
        }
