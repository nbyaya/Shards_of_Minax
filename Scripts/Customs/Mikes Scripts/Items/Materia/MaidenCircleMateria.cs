...
{
    // ---------------------------------------------------
    // Maiden Circle Materia
    // This materia, when socketed, allows the bearer to perform a powerful maiden circle attack
    // ---------------------------------------------------

    public class MaidenCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public MaidenCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Maiden Circle Materia";
        ...
        public MaidenCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful maiden circle attack, damaging all foes within its radius.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Maiden Circle effect with specified parameters (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlMaidenCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
