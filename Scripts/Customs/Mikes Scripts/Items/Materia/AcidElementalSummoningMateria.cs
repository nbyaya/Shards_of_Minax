...
{
    // ---------------------------------------------------
    // Acid Elemental Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Acid Elemental on hit
    // ---------------------------------------------------

    public class AcidElementalSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public AcidElementalSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Acid Elemental Materia";
        ...
        public AcidElementalSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Acid Elemental.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("AcidElemental", 99, 5.0));
                return true;
            }
            return false;
        }
