...
{
    // ---------------------------------------------------
    // Heart Circle Materia
    // This materia, when socketed, allows the bearer to perform a powerful heart circle attack
    // ---------------------------------------------------

    public class HeartCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public HeartCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Heart Circle Materia";
        ...
        public HeartCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful heart circle attack, damaging all foes within its radius.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Heart Circle effect with specified parameters (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlHeartCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
