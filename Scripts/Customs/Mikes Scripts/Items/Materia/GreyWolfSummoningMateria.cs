...
{
    // ---------------------------------------------------
    // Grey Wolf Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Grey Wolf on hit
    // ---------------------------------------------------

    public class GreyWolfSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public GreyWolfSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Grey Wolf Materia";
        ...
        public GreyWolfSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Grey Wolf.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("GreyWolf", 99, 5.0));
                return true;
            }
            return false;
        }
