...
{
    // ---------------------------------------------------
    // Mountain Goat Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Mountain Goat on hit
    // ---------------------------------------------------

    public class MountainGoatSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public MountainGoatSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Mountain Goat Materia";
        ...
        public MountainGoatSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Mountain Goat.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("MountainGoat", 99, 5.0));
                return true;
            }
            return false;
        }
