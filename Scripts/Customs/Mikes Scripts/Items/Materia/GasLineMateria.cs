...
namespace Server.Items
{
    // ---------------------------------------------------
    // Gas Line Materia
    // This materia, when socketed, allows the bearer to unleash a gas line attack
    // ---------------------------------------------------

    public class GasLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public GasLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Gas Line Materia";
        ...
        public GasLineMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful gas line attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Gas Line effect with specified parameters (example: refractory 5 seconds, damage 20, range 8)
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlGasLine(5.0, 20, 8));
                return true;
            }
            return false;
        }
