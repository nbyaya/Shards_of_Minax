...
{
    // ---------------------------------------------------
    // EvilMage Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Evil Mage on hit
    // ---------------------------------------------------

    public class EvilMageSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public EvilMageSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Evil Mage Materia";
        ...
        public EvilMageSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Evil Mage.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("EvilMage", 99, 5.0));
                return true;
            }
            return false;
        }
