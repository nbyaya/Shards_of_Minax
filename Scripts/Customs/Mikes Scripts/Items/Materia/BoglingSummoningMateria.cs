...
{
    // ---------------------------------------------------
    // Bogling Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Bogling on hit
    // ---------------------------------------------------

    public class BoglingSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public BoglingSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Bogling Materia";
        ...
        public BoglingSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Bogling.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Bogling", 99, 5.0));
                return true;
            }
            return false;
        }
