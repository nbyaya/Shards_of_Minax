...
{
    // ---------------------------------------------------
    // Walrus Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Walrus on hit
    // ---------------------------------------------------

    public class WalrusSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public WalrusSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Walrus Materia";
        ...
        public WalrusSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Walrus.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Walrus", 99, 5.0));
                return true;
            }
            return false;
        }
