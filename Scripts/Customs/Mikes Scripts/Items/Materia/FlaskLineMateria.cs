...
namespace Server.Items
{
    // ---------------------------------------------------
    // Flak Line Materia
    // This materia, when socketed, allows the bearer to unleash a flak line attack
    // ---------------------------------------------------

    public class FlaskLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public FlaskLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Flak Line Materia";
        ...
        public FlaskLineMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Flak Line effect with specified parameters
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlFlaskLine( /* Add your parameters here */ ));
                return true;
            }
            return false;
        }
