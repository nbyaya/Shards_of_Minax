...
{
    // ---------------------------------------------------
    // Hind Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Hind on hit
    // ---------------------------------------------------

    public class HindSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public HindSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Hind Materia";
        ...
        public HindSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Hind.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Hind", 99, 5.0));
                return true;
            }
            return false;
        }
