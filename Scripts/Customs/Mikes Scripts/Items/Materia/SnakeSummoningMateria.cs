...
{
    // ---------------------------------------------------
    // Snake Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Snake on hit
    // ---------------------------------------------------

    public class SnakeSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public SnakeSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Snake Materia";
        ...
        public SnakeSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Snake.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Snake", 99, 5.0));
                return true;
            }
            return false;
        }
