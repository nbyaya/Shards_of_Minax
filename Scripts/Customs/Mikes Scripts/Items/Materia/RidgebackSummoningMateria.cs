...
{
    // ---------------------------------------------------
    // Ridgeback Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Ridgeback on hit
    // ---------------------------------------------------

    public class RidgebackSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public RidgebackSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Ridgeback Materia";
        ...
        public RidgebackSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Ridgeback.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Ridgeback", 99, 5.0));
                return true;
            }
            return false;
        }
