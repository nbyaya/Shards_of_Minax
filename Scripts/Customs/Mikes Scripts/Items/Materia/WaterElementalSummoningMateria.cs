...
{
    // ---------------------------------------------------
    // Water Elemental Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Water Elemental on hit
    // ---------------------------------------------------

    public class WaterElementalSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public WaterElementalSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Water Elemental Materia";
        ...
        public WaterElementalSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Water Elemental.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("WaterElemental", 99, 5.0));
                return true;
            }
            return false;
        }
