...
{
    // ---------------------------------------------------
    // Grizzly Bear Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Grizzly Bear on hit
    // ---------------------------------------------------

    public class GrizzlyBearSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public GrizzlyBearSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Grizzly Bear Materia";
        ...
        public GrizzlyBearSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Grizzly Bear.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("GrizzlyBear", 99, 5.0));
                return true;
            }
            return false;
        }
