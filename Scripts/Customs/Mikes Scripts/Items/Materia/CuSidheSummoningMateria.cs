...
{
    // ---------------------------------------------------
    // CuSidhe Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a CuSidhe on hit
    // ---------------------------------------------------

    public class CuSidheSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public CuSidheSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning CuSidhe Materia";
        ...
        public CuSidheSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a CuSidhe.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("CuSidhe", 99, 5.0));
                return true;
            }
            return false;
        }
