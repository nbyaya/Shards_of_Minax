...
{
    public class OrcBruteSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public OrcBruteSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Orc Brute Materia";
        ...
        public OrcBruteSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Orc Brute.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("OrcBrute", 99, 5.0));
                return true;
            }
            return false;
        }
