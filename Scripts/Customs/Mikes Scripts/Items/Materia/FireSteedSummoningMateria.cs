...
{
    // ---------------------------------------------------
    // FireSteed Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a FireSteed on hit
    // ---------------------------------------------------

    public class FireSteedSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public FireSteedSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning FireSteed Materia";
        ...
        public FireSteedSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a FireSteed.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("FireSteed", 99, 5.0));
                return true;
            }
            return false;
        }
