...
{
    // ---------------------------------------------------
    // Gargoyle Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Gargoyle on hit
    // ---------------------------------------------------

    public class GargoyleSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public GargoyleSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Gargoyle Materia";
        ...
        public GargoyleSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Gargoyle.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Gargoyle", 99, 5.0));
                return true;
            }
            return false;
        }
