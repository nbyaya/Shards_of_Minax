...
{
    // ---------------------------------------------------
    // Ophidian Archmage Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Ophidian Archmage on hit
    // ---------------------------------------------------

    public class OphidianArchmageSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public OphidianArchmageSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Ophidian Archmage Materia";
        ...
        public OphidianArchmageSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Ophidian Archmage.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("OphidianArchmage", 99, 5.0));
                return true;
            }
            return false;
        }
