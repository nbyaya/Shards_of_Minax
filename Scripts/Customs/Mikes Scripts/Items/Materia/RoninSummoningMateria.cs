...
{
    // ---------------------------------------------------
    // Ronin Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Ronin on hit
    // ---------------------------------------------------

    public class RoninSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public RoninSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Ronin Materia";
        ...
        public RoninSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Ronin.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Ronin", 99, 5.0));
                return true;
            }
            return false;
        }
