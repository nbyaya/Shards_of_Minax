...
{
    // ---------------------------------------------------
    // Spike Breath Materia
    // This materia, when socketed, allows the bearer to unleash a spike breath attack
    // ---------------------------------------------------

    public class SpikeBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public SpikeBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Spike Breath Materia";
        ...
        public SpikeBreathMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a devastating spike breath attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Spike Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlSpikeBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
