...
{
    // ---------------------------------------------------
    // Vortex Circle Materia
    // This materia, when socketed, allows the bearer to perform a powerful vortex circle attack
    // ---------------------------------------------------

    public class VortexCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public VortexCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Vortex Circle Materia";
        ...
        public VortexCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful vortex circle attack, damaging all foes within its radius.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Vortex Circle effect with specified parameters (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlVortexCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
