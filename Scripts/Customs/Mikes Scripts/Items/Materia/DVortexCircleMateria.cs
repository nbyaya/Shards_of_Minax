...
{
    // ---------------------------------------------------
    // DVortex Circle Materia
    // This materia, when socketed, allows the bearer to perform a DVortex circle attack
    // ---------------------------------------------------

    public class DVortexCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public DVortexCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "DVortex Circle Materia";
        ...
        public DVortexCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful DVortex circle attack, damaging all foes within its radius.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the DVortex Circle effect with specified parameters (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlDVortexCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
