...
{
    // ---------------------------------------------------
    // Kirin Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Kirin on hit
    // ---------------------------------------------------

    public class KirinSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public KirinSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Kirin Materia";
        ...
        public KirinSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Kirin.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Kirin", 99, 5.0));
                return true;
            }
            return false;
        }
