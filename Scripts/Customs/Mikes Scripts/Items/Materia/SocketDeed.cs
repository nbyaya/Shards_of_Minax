...
{
    public class SocketDeed : Item
    {
        [Constructable]
        public SocketDeed() : base(0x14F0)
        {
            Weight = 1.0;
            Name = "a socket deed";
        ...
        public SocketDeed(Serial serial) : base(serial)
        {
        }
        ...
        {
            private SocketDeed m_Deed;

            public InternalTarget(SocketDeed deed) : base(1, false, TargetFlags.None)
            {
                m_Deed = deed;
            }
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is Item)
                {
                    ...
                    else
                    {
                        ...
                        XmlAttach.AttachTo(item, new XmlSocketable(6));
