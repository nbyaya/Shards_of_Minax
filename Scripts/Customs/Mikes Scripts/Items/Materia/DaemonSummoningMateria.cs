...
{
    // ---------------------------------------------------
    // Daemon Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Daemon on hit
    // ---------------------------------------------------

    public class DaemonSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public DaemonSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Daemon Materia";
        ...
        public DaemonSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Daemon.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Daemon", 99, 5.0));
                return true;
            }
            return false;
        }
