...
{
    // ---------------------------------------------------
    // Sea Serpent Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Sea Serpent on hit
    // ---------------------------------------------------

    public class SeaSerpentSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public SeaSerpentSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Sea Serpent Materia";
        ...
        public SeaSerpentSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Sea Serpent.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("SeaSerpent", 99, 5.0)); // Change "SeaSerpent" to the appropriate creature name
                return true;
            }
            return false;
        }
