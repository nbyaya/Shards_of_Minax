...
{
    // ---------------------------------------------------
    // Succubus Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Succubus on hit
    // ---------------------------------------------------

    public class SuccubusSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public SuccubusSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Succubus Materia";
        ...
        public SuccubusSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Succubus.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Succubus", 99, 5.0));
                return true;
            }
            return false;
        }
