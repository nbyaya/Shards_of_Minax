...
{
    // ---------------------------------------------------
    // VampireBat Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Vampire Bat on hit
    // ---------------------------------------------------

    public class VampireBatSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public VampireBatSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Vampire Bat Materia";
        ...
        public VampireBatSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Vampire Bat.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("VampireBat", 99, 5.0));
                return true;
            }
            return false;
        }
