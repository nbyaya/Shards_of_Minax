...
{
    // ---------------------------------------------------
    // Poison Elemental Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Poison Elemental on hit
    // ---------------------------------------------------

    public class PoisonElementalSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public PoisonElementalSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Poison Elemental Materia";
        ...
        public PoisonElementalSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Poison Elemental.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("PoisonElemental", 99, 5.0));
                return true;
            }
            return false;
        }
