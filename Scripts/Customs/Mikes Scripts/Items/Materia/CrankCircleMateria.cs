...
{
    // ---------------------------------------------------
    // Crank Circle Materia
    // This materia, when socketed, allows the bearer to perform a powerful crank circle ability
    // ---------------------------------------------------

    public class CrankCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public CrankCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Crank Circle Materia";
        ...
        public CrankCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful crank circle ability with specified parameters.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Crank Circle effect with specified parameters
                // Example: refractory 10 seconds, damage 30, radius 6, thickness 2
                XmlAttach.AttachTo(target, new XmlCrankCircle(10.0, 30, 6, 2));
                return true;
            }
            return false;
        }
