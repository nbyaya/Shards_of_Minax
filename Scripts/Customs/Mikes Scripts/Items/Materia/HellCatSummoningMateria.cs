...
{
    // ---------------------------------------------------
    // HellCat Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a HellCat on hit
    // ---------------------------------------------------

    public class HellCatSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public HellCatSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning HellCat Materia";
        ...
        public HellCatSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a HellCat.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("HellCat", 99, 5.0));
                return true;
            }
            return false;
        }
