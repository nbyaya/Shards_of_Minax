...
{
    // ---------------------------------------------------
    // Crank Breath Materia
    // This materia, when socketed, allows the bearer to unleash a crank breath attack
    // ---------------------------------------------------

    public class CrankBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public CrankBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Crank Breath Materia";
        ...
        public CrankBreathMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Crank Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlCrankBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
