...
{
    // ---------------------------------------------------
    // AncientWyrm Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Ancient Wyrm on hit
    // ---------------------------------------------------

    public class AncientWyrmSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public AncientWyrmSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Ancient Wyrm Materia";
        ...
        public AncientWyrmSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Ancient Wyrm.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("AncientWyrm", 99, 5.0));
                return true;
            }
            return false;
        }
