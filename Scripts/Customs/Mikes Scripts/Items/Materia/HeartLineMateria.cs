...
namespace Server.Items
{
    // ---------------------------------------------------
    // Heart Line Materia
    // This materia, when socketed, allows the bearer to unleash a heart line attack
    // ---------------------------------------------------

    public class HeartLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public HeartLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Heart Line Materia";
        ...
        public HeartLineMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful heart line attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Heart Line effect with specified parameters (example: refractory 5 seconds, damage 20, range 8)
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlHeartLine(5.0, 20, 8));
                return true;
            }
            return false;
        }
