...
{
    // ---------------------------------------------------
    // Boulder Circle Materia
    // This materia, when socketed, allows the bearer to summon a boulder circle attack
    // ---------------------------------------------------

    public class BoulderCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public BoulderCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Boulder Circle Materia";
        ...
        public BoulderCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Summons a boulder circle attack, damaging all foes within its radius.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Boulder Circle effect with specified parameters (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlBoulderCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
