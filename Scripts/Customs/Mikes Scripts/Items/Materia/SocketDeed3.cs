...
{
    public class SocketDeed3 : Item
    {
        [Constructable]
        public SocketDeed3() : base(0x14F0)
        {
            Weight = 1.0;
            Name = "a tier 3 socket deed";
            LootType = LootType.Blessed;
        }

        public SocketDeed3(Serial serial) : base(serial)
        {
        }
        ...
        {
            private SocketDeed3 m_Deed;

            public InternalTarget(SocketDeed3 deed) : base(1, false, TargetFlags.None)
            {
                m_Deed = deed;
            }
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is Item)
                {
                    ...
                    else
                    {
                        ...
                        XmlAttach.AttachTo(item, new XmlSocketable(3));
