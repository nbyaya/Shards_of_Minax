...
{
    // ---------------------------------------------------
    // Blades Circle Materia
    // This materia, when socketed, allows the bearer to perform a powerful blades circle attack
    // ---------------------------------------------------

    public class BladesCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public BladesCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Blades Circle Materia";
        ...
        public BladesCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful blades circle attack, damaging all foes within its radius.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Blades Circle effect with specified parameters (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlBladesCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
