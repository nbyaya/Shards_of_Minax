...
{
    // ---------------------------------------------------
    // Arctic Ogre Lord Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Arctic Ogre Lord on hit
    // ---------------------------------------------------

    public class ArcticOgreLordSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public ArcticOgreLordSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Arctic Ogre Lord Materia";
        ...
        public ArcticOgreLordSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Arctic Ogre Lord.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("ArcticOgreLord", 99, 5.0));
                return true;
            }
            return false;
        }
