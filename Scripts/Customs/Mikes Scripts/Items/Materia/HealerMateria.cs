...
namespace Server.Items
{
    // ---------------------------------------------------
    // Healer Materia
    // This materia, when socketed, gives a 99% chance to heal the player on hit
    // ---------------------------------------------------

    public class HealerMateria : BaseSocketAugmentation
    {

        [Constructable]
        public HealerMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Healer Materia";
        ...
        public HealerMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to heal the player.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the healing effect to the weapon
                XmlAttach.AttachTo(target, new XmlSummonStrike("HealPlayer", 99, 5.0));
                return true;
            }
            return false;
        }
