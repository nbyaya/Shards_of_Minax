...
{
    // ---------------------------------------------------
    // Goat Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Goat on hit
    // ---------------------------------------------------

    public class GoatSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public GoatSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Goat Materia";
        ...
        public GoatSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Goat.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Goat", 99, 5.0));
                return true;
            }
            return false;
        }
