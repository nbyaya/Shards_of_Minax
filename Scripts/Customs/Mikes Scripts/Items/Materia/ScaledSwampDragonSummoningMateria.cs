...
{
    // ---------------------------------------------------
    // ScaledSwampDragon Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a ScaledSwampDragon on hit
    // ---------------------------------------------------

    public class ScaledSwampDragonSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public ScaledSwampDragonSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning ScaledSwampDragon Materia";
        ...
        public ScaledSwampDragonSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Scaled Swamp Dragon.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("ScaledSwampDragon", 99, 5.0));
                return true;
            }
            return false;
        }
