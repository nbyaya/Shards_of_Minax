...
public class GorefeastButcherKnife : ButcherKnife
{
    [Constructable]
    public GorefeastButcherKnife()
    {
        Name = "Gorefeast ButcherKnife";
    ...
    public GorefeastButcherKnife(Serial serial) : base(serial)
    {
    }
