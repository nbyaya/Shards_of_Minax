...
{    
    /// <summary>
    /// A concrete example: CampingLanturn.
    ...
    public class CampingLanturn : BaseMagicRanged
    {
        ...
        public override Type ReagentAmmoType { get { return typeof(Kindling); } }
        public override Item ReagentAmmo { get { return new Kindling(); } }
