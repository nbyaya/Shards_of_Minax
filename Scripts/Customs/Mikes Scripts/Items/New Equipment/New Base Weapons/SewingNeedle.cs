...
namespace Server.Items
{
    ...
    public class SewingNeedle : BaseSpear
    {
        [Constructable]
        public SewingNeedle()
            : base(0x1403)
        {
            this.Weight = 4.0;
            this.Name = "Sewing Needle";

            // Apply random tier damage here
            ApplyRandomTier();
        }

        public SewingNeedle(Serial serial)
            : base(serial)
        {
        }
        ...
        public override SkillName DefSkill => SkillName.Tailoring;

        public override void AddNameProperties(ObjectPropertyList list)
        {
            base.AddNameProperties(list);
            list.Add("Skill Required: Tailoring");
        }
