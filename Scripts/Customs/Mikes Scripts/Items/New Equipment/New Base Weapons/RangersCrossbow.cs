...
namespace Server.Items
{
    ...
    public class RangersCrossbow : BaseRanged
    {
        [Constructable]
        public RangersCrossbow()
            : base(0x13FD)
        {
            this.Weight = 9.0;
            this.Layer = Layer.TwoHanded;
            this.Name = "Rangers Crossbow";

            // Apply random tier damage
            ApplyRandomTier();
        }

        public RangersCrossbow(Serial serial)
            : base(serial)
        {
        }
        ...
        public override SkillName DefSkill => SkillName.Tracking;

        public override void AddNameProperties(ObjectPropertyList list)
        {
            base.AddNameProperties(list);
            list.Add("Skill Required: Tracking");
        }
