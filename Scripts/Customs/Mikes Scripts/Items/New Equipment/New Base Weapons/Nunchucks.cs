...
namespace Server.Items
{
    ...
    public class Nunchucks : BaseBashing
    {
        [Constructable]
        public Nunchucks()
            : base(0x27AE)
        ...
        public Nunchucks(Serial serial)
            : base(serial)
        {
        }
        ...
        public override SkillName DefSkill => SkillName.Provocation;

        public override void AddNameProperties(ObjectPropertyList list)
        {
            base.AddNameProperties(list);
            list.Add("Skill Required: Provocation");
        }
