...
{    
    /// <summary>
    /// A concrete example: NecromancersStaff.
    /// This blaster uses SulfurousAsh as ammo and adds extra fire damage.
    /// </summary>
    [FlipableAttribute(0x13F8, 0x13F9)]
    public class NecromancersStaff : BaseMagicRanged
    {
        [Constructable]
        public NecromancersStaff() : base(0x13F8)
        {
            this.Weight = 9.0;
            this.Layer = Layer.TwoHanded;
			this.Name = "Necromancers Staff";
			this.Hue = 533;
            // Additional initialization for a fire elemental blaster can be done here.
        }
        
        public NecromancersStaff(Serial serial) : base(serial)
        {
        }
        ...
        public override Type ReagentAmmoType { get { return typeof(NoxCrystal); } }
        public override Item ReagentAmmo { get { return new NoxCrystal(); } }
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            list.Add("Skill Required: Necromancy");
			list.Add("Ammo: Nox Crystal");
        }	
