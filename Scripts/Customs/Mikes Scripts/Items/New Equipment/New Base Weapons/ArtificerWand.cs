...
{    
    ...
    public class ArtificerWand : BaseMagicRanged
    {
        ...
        public override Type ReagentAmmoType => typeof(DaemonBlood);
        public override Item ReagentAmmo => new DaemonBlood();
        ...
        public override SkillName DefSkill => SkillName.Imbuing;
