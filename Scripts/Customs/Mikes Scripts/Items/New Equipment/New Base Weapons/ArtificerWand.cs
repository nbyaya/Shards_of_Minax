...
{    
    /// <summary>
    /// A concrete example: ArtificerWand.
    /// This blaster uses SulfurousAsh as ammo and adds extra fire damage.
    /// </summary>
    [FlipableAttribute(0xDF2, 0xDF3)]
    public class ArtificerWand : BaseMagicRanged
    {
        [Constructable]
        public ArtificerWand() : base(Utility.RandomList(0xDF2, 0xDF3, 0xDF4, 0xDF5))
        {
            this.Weight = 9.0;
            this.Layer = Layer.TwoHanded;
			this.Name = "Artificer Wand";
			this.Hue = 2576;
            // Additional initialization for a fire elemental blaster can be done here.
        }
        
        public ArtificerWand(Serial serial) : base(serial)
        {
        }
        ...
        public override Type ReagentAmmoType { get { return typeof(DaemonBlood); } }
        public override Item ReagentAmmo { get { return new DaemonBlood(); } }
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            list.Add("Skill Required: Imbuing");
			list.Add("Ammo: Daemon Blood");
        }	
