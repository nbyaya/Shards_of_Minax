...
{    
    /// <summary>
    /// A concrete example: SpellWeaversWand.
    ...
    public class SpellWeaversWand : BaseMagicRanged
    {
        ...
        public override Type ReagentAmmoType { get { return typeof(PigIron); } }
        public override Item ReagentAmmo { get { return new PigIron(); } }
