...
{
    [Alterable(typeof(DefBlacksmithy), typeof(ScribeSword))]
    [FlipableAttribute(0xF61, 0xF60)]
    public class ScribeSword : BaseSword
    {
        [Constructable]
        public ScribeSword()
            : base(0xF61)
        {
            this.Weight = 7.0;
            this.Name = "Scribe Sword";

            // Apply random tier damage here
            ApplyRandomTier();
        }

        public ScribeSword(Serial serial)
            : base(serial)
        {
        }
        ...
        public override SkillName DefSkill => SkillName.Inscribe;

        public override void AddNameProperties(ObjectPropertyList list)
        {
            base.AddNameProperties(list);
            list.Add("Skill Required: Inscription");
        }
