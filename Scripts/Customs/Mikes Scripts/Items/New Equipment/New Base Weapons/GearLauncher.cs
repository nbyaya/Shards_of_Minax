...
namespace Server.Items
{
    ...
    public class GearLauncher : BaseMagicRanged
    {
        [Constructable]
        public GearLauncher() : base(0x13FD)
        {
            this.Weight = 9.0;
            this.Layer = Layer.TwoHanded;
            this.Name = "Gear Launcher";
            this.Hue = 1555;
        ...
        public GearLauncher(Serial serial) : base(serial)
        {
        }
        ...
        public override Type ReagentAmmoType => typeof(Gears);
        public override Item ReagentAmmo => new Gears();
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            list.Add("Skill Required: Tinkering");
            list.Add("Ammo: Gears");
        }

        public override SkillName DefSkill => SkillName.Tinkering;
