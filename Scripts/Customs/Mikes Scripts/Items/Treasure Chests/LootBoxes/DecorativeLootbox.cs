...
{
    public class DecorativeLootbox : LockableContainer
    {
        [Constructable]
        public DecorativeLootbox() : base(0xE41) // Treasure Chest item ID
        {
            Name = "Decorative Lootbox";
			...
			AddItemWithProbability(new AncientWood(), 0.005);
        ...
        public DecorativeLootbox(Serial serial) : base(serial)
        {
        }
