...
{
    public class MurderTreasureChest : LockableContainer
    {
        [Constructable]
        public MurderTreasureChest() : base(0xE41) // Treasure Chest item ID
        {
            Name = "Treasure Chest";
            Hue = Utility.RandomMinMax(1, 1600);

            // Add gold
            AddItemWithProbability(new Gold(Utility.RandomMinMax(5000, 10000)), 1.0);
            ...
            // Add rare artifacts
            AddItemWithProbability(new RandomMagicArmor(), 0.07);
			AddItemWithProbability(new RandomMagicWeapon(), 0.07);
			AddItemWithProbability(new RandomMagicWeapon(), 0.07);
			AddItemWithProbability(new RandomMagicWeapon(), 0.07);
			AddItemWithProbability(new RandomMagicWeapon(), 0.07);
			AddItemWithProbability(new RandomMagicWeapon(), 0.07);
			...
			AddItemWithProbability(new RandomMagicWeapon(), 0.07);
			AddItemWithProbability(new RandomMagicWeapon(), 0.07);
			AddItemWithProbability(new RandomMagicClothing(), 0.06);
			AddItemWithProbability(new RandomMagicClothing(), 0.06);
			AddItemWithProbability(new RandomMagicClothing(), 0.06);
			AddItemWithProbability(new RandomMagicClothing(), 0.06);
			AddItemWithProbability(new RandomMagicClothing(), 0.06);
			AddItemWithProbability(new RandomMagicClothing(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryA(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryB(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryC(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryD(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryE(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryF(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryG(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryH(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryI(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryJ(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryK(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryL(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryM(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryN(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryO(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryP(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryQ(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryR(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryS(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryT(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryU(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryV(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryW(), 0.06);
			AddItemWithProbability(new RandomMagicJewelry(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryY(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryZ(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryAA(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryAB(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryAC(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryAD(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryAE(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryAF(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryAG(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryAH(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryAI(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryAJ(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryAK(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryAL(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryAM(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryAN(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryAO(), 0.06);
			AddItemWithProbability(new RandomSkillJewelryAP(), 0.06);
			AddItemWithProbability(new RandomMagicJewelry(), 0.06);
			AddItemWithProbability(new RandomMagicJewelry(), 0.06);
			AddItemWithProbability(new RandomMagicJewelry(), 0.06);
			AddItemWithProbability(new RandomMagicJewelry(), 0.06);
			...
			AddItemWithProbability(CreateValuableDocument(), 0.2);
			AddItemWithProbability(CreateValuableDocument(), 0.2);
			AddItemWithProbability(new StonePlasterHouseDeed(), 0.02);
			AddItemWithProbability(new FieldStoneHouseDeed(), 0.02);
			AddItemWithProbability(new SmallBrickHouseDeed(), 0.02);
			AddItemWithProbability(new WoodHouseDeed(), 0.02);
			AddItemWithProbability(new WoodPlasterHouseDeed(), 0.02);
			AddItemWithProbability(new ThatchedRoofCottageDeed(), 0.02);
			AddItemWithProbability(new BrickHouseDeed(), 0.02);
			AddItemWithProbability(new TwoStoryStonePlasterHouseDeed(), 0.02);
			AddItemWithProbability(new TwoStoryWoodPlasterHouseDeed(), 0.02);
			AddItemWithProbability(new TowerDeed(), 0.02);
			AddItemWithProbability(new KeepDeed(), 0.02);
			AddItemWithProbability(new CastleDeed(), 0.02);
			AddItemWithProbability(new LargePatioDeed(), 0.02);
			AddItemWithProbability(new LargeMarbleDeed(), 0.02);
			AddItemWithProbability(new SmallTowerDeed(), 0.02);
			AddItemWithProbability(new LogCabinDeed(), 0.02);
			AddItemWithProbability(new SandstonePatioDeed(), 0.02);
			AddItemWithProbability(new VillaDeed(), 0.02);
			AddItemWithProbability(new StoneWorkshopDeed(), 0.02);
			AddItemWithProbability(new MarbleWorkshopDeed(), 0.02);
			AddItemWithProbability(new SmallBoatDeed(), 0.02);
			AddItemWithProbability(new SmallDragonBoatDeed(), 0.02);
			AddItemWithProbability(new MediumBoatDeed(), 0.02);
			AddItemWithProbability(new MediumDragonBoatDeed(), 0.02);
			AddItemWithProbability(new LargeBoatDeed(), 0.02);
			AddItemWithProbability(new LargeDragonBoatDeed(), 0.02);
        }
        ...
        public MurderTreasureChest(Serial serial) : base(serial)
        {
        }
