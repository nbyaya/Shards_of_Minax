...
public class RandomSkillJewelryN : BaseJewel
{
    private static string[] prefixes = { "Sturdy", "Resilient" };
    ...
    [Constructable]
    public RandomSkillJewelryN() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void InitializeJewelryAttributes(BaseJewel tempJewelry)
    {
        ...
        if (tierChance < 0.05) // Very rare
        {
            ...
            this.Attributes.WeaponDamage = Utility.RandomMinMax(0, 200);
            SkillBonuses.SetValues(0, SkillName.Macing, Utility.RandomMinMax(0, 100));
            SkillBonuses.SetValues(1, SkillName.Tactics, Utility.RandomMinMax(0, 100));
            SkillBonuses.SetValues(2, SkillName.Anatomy, Utility.RandomMinMax(0, 100));
            this.Attributes.BonusStam = Utility.RandomMinMax(1, 50);
        }
        else if (tierChance < 0.2) // Rare
        {
            this.Attributes.Luck = rand.Next(40, 79);
            SkillBonuses.SetValues(0, SkillName.Macing, Utility.RandomMinMax(0, 35));
            SkillBonuses.SetValues(1, SkillName.Tactics, Utility.RandomMinMax(0, 35));
            SkillBonuses.SetValues(2, SkillName.Anatomy, Utility.RandomMinMax(0, 35));
            this.Attributes.BonusStam = Utility.RandomMinMax(1, 40);
        }
        else if (tierChance < 0.5) // Uncommon
        {
            this.Attributes.Luck = rand.Next(20, 39);
            SkillBonuses.SetValues(0, SkillName.Macing, Utility.RandomMinMax(0, 24));
            SkillBonuses.SetValues(1, SkillName.Tactics, Utility.RandomMinMax(0, 24));
            SkillBonuses.SetValues(2, SkillName.Anatomy, Utility.RandomMinMax(0, 24));
            this.Attributes.BonusStam = Utility.RandomMinMax(1, 30);
        }
        else // Common
        {
            this.Attributes.Luck = rand.Next(1, 19);
            SkillBonuses.SetValues(0, SkillName.Macing, Utility.RandomMinMax(0, 10));
            SkillBonuses.SetValues(1, SkillName.Tactics, Utility.RandomMinMax(0, 10));
            SkillBonuses.SetValues(2, SkillName.Anatomy, Utility.RandomMinMax(0, 10));
        }
    }
    ...
    public RandomSkillJewelryN(Serial serial) : base(serial) { }
