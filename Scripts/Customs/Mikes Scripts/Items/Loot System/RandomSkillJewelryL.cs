...
public class RandomSkillJewelryL : BaseJewel
{
    private static string[] prefixes = { "Holy", "Divine" };
    ...
    [Constructable]
    public RandomSkillJewelryL() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void InitializeJewelryAttributes(BaseJewel tempJewelry)
    {
        ...
        if (tierChance < 0.05) // Very rare
        {
            ...
            SkillBonuses.SetValues(2, SkillName.Chivalry, Utility.RandomMinMax(0, 100));
    ...
    public RandomSkillJewelryL(Serial serial) : base(serial) { }
