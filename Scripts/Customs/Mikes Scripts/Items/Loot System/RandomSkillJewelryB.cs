...
public class RandomSkillJewelryB : BaseJewel
{
    private static string[] prefixes = { "Ancient", "Mystical" };
    ...
    [Constructable]
    public RandomSkillJewelryB() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void InitializeJewelryAttributes(BaseJewel tempJewelry)
    {
        ...
        if (tierChance < 0.05) // Very rare
        {
            ...
            this.Attributes.RegenMana = rand.Next(2, 5);
            this.Attributes.SpellChanneling = 1;
            SkillBonuses.SetValues(0, SkillName.Anatomy, Utility.RandomMinMax(0, 100));
            SkillBonuses.SetValues(1, SkillName.MagicResist, Utility.RandomMinMax(0, 100));
            SkillBonuses.SetValues(2, SkillName.Healing, Utility.RandomMinMax(0, 100));
            this.Attributes.ReflectPhysical = Utility.RandomMinMax(0, 10);
            this.Attributes.WeaponDamage = Utility.RandomMinMax(0, 25);
        }
        else if (tierChance < 0.2) // Rare
        {
            this.Attributes.Luck = rand.Next(40, 79);
            SkillBonuses.SetValues(0, SkillName.Anatomy, Utility.RandomMinMax(0, 50));
            SkillBonuses.SetValues(1, SkillName.MagicResist, Utility.RandomMinMax(0, 50));
            SkillBonuses.SetValues(2, SkillName.Healing, Utility.RandomMinMax(0, 50));
            this.Attributes.ReflectPhysical = Utility.RandomMinMax(0, 5);
            this.Attributes.WeaponDamage = Utility.RandomMinMax(0, 15);
        }
        else if (tierChance < 0.5) // Uncommon
        {
            this.Attributes.Luck = rand.Next(20, 39);
            SkillBonuses.SetValues(0, SkillName.Anatomy, Utility.RandomMinMax(0, 25));
            SkillBonuses.SetValues(1, SkillName.MagicResist, Utility.RandomMinMax(0, 25));
            SkillBonuses.SetValues(2, SkillName.Healing, Utility.RandomMinMax(0, 25));
            this.Attributes.ReflectPhysical = Utility.RandomMinMax(0, 3);
            this.Attributes.WeaponDamage = Utility.RandomMinMax(0, 10);
        }
        else // Common
        {
            this.Attributes.Luck = rand.Next(1, 19);
            SkillBonuses.SetValues(0, SkillName.Anatomy, Utility.RandomMinMax(0, 10));
            SkillBonuses.SetValues(1, SkillName.MagicResist, Utility.RandomMinMax(0, 10));
        }
    }
    ...
    public RandomSkillJewelryB(Serial serial) : base(serial) { }
