...
public class RandomSkillJewelryAA : BaseJewel
{
    ...
    [Constructable]
    public RandomSkillJewelryAA() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void InitializeJewelryAttributes(BaseJewel tempJewelry)
    {
        ...
        else // Common
        {
            ...
            SkillBonuses.SetValues(2, SkillName.RemoveTrap, Utility.RandomMinMax(0, 10));
        }
    }
    ...
    public RandomSkillJewelryAA(Serial serial) : base(serial) { }
