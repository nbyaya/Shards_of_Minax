...
public class RandomSkillJewelryR : BaseJewel
{
    ...
    [Constructable]
    public RandomSkillJewelryR() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    public RandomSkillJewelryR(Serial serial) : base(serial) { }
