...
public class RandomSkillJewelryAO : BaseJewel
{
    private static string[] prefixes = { "Miner's", "Digger's" };
    ...
    [Constructable]
    public RandomSkillJewelryAO() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void InitializeJewelryAttributes(BaseJewel tempJewelry)
    {
        ...
        if (tierChance < 0.05) // Very rare
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Mining, Utility.RandomMinMax(0, 100));
        ...
        else if (tierChance < 0.2) // Rare
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Mining, Utility.RandomMinMax(0, 35));
        ...
        else if (tierChance < 0.5) // Uncommon
        {
            ...
            // Medium bonuses
            SkillBonuses.SetValues(0, SkillName.Mining, Utility.RandomMinMax(0, 24));
        ...
        else // Common
        {
            ...
            // Lowest bonuses
            SkillBonuses.SetValues(0, SkillName.Mining, Utility.RandomMinMax(0, 10));
    ...
    public RandomSkillJewelryAO(Serial serial) : base(serial) { }
