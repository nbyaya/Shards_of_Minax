...
public class RandomSkillJewelryE : BaseJewel
{
    ...
    [Constructable]
    public RandomSkillJewelryE() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void InitializeJewelryAttributes(BaseJewel tempJewelry)
    {
        ...
        if (tierChance < 0.05) // Very rare
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Fishing, Utility.RandomMinMax(0, 100));
            SkillBonuses.SetValues(1, SkillName.Camping, Utility.RandomMinMax(0, 100));
            SkillBonuses.SetValues(2, SkillName.AnimalTaming, Utility.RandomMinMax(0, 100));
        ...
        else if (tierChance < 0.2) // Rare
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Fishing, Utility.RandomMinMax(0, 50));
            SkillBonuses.SetValues(1, SkillName.Camping, Utility.RandomMinMax(0, 50));
            SkillBonuses.SetValues(2, SkillName.AnimalTaming, Utility.RandomMinMax(0, 50));
        ...
        else if (tierChance < 0.5) // Uncommon
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Fishing, Utility.RandomMinMax(0, 25));
            SkillBonuses.SetValues(1, SkillName.Camping, Utility.RandomMinMax(0, 25));
            SkillBonuses.SetValues(2, SkillName.AnimalTaming, Utility.RandomMinMax(0, 25));
            this.Attributes.WeaponDamage = Utility.RandomMinMax(0, 10);
        }
        else // Common
        {
            this.Attributes.Luck = rand.Next(1, 19);
            SkillBonuses.SetValues(0, SkillName.Fishing, Utility.RandomMinMax(0, 10));
            SkillBonuses.SetValues(1, SkillName.Camping, Utility.RandomMinMax(0, 10));
        }
    }
    ...
    public RandomSkillJewelryE(Serial serial) : base(serial) { }
