...
public class RandomSkillJewelryG : BaseJewel
{
    ...
    [Constructable]
    public RandomSkillJewelryG() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void InitializeJewelryAttributes(BaseJewel tempJewelry)
    {
        ...
        if (tierChance < 0.05) // Very rare
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Carpentry, Utility.RandomMinMax(0, 100));
            SkillBonuses.SetValues(1, SkillName.Tinkering, Utility.RandomMinMax(0, 100));
            SkillBonuses.SetValues(2, SkillName.Blacksmith, Utility.RandomMinMax(0, 100));
        ...
        else if (tierChance < 0.2) // Rare
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Carpentry, Utility.RandomMinMax(0, 50));
            SkillBonuses.SetValues(1, SkillName.Tinkering, Utility.RandomMinMax(0, 50));
            SkillBonuses.SetValues(2, SkillName.Blacksmith, Utility.RandomMinMax(0, 50));
        ...
        else if (tierChance < 0.5) // Uncommon
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Carpentry, Utility.RandomMinMax(0, 25));
            SkillBonuses.SetValues(1, SkillName.Tinkering, Utility.RandomMinMax(0, 25));
            SkillBonuses.SetValues(2, SkillName.Blacksmith, Utility.RandomMinMax(0, 25));
            this.Attributes.WeaponSpeed = Utility.RandomMinMax(0, 5);
        }
        else // Common
        {
            this.Attributes.Luck = rand.Next(1, 19);
            SkillBonuses.SetValues(0, SkillName.Carpentry, Utility.RandomMinMax(0, 10));
            SkillBonuses.SetValues(1, SkillName.Tinkering, Utility.RandomMinMax(0, 10));
        }
    }
    ...
    public RandomSkillJewelryG(Serial serial) : base(serial) { }
