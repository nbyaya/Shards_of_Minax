...
public class RandomSkillJewelryC : BaseJewel
{
    ...
    [Constructable]
    public RandomSkillJewelryC() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void InitializeJewelryAttributes(BaseJewel tempJewelry)
    {
        ...
        if (tierChance < 0.05) // Very rare
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Fencing, Utility.RandomMinMax(0, 100));
            SkillBonuses.SetValues(1, SkillName.Macing, Utility.RandomMinMax(0, 100));
        ...
        else if (tierChance < 0.2) // Rare
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Fencing, Utility.RandomMinMax(0, 50));
            SkillBonuses.SetValues(1, SkillName.Macing, Utility.RandomMinMax(0, 50));
            SkillBonuses.SetValues(2, SkillName.Archery, Utility.RandomMinMax(0, 50));
        ...
        else if (tierChance < 0.5) // Uncommon
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Fencing, Utility.RandomMinMax(0, 25));
            SkillBonuses.SetValues(1, SkillName.Macing, Utility.RandomMinMax(0, 25));
            SkillBonuses.SetValues(2, SkillName.Archery, Utility.RandomMinMax(0, 25));
            this.Attributes.WeaponSpeed = Utility.RandomMinMax(0, 5);
            this.Attributes.WeaponDamage = Utility.RandomMinMax(0, 10);
        }
        else // Common
        {
            this.Attributes.Luck = rand.Next(1, 19);
            SkillBonuses.SetValues(0, SkillName.Fencing, Utility.RandomMinMax(0, 10));
            SkillBonuses.SetValues(1, SkillName.Macing, Utility.RandomMinMax(0, 10));
        }
    }
    ...
    public RandomSkillJewelryC(Serial serial) : base(serial) { }
