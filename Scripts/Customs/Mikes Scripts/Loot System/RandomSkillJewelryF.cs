...
public class RandomSkillJewelryF : BaseJewel
{
    ...
    [Constructable]
    public RandomSkillJewelryF() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void InitializeJewelryAttributes(BaseJewel tempJewelry)
    {
        ...
        if (tierChance < 0.05) // Very rare
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Lockpicking, Utility.RandomMinMax(0, 100));
            SkillBonuses.SetValues(1, SkillName.Mining, Utility.RandomMinMax(0, 100));
            SkillBonuses.SetValues(2, SkillName.Lumberjacking, Utility.RandomMinMax(0, 100));
            this.Attributes.WeaponSpeed = Utility.RandomMinMax(-10, -5);
            this.Attributes.WeaponDamage = Utility.RandomMinMax(0, 25);
        }
        else if (tierChance < 0.2) // Rare
        {
            this.Attributes.Luck = rand.Next(40, 79);
            SkillBonuses.SetValues(0, SkillName.Lockpicking, Utility.RandomMinMax(0, 50));
            SkillBonuses.SetValues(1, SkillName.Mining, Utility.RandomMinMax(0, 50));
            SkillBonuses.SetValues(2, SkillName.Lumberjacking, Utility.RandomMinMax(0, 50));
            this.Attributes.WeaponSpeed = Utility.RandomMinMax(-5, 0);
        ...
        else if (tierChance < 0.5) // Uncommon
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Lockpicking, Utility.RandomMinMax(0, 25));
            SkillBonuses.SetValues(1, SkillName.Mining, Utility.RandomMinMax(0, 25));
            SkillBonuses.SetValues(2, SkillName.Lumberjacking, Utility.RandomMinMax(0, 25));
            this.Attributes.WeaponDamage = Utility.RandomMinMax(0, 10);
        }
        else // Common
        {
            this.Attributes.Luck = rand.Next(1, 19);
            SkillBonuses.SetValues(0, SkillName.Lockpicking, Utility.RandomMinMax(0, 10));
            SkillBonuses.SetValues(1, SkillName.Mining, Utility.RandomMinMax(0, 10));
        }
    }
    ...
    public RandomSkillJewelryF(Serial serial) : base(serial) { }
