...
public class RandomSkillJewelryAE : BaseJewel
{
    private static string[] prefixes = { "Shadowy", "Silent" };
    ...
    [Constructable]
    public RandomSkillJewelryAE() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void InitializeJewelryAttributes(BaseJewel tempJewelry)
    {
        ...
        if (tierChance < 0.05) // Very rare
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Ninjitsu, Utility.RandomMinMax(0, 100));
            SkillBonuses.SetValues(1, SkillName.Stealth, Utility.RandomMinMax(0, 100));
        ...
        else if (tierChance < 0.2) // Rare
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Ninjitsu, Utility.RandomMinMax(0, 35));
            SkillBonuses.SetValues(1, SkillName.Stealth, Utility.RandomMinMax(0, 35));
        ...
        else if (tierChance < 0.5) // Uncommon
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Ninjitsu, Utility.RandomMinMax(0, 24));
            SkillBonuses.SetValues(1, SkillName.Stealth, Utility.RandomMinMax(0, 24));
        ...
        else // Common
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Ninjitsu, Utility.RandomMinMax(0, 10));
            SkillBonuses.SetValues(1, SkillName.Stealth, Utility.RandomMinMax(0, 10));
    ...
    public RandomSkillJewelryAE(Serial serial) : base(serial) { }
