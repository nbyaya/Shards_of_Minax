...
public class RandomSkillJewelryD : BaseJewel
{
    ...
    [Constructable]
    public RandomSkillJewelryD() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void InitializeJewelryAttributes(BaseJewel tempJewelry)
    {
        ...
        if (tierChance < 0.05) // Very rare
        {
            ...
            SkillBonuses.SetValues(1, SkillName.Stealing, Utility.RandomMinMax(0, 100));
            SkillBonuses.SetValues(2, SkillName.Snooping, Utility.RandomMinMax(0, 100));
        ...
        else if (tierChance < 0.2) // Rare
        {
            ...
            SkillBonuses.SetValues(1, SkillName.Stealing, Utility.RandomMinMax(0, 50));
            SkillBonuses.SetValues(2, SkillName.Snooping, Utility.RandomMinMax(0, 50));
        ...
        else if (tierChance < 0.5) // Uncommon
        {
            ...
            SkillBonuses.SetValues(1, SkillName.Stealing, Utility.RandomMinMax(0, 25));
            SkillBonuses.SetValues(2, SkillName.Snooping, Utility.RandomMinMax(0, 25));
        }
        else // Common
        {
            this.Attributes.Luck = rand.Next(1, 19);
            SkillBonuses.SetValues(0, SkillName.Lockpicking, Utility.RandomMinMax(0, 10));
            SkillBonuses.SetValues(1, SkillName.Stealing, Utility.RandomMinMax(0, 10));
        }
    }
    ...
    public RandomSkillJewelryD(Serial serial) : base(serial) { }
