...
public class RandomSkillJewelryAP : BaseJewel
{
    private static string[] prefixes = { "Forester's", "Woodcutter's" };
    ...
    [Constructable]
    public RandomSkillJewelryAP() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void InitializeJewelryAttributes(BaseJewel tempJewelry)
    {
        ...
        if (tierChance < 0.05) // Very rare
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Lumberjacking, Utility.RandomMinMax(0, 100));
            SkillBonuses.SetValues(1, SkillName.Carpentry, Utility.RandomMinMax(0, 100));
            SkillBonuses.SetValues(2, SkillName.Tinkering, Utility.RandomMinMax(0, 100));
        ...
        else if (tierChance < 0.2) // Rare
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Lumberjacking, Utility.RandomMinMax(0, 35));
            SkillBonuses.SetValues(1, SkillName.Carpentry, Utility.RandomMinMax(0, 35));
            SkillBonuses.SetValues(2, SkillName.Tinkering, Utility.RandomMinMax(0, 35));
        ...
        else if (tierChance < 0.5) // Uncommon
        {
            ...
            // Medium bonuses
            SkillBonuses.SetValues(0, SkillName.Lumberjacking, Utility.RandomMinMax(0, 24));
            SkillBonuses.SetValues(1, SkillName.Carpentry, Utility.RandomMinMax(0, 24));
            SkillBonuses.SetValues(2, SkillName.Tinkering, Utility.RandomMinMax(0, 24));
        ...
        else // Common
        {
            ...
            // Lowest bonuses
            SkillBonuses.SetValues(0, SkillName.Lumberjacking, Utility.RandomMinMax(0, 10));
            SkillBonuses.SetValues(1, SkillName.Carpentry, Utility.RandomMinMax(0, 10));
            SkillBonuses.SetValues(2, SkillName.Tinkering, Utility.RandomMinMax(0, 10));
        }
    }
    ...
    public RandomSkillJewelryAP(Serial serial) : base(serial) { }
