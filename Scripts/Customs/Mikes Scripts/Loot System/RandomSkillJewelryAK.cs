...
public class RandomSkillJewelryAK : BaseJewel
{
    ...
    [Constructable]
    public RandomSkillJewelryAK() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    public RandomSkillJewelryAK(Serial serial) : base(serial) { }
