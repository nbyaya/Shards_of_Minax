...
public class RandomSkillJewelryY : BaseJewel
{
    ...
    [Constructable]
    public RandomSkillJewelryY() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void InitializeJewelryAttributes(BaseJewel tempJewelry)
    {
        ...
        if (tierChance < 0.05) // Very rare
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Begging, Utility.RandomMinMax(0, 100));
        ...
        else if (tierChance < 0.2) // Rare
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Begging, Utility.RandomMinMax(0, 35));
        ...
        else if (tierChance < 0.5) // Uncommon
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Begging, Utility.RandomMinMax(0, 24));
        ...
        else // Common
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Begging, Utility.RandomMinMax(0, 10));
    ...
    public RandomSkillJewelryY(Serial serial) : base(serial) { }
