...
public class RandomSkillJewelryAM : BaseJewel
{
    private static string[] prefixes = { "Craftsman's", "Artisan's" };
    ...
    [Constructable]
    public RandomSkillJewelryAM() : base(GetRandomItemID(), Layer.Ring)
    {
    ...
    private void InitializeJewelryAttributes(BaseJewel tempJewelry)
    {
        ...
        else if (tierChance < 0.2) // Rare
        {
            ...
            SkillBonuses.SetValues(0, SkillName.Carpentry, Utility.RandomMinMax(0, 35));
            SkillBonuses.SetValues(1, SkillName.Tinkering, Utility.RandomMinMax(0, 35));
            SkillBonuses.SetValues(2, SkillName.Blacksmith, Utility.RandomMinMax(0, 35));
            this.Attributes.CastSpeed = Utility.RandomMinMax(1, 3);
        }
        else if (tierChance < 0.5) // Uncommon
        {
            this.Attributes.Luck = rand.Next(20, 39);
            SkillBonuses.SetValues(0, SkillName.Carpentry, Utility.RandomMinMax(0, 24));
            SkillBonuses.SetValues(1, SkillName.Tinkering, Utility.RandomMinMax(0, 24));
            SkillBonuses.SetValues(2, SkillName.Blacksmith, Utility.RandomMinMax(0, 24));
        ...
        else // Common
        {
            ...
            SkillBonuses.SetValues(2, SkillName.Blacksmith, Utility.RandomMinMax(0, 10));
        }
    }
    ...
    public RandomSkillJewelryAM(Serial serial) : base(serial) { }
