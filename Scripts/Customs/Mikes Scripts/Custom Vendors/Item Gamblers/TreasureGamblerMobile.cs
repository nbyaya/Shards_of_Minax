...
{
    public class TreasureGamblerMobile : BaseCreature
    {
        // Existing code...
        [Constructable]
        public TreasureGamblerMobile() : base(AIType.AI_Vendor, FightMode.None, 2, 1, 0.5, 2)
        {
        ...
        public TreasureGamblerMobile(Serial serial) : base(serial)
        {
        }
