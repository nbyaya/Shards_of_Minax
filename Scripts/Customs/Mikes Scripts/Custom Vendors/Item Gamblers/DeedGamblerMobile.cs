...
{
    public class DeedGamblerMobile : BaseCreature
    {
        // Existing code...
        [Constructable]
        public DeedGamblerMobile() : base(AIType.AI_Vendor, FightMode.None, 2, 1, 0.5, 2)
        {
        ...
        public DeedGamblerMobile(Serial serial) : base(serial)
        {
        }
