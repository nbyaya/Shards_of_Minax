...
{
    public class ArtifactGamblerMobile : BaseCreature
    {
        // Existing code...
        [Constructable]
        public ArtifactGamblerMobile() : base(AIType.AI_Vendor, FightMode.None, 2, 1, 0.5, 2)
        {
        ...
        public ArtifactGamblerMobile(Serial serial) : base(serial)
        {
        }
