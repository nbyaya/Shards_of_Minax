...
{
    [CorpseName("an Forensics master's corpse")]
    public class UltimateForensicsMaster : QuestGiver
    {
        public override bool IsInvulnerable { get { return true; } }
        [Constructable]
        public UltimateForensicsMaster()
        {
            ...
            Title = "the ultimate Forensics master";
            CantWalk = true;
        }

        public UltimateForensicsMaster(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            return QuestHandler.HandleOnDragDrop(from, dropped, SkillName.Forensics, "Forensics", 0x4B5); // Bushido hue
        }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            list.Add(new QuestGiverContextMenuEntry(from, "Forensics Master", "Forensics"));
        }
    }
}
