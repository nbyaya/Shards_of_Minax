...
{
    [CorpseName("an Macing master's corpse")]
    public class UltimateMacingMaster : QuestGiver
    {
        public override bool IsInvulnerable { get { return true; } }
        [Constructable]
        public UltimateMacingMaster()
        {
            ...
            Title = "the ultimate Macing master";
            CantWalk = true;
        }

        public UltimateMacingMaster(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            return QuestHandler.HandleOnDragDrop(from, dropped, SkillName.Macing, "Macing", 0x4B5); // Bushido hue
        }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            list.Add(new QuestGiverContextMenuEntry(from, "Macing Master", "Macing"));
        }
    }
}
