...
{
    public class UltimateFishingMasterContract : Item
    {
        ...
        [Constructable]
        public UltimateFishingMasterContract() : base(0x14EF)
        {
            Weight = 1.0;
            Movable = true;
            ...
            int itemIndex = FishingCollectionType.Random();
            ItemType = FishingCollectionType.Items[itemIndex].Type;
            AmountNeeded = Utility.Random(10) + 10; // a bit more demanding
            Name = $"Fishing Collection Contract: {AmountNeeded} {FishingCollectionType.Items[itemIndex].Name}(s)";
            AmountCollected = 0;
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                from.SendGump(new UltimateFishingMasterContractGump(from, this));
            }
            else
            {
        ...
        public UltimateFishingMasterContract(Serial serial) : base(serial)
        {
        }
