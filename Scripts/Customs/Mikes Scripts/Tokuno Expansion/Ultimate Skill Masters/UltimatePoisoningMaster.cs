...
{
    [CorpseName("an Poisoning master's corpse")]
    public class UltimatePoisoningMaster : QuestGiver
    {
        public override bool IsInvulnerable { get { return true; } }
        [Constructable]
        public UltimatePoisoningMaster()
        {
            ...
            Title = "the ultimate Poisoning master";
            CantWalk = true;
        }

        public UltimatePoisoningMaster(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            return QuestHandler.HandleOnDragDrop(from, dropped, SkillName.Poisoning, "Poisoning", 0x4B5); // Bushido hue
        }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            list.Add(new QuestGiverContextMenuEntry(from, "Poisoning Master", "Poisoning"));
        }
    }
}
