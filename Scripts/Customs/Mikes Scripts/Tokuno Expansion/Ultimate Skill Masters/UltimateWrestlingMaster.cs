...
{
    [CorpseName("an Wrestling master's corpse")]
    public class UltimateWrestlingMaster : QuestGiver
    {
        public override bool IsInvulnerable { get { return true; } }
        [Constructable]
        public UltimateWrestlingMaster()
        {
            ...
            Title = "the ultimate Wrestling master";
            CantWalk = true;
        }

        public UltimateWrestlingMaster(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            return QuestHandler.HandleOnDragDrop(from, dropped, SkillName.Wrestling, "Wrestling", 0x4B5); // Bushido hue
        }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            list.Add(new QuestGiverContextMenuEntry(from, "Wrestling Master", "Wrestling"));
        }
    }
}
