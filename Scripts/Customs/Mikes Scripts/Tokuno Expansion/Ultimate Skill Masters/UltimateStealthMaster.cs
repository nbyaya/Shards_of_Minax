...
{
    [CorpseName("an Stealth master's corpse")]
    public class UltimateStealthMaster : QuestGiver
    {
        public override bool IsInvulnerable { get { return true; } }
        [Constructable]
        public UltimateStealthMaster()
        {
            ...
            Title = "the ultimate Stealth master";
            CantWalk = true;
        }

        public UltimateStealthMaster(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            return QuestHandler.HandleOnDragDrop(from, dropped, SkillName.Stealth, "Stealth", 0x4B5); // Bushido hue
        }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            list.Add(new QuestGiverContextMenuEntry(from, "Stealth Master", "Stealth"));
        }
    }
}
