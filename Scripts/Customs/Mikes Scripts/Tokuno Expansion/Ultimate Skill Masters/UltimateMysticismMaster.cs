...
{
    [CorpseName("an Mysticism master's corpse")]
    public class UltimateMysticismMaster : QuestGiver
    {
        public override bool IsInvulnerable { get { return true; } }
        [Constructable]
        public UltimateMysticismMaster()
        {
            ...
            Title = "the ultimate Mysticism master";
            CantWalk = true;
        }

        public UltimateMysticismMaster(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            return QuestHandler.HandleOnDragDrop(from, dropped, SkillName.Mysticism, "Mysticism", 0x4B5); // Bushido hue
        }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            list.Add(new QuestGiverContextMenuEntry(from, "Mysticism Master", "Mysticism"));
        }
    }
}
