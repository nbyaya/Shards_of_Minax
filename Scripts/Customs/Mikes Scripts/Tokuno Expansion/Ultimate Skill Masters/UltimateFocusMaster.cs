...
{
    [CorpseName("an Focus master's corpse")]
    public class UltimateFocusMaster : QuestGiver
    {
        public override bool IsInvulnerable { get { return true; } }
        [Constructable]
        public UltimateFocusMaster()
        {
            ...
            Title = "the ultimate Focus master";
            CantWalk = true;
        }

        public UltimateFocusMaster(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            return QuestHandler.HandleOnDragDrop(from, dropped, SkillName.Focus, "Focus", 0x4B5); // Bushido hue
        }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            list.Add(new QuestGiverContextMenuEntry(from, "Focus Master", "Focus"));
        }
    }
}
