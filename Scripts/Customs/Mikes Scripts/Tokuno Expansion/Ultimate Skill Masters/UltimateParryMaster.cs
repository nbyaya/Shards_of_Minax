...
{
    [CorpseName("an Parry master's corpse")]
    public class UltimateParryMaster : QuestGiver
    {
        public override bool IsInvulnerable { get { return true; } }
        [Constructable]
        public UltimateParryMaster()
        {
            ...
            Title = "the ultimate Parry master";
            CantWalk = true;
        }

        public UltimateParryMaster(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            return QuestHandler.HandleOnDragDrop(from, dropped, SkillName.Parry, "Parry", 0x4B5); // Bushido hue
        }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            list.Add(new QuestGiverContextMenuEntry(from, "Parry Master", "Parry"));
        }
    }
}
