...
{
    [CorpseName("an EvalInt master's corpse")]
    public class UltimateEvalIntMaster : QuestGiver
    {
        public override bool IsInvulnerable { get { return true; } }
        [Constructable]
        public UltimateEvalIntMaster()
        {
            ...
            Title = "the ultimate EvalInt master";
            CantWalk = true;
        }

        public UltimateEvalIntMaster(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            return QuestHandler.HandleOnDragDrop(from, dropped, SkillName.EvalInt, "EvalInt", 0x4B5); // Bushido hue
        }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            list.Add(new QuestGiverContextMenuEntry(from, "EvalInt Master", "EvalInt"));
        }
    }
}
