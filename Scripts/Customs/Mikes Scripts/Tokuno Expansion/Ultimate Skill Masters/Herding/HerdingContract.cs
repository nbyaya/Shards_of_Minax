...
namespace Server.Items
{
    ...
    public class HerdingContract : Item
    {
        ...
        [Constructable]
        public HerdingContract(PlayerMobile player) : base(0x14EF)
        {
            Weight = 1.0;
            Movable = true;
            ...
            var candidates = HerdingContractType.Get
                .Where(ct =>
                {
                    try
                    {
            ...
            {
                Name = "Herding Contract: No tamable creatures available";
                return;
            }
            ...
            m_CreatureType = Array.IndexOf(HerdingContractType.Get, selected);
            ...
            Name = $"Herding Contract: {m_AmountToTame} {selected.Name}";

            // Power‐scroll defaults
            m_PowerScrollSkill = SkillName.Herding;
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                // Calculate PowerScrollValue based on player's current Herding skill cap
                Skill Herding = from.Skills[SkillName.Herding];
                if (Herding != null)
                {
                    double currentCap = Herding.Cap;
                ...
                from.SendGump(new HerdingContractGump(from, this));
            }
            else
            {
        ...
        public HerdingContract(Serial serial) : base(serial) { }
