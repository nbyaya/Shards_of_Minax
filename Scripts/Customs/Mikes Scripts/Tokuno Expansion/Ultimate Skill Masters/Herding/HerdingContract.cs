...
namespace Server.Items
{
    ...
    public class HerdingContract : Item
    {
        ...
        public HerdingContract(PlayerMobile player) : base(0x14EF)
        {
            ...
            var validCreatures = HerdingContractType.Get.Where(creatureType =>
            {
                try
                {
            ...
            if (validCreatures.Count > 0)
            {
                ...
                Name = "Herding Contract: " + AmountToTame + " " + selectedCreature.Name;
                AmountTamed = 0;

                PowerScrollSkill = SkillName.Herding;
