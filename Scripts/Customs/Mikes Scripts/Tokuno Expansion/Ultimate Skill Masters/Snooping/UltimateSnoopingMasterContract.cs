...
{
    public class UltimateSnoopingMasterContract : Item
    {
        ...
        [Constructable]
        public UltimateSnoopingMasterContract() : base(0x14EF)
        {
            Weight = 1.0;
            Movable = true;
            ...
            int itemIndex = SnoopingCollectionType.Random();
            ItemType = SnoopingCollectionType.Items[itemIndex].Type;
            AmountNeeded = Utility.Random(10) + 10; // a bit more demanding
            Name = $"Snooping Collection Contract: {AmountNeeded} {SnoopingCollectionType.Items[itemIndex].Name}(s)";
            AmountCollected = 0;
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                from.SendGump(new UltimateSnoopingMasterContractGump(from, this));
            }
            else
            {
        ...
        public UltimateSnoopingMasterContract(Serial serial) : base(serial)
        {
        }
