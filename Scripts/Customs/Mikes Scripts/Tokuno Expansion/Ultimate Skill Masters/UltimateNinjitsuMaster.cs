...
{
    [CorpseName("an Ninjitsu master's corpse")]
    public class UltimateNinjitsuMaster : QuestGiver
    {
        public override bool IsInvulnerable { get { return true; } }
        [Constructable]
        public UltimateNinjitsuMaster()
        {
            ...
            Title = "the ultimate Ninjitsu master";
            CantWalk = true;
        }

        public UltimateNinjitsuMaster(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            return QuestHandler.HandleOnDragDrop(from, dropped, SkillName.Ninjitsu, "Ninjitsu", 0x4B5); // Bushido hue
        }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            list.Add(new QuestGiverContextMenuEntry(from, "Ninjitsu Master", "Ninjitsu"));
        }
    }
}
