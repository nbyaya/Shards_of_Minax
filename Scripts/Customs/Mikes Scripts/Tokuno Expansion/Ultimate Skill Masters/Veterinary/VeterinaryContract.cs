...
namespace Server.Items
{
    ...
    public class VeterinaryContract : Item
    {
        ...
        public VeterinaryContract(PlayerMobile player) : base(0x14EF)
        {
            ...
            var validCreatures = VeterinaryContractType.Get.Where(creatureType =>
            {
                try
                {
            ...
            if (validCreatures.Count > 0)
            {
                ...
                Name = "Veterinary Contract: " + AmountToTame + " " + selectedCreature.Name;
                AmountTamed = 0;

                PowerScrollSkill = SkillName.Veterinary;
