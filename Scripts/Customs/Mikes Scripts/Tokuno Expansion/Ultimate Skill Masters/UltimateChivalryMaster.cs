...
{
    [CorpseName("an Chivalry master's corpse")]
    public class UltimateChivalryMaster : QuestGiver
    {
        public override bool IsInvulnerable { get { return true; } }

        [Constructable]
        public UltimateChivalryMaster()
        {
            ...
            Title = "the ultimate Chivalry master";
            CantWalk = true;
        }

        public UltimateChivalryMaster(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            return QuestHandler.HandleOnDragDrop(from, dropped, SkillName.Chivalry, "Chivalry", 0x4B5); // Bushido hue
        }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            list.Add(new QuestGiverContextMenuEntry(from, "Chivalry Master", "Chivalry"));
        }
    }
}
