...
{
    public class UltimateImbuingMasterContract : Item
    {
        ...
        [Constructable]
        public UltimateImbuingMasterContract() : base(0x14EF)
        {
            Weight = 1.0;
            Movable = true;
            ...
            int itemIndex = ImbuingCollectionType.Random();
            ItemType = ImbuingCollectionType.Items[itemIndex].Type;
            AmountNeeded = Utility.Random(10) + 10; // a bit more demanding
            Name = $"Imbuing Collection Contract: {AmountNeeded} {ImbuingCollectionType.Items[itemIndex].Name}(s)";
            AmountCollected = 0;
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                from.SendGump(new UltimateImbuingMasterContractGump(from, this));
            }
            else
            {
        ...
        public UltimateImbuingMasterContract(Serial serial) : base(serial)
        {
        }
