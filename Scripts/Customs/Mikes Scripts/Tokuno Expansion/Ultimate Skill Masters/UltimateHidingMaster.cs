...
{
    [CorpseName("an Hiding master's corpse")]
    public class UltimateHidingMaster : QuestGiver
    {
        public override bool IsInvulnerable { get { return true; } }
        [Constructable]
        public UltimateHidingMaster()
        {
            ...
            Title = "the ultimate Hiding master";
            CantWalk = true;
        }

        public UltimateHidingMaster(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            return QuestHandler.HandleOnDragDrop(from, dropped, SkillName.Hiding, "Hiding", 0x4B5); // Bushido hue
        }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            list.Add(new QuestGiverContextMenuEntry(from, "Hiding Master", "Hiding"));
        }
    }
}
