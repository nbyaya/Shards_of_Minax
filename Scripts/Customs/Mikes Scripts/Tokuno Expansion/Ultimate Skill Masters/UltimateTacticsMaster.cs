...
{
    [CorpseName("an Tactics master's corpse")]
    public class UltimateTacticsMaster : QuestGiver
    {
        public override bool IsInvulnerable { get { return true; } }
        [Constructable]
        public UltimateTacticsMaster()
        {
            ...
            Title = "the ultimate Tactics master";
            CantWalk = true;
        }

        public UltimateTacticsMaster(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            return QuestHandler.HandleOnDragDrop(from, dropped, SkillName.Tactics, "Tactics", 0x4B5); // Bushido hue
        }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            list.Add(new QuestGiverContextMenuEntry(from, "Tactics Master", "Tactics"));
        }
    }
}
