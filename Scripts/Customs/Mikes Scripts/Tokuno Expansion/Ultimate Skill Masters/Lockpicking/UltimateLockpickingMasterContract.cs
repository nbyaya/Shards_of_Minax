...
{
    public class UltimateLockpickingMasterContract : Item
    {
        ...
        [Constructable]
        public UltimateLockpickingMasterContract() : base(0x14EF)
        {
            Weight = 1.0;
            Movable = true;
            ...
            int itemIndex = LockpickingCollectionType.Random();
            ItemType = LockpickingCollectionType.Items[itemIndex].Type;
            AmountNeeded = Utility.Random(10) + 10; // a bit more demanding
            Name = $"Lockpicking Collection Contract: {AmountNeeded} {LockpickingCollectionType.Items[itemIndex].Name}(s)";
            AmountCollected = 0;
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                from.SendGump(new UltimateLockpickingMasterContractGump(from, this));
            }
            else
            {
        ...
        public UltimateLockpickingMasterContract(Serial serial) : base(serial)
        {
        }
