...
{
    [CorpseName("an Fencing master's corpse")]
    public class UltimateFencingMaster : QuestGiver
    {
        public override bool IsInvulnerable { get { return true; } }
        [Constructable]
        public UltimateFencingMaster()
        {
            ...
            Title = "the ultimate Fencing master";
            CantWalk = true;
        }

        public UltimateFencingMaster(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnDragDrop(Mobile from, Item dropped)
        {
            ...
            return QuestHandler.HandleOnDragDrop(from, dropped, SkillName.Fencing, "Fencing", 0x4B5); // Bushido hue
        }
        ...
        public override void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            list.Add(new QuestGiverContextMenuEntry(from, "Fencing Master", "Fencing"));
        }
    }
}
