...
{
    public class UltimateStealingMasterContract : Item
    {
        ...
        [Constructable]
        public UltimateStealingMasterContract() : base(0x14EF)
        {
            Weight = 1.0;
            Movable = true;
            ...
            int itemIndex = StealingCollectionType.Random();
            ItemType = StealingCollectionType.Items[itemIndex].Type;
            AmountNeeded = Utility.Random(10) + 10; // a bit more demanding
            Name = $"Stealing Collection Contract: {AmountNeeded} {StealingCollectionType.Items[itemIndex].Name}(s)";
            AmountCollected = 0;
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                from.SendGump(new UltimateStealingMasterContractGump(from, this));
            }
            else
            {
        ...
        public UltimateStealingMasterContract(Serial serial) : base(serial)
        {
        }
