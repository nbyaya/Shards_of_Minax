...
{
    public class ToxicWardensSash : BodySash
    {
        private Timer m_Timer;
        private int m_BonusFollowers;

        [Constructable]
        public ToxicWardensSash()
        {
            Weight = 1.0;
            Name = "Toxic Warden's Sash";
            Hue = 1167; // Toxic green color
        ...
        public ToxicWardensSash(Serial serial) : base(serial)
        {
        }
        ...
        public override void OnRemoved(object parent)
        {
            ...
            if (parent is PlayerMobile pm)
            {
                ...
                pm.FollowersMax -= m_BonusFollowers;
                pm.SendMessage(37, "You feel your control over toxic beings weaken.");
            }
        ...
        private class SummonAcidElementalTimer : Timer
        {
            ...
            protected override void OnTick()
            {
                ...
                if (m_Owner.Followers < m_Owner.FollowersMax)
                {
                    ...
                    popper.MoveToWorld(m_Owner.Location, m_Owner.Map);
                    m_Owner.SendMessage(38, "An AcidElemental emerges from the toxic ether to serve you!");
                }
            }
        }
    }
