...
{
    public class SwamplardsSash : BodySash
    {
        private Timer m_Timer;
        private int m_BonusFollowers;

        [Constructable]
        public SwamplardsSash()
        {
            Weight = 1.0;
            Name = "Swamproot Sash";
        ...
        public SwamplardsSash(Serial serial) : base(serial)
        {
        }
        ...
        private class SummonSwampTentacleTimer : Timer
        {
            ...
            {
                if (m_Owner == null || m_Owner.Deleted || !(m_Owner.FindItemOnLayer(Layer.Waist) is SwamplardsSash))
                {
                    Stop();
                    return;
                }
                ...
                {
                    TanglingRoots tentacle = new TanglingRoots
                    {
                        Controlled = true,
