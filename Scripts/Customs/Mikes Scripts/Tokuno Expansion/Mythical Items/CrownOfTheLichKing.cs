...
{
    public class CrownOfTheLichKing : PlateHelm
    {
        private Timer m_Timer;
        private int m_BonusFollowers;

        [Constructable]
        public CrownOfTheLichKing()
        {
            Weight = 5.0;
            Name = "Crown of the Lich King";
            Hue = 1175; // Shadowy, undead-like hue
        ...
        public CrownOfTheLichKing(Serial serial) : base(serial)
        {
        }
        ...
        public override void OnRemoved(object parent)
        {
            ...
            if (parent is PlayerMobile pm)
            {
                ...
                pm.FollowersMax -= m_BonusFollowers;
                pm.SendMessage(37, "The dark power fades, reducing your control over followers.");
            }
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            list.Add("Summons Lich Lords");
            list.Add("Increases maximum followers by 2");
            list.Add("Boosts Necromancy and Spirit Speak skills");
        }
        ...
        private class SummonLichLordTimer : Timer
        {
            private Mobile m_Owner;

            public SummonLichLordTimer(Mobile owner)
            ...
            {
                if (m_Owner == null || m_Owner.Deleted || !(m_Owner.FindItemOnLayer(Layer.Helm) is CrownOfTheLichKing))
                {
                    Stop();
                    return;
                }
                ...
                if (AutoSummonManager.IsAutoSummonEnabled(m_Owner) && m_Owner.Followers < m_Owner.FollowersMax)
                {
                    ...
                    lichLord.MoveToWorld(m_Owner.Location, m_Owner.Map);
                    m_Owner.SendMessage(38, "A Lich Lord emerges from the shadows to serve you!");
                }
            }
        }
    }
