...
{
    public class RareGambleMobile : BaseCreature
    {
        // Existing code...
        [Constructable]
        public RareGambleMobile() : base(AIType.AI_Vendor, FightMode.None, 2, 1, 0.5, 2)
        {
        ...
        public RareGambleMobile(Serial serial) : base(serial)
        {
        }
