...
{
    public class BookGambleMobile : BaseCreature
    {
        // Existing code...
        [Constructable]
        public BookGambleMobile() : base(AIType.AI_Vendor, FightMode.None, 2, 1, 0.5, 2)
        {
            // Set the NPC's attributes here
            Hue = Utility.RandomSkinHue();
            Body = 0x190;
            Name = "Special Librarian";
        ...
        public BookGambleMobile(Serial serial) : base(serial)
        {
        }
