...
{
    public class MasterSkillTrainer : BaseCreature
    {
        [Constructable]
        public MasterSkillTrainer() : base(AIType.AI_Vendor, FightMode.None, 2, 1, 0.5, 2)
        {
        ...
        public MasterSkillTrainer(Serial serial) : base(serial)
        {
        }
