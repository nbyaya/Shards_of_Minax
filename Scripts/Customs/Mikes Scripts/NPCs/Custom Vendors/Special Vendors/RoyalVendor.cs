...
namespace Server.Custom.RoyalVendor
{
    public class RoyalVendor : BaseCreature
    {
        [Constructable]
        public RoyalVendor() : base(AIType.AI_Vendor, FightMode.None, 2, 1, 0.5, 2)
        {
        ...
        public RoyalVendor(Serial serial) : base(serial)
        {
        }
