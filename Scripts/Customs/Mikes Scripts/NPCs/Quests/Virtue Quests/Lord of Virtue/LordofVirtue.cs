...
namespace Server.Custom.LordofVirtue
{
    public class LordofVirtue : BaseCreature
    {
        [Constructable]
        public LordofVirtue() : base(AIType.AI_Vendor, FightMode.None, 2, 1, 0.5, 2)
        {
			...
			this.AddItem(new TallStrawHat(0x5E8));	
        }
        ...
        public LordofVirtue(Serial serial) : base(serial)
        {
        }
