...
{
    public class MonsterChestAX : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAX() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int juggernautCount = Utility.Random(1, 6);

            for (int i = 0; i < juggernautCount; i++)
                monsters.Add(new JazzAgeJuggernaut());
        ...
        public MonsterChestAX(Serial serial) : base(serial)
        {
        }
