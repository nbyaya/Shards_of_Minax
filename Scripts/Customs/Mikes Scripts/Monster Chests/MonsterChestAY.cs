...
{
    public class MonsterChestAY : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAY() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int paladinCount = Utility.Random(1, 6);

            for (int i = 0; i < paladinCount; i++)
                monsters.Add(new PunkRockPaladin());
        ...
        public MonsterChestAY(Serial serial) : base(serial)
        {
        }
