...
{
    public class MonsterChestAO : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAO() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int beastmasterCount = Utility.Random(1, 6);

            for (int i = 0; i < beastmasterCount; i++)
                monsters.Add(new BmovieBeastmaster());
        ...
        public MonsterChestAO(Serial serial) : base(serial)
        {
        }
