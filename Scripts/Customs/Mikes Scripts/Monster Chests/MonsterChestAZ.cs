...
{
    public class MonsterChestAZ : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAZ() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int robotCount = Utility.Random(1, 6);

            for (int i = 0; i < robotCount; i++)
                monsters.Add(new RetroRobotRomancer()); // Spawn RetroRobotRomancer instead of Pirate
        ...
        public MonsterChestAZ(Serial serial) : base(serial)
        {
        }
