...
{
    public class MonsterChestAQ : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAQ() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int mechanicCount = Utility.Random(1, 6);

            for (int i = 0; i < mechanicCount; i++)
                monsters.Add(new RenaissanceMechanic());
        ...
        public MonsterChestAQ(Serial serial) : base(serial)
        {
        }
