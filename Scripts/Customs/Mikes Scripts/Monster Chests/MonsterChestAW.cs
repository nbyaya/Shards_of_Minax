...
{
    public class MonsterChestAW : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAW() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int vampireCount = Utility.Random(1, 6);

            for (int i = 0; i < vampireCount; i++)
                monsters.Add(new NeoVictorianVampire()); // Use NeoVictorianVampire instead of Pirate
        ...
        public MonsterChestAW(Serial serial) : base(serial)
        {
        }
