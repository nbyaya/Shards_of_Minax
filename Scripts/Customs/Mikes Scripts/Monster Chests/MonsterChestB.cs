...
{
    public class MonsterChestB : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestB() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int pirateCount = Utility.Random(1, 6);

            for (int i = 0; i < pirateCount; i++)
                monsters.Add(new Pirate());
        ...
        public MonsterChestB(Serial serial) : base(serial)
        {
        }
