...
{
    public class MonsterChestBI : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestBI() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int raveRogueCount = Utility.Random(1, 6);

            for (int i = 0; i < raveRogueCount; i++)
                monsters.Add(new RaveRogue()); // Make sure you have a RaveRogue class defined in your scripts.
        ...
        public MonsterChestBI(Serial serial) : base(serial)
        {
        }
