...
{
    public class MonsterChestBC : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestBC() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int surferSummonerCount = Utility.Random(1, 6);

            for (int i = 0; i < surferSummonerCount; i++)
                monsters.Add(new SurferSummoner()); // Change this to the appropriate SurferSummoner class name
        ...
        public MonsterChestBC(Serial serial) : base(serial)
        {
        }
