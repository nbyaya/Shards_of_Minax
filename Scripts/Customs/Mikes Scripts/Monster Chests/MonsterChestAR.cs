...
{
    public class MonsterChestAR : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAR() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int shamanCount = Utility.Random(1, 6);

            for (int i = 0; i < shamanCount; i++)
                monsters.Add(new PsychedelicShaman());
        ...
        public MonsterChestAR(Serial serial) : base(serial)
        {
        }
