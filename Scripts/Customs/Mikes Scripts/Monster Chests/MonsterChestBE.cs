...
{
    public class MonsterChestBE : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestBE() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int hopliteCount = Utility.Random(1, 6);

            for (int i = 0; i < hopliteCount; i++)
                monsters.Add(new HippieHoplite()); // Spawn HippieHoplite
        ...
        public MonsterChestBE(Serial serial) : base(serial)
        {
        }
