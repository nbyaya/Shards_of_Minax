...
{
    public class MonsterChestBH : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestBH() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int fungiCount = Utility.Random(1, 6);

            for (int i = 0; i < fungiCount; i++)
                monsters.Add(new FunkFungiFamiliar());
        ...
        public MonsterChestBH(Serial serial) : base(serial)
        {
        }
