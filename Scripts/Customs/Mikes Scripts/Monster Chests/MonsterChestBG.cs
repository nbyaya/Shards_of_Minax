...
{
    public class MonsterChestBG : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestBG() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int sorceressCount = Utility.Random(1, 6);

            for (int i = 0; i < sorceressCount; i++)
                monsters.Add(new SwinginSorceress());
        ...
        public MonsterChestBG(Serial serial) : base(serial)
        {
        }
