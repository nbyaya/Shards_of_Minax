...
{
    public class MonsterChestAM : WoodenChest
    {
        private bool m_Activated = false;

        [Constructable]
        public MonsterChestAM() : base()
        {
            this.Movable = true;
        }
        ...
        private void SpawnCreatures(Mobile from)
        {
            ...
            int flapperElementalistCount = Utility.Random(1, 6);

            for (int i = 0; i < flapperElementalistCount; i++)
                monsters.Add(new FlapperElementalist());
        ...
        public MonsterChestAM(Serial serial) : base(serial)
        {
        }
