...
{
    public class XmlGlowLine : XmlAttachment
    {
        ...
        public XmlGlowLine(ASerial serial) : base(serial) { }

        [Attachable]
        public XmlGlowLine() { }

        [Attachable]
        public XmlGlowLine(double refractory, int damage, int range)
        {
            ...
            for (int i = 0; i < m_Range; i++)
            {
                ...
                for (int thickness = -1; thickness <= 1; thickness++)
                {
                    ...
                    if (map.CanFit(thickX, thickY, start.Z, 16, false, false))
                    {
                        ...
                        int glowHue = 0;  // Adjust hue if needed
                        Effects.SendLocationEffect(p, map, 0x37B9, 16, 10, glowHue, 0);
