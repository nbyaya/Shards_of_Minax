...
{
    public class XmlOFlaskLine : XmlAttachment
    {
        ...
        public XmlOFlaskLine(ASerial serial) : base(serial) { }

        [Attachable]
        public XmlOFlaskLine() { }

        [Attachable]
        public XmlOFlaskLine(double refractory, int damage, int range)
        {
            ...
            for (int i = 0; i < m_Range; i++)
            {
                ...
                for (int thickness = -1; thickness <= 1; thickness++)
                {
                    ...
                    if (map.CanFit(thickX, thickY, start.Z, 16, false, false))
                    {
                        ...
                        Effects.SendLocationEffect(p, map, 0x1C19, 16, 10, flameHue, 0);
