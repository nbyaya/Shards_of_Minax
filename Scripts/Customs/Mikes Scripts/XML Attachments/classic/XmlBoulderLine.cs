...
{
    public class XmlBoulderLine : XmlAttachment
    {
        ...
        public XmlBoulderLine(ASerial serial) : base(serial) { }

        [Attachable]
        public XmlBoulderLine() { }

        [Attachable]
        public XmlBoulderLine(double refractory, int damage, int range)
        {
            ...
            for (int i = 0; i < m_Range; i++)
            {
                ...
                for (int thickness = -1; thickness <= 1; thickness++)
                {
                    ...
                    if (map.CanFit(thickX, thickY, start.Z, 16, false, false))
                    {
                        ...
                        int boulderHue = 0;  // Or adjust hue if needed
                        Effects.SendLocationEffect(p, map, 0x3660, 16, 10, boulderHue, 0);
