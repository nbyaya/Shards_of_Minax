...
{
    public class XmlCrankLine : XmlAttachment
    {
        ...
        public XmlCrankLine(ASerial serial) : base(serial) { }

        [Attachable]
        public XmlCrankLine() { }

        [Attachable]
        public XmlCrankLine(double refractory, int damage, int range)
        {
            ...
            for (int i = 0; i < m_Range; i++)
            {
                ...
                for (int thickness = -1; thickness <= 1; thickness++)
                {
                    ...
                    if (map.CanFit(thickX, thickY, start.Z, 16, false, false))
                    {
                        ...
                        int flameHue = 0;
                        Effects.SendLocationEffect(p, map, 0x1934, 16, 10, flameHue, 0);
