...
namespace Server.ACC.CSS.Systems.HidingMagic
{
    ...
    public class HidingTree
    {
        ...
        public HidingTree(PlayerMobile player)
        {
            ...
            nodeIndex <<= 1;
            var shadowCamouflage = new SkillNode(nodeIndex, "Shadow's Camouflage", 6, "Enhances your ability to blend with shadows", (p) =>
            {
                p.AcquireTalents().Talents[TalentID.HidingEfficiency].Points += 1;
            });

            nodeIndex <<= 1;
            var silentMovement = new SkillNode(nodeIndex, "Silent Movement", 6, "Allows you to move without noise", (p) =>
            {
                p.AcquireTalents().Talents[TalentID.HidingEfficiency].Points += 1;
            });
            ...
            nodeIndex <<= 1;
            var ghostlyQuiet = new SkillNode(nodeIndex, "Ghostly Quiet", 8, "Reduces detection range", (p) =>
            {
                p.AcquireTalents().Talents[TalentID.HidingEfficiency].Points += 1;
            });
            ...
            nodeIndex <<= 1;
            var darkenedAura = new SkillNode(nodeIndex, "Darkened Aura", 9, "Reduces chance of detection", (p) =>
            {
                p.AcquireTalents().Talents[TalentID.HidingEfficiency].Points += 1;
            });
            ...
            nodeIndex <<= 1;
            var quickFade = new SkillNode(nodeIndex, "Quick Fade", 10, "Allows rapid re-hiding after combat", (p) =>
            {
                p.AcquireTalents().Talents[TalentID.HidingEfficiency].Points += 1;
            });

            shadowsFortitude.AddChild(stealthEfficiency);
            silenceOfTheNight.AddChild(cloakOfShadows);
            ...
            nodeIndex <<= 1;
            var fadeMastery = new SkillNode(nodeIndex, "Fade Mastery", 11, "Improves speed of fading into shadows", (p) =>
            {
                p.AcquireTalents().Talents[TalentID.HidingEfficiency].Points += 1;
            });
            ...
            {
                p.AcquireTalents().Talents[TalentID.HidingSpells].Points |= 0x400 | 0x800;
                p.AcquireTalents().Talents[TalentID.HidingEfficiency].Points += 1;
            });
