...
{
    public class TrainingPuzzleBox : Item
    {
        public List<int> Path { get; set; }

        [Constructable]
        public TrainingPuzzleBox() : base(0xE80) // Wooden box item ID
        {
            Name = "Training Puzzle Box";
            Weight = 1.0;
            Path = GetRandomPath();
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                from.SendGump(new PuzzleBoxGump((PlayerMobile)from, this));
            }
        }
        ...
        {
            pm.PrivateOverheadMessage(MessageType.Regular, 0x35, false, "You have solved the puzzle and gained experience in Remove Trap!", pm.NetState);
            pm.CheckSkill(SkillName.RemoveTrap, 0, 100);
            Delete();
        }

        public TrainingPuzzleBox(Serial serial) : base(serial)
        {
        }
        ...
        public class PuzzleBoxGump : Gump
        {
            public TrainingPuzzleBox Box { get; set; }
            ...
            public PuzzleBoxGump(PlayerMobile pm, TrainingPuzzleBox box)
                : base(25, 25)
            {
                Box = box;
                User = pm;
            ...
            public void AddGumpLayout()
            {
                ...
                AddHtml(220, 90, 210, 16, "<center>Training Puzzle Box</center>", false, false);
                ...
                if (User.Skills[SkillName.RemoveTrap].Base >= 100)
                {
            ...
            public void HandleButton(int id)
            {
                ...
                if (id > 0 && id < 5)
                {
                    ...
                    if (Progress.Contains(pick) || pick < 0 || pick > 15)
                    {
