...
{
    public class TreasureMap1Scroll : Item
    {
        [Constructable]
        public TreasureMap1Scroll() : base(0x1F4C) // Item ID for a scroll
        {
        ...
        public TreasureMap1Scroll(Serial serial) : base(serial)
        {
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            TreasureMap treasureMap = new TreasureMap(1, from.Map);
            ...
            {
                from.SendMessage("A level 1 treasure map has been placed in your backpack.");
