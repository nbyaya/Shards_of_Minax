...
{
    public class TreasureMap4Scroll : Item
    {
        [Constructable]
        public TreasureMap4Scroll() : base(0x1F4C) // Item ID for a scroll
        {
        ...
        public TreasureMap4Scroll(Serial serial) : base(serial)
        {
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            TreasureMap treasureMap = new TreasureMap(4, from.Map);
            ...
            {
                from.SendMessage("A level 4 treasure map has been placed in your backpack.");
