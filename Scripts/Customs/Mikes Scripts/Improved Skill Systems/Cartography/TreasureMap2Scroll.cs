...
{
    public class TreasureMap2Scroll : Item
    {
        [Constructable]
        public TreasureMap2Scroll() : base(0x1F4C) // Item ID for a scroll
        {
        ...
        public TreasureMap2Scroll(Serial serial) : base(serial)
        {
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            TreasureMap treasureMap = new TreasureMap(2, from.Map);
            ...
            {
                from.SendMessage("A level 2 treasure map has been placed in your backpack.");
