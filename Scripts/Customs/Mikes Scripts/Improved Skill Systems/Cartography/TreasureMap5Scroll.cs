...
{
    public class TreasureMap5Scroll : Item
    {
        [Constructable]
        public TreasureMap5Scroll() : base(0x1F4C) // Item ID for a scroll
        {
        ...
        public TreasureMap5Scroll(Serial serial) : base(serial)
        {
        }
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            TreasureMap treasureMap = new TreasureMap(5, from.Map);
            ...
            {
                from.SendMessage("A level 5 treasure map has been placed in your backpack.");
