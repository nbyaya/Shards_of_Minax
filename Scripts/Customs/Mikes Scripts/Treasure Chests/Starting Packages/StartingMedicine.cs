...
{
    public class StartingMedicine : LockableContainer
    {
        [Constructable]
        public StartingMedicine() : base(0x9A8) // Medicine Cabinet item ID
        {
        ...
        public StartingMedicine(Serial serial) : base(serial)
        {
        }
