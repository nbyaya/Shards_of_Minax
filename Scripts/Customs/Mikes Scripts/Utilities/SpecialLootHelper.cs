...
namespace Server.Custom
{
    public class SpecialLootHelper
    {
        private static readonly List<Func<Item>> LootTable = new List<Func<Item>>
        {
            ...
            () => new RandomMagicArmor(),
            () => new RandomMagicArmor(),
            () => new RandomMagicArmor(), // Adjust chance as needed
            () => new AlchemyAugmentCrystal(),
            ...
            () => new Zulfiqar(),
            () => new AbbasidsTreasureChest(),
            () => new AbyssalPlaneChest(),
            () => new AlehouseChest(),
            () => new AlienArtifactChest(),
            () => new AlienArtifaxChest(),
            () => new AlliedForcesTreasureChest(),
            () => new AnarchistsCache(),
            () => new AncientRelicChest(),
            () => new AngelBlessingChest(),
            () => new AnglersBounty(),
            () => new ArcadeKingsTreasure(),
            () => new ArcadeMastersVault(),
            () => new ArcaneTreasureChest(),
            () => new ArcanumChest(),
            () => new ArcheryBonusChest(),
            () => new AshokasTreasureChest(),
            () => new AshokaTreasureChest(),
            () => new AssassinsCoffer(),
            () => new AthenianTreasureChest(),
            () => new BabylonianChest(),
            () => new BakersDelightChest(),
            () => new BakersDolightChest(),
            () => new BavarianFestChest(),
            () => new BismarcksTreasureChest(),
            () => new BolsheviksLoot(),
            () => new BountyHuntersCache(),
            () => new BoyBandBox(),
            () => new BrewmastersChest(),
            () => new BritainsRoyalTreasuryChest(),
            () => new BuccaneersChest(),
            () => new CaesarChest(),
            () => new CandyCarnivalCoffer(),
            () => new CaptainCooksTreasure(),
            () => new CelticLegendsChest(),
            () => new ChamplainTreasureChest(),
            () => new CheeseConnoisseursCache(),
            () => new ChocolatierTreasureChest(),
            () => new CivilRightsStrongbox(),
            () => new CivilWarCache(),
            () => new CivilWarChest(),
            () => new CivilWorChest(),
            () => new ClownsWhimsicalChest(),
            () => new ColonialPioneersCache(),
            () => new ComradesCache(),
            () => new ConfederationCache(),
            () => new ConquistadorsHoard(),
            () => new CovenTreasuresChest(),
            () => new CyberneticCache(),
            () => new CyrusTreasure(),
            () => new DesertPharaohChest(),
            () => new DinerDelightChest(),
            () => new DoctorsBag(),
            () => new DojoLegacyChest(),
            () => new DragonGuardiansHoardChest(),
            () => new DragonHoardChest(),
            () => new DragonHoChest(),
            () => new DragonHodChest(),
            () => new DragonHorChest(),
            () => new DriveInTreasureTrove(),
            () => new DroidWorkshopChest(),
            () => new DynastyRelicsChest(),
            () => new EdisonsTreasureChest(),
            () => new EgyptianChest(),
            () => new EliteFoursVault(),
            () => new ElvenEnchantressChest(),
            () => new ElvenTreasuryChest(),
            () => new EmeraldIsleChest(),
            () => new EmperorJustinianCache(),
            () => new EmperorLegacyChest(),
            () => new EnchantedForestChest(),
            () => new EtherealPlaneChest(),
            () => new EuropeanRelicsChest(),
            () => new FairyDustChest(),
            () => new FirstNationsHeritageChest(),
            () => new FlowerPowerChest(),
            () => new FocusBonusChest(),
            () => new ForbiddenAlchemistsCache(),
            () => new FrontierExplorersStash(),
            () => new FunkyFashionChest(),
            () => new FurTradersChest(),
            () => new GalacticExplorersTrove(),
            () => new GalacticRelicsChest(),
            () => new GamersLootbox(),
            () => new GardenersParadiseChest(),
            () => new GeishasGift(),
            () => new GermanUnificationChest(),
            () => new GoldRushBountyChest(),
            () => new GoldRushRelicChest(),
            () => new GreasersGoldmineChest(),
            () => new GroovyVabesChest(),
            () => new GroovyVibesChest(),
            () => new GrungeRockersCache(),
            () => new HipHopRapVault(),
            () => new HolyRomanEmpireChest(),
            () => new HomewardBoundChest(),
            () => new HussarsChest(),
            () => new InfernalPlaneChest(),
            () => new InnovatorVault(),
            () => new JedisReliquary(),
            () => new JestersGigglingChest(),
            () => new JestersJamboreeChest(),
            () => new JestersJest(),
            () => new JudahsTreasureChest(),
            () => new JukeboxJewels(),
            () => new JustinianTreasureChest(),
            () => new KagesTreasureChest(),
            () => new KingdomsVaultChest(),
            () => new KingKamehamehaTreasure(),
            () => new KingsBest(),
            () => new KoscheisUndyingChest(),
            () => new LawyerBriefcase(),
            () => new LeprechaunsLootChest(),
            () => new LeprechaunsTrove(),
            () => new LouisTreasuryChest(),
            () => new MacingBonusChest(),
            () => new MagesArcaneChest(),
            () => new MagesRelicChest(),
            () => new MaharajaTreasureChest(),
            () => new MarioTreasureBox(),
            () => new MedievalEnglandChest(),
            () => new MerchantChest(),
            () => new MerchantFortuneChest(),
            () => new MermaidTreasureChest(),
            () => new MillenniumTimeCapsule(),
            () => new MimeSilentChest(),
            () => new MirageChest(),
            () => new ModMadnessTrunk(),
            () => new MondainsDarkSecretsChest(),
            () => new MysticalDaoChest(),
            () => new MysticalEnchantersChest(),
            () => new MysticEnigmaChest(),
            () => new MysticGardenCache(),
            () => new MysticMoonChest(),
            () => new NaturesBountyChest(),
            () => new NavyCaptainsChest(),
            () => new NecroAlchemicalChest(),
            () => new NeonNightsChest(),
            () => new NeroChest(),
            () => new NinjaChest(),
            () => new NordicExplorersChest(),
            () => new PatriotCache(),
            () => new PeachRoyalCache(),
            () => new PharaohsReliquary(),
            () => new PharaohsTreasure(),
            () => new PixieDustChest(),
            () => new PokeballTreasureChest(),
            () => new PolishRoyalChest(),
            () => new PopStarsTrove(),
            () => new RadBoomboxTrove(),
            () => new Radical90sRelicsChest(),
            () => new RadRidersStash(),
            () => new RailwayWorkersChest(),
            () => new RebelChest(),
            () => new RenaissanceCollectorsChest(),
            () => new RetroArcadeChest(),
            () => new RevolutionaryChess(),
            () => new RevolutionaryChest(),
            () => new RevolutionaryRelicChest(),
            () => new RevolutionChest(),
            () => new RhineValleyChest(),
            () => new RiverPiratesChest(),
            () => new RiverRaftersChest(),
            () => new RockersVault(),
            () => new RockNBallVault(),
            () => new RockNRallVault(),
            () => new RockNRollVault(),
            () => new RoguesHiddenChest(),
            () => new RomanBritanniaChest(),
            () => new RomanEmperorsVault(),
            () => new SamuraiHonorChest(),
            () => new SamuraiStash(),
            () => new SandstormChest(),
            () => new ScholarEnlightenmentChest(),
            () => new SeaDogsChest(),
            () => new ShinobiSecretsChest(),
            () => new SilkRoadTreasuresChest(),
            () => new SilverScreenChest(),
            () => new SithsVault(),
            () => new SlavicBrosChest(),
            () => new SlavicLegendsChest(),
            () => new SmugglersCache(),
            () => new SocialMediaMavensChest(),
            () => new SorceressSecretsChest(),
            () => new SpaceRaceCache(),
            () => new SpartanTreasureChest(),
            () => new SpecialChivalryChest(),
            () => new SpecialWoodenChestConstantine(),
            () => new SpecialWoodenChestExplorerLegacy(),
            () => new SpecialWoodenChestFrench(),
            () => new SpecialWoodenChestHelios(),
            () => new SpecialWoodenChestIvan(),
            () => new SpecialWoodenChestOisin(),
            () => new SpecialWoodenChestTomoe(),
            () => new SpecialWoodenChestWashington(),
            () => new StarfleetsVault(),
            () => new SugarplumFairyChest(),
            () => new SwingTimeChest(),
            () => new SwordsmanshipBonusChest(),
            () => new TacticsBonusChest(),
            () => new TangDynastyChest(),
            () => new TechnicolorTalesChest(),
            () => new TechnophilesCache(),
            () => new TeutonicRelicChest(),
            () => new TeutonicTreasuresChest(),
            () => new ThiefsHideawayStash(),
            () => new ToxicologistsTrove(),
            () => new TrailblazersTrove(),
            () => new TravelerChest(),
            () => new TreasureChestOfTheQinDynasty(),
            () => new TreasureChestOfTheThreeKingdoms(),
            () => new TsarsLegacyChest(),
            () => new TsarsRoyalChest(),
            () => new TsarsTreasureChest(),
            () => new TudorDynastyChest(),
            () => new UndergroundAnarchistsCache(),
            () => new USSRRelicsChest(),
            () => new VenetianMerchantsStash(),
            () => new VHSAdventureCache(),
            () => new VictorianEraChest(),
            () => new VikingChest(),
            () => new VintnersVault(),
            () => new VinylVault(),
            () => new VirtuesGuardianChest(),
            () => new WarOf1812Vault(),
            () => new WarringStatesChest(),
            () => new WingedHusChest(),
            () => new WingedHussarsChest(),
            () => new WitchsBrewChest(),
            () => new WorkersRevolutionChest(),
            () => new WorldWarIIChest(),
            () => new WWIIValorChest(),
            () => new MahJongTile(),
            () => new AlchemyTalisman(),
            ...
            () => new TeleportToIlshenarItem(),
            () => new TeleportToMalasItem(),		
            () => new TeleportToTokuno(),	
            () => new MirrorOfKalandra()
        };
        ...
        public static void AddLoot(Mobile mob)
        {
            ...
            if (pack == null)
            {
                ...
                mob.AddItem(pack); // This is the correct way to give a backpack to the mobile.
            }

            // Add gold and notes (non-table items)
            ...
            // Determine how many items to drop in a single random roll
            int dropCount = 0;
            ...
            // Avoid selecting duplicate items unnecessarily
            HashSet<int> chosenIndexes = new HashSet<int>();
            for (int i = 0; i < dropCount && chosenIndexes.Count < LootTable.Count; i++)
            {
                int index;
                do
                {
                ...
                while (!chosenIndexes.Add(index)); // Ensures we don't pick the same item twice
