...
{
    public class EndOfTimeCommand
    {
        public static void Initialize()
        {
            CommandSystem.Register("endoftime", AccessLevel.Player, new CommandEventHandler(EndOfTime_OnCommand));
        }

        [Usage("endoftime")]
        [Description("Instantly teleports you and your pets to the end of time, and creates a limited-time portal to return.")]
        public static void EndOfTime_OnCommand(CommandEventArgs e)
        {
            ...
            Point3D newLocation = new Point3D(4803, 3408, 0);
            Map newMap = Map.Sosaria;
            ...
            TemporaryTimePortal portal = new TemporaryTimePortal(oldLocation, oldMap, TimeSpan.FromMinutes(2.0), pets);
    ...
    public class TemporaryTimePortal : Item
    {
        ...
        [Constructable]
        public TemporaryTimePortal(Point3D returnLocation, Map returnMap, TimeSpan duration, List<BaseCreature> pets)
            : base(0xF6C)
        {
            Movable = false;
            Hue = 0x490;
        ...
        public TemporaryTimePortal(Serial serial) : base(serial)
        {
        }
