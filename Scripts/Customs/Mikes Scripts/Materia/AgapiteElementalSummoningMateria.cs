...
{
    public class AgapiteElementalSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public AgapiteElementalSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Agapite Elemental Materia";
        ...
        public AgapiteElementalSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Agapite Elemental.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("AgapiteElemental", 99, 5.0));
                return true;
            }
            return false;
        }
