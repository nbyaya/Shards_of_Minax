...
{
    // ---------------------------------------------------
    // DarkWisp Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a DarkWisp on hit
    // ---------------------------------------------------

    public class DarkWispSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public DarkWispSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning DarkWisp Materia";
        ...
        public DarkWispSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a DarkWisp.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("DarkWisp", 99, 5.0));
                return true;
            }
            return false;
        }
