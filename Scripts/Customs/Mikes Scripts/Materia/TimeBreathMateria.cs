...
namespace Server.Items
{
    // ---------------------------------------------------
    // Time Breath Materia
    // This materia, when socketed, allows the bearer to unleash a time breath attack
    // ---------------------------------------------------

    public class TimeBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public TimeBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Time Breath Materia";
        ...
        public TimeBreathMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a devastating time-based breath attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Time Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlTimeBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
