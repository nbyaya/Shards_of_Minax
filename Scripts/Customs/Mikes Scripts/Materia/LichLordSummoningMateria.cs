...
{
    // ---------------------------------------------------
    // LichLord Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a LichLord on hit
    // ---------------------------------------------------

    public class LichLordSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public LichLordSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning LichLord Materia";
        ...
        public LichLordSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a LichLord.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("LichLord", 99, 5.0));
                return true;
            }
            return false;
        }
