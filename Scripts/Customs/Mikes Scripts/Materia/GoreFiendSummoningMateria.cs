...
{
    // ---------------------------------------------------
    // GoreFiend Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a GoreFiend on hit
    // ---------------------------------------------------

    public class GoreFiendSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public GoreFiendSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning GoreFiend Materia";
        ...
        public GoreFiendSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a GoreFiend.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("GoreFiend", 99, 5.0));
                return true;
            }
            return false;
        }
