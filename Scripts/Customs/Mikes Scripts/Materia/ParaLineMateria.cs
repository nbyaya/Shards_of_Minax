...
namespace Server.Items
{
    // ---------------------------------------------------
    // Para Line Materia
    // This materia, when socketed, allows the bearer to unleash a paralyzing line attack
    // ---------------------------------------------------

    public class ParaLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public ParaLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Para Line Materia";
        ...
        public ParaLineMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful paralyzing line attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Para Line effect with specified parameters (example: refractory 5 seconds, damage 20, range 8)
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlParaLine(5.0, 20, 8));
                return true;
            }
            return false;
        }
