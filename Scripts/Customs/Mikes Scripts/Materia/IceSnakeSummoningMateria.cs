...
{
    // ---------------------------------------------------
    // IceSnake Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an IceSnake on hit
    // ---------------------------------------------------

    public class IceSnakeSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public IceSnakeSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning IceSnake Materia";
        ...
        public IceSnakeSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an IceSnake.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("IceSnake", 99, 5.0));
                return true;
            }
            return false;
        }
