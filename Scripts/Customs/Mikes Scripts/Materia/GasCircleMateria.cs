...
namespace Server.Items
{
    // ---------------------------------------------------
    // Gas Circle Materia
    // This materia, when socketed, allows the bearer to release a gas circle attack
    // ---------------------------------------------------

    public class GasCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public GasCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Gas Circle Materia";
        ...
        public GasCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Releases a gas circle attack, damaging all foes within its radius.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Gas Circle effect with specified parameters (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlGasCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
