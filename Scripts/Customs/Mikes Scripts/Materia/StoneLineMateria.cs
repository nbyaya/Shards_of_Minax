...
namespace Server.Items
{
    // ---------------------------------------------------
    // Stone Line Materia
    // This materia, when socketed, allows the bearer to unleash a stone line attack
    // ---------------------------------------------------

    public class StoneLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public StoneLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Stone Line Materia";
        ...
        public StoneLineMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Stone Line effect with specified parameters (example: refractory 5 seconds, damage 20, range 8)
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlStoneLine(5.0, 20, 8));
                return true;
            }
            return false;
        }
