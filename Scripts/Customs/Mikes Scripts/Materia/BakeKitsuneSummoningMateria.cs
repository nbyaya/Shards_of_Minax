...
{
    // ---------------------------------------------------
    // BakeKitsune Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a BakeKitsune on hit
    // ---------------------------------------------------

    public class BakeKitsuneSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public BakeKitsuneSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning BakeKitsune Materia";
        ...
        public BakeKitsuneSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a BakeKitsune.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("BakeKitsune", 99, 5.0));
                return true;
            }
            return false;
        }
