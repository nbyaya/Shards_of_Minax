...
namespace Server.Items
{
    // ---------------------------------------------------
    // Gate Breath Materia
    // This materia, when socketed, allows the bearer to unleash a gate breath attack
    // ---------------------------------------------------

    public class GateBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public GateBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Gate Breath Materia";
        ...
        public GateBreathMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Gate Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlGateBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
