...
{
    // ---------------------------------------------------
    // Lich Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Lich on hit
    // ---------------------------------------------------

    public class LichSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public LichSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Lich Materia";
        ...
        public LichSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Lich.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Lich", 99, 5.0));
                return true;
            }
            return false;
        }
