...
{
    // ---------------------------------------------------
    // Harpy Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Harpy on hit
    // ---------------------------------------------------

    public class HarpySummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public HarpySummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Harpy Materia";
        ...
        public HarpySummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Harpy.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Harpy", 99, 5.0));
                return true;
            }
            return false;
        }
