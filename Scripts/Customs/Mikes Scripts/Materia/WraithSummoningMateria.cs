...
{
    // ---------------------------------------------------
    // Wraith Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Wraith on hit
    // ---------------------------------------------------

    public class WraithSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public WraithSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Wraith Materia";
        ...
        public WraithSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Wraith.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Wraith", 99, 5.0));
                return true;
            }
            return false;
        }
