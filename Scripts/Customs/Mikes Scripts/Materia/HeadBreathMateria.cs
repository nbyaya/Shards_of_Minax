...
namespace Server.Items
{
    // ---------------------------------------------------
    // Head Breath Materia
    // This materia, when socketed, allows the bearer to unleash a head breath attack
    // ---------------------------------------------------

    public class HeadBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public HeadBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Head Breath Materia";
        ...
        public HeadBreathMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Head Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlHeadBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
