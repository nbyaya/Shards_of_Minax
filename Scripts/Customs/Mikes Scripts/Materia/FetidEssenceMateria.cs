...
{
    // ---------------------------------------------------
    // Fetid Essence Materia
    // This materia, when socketed, gives a 99% chance to summon a Fetid Essence on hit
    // ---------------------------------------------------

    public class FetidEssenceMateria : BaseSocketAugmentation
    {

        [Constructable]
        public FetidEssenceMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Fetid Essence Materia";
        ...
        public FetidEssenceMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Fetid Essence.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("FetidEssence", 99, 5.0));
                return true;
            }
            return false;
        }
