...
namespace Server.Items
{
    // ---------------------------------------------------
    // Vortex Line Materia
    // This materia, when socketed, allows the bearer to unleash a vortex line attack
    // ---------------------------------------------------

    public class VortexLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public VortexLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Vortex Line Materia";
        ...
        public VortexLineMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful vortex line attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Vortex Line effect with specified parameters (example: refractory 5 seconds, damage 20, range 8)
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlVortexLine(5.0, 20, 8));
                return true;
            }
            return false;
        }
