...
{
    // ---------------------------------------------------
    // Alligator Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Alligator on hit
    // ---------------------------------------------------

    public class AlligatorSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public AlligatorSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Alligator Materia";
        ...
        public AlligatorSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Alligator.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Alligator", 99, 5.0));
                return true;
            }
            return false;
        }
