...
{
    // ---------------------------------------------------
    // Giant Serpent Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Giant Serpent on hit
    // ---------------------------------------------------

    public class GiantSerpentSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public GiantSerpentSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Giant Serpent Materia";
        ...
        public GiantSerpentSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Giant Serpent.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("GiantSerpent", 99, 5.0));
                return true;
            }
            return false;
        }
