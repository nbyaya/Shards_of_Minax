...
{
    // ---------------------------------------------------
    // Reaper Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Reaper on hit
    // ---------------------------------------------------

    public class ReaperSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public ReaperSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Reaper Materia";
        ...
        public ReaperSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Reaper.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Reaper", 99, 5.0));
                return true;
            }
            return false;
        }
