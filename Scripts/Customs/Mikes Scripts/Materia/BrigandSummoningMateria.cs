...
{
    // ---------------------------------------------------
    // Brigand Summoning Materia
    // This materia, when socketed, gives a chance to summon a Brigand on hit
    // ---------------------------------------------------

    public class BrigandSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public BrigandSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Brigand Materia";
        ...
        public BrigandSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a chance on hit to summon a Brigand.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Brigand", 50, 5.0)); // Adjust the chance as needed (e.g., 50%)
                return true;
            }
            return false;
        }
