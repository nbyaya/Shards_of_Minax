...
{
    // ---------------------------------------------------
    // AntLion Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an AntLion on hit
    // ---------------------------------------------------

    public class AntLionSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public AntLionSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning AntLion Materia";
        ...
        public AntLionSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an AntLion.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("AntLion", 99, 5.0));
                return true;
            }
            return false;
        }
