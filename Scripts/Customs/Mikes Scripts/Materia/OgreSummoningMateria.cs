...
{
    // ---------------------------------------------------
    // Ogre Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Ogre on hit
    // ---------------------------------------------------

    public class OgreSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public OgreSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Ogre Materia";
        ...
        public OgreSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Ogre.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Ogre", 99, 5.0));
                return true;
            }
            return false;
        }
