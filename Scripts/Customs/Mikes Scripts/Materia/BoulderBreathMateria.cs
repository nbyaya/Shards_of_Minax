...
{
    // ---------------------------------------------------
    // Boulder Breath Materia
    // This materia, when socketed, allows the bearer to unleash a boulder breath attack
    // ---------------------------------------------------

    public class BoulderBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public BoulderBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Boulder Breath Materia";
        ...
        public BoulderBreathMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a devastating boulder breath attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Boulder Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlBoulderBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
