...
{
    // ---------------------------------------------------
    // Lava Serpent Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Lava Serpent on hit
    // ---------------------------------------------------

    public class LavaSerpentSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public LavaSerpentSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Lava Serpent Materia";
        ...
        public LavaSerpentSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Lava Serpent.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("LavaSerpent", 99, 5.0));
                return true;
            }
            return false;
        }
