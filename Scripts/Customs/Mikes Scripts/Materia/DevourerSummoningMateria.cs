...
{
    // ---------------------------------------------------
    // Devourer Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Devourer on hit
    // ---------------------------------------------------

    public class DevourerSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public DevourerSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Devourer Materia";
        ...
        public DevourerSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Devourer.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Devourer", 99, 5.0));
                return true;
            }
            return false;
        }
