...
namespace Server.Items
{
    // ---------------------------------------------------
    // Para Circle Materia
    // This materia, when socketed, allows the bearer to perform a powerful para circle attack
    // ---------------------------------------------------

    public class ParaCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public ParaCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Para Circle Materia";
        ...
        public ParaCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful para circle attack, damaging all foes within its radius.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Para Circle effect with specified parameters (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlParaCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
