...
{
    // ---------------------------------------------------
    // Corrosive Slime Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Corrosive Slime on hit
    // ---------------------------------------------------

    public class CorrosiveSlimeSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public CorrosiveSlimeSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Corrosive Slime Materia";
        ...
        public CorrosiveSlimeSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Corrosive Slime.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("CorrosiveSlime", 99, 5.0));
                return true;
            }
            return false;
        }
