...
{
    // ---------------------------------------------------
    // Ophidian Knight Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Ophidian Knight on hit
    // ---------------------------------------------------

    public class OphidianKnightSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public OphidianKnightSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Ophidian Knight Materia";
        ...
        public OphidianKnightSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Ophidian Knight.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("OphidianKnight", 99, 5.0));
                return true;
            }
            return false;
        }
