...
namespace Server.Items
{
    ...
    public class OFlaskBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public OFlaskBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
        ...
        public OFlaskBreathMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon || target is BaseArmor) // Allows for weapon or armor augmentation
            {
                ...
                XmlAttach.AttachTo(target, new XmlOFlaskBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
