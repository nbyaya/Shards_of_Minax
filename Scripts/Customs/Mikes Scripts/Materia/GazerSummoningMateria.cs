...
{
    // ---------------------------------------------------
    // Gazer Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Gazer on hit
    // ---------------------------------------------------

    public class GazerSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public GazerSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Gazer Materia";
        ...
        public GazerSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Gazer.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Gazer", 99, 5.0));
                return true;
            }
            return false;
        }
