...
{
    // ---------------------------------------------------
    // EliteNinja Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an EliteNinja on hit
    // ---------------------------------------------------

    public class EliteNinjaSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public EliteNinjaSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning EliteNinja Materia";
        ...
        public EliteNinjaSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an EliteNinja.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("EliteNinja", 99, 5.0));
                return true;
            }
            return false;
        }
