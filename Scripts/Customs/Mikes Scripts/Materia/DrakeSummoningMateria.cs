...
{
    // ---------------------------------------------------
    // Drake Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Drake on hit
    // ---------------------------------------------------

    public class DrakeSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public DrakeSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Drake Materia";
        ...
        public DrakeSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Drake.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Drake", 99, 5.0));
                return true;
            }
            return false;
        }
