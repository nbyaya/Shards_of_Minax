...
{
    // ---------------------------------------------------
    // Imp Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Imp on hit
    // ---------------------------------------------------

    public class ImpSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public ImpSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Imp Materia";
            Hue = Utility.RandomMinMax(1, 3000); // Randomly generate a hue between 1 and 3000
        }
        ...
        public ImpSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Imp.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Imp", 99, 5.0));
                return true;
            }
            return false;
        }
