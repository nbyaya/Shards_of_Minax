...
{
    // ---------------------------------------------------
    // DeathWatchBeetle Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a DeathWatchBeetle on hit
    // ---------------------------------------------------

    public class DeathWatchBeetleSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public DeathWatchBeetleSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning DeathWatchBeetle Materia";
        ...
        public DeathWatchBeetleSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a DeathWatchBeetle.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("DeathWatchBeetle", 99, 5.0));
                return true;
            }
            return false;
        }
