...
{
    // ---------------------------------------------------
    // Materia for XmlGuillotineLine
    // This materia, when socketed, allows the bearer to unleash the XmlGuillotineLine ability
    // ---------------------------------------------------

    public class GuillotineLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public GuillotineLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "XmlGuillotineLine Materia";
        ...
        public GuillotineLineMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful XmlGuillotineLine attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the XmlGuillotineLine effect with specified parameters (example: refractory 5 seconds, damage 20, range 8)
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlGuillotineLine(5.0, 20, 8));
                return true;
            }
            return false;
        }
