...
{
    // ---------------------------------------------------
    // Skeletal Mage Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Skeletal Mage on hit
    // ---------------------------------------------------

    public class SkeletalMageSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public SkeletalMageSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Skeletal Mage Materia";
        ...
        public SkeletalMageSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Skeletal Mage.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("SkeletalMage", 99, 5.0));
                return true;
            }
            return false;
        }
