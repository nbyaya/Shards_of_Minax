...
{
    // ---------------------------------------------------
    // Boulder Line Materia
    // This materia, when socketed, allows the bearer to unleash a boulder line attack
    // ---------------------------------------------------

    public class BoulderLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public BoulderLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Boulder Line Materia";
        ...
        public BoulderLineMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful boulder line attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Boulder Line effect with specified parameters (example: refractory 5 seconds, damage 20, range 8)
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlBoulderLine(5.0, 20, 8));
                return true;
            }
            return false;
        }
