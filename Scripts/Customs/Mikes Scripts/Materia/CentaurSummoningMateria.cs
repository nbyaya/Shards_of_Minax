...
{
    // ---------------------------------------------------
    // Centaur Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Centaur on hit
    // ---------------------------------------------------

    public class CentaurSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public CentaurSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Centaur Materia";
        ...
        public CentaurSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Centaur.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Centaur", 99, 5.0));
                return true;
            }
            return false;
        }
