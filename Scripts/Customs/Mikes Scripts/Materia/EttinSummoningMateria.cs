...
{
    // ---------------------------------------------------
    // Ettin Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Ettin on hit
    // ---------------------------------------------------

    public class EttinSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public EttinSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Ettin Materia";
        ...
        public EttinSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Ettin.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Ettin", 99, 5.0));
                return true;
            }
            return false;
        }
