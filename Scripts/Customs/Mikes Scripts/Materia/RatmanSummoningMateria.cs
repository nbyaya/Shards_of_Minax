...
{
    // ---------------------------------------------------
    // Ratman Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Ratman on hit
    // ---------------------------------------------------

    public class RatmanSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public RatmanSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Ratman Materia";
        ...
        public RatmanSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Ratman.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Ratman", 99, 5.0));
                return true;
            }
            return false;
        }
