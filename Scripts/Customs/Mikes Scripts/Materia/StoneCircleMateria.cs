...
{
    // ---------------------------------------------------
    // Stone Circle Materia
    // This materia, when socketed, allows the bearer to perform a powerful stone circle ability
    // ---------------------------------------------------

    public class StoneCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public StoneCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Stone Circle Materia";
        ...
        public StoneCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful stone circle ability, damaging all foes within its radius.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Stone Circle effect with specified parameters (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlStoneCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
