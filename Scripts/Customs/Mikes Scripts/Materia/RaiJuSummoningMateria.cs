...
{
    // ---------------------------------------------------
    // RaiJu Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a RaiJu on hit
    // ---------------------------------------------------

    public class RaiJuSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public RaiJuSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning RaiJu Materia";
        ...
        public RaiJuSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a RaiJu.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("RaiJu", 99, 5.0));
                return true;
            }
            return false;
        }
