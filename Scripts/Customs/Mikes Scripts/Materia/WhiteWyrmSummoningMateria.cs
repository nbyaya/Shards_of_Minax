...
{
    // ---------------------------------------------------
    // WhiteWyrm Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a WhiteWyrm on hit
    // ---------------------------------------------------

    public class WhiteWyrmSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public WhiteWyrmSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning WhiteWyrm Materia";
            Hue = Utility.Random(1, 3001); // Generate a random hue between 1 and 3000
        }
        ...
        public WhiteWyrmSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a WhiteWyrm.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("WhiteWyrm", 99, 5.0));
                return true;
            }
            return false;
        }
