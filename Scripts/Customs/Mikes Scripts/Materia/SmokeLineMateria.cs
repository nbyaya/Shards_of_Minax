...
namespace Server.Items
{
    // ---------------------------------------------------
    // Smoke Line Materia
    // This materia, when socketed, allows the bearer to unleash a smoke line attack
    // ---------------------------------------------------

    public class SmokeLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public SmokeLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Smoke Line Materia";
        ...
        public SmokeLineMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful smoke line attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Smoke Line effect with specified parameters (example: refractory 5 seconds, damage 20, range 8)
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlSmokeLine(5.0, 20, 8));
                return true;
            }
            return false;
        }
