...
{
    // ---------------------------------------------------
    // Guillotine Breath Materia
    // This materia, when socketed, allows the bearer to unleash a guillotine breath attack
    // ---------------------------------------------------

    public class GuillotineBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public GuillotineBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Guillotine Breath Materia";
        ...
        public GuillotineBreathMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a devastating guillotine breath attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Guillotine Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlGuillotineBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
