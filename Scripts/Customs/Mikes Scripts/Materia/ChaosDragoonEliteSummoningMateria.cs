...
{
    // ---------------------------------------------------
    // Chaos Dragoon Elite Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Chaos Dragoon Elite on hit
    // ---------------------------------------------------

    public class ChaosDragoonEliteSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public ChaosDragoonEliteSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Chaos Dragoon Elite Materia";
        ...
        public ChaosDragoonEliteSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Chaos Dragoon Elite.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("ChaosDragoonElite", 99, 5.0));
                return true;
            }
            return false;
        }
