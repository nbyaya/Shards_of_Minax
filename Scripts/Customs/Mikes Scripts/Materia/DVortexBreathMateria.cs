...
{
    // ---------------------------------------------------
    // DVortex Breath Materia
    // This materia, when socketed, allows the bearer to unleash a DVortex breath attack
    // ---------------------------------------------------

    public class DVortexBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public DVortexBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "DVortex Breath Materia";
        ...
        public DVortexBreathMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a devastating DVortex breath attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the DVortex Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlDVortexBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
