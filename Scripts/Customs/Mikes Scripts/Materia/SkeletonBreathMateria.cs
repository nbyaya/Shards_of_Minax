...
{
    // ---------------------------------------------------
    // Skeleton Breath Materia
    // This materia, when socketed, allows the bearer to unleash a skeleton breath attack
    // ---------------------------------------------------

    public class SkeletonBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public SkeletonBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Skeleton Breath Materia";
        ...
        public SkeletonBreathMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Skeleton Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlSkeletonBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
