...
{
    // ---------------------------------------------------
    // Sparkle Line Materia
    // This materia, when socketed, allows the bearer to unleash a sparkle line attack
    // ---------------------------------------------------

    public class SparkleLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public SparkleLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Sparkle Line Materia";
        ...
        public SparkleLineMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a sparkling line attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Sparkle Line effect with specified parameters (example: refractory 5 seconds, damage 20, range 8)
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlSparkleLine(5.0, 20, 8));
                return true;
            }
            return false;
        }
