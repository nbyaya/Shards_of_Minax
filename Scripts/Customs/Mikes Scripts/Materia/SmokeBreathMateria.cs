...
{
    // ---------------------------------------------------
    // Smoke Breath Materia
    // This materia, when socketed, allows the bearer to unleash a smoke breath attack
    // ---------------------------------------------------

    public class SmokeBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public SmokeBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Smoke Breath Materia";
        ...
        public SmokeBreathMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a smoky breath attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Smoke Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlSmokeBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
