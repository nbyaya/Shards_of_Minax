...
{
    // ---------------------------------------------------
    // Wyvern Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Wyvern on hit
    // ---------------------------------------------------

    public class WyvernSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public WyvernSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Wyvern Materia";
        ...
        public WyvernSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Wyvern.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Wyvern", 99, 5.0));
                return true;
            }
            return false;
        }
