...
{
    // ---------------------------------------------------
    // FireBeetle Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a FireBeetle on hit
    // ---------------------------------------------------

    public class FireBeetleSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public FireBeetleSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning FireBeetle Materia";
        ...
        public FireBeetleSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a FireBeetle.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("FireBeetle", 99, 5.0));
                return true;
            }
            return false;
        }
