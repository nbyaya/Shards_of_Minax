...
{
    // ---------------------------------------------------
    // Rikktor Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Rikktor on hit
    // ---------------------------------------------------

    public class RikktorSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public RikktorSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Rikktor Materia";
        ...
        public RikktorSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Rikktor.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Rikktor", 99, 5.0));
                return true;
            }
            return false;
        }
