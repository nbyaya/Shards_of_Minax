...
{
    // ---------------------------------------------------
    // FTree Circle Materia
    // This materia, when socketed, allows the bearer to perform a powerful FTree circle attack
    // ---------------------------------------------------

    public class FTreeCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public FTreeCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "FTree Circle Materia";
        ...
        public FTreeCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful FTree circle attack, damaging all foes within its radius.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the FTree Circle effect with specified parameters (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlFTreeCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
