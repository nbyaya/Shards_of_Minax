...
{
    // ---------------------------------------------------
    // Cow Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Cow on hit
    // ---------------------------------------------------

    public class CowSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public CowSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Cow Materia";
        ...
        public CowSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Cow.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Cow", 99, 5.0));
                return true;
            }
            return false;
        }
