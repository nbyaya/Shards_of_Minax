...
{
    // ---------------------------------------------------
    // DarkWolf Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a DarkWolf on hit
    // ---------------------------------------------------

    public class DarkWolfSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public DarkWolfSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning DarkWolf Materia";
        ...
        public DarkWolfSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a DarkWolf.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("DarkWolf", 99, 5.0));
                return true;
            }
            return false;
        }
