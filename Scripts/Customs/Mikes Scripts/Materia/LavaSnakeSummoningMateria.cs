...
{
    // ---------------------------------------------------
    // LavaSnake Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a LavaSnake on hit
    // ---------------------------------------------------

    public class LavaSnakeSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public LavaSnakeSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning LavaSnake Materia";
        ...
        public LavaSnakeSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a LavaSnake.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("LavaSnake", 99, 5.0));
                return true;
            }
            return false;
        }
