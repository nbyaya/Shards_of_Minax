...
{
    // ---------------------------------------------------
    // Frenzied Ostard Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Frenzied Ostard on hit
    // ---------------------------------------------------

    public class FrenziedOstardSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public FrenziedOstardSummoningMateria() : base(0x2809) // Use the appropriate item ID for the materia graphic
        {
            Name = "Summoning Frenzied Ostard Materia";
        ...
        public FrenziedOstardSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Frenzied Ostard.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("FrenziedOstard", 99, 5.0));
                return true;
            }
            return false;
        }
