...
namespace Server.Items
{
    // ---------------------------------------------------
    // Bee Breath Materia
    // This materia, when socketed, allows the bearer to unleash a bee breath attack
    // ---------------------------------------------------

    public class BeeBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public BeeBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Bee Breath Materia";
        ...
        public BeeBreathMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a devastating bee breath attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Bee Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlBeeBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
