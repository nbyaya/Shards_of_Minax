...
{
    // ---------------------------------------------------
    // Dragon Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Dragon on hit
    // ---------------------------------------------------

    public class DragonSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public DragonSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Dragon Materia";
        ...
        public DragonSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Dragon.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Dragon", 99, 5.0));
                return true;
            }
            return false;
        }
