...
namespace Server.Items
{
    // ---------------------------------------------------
    // Saw Circle Materia
    // This materia, when socketed, allows the bearer to perform a powerful saw circle attack
    // ---------------------------------------------------

    public class SawCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public SawCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Saw Circle Materia";
        ...
        public SawCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful saw circle attack, damaging all foes within its radius.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Saw Circle effect with specified parameters (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlSawCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
