...
{
    // ---------------------------------------------------
    // Zombie Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Zombie on hit
    // ---------------------------------------------------

    public class ZombieSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public ZombieSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Zombie Materia";
        ...
        public ZombieSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Zombie.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Zombie", 99, 5.0));
                return true;
            }
            return false;
        }
