...
{
    public class SocketDeed2 : Item
    {
        [Constructable]
        public SocketDeed2() : base(0x14F0)
        {
            Weight = 1.0;
            Name = "a tier 2 socket deed";
            LootType = LootType.Blessed;
        }

        public SocketDeed2(Serial serial) : base(serial)
        {
        }
        ...
        {
            private SocketDeed2 m_Deed;

            public InternalTarget(SocketDeed2 deed) : base(1, false, TargetFlags.None)
            {
                m_Deed = deed;
            }
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is Item)
                {
                    ...
                    else
                    {
                        ...
                        XmlAttach.AttachTo(item, new XmlSocketable(2));
