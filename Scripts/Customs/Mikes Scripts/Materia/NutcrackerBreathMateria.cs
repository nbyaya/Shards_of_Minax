...
{
    // ---------------------------------------------------
    // Nutcracker Breath Materia
    // This materia, when socketed, allows the bearer to unleash a nutcracker breath attack
    // ---------------------------------------------------

    public class NutcrackerBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public NutcrackerBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Nutcracker Breath Materia";
        ...
        public NutcrackerBreathMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Nutcracker Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlNutcrackerBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
