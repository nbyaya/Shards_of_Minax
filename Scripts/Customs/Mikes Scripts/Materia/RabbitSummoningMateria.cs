...
{
    // Rabbit Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Rabbit on hit
    public class RabbitSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public RabbitSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Rabbit Materia";
        ...
        public RabbitSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Rabbit.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Rabbit", 99, 5.0));
                return true;
            }
            return false;
        }
