...
namespace Server.Items
{
    // ---------------------------------------------------
    // Executioner Materia
    // This materia, when socketed, gives a 99% chance to summon an Executioner on hit
    // ---------------------------------------------------

    public class ExecutionerMateria : BaseSocketAugmentation
    {

        [Constructable]
        public ExecutionerMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Executioner Materia";
        ...
        public ExecutionerMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Executioner.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Executioner", 99, 5.0));
                return true;
            }
            return false;
        }
