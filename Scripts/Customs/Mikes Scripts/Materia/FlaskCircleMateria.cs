...
namespace Server.Items
{
    ...
    public class FlaskCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public FlaskCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
        ...
        public FlaskCircleMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Flask Circle effect with specified parameters
                // Example: refractory 15 seconds, damage 20, radius 5, thickness 1
                XmlAttach.AttachTo(target, new XmlFlaskCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
