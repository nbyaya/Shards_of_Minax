...
{
    // ---------------------------------------------------
    // Frost Troll Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Frost Troll on hit
    // ---------------------------------------------------

    public class FrostTrollSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public FrostTrollSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Frost Troll Materia";
        ...
        public FrostTrollSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Frost Troll.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("FrostTroll", 99, 5.0));
                return true;
            }
            return false;
        }
