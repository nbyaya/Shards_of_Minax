...
{
    // ---------------------------------------------------
    // FrostSpider Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a FrostSpider on hit
    // ---------------------------------------------------

    public class FrostSpiderSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public FrostSpiderSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning FrostSpider Materia";
        ...
        public FrostSpiderSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a FrostSpider.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("FrostSpider", 99, 5.0));
                return true;
            }
            return false;
        }
