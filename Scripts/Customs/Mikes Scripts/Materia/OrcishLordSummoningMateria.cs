...
{
    // ---------------------------------------------------
    // Orcish Lord Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Orcish Lord on hit
    // ---------------------------------------------------

    public class OrcishLordSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public OrcishLordSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Orcish Lord Materia";
        ...
        public OrcishLordSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Orcish Lord.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("OrcishLord", 99, 5.0));
                return true;
            }
            return false;
        }
