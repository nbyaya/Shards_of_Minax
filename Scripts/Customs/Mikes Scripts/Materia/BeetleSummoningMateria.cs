...
{
    // ---------------------------------------------------
    // Beetle Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Beetle on hit
    // ---------------------------------------------------

    public class BeetleSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public BeetleSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Beetle Materia";
        ...
        public BeetleSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Beetle.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Beetle", 99, 5.0));
                return true;
            }
            return false;
        }
