...
{
    // ---------------------------------------------------
    // FleshRenderer Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a FleshRenderer on hit
    // ---------------------------------------------------

    public class FleshRendererSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public FleshRendererSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning FleshRenderer Materia";
        ...
        public FleshRendererSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a FleshRenderer.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("FleshRenderer", 99, 5.0));
                return true;
            }
            return false;
        }
