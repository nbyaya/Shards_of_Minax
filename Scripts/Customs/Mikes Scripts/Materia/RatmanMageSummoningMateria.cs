...
{
    // ---------------------------------------------------
    // Ratman Mage Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Ratman Mage on hit
    // ---------------------------------------------------

    public class RatmanMageSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public RatmanMageSummoningMateria() : base(0x2809) // Keep the same graphic (0x2809)
        {
            Name = "Summoning Ratman Mage Materia";
        ...
        public RatmanMageSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Ratman Mage.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("RatmanMage", 99, 5.0));
                return true;
            }
            return false;
        }
