...
{
    // ---------------------------------------------------
    // Sheep Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Sheep on hit
    // ---------------------------------------------------

    public class SheepSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public SheepSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Sheep Materia";
        ...
        public SheepSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Sheep.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Sheep", 99, 5.0));
                return true;
            }
            return false;
        }
