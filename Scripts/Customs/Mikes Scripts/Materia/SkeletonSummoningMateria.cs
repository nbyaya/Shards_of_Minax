...
{
    // ---------------------------------------------------
    // Skeleton Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Skeleton on hit
    // ---------------------------------------------------

    public class SkeletonSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public SkeletonSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Skeleton Materia";
        ...
        public SkeletonSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Skeleton.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Skeleton", 99, 5.0));
                return true;
            }
            return false;
        }
