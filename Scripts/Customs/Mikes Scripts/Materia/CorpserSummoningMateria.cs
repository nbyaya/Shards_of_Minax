...
{
    // ---------------------------------------------------
    // Corpser Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Corpser on hit
    // ---------------------------------------------------

    public class CorpserSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public CorpserSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Corpser Materia";
        ...
        public CorpserSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Corpser.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Corpser", 99, 5.0));
                return true;
            }
            return false;
        }
