...
{
    // ---------------------------------------------------
    // Cat Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Cat on hit
    // ---------------------------------------------------

    public class CatSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public CatSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Cat Materia";
        ...
        public CatSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Cat.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Cat", 99, 5.0));
                return true;
            }
            return false;
        }
