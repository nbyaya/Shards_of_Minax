...
{
    // ---------------------------------------------------
    // Giant Toad Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Giant Toad on hit
    // ---------------------------------------------------

    public class GiantToadSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public GiantToadSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Giant Toad Materia";
        ...
        public GiantToadSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Giant Toad.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("GiantToad", 99, 5.0));
                return true;
            }
            return false;
        }
