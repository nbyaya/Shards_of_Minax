...
{
    // ---------------------------------------------------
    // DVortex Line Materia
    // This materia, when socketed, allows the bearer to unleash a DVortex line attack
    // ---------------------------------------------------

    public class DVortexLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public DVortexLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "DVortex Line Materia";
        ...
        public DVortexLineMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful DVortex line attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the DVortex Line effect with specified parameters (example: refractory 5 seconds, damage 20, range 8)
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlDVortexLine(5.0, 20, 8));
                return true;
            }
            return false;
        }
