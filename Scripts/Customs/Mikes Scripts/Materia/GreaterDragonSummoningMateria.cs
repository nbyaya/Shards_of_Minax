...
{
    // ---------------------------------------------------
    // Greater Dragon Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Greater Dragon on hit
    // ---------------------------------------------------

    public class GreaterDragonSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public GreaterDragonSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Greater Dragon Materia";
        ...
        public GreaterDragonSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Greater Dragon.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("GreaterDragon", 99, 5.0));
                return true;
            }
            return false;
        }
