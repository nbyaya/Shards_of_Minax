...
{
    // ---------------------------------------------------
    // Materia for XmlMushroomLine ability
    // This materia, when socketed, allows the bearer to use the XmlMushroomLine ability
    // ---------------------------------------------------

    public class MushroomLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public MushroomLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "XmlMushroomLine Materia";
        ...
        public MushroomLineMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Allows the bearer to use the XmlMushroomLine ability.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the XmlMushroomLine effect with specified parameters
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlMushroomLine(/* Add parameters here */));
                return true;
            }
            return false;
        }
