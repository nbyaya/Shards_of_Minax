...
{
    // ---------------------------------------------------
    // Doppleganger Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Doppleganger on hit
    // ---------------------------------------------------

    public class DopplegangerSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public DopplegangerSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Doppleganger Materia";
        ...
        public DopplegangerSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Doppleganger.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Doppleganger", 99, 5.0));
                return true;
            }
            return false;
        }
