...
{
    // ---------------------------------------------------
    // Unicorn Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Unicorn on hit
    // ---------------------------------------------------

    public class UnicornSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public UnicornSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Unicorn Materia";
        ...
        public UnicornSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Unicorn.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Unicorn", 99, 5.0));
                return true;
            }
            return false;
        }
