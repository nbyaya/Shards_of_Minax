...
{
    // ---------------------------------------------------
    // Air Elemental Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Air Elemental on hit
    // ---------------------------------------------------

    public class AirElementalSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public AirElementalSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Air Elemental Materia";
        ...
        public AirElementalSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Air Elemental.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("AirElemental", 99, 5.0));
                return true;
            }
            return false;
        }
