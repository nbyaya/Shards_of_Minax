...
{
    // ---------------------------------------------------
    // Bone Magi Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Bone Magi on hit
    // ---------------------------------------------------

    public class BoneMagiSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public BoneMagiSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Bone Magi Materia";
        ...
        public BoneMagiSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Bone Magi.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("BoneMagi", 99, 5.0));
                return true;
            }
            return false;
        }
