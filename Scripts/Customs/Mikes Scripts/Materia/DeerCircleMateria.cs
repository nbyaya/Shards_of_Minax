...
namespace Server.Items
{
    // ---------------------------------------------------
    // Deer Circle Materia
    // This materia, when socketed, allows the bearer to perform a powerful deer circle attack
    // ---------------------------------------------------

    public class DeerCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public DeerCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Deer Circle Materia";
        ...
        public DeerCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful deer circle attack, damaging all foes within its radius.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Deer Circle effect with specified parameters (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlDeerCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
