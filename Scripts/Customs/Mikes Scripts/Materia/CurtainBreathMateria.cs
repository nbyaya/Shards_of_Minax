...
{
    // ---------------------------------------------------
    // Curtain Breath Materia
    // This materia, when socketed, allows the bearer to unleash a curtain breath attack
    // ---------------------------------------------------

    public class CurtainBreathMateria : BaseSocketAugmentation
    {
        [Constructable]
        public CurtainBreathMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Curtain Breath Materia";
        ...
        public CurtainBreathMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a devastating curtain breath attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Curtain Breath effect with specified parameters (example: refractory 10 seconds, damage 30, range 10)
                XmlAttach.AttachTo(target, new XmlCurtainBreath(10.0, 30, 10));
                return true;
            }
            return false;
        }
