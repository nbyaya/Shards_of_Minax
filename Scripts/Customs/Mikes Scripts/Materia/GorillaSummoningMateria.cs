...
{
    // ---------------------------------------------------
    // Gorilla Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Gorilla on hit
    // ---------------------------------------------------

    public class GorillaSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public GorillaSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Gorilla Materia";
        ...
        public GorillaSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Gorilla.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Gorilla", 99, 5.0));
                return true;
            }
            return false;
        }
