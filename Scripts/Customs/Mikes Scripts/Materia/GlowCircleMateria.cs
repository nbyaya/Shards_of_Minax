...
namespace Server.Items
{
    // ---------------------------------------------------
    // Glow Circle Materia
    // This materia, when socketed, allows the bearer to perform a powerful glow circle attack
    // ---------------------------------------------------

    public class GlowCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public GlowCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Glow Circle Materia";
        ...
        public GlowCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful glow circle attack, damaging all foes within its radius.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Glow Circle effect with specified parameters (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlGlowCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
