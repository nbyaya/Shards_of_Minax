...
{
    // ---------------------------------------------------
    // Orcish Mage Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Orcish Mage on hit
    // ---------------------------------------------------

    public class OrcishMageSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public OrcishMageSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Orcish Mage Materia";
            // Set the hue to a value between 1 and 3000 (e.g., 1500)
        ...
        public OrcishMageSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Orcish Mage.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("OrcishMage", 99, 5.0));
                return true;
            }
            return false;
        }
