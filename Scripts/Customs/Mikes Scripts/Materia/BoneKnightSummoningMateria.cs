...
{
    // ---------------------------------------------------
    // BoneKnight Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a BoneKnight on hit
    // ---------------------------------------------------

    public class BoneKnightSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public BoneKnightSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning BoneKnight Materia";
        ...
        public BoneKnightSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a BoneKnight.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("BoneKnight", 99, 5.0));
                return true;
            }
            return false;
        }
