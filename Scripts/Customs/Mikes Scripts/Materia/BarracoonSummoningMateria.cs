...
{
    // ---------------------------------------------------
    // Barracoon Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Barracoon on hit
    // ---------------------------------------------------

    public class BarracoonSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public BarracoonSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Barracoon Materia";
        ...
        public BarracoonSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Barracoon.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Barracoon", 99, 5.0));
                return true;
            }
            return false;
        }
