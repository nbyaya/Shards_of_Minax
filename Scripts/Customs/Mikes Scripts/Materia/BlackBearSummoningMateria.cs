...
{
    // ---------------------------------------------------
    // Black Bear Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Black Bear on hit
    // ---------------------------------------------------

    public class BlackBearSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public BlackBearSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Black Bear Materia";
        ...
        public BlackBearSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Black Bear.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("BlackBear", 99, 5.0));
                return true;
            }
            return false;
        }
