...
{
    // ---------------------------------------------------
    // Desert Ostard Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Desert Ostard on hit
    // ---------------------------------------------------

    public class DesertOstardSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public DesertOstardSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Desert Ostard Materia";
        ...
        public DesertOstardSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Desert Ostard.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("DesertOstard", 99, 5.0));
                return true;
            }
            return false;
        }
