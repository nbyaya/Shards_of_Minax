...
{
    // ---------------------------------------------------
    // Spike Circle Materia
    // This materia, when socketed, allows the bearer to perform a powerful spike circle attack
    // ---------------------------------------------------

    public class SpikeCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public SpikeCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Spike Circle Materia";
        ...
        public SpikeCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful spike circle attack, damaging all foes within its radius.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Spike Circle effect with specified parameters
                // (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlSpikeCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
