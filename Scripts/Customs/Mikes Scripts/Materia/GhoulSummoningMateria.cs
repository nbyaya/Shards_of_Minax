...
{
    // ---------------------------------------------------
    // Ghoul Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Ghoul on hit
    // ---------------------------------------------------

    public class GhoulSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public GhoulSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Ghoul Materia";
        ...
        public GhoulSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Ghoul.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Ghoul", 99, 5.0));
                return true;
            }
            return false;
        }
