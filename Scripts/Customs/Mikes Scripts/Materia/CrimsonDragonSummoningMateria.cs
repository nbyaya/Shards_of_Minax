...
{
    // ---------------------------------------------------
    // Crimson Dragon Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Crimson Dragon on hit
    // ---------------------------------------------------

    public class CrimsonDragonSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public CrimsonDragonSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Crimson Dragon Materia";
        ...
        public CrimsonDragonSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Crimson Dragon.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("CrimsonDragon", 99, 5.0));
                return true;
            }
            return false;
        }
