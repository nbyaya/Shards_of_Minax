...
{
    // ---------------------------------------------------
    // SnowLeopard Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a SnowLeopard on hit
    // ---------------------------------------------------

    public class SnowLeopardSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public SnowLeopardSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning SnowLeopard Materia";
        ...
        public SnowLeopardSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a SnowLeopard.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("SnowLeopard", 99, 5.0));
                return true;
            }
            return false;
        }
