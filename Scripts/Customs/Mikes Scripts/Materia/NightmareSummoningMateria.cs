...
{
    // ---------------------------------------------------
    // Nightmare Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Nightmare on hit
    // ---------------------------------------------------

    public class NightmareSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public NightmareSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Nightmare Materia";
        ...
        public NightmareSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Nightmare.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Nightmare", 99, 5.0));
                return true;
            }
            return false;
        }
