...
{
    // Bronze Elemental Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Bronze Elemental on hit
    public class BronzeElementalSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public BronzeElementalSummoningMateria() : base(0x2809) // Use the appropriate graphic ID for your materia
        {
            Name = "Summoning Bronze Elemental Materia";
        ...
        public BronzeElementalSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Bronze Elemental.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("BronzeElemental", 99, 5.0));
                return true;
            }
            return false;
        }
