...
{
    // ---------------------------------------------------
    // LavaLizard Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a LavaLizard on hit
    // ---------------------------------------------------

    public class LavaLizardSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public LavaLizardSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning LavaLizard Materia";
        ...
        public LavaLizardSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a LavaLizard.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("LavaLizard", 99, 5.0));
                return true;
            }
            return false;
        }
