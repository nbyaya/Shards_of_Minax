...
{
    // ---------------------------------------------------
    // Skeleton Circle Materia
    // This materia, when socketed, allows the bearer to perform a skeleton circle attack
    // ---------------------------------------------------

    public class SkeletonCircleMateria : BaseSocketAugmentation
    {
        [Constructable]
        public SkeletonCircleMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Skeleton Circle Materia";
        ...
        public SkeletonCircleMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful skeleton circle attack, damaging all foes within its radius.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Skeleton Circle effect with specified parameters (example: refractory 15 seconds, damage 20, radius 5, thickness 1)
                XmlAttach.AttachTo(target, new XmlSkeletonCircle(15.0, 20, 5, 1));
                return true;
            }
            return false;
        }
