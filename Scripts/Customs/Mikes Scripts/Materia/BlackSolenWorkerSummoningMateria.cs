...
{
    // ---------------------------------------------------
    // Black Solen Worker Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Black Solen Worker on hit
    // ---------------------------------------------------

    public class BlackSolenWorkerSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public BlackSolenWorkerSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Black Solen Worker Materia";
        ...
        public BlackSolenWorkerSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Black Solen Worker.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("BlackSolenWorker", 99, 5.0));
                return true;
            }
            return false;
        }
