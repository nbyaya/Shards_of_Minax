...
namespace Server.Items
{
    // ---------------------------------------------------
    // Water Line Materia
    // This materia, when socketed, allows the bearer to unleash a water line attack
    // ---------------------------------------------------

    public class WaterLineMateria : BaseSocketAugmentation
    {
        [Constructable]
        public WaterLineMateria() : base(0x2809) // Use the item ID for your materia graphic
        {
            Name = "Water Line Materia";
        ...
        public WaterLineMateria(Serial serial) : base(serial)
        {
        }

        public override string OnIdentify(Mobile from)
        {
            return "Unleashes a powerful water line attack on your foes.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            ...
            {
                // Attach the Water Line effect with specified parameters (example: refractory 5 seconds, damage 20, range 8)
                // Adjust these parameters based on the desired effect
                XmlAttach.AttachTo(target, new XmlWaterLine(5.0, 20, 8));
                return true;
            }
            return false;
        }
