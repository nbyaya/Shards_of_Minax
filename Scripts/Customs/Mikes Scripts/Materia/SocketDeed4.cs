...
{
    public class SocketDeed4 : Item
    {
        [Constructable]
        public SocketDeed4() : base(0x14F0)
        {
            Weight = 1.0;
            Name = "a tier 4 socket deed";
            LootType = LootType.Blessed;
        }

        public SocketDeed4(Serial serial) : base(serial)
        {
        }
        ...
        {
            private SocketDeed4 m_Deed;

            public InternalTarget(SocketDeed4 deed) : base(1, false, TargetFlags.None)
            {
                m_Deed = deed;
            }
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is Item)
                {
                    ...
                    else
                    {
                        ...
                        XmlAttach.AttachTo(item, new XmlSocketable(4));
