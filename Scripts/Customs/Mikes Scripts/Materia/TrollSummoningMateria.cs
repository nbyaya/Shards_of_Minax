...
{
    // ---------------------------------------------------
    // Troll Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Troll on hit
    // ---------------------------------------------------

    public class TrollSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public TrollSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Troll Materia";
        ...
        public TrollSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Troll.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Troll", 99, 5.0));
                return true;
            }
            return false;
        }
