...
{
    // ---------------------------------------------------
    // Earth Elemental Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon an Earth Elemental on hit
    // ---------------------------------------------------

    public class EarthElementalSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public EarthElementalSummoningMateria() : base(0x2809) // Use the desired graphic ID for your materia
        {
            Name = "Summoning Earth Elemental Materia";
        ...
        public EarthElementalSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon an Earth Elemental.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("EarthElemental", 99, 5.0));
                return true;
            }
            return false;
        }
