...
{
    public class RatSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public RatSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Rat Materia";
        ...
        public RatSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Rat.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("Rat", 99, 5.0));
                return true;
            }
            return false;
        }
