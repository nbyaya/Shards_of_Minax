...
{
    // ---------------------------------------------------
    // Fire Elemental Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Fire Elemental on hit
    // ---------------------------------------------------

    public class FireElementalSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public FireElementalSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Fire Elemental Materia";
        ...
        public FireElementalSummoningMateria( Serial serial ) : base( serial )
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Fire Elemental.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("FireElemental", 99, 5.0));
                return true;
            }
            return false;
        }
