...
{
    // ---------------------------------------------------
    // FrostOoze Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a Frost Ooze on hit
    // ---------------------------------------------------

    public class FrostOozeSummoningMateria : BaseSocketAugmentation
    {

        [Constructable]
        public FrostOozeSummoningMateria() : base(0x2809) // You can change the item ID to match your materia graphic
        {
            Name = "Summoning Frost Ooze Materia";
        ...
        public FrostOozeSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a Frost Ooze.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("FrostOoze", 99, 5.0)); // Replace "FrostOoze" with the actual creature name
                return true;
            }
            return false;
        }
