...
{
    // ---------------------------------------------------
    // DireWolf Summoning Materia
    // This materia, when socketed, gives a 99% chance to summon a DireWolf on hit
    // ---------------------------------------------------

    public class DireWolfSummoningMateria : BaseSocketAugmentation
    {
        [Constructable]
        public DireWolfSummoningMateria() : base(0x2809) // Use the same graphic as Blood Elemental Materia (0x2809)
        {
            Name = "Summoning DireWolf Materia";
        ...
        public DireWolfSummoningMateria(Serial serial) : base(serial)
        {
        }
        ...
        public override string OnIdentify(Mobile from)
        {
            ...
            return "Grants a 99% chance on hit to summon a DireWolf.";
        }
        ...
        public override bool OnAugment(Mobile from, object target)
        {
            if (target is BaseWeapon)
            {
                ...
                XmlAttach.AttachTo(target, new XmlSummonStrike("DireWolf", 99, 5.0));
                return true;
            }
            return false;
        }
