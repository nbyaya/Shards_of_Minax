...
{
    public class DesertOstardFeeder : Barrel
    {
        private static List<DesertOstardFeeder> Feeders = new List<DesertOstardFeeder>();

        [Constructable]
        public DesertOstardFeeder()
        {
            Name = "DesertOstard Feeder";
            ItemID = 0x0E83;
            Feeders.Add(this);
        }
        ...
        public override void AddNameProperties(ObjectPropertyList list)
        {
            ...
            list.Add("Place Squash inside to raise DesertOstards");
        }
        ...
        {
            foreach (DesertOstardFeeder feeder in Feeders)
            {
                if (feeder != null && !feeder.Deleted)
                {
                    feeder.CheckAndSpawnDesertOstard();
                }
            }
        }

        private void CheckAndSpawnDesertOstard()
        {
        ...
        public DesertOstardFeeder(Serial serial) : base(serial)
        {
        }
