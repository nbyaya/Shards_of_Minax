...
{
    public class CantaloupeVineSeed : Item
    {
        [Constructable]
        public CantaloupeVineSeed() : base(0xF27) // Example seed graphic
        {
            Weight = 0.1;
            Name = "a cantaloupe seed";
        }
        ...
        private void PlantTarget(Mobile from, object targeted, object state)
        {
            ...
            if (from.Map.CanFit(loc.X, loc.Y, loc.Z, 16, false, true))
            {
                ...
                HarvestCantaloupeVine vine = new HarvestCantaloupeVine();
        ...
        public CantaloupeVineSeed(Serial serial) : base(serial)
        {
        }
