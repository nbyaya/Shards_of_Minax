...
{
    public class GrapeSeed : Item
    {
        [Constructable]
        public GrapeSeed() : base(0xF27) // Example seed graphic
        {
            Weight = 0.1;
            Name = "a grape seed";
        }
        ...
        private void PlantTarget(Mobile from, object targeted, object state)
        {
            ...
            if (from.Map.CanFit(loc.X, loc.Y, loc.Z, 16, false, true))
            {
                ...
                HarvestGrapeVine vine = new HarvestGrapeVine();
        ...
        public GrapeSeed(Serial serial) : base(serial)
        {
        }
