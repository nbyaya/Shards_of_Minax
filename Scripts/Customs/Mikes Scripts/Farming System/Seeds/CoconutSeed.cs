...
{
    public class CoconutTreeSeed : Item
    {
        [Constructable]
        public CoconutTreeSeed() : base(0xF28) // Example seed graphic
        {
            Weight = 0.1;
            Name = "a coconut seed";
        }
        ...
        private void PlantTarget(Mobile from, object targeted, object state)
        {
            ...
            if (from.Map.CanFit(loc.X, loc.Y, loc.Z, 16, false, true))
            {
                ...
                HarvestCoconutTree tree = new HarvestCoconutTree(); // Create a new instance of HarvestCoconutTree
        ...
        public CoconutTreeSeed(Serial serial) : base(serial)
        {
        }
