...
{
    public class SquashVineSeed : Item
    {
        [Constructable]
        public SquashVineSeed() : base(0xF27) // Example seed graphic
        {
            Weight = 0.1;
            Name = "a squash seed";
        }
        ...
        private void PlantTarget(Mobile from, object targeted, object state)
        {
            ...
            if (from.Map.CanFit(loc.X, loc.Y, loc.Z, 16, false, true))
            {
                ...
                HarvestSquashVine vine = new HarvestSquashVine();
        ...
        public SquashVineSeed(Serial serial) : base(serial)
        {
        }
