...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomBeholder : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomBeholder() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomBeholder(Serial serial) : base(serial)
        {
        }
