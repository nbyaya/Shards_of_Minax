...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomWizardWitch : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomWizardWitch() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomWizardWitch(Serial serial) : base(serial)
        {
        }
