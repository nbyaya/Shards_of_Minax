...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomArachnid : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomArachnid() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomArachnid(Serial serial) : base(serial)
        {
        }
