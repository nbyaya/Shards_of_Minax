...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomRodent : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomRodent() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomRodent(Serial serial) : base(serial)
        {
        }
