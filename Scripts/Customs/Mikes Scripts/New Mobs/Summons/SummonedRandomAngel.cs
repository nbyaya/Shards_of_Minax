...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomAngel : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomAngel() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomAngel(Serial serial) : base(serial)
        {
        }
