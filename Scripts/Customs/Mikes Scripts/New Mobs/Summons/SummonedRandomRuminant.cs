...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomRuminant : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomRuminant() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomRuminant(Serial serial) : base(serial)
        {
        }
