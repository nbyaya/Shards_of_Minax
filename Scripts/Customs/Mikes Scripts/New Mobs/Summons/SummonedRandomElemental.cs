...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomElemental : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomElemental() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomElemental(Serial serial) : base(serial)
        {
        }
