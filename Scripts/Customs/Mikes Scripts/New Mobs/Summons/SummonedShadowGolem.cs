...
namespace Server.Mobiles
{
    ...
    public class SummonedShadowGolem : BaseCreature
    {
        ...
        public SummonedShadowGolem(Serial serial) : base(serial)
        {
        }
        ...
        private void ShadowClone()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                SummonedShadowGolemClone clone = new SummonedShadowGolemClone();
                clone.Team = Team;
    ...
    public class SummonedShadowGolemClone : BaseCreature
    {
        [Constructable]
        public SummonedShadowGolemClone()
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.4, 0.8)
        {
            Name = "shadow clone";
            Body = 752; // Golem body
        ...
        public SummonedShadowGolemClone(Serial serial) : base(serial)
        {
        }
