...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomRidable : BaseMount
    {
        ...
        [Constructable]
        public SummonedRandomRidable() : base("a unique mount", Utility.RandomList(ridableBodies), Utility.RandomList(ridableBodies), AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomRidable(Serial serial) : base(serial)
        {
        }
