...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomCanine : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomCanine() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomCanine(Serial serial) : base(serial)
        {
        }
