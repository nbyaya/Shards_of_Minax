...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomFey : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomFey() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomFey(Serial serial) : base(serial)
        {
        }
