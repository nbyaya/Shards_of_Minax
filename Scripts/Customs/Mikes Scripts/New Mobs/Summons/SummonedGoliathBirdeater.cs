...
namespace Server.Mobiles
{
    ...
    public class SummonedGoliathBirdeater : BaseCreature
    {
        ...
        [Constructable]
        public SummonedGoliathBirdeater()
        ...
        public SummonedGoliathBirdeater(Serial serial)
            : base(serial)
        {
        }
            ...
            foreach (Mobile m in GetMobilesInRange(10))
            {
                if (m != this && m.Alive && m != Combatant)
                {
                    if (Utility.RandomDouble() < 0.6) // 60% chance to flee
                    {
                        ...
                        // Additional logic to move away from SummonedGoliathBirdeater
                    }
                }
            }
