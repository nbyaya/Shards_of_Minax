...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomUndead : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomUndead() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomUndead(Serial serial) : base(serial)
        {
        }
