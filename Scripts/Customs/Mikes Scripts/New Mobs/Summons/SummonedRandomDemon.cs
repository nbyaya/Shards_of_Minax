...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomDemon : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomDemon() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomDemon(Serial serial) : base(serial)
        {
        }
