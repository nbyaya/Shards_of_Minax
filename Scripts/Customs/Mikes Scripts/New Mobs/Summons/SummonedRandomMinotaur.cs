...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomMinotaur : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomMinotaur() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomMinotaur(Serial serial) : base(serial)
        {
        }
