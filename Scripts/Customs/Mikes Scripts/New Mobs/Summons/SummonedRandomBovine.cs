...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomBovine : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomBovine() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomBovine(Serial serial) : base(serial)
        {
        }
