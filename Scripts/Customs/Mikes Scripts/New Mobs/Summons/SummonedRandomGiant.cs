...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomGiant : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomGiant() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomGiant(Serial serial) : base(serial)
        {
        }
