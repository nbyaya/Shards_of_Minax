...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomRobot : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomRobot() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomRobot(Serial serial) : base(serial)
        {
        }
