...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomMonster : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomMonster() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomMonster(Serial serial) : base(serial)
        {
        }
