...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomSlime : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomSlime() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomSlime(Serial serial) : base(serial)
        {
        }
