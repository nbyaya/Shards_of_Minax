...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomApe : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomApe() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomApe(Serial serial) : base(serial)
        {
        }
