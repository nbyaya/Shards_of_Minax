...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomPig : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomPig() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomPig(Serial serial) : base(serial)
        {
        }
