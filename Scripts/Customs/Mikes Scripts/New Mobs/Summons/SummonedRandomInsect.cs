...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomInsect : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomInsect() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomInsect(Serial serial) : base(serial)
        {
        }
