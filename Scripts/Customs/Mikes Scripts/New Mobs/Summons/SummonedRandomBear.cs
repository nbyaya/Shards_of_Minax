...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomBear : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomBear() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomBear(Serial serial) : base(serial)
        {
        }
