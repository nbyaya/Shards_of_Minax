...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomCat : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomCat() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomCat(Serial serial) : base(serial)
        {
        }
