...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomLizard : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomLizard() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomLizard(Serial serial) : base(serial)
        {
        }
