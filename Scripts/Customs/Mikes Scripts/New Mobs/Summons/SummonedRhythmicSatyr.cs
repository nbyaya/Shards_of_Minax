...
namespace Server.Mobiles
{
    ...
    public class SummonedRhythmicSatyr : BaseCreature
    {
        ...
        public SummonedRhythmicSatyr(Serial serial)
            : base(serial)
        {
        }
        ...
        private void RhythmOfRecovery()
        {
            ...
            foreach (Mobile m in GetMobilesInRange(5))
            {
                if (m is SummonedRhythmicSatyr && m.Alive)
                {
