...
namespace Server.Mobiles
{
    ...
    public class SummonedPurseSpider : BaseCreature
    {
        ...
        [Constructable]
        public SummonedPurseSpider() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "a purse spider";
        ...
        public SummonedPurseSpider(Serial serial) : base(serial)
        {
        }
        ...
        private void WebSummon()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                {
                    SummonedPurseSpiderling spiderling = new SummonedPurseSpiderling();
    ...
    public class SummonedPurseSpiderling : BaseCreature
    {
        [Constructable]
        public SummonedPurseSpiderling() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedPurseSpiderling(Serial serial) : base(serial)
        {
        }
