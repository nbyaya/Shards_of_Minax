...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomGargoyle : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomGargoyle() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomGargoyle(Serial serial) : base(serial)
        {
        }
