...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomOrc : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomOrc() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomOrc(Serial serial) : base(serial)
        {
        }
