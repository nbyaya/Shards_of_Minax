...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomSnake : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomSnake() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomSnake(Serial serial) : base(serial)
        {
        }
