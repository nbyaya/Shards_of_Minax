...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomDragon : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomDragon() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomDragon(Serial serial) : base(serial)
        {
        }
