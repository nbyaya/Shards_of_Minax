...
namespace Server.Mobiles
{
    ...
    public class SummonedRandomAnimatedPlant : BaseCreature
    {
        ...
        [Constructable]
        public SummonedRandomAnimatedPlant() : base(AIType.AI_Animal, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public SummonedRandomAnimatedPlant(Serial serial) : base(serial)
        {
        }
