...
{
    [CorpseName("a Storm Crab corpse")]
    public class StormCrab : BaseMount
    {
        ...
        public StormCrab(Serial serial)
            : base(serial)
        {
        }
        ...
        public void CycloneGrasp(Mobile target)
        {
            ...
            target.SendMessage("You are caught in the Storm Crab's cyclone!");
