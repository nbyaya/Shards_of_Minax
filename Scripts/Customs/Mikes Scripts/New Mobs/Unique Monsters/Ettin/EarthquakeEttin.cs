...
{
    [CorpseName("an earthquake ettin corpse")]
    public class EarthquakeEttin : BaseCreature
    {
        ...
        [Constructable]
        public EarthquakeEttin()
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Name = "an earthquake ettin";
            Body = 18;
            BaseSoundID = 367;
        ...
        public EarthquakeEttin(Serial serial)
            : base(serial)
        {
        }
        ...
        {
            PublicOverheadMessage(MessageType.Regular, 0x3B2, true, "* The Earthquake Ettin stomps the ground, causing violent tremors! *");
            PlaySound(0x2F3);
        ...
        {
            PublicOverheadMessage(MessageType.Regular, 0x3B2, true, "* The Earthquake Ettin encases itself in rock-like armor! *");
            PlaySound(0x1BC);
        ...
        {
            PublicOverheadMessage(MessageType.Regular, 0x3B2, true, "* The Earthquake Ettin summons stone spires from the ground! *");
            PlaySound(0x216);
