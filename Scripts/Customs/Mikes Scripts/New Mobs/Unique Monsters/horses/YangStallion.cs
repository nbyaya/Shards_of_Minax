...
{
    [CorpseName("a Yang Stallion corpse")]
    public class YangStallion : BaseMount
    {
        ...
        [Constructable]
        public YangStallion()
            : base("a Yang Stallion", 0xE2, 0x3EA0, AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
            Body = 0xE2; // Horse body
            Hue = 2080; // Dark hue for Yin (Darkness)
            BaseSoundID = 0xA8;
        ...
        public YangStallion(Serial serial)
            : base(serial)
        {
        }
        ...
        private void ShadowStrike()
        {
            ...
            if (target != null && target.Alive)
            {
                ...
                PublicOverheadMessage(MessageType.Regular, 0x3B2, true, "*The Yang Stallion strikes from the shadows!*");
        ...
        private void SoulDrain()
        {
            ...
            if (target != null && target.Alive)
            {
                ...
                PublicOverheadMessage(MessageType.Regular, 0x3B2, true, "*The Yang Stallion drains your soul!*");
