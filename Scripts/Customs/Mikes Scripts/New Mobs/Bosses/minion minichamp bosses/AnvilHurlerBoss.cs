...
{
    [CorpseName("corpse of the anvil overlord")]
    public class AnvilHurlerBoss : AnvilHurler
    {
        [Constructable]
        public AnvilHurlerBoss() : base()
        {
            Name = "Anvil Overlord";
            Title = "the Supreme Hurler";
        ...
        public AnvilHurlerBoss(Serial serial) : base(serial)
        {
        }
