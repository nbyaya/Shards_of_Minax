...
{
    [CorpseName("a boss VietnamesePig corpse")]
    public class BossVietnamesePig : VietnamesePig
    {
        [Constructable]
        public BossVietnamesePig() : base()
        {
            Name = "Boss VietnamesePig";
            Title = "the Enforcer";
        ...
        public BossVietnamesePig(Serial serial) : base(serial)
        {
        }
