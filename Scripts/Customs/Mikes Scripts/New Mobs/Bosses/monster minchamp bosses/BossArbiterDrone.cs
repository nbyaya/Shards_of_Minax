...
{
    [CorpseName("a boss ArbiterDrone corpse")]
    public class BossArbiterDrone : ArbiterDrone
    {
        [Constructable]
        public BossArbiterDrone() : base()
        {
            Name = "Boss ArbiterDrone";
            Title = "the Enforcer";
        ...
        public BossArbiterDrone(Serial serial) : base(serial)
        {
        }
