...
{
    [CorpseName("a boss RedSquirrel corpse")]
    public class BossRedSquirrel : RedSquirrel
    {
        [Constructable]
        public BossRedSquirrel() : base()
        {
            Name = "Boss RedSquirrel";
            Title = "the Enforcer";
        ...
        public BossRedSquirrel(Serial serial) : base(serial)
        {
        }
