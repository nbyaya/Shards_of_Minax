...
{
    [CorpseName("a boss FiestaLlama corpse")]
    public class BossFiestaLlama : FiestaLlama
    {
        [Constructable]
        public BossFiestaLlama() : base()
        {
            Name = "Boss FiestaLlama";
            Title = "the Enforcer";
        ...
        public BossFiestaLlama(Serial serial) : base(serial)
        {
        }
