...
{
    [CorpseName("a boss TalonMachine corpse")]
    public class BossTalonMachine : TalonMachine
    {
        [Constructable]
        public BossTalonMachine() : base()
        {
            Name = "Boss TalonMachine";
            Title = "the Enforcer";
        ...
        public BossTalonMachine(Serial serial) : base(serial)
        {
        }
