...
{
    [CorpseName("a boss TaffyTitan corpse")]
    public class BossTaffyTitan : TaffyTitan
    {
        [Constructable]
        public BossTaffyTitan() : base()
        {
            Name = "Boss TaffyTitan";
            Title = "the Enforcer";
        ...
        public BossTaffyTitan(Serial serial) : base(serial)
        {
        }
