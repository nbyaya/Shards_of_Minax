...
{
    [CorpseName("a boss FrostboundChampion corpse")]
    public class BossFrostboundChampion : FrostboundChampion
    {
        [Constructable]
        public BossFrostboundChampion() : base()
        {
            Name = "Boss FrostboundChampion";
            Title = "the Enforcer";
        ...
        public BossFrostboundChampion(Serial serial) : base(serial)
        {
        }
