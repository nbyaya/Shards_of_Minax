...
{
    [CorpseName("a boss NightmarePanther corpse")]
    public class BossNightmarePanther : NightmarePanther
    {
        [Constructable]
        public BossNightmarePanther() : base()
        {
            Name = "Boss NightmarePanther";
            Title = "the Enforcer";
        ...
        public BossNightmarePanther(Serial serial) : base(serial)
        {
        }
