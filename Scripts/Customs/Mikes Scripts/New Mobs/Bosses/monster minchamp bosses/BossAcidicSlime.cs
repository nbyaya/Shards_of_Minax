...
{
    [CorpseName("a boss AcidicSlime corpse")]
    public class BossAcidicSlime : AcidicSlime
    {
        [Constructable]
        public BossAcidicSlime() : base()
        {
            Name = "Boss AcidicSlime";
            Title = "the Enforcer";
        ...
        public BossAcidicSlime(Serial serial) : base(serial)
        {
        }
