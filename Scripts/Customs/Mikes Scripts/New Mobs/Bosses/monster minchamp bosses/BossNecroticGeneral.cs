...
{
    [CorpseName("a boss NecroticGeneral corpse")]
    public class BossNecroticGeneral : NecroticGeneral
    {
        [Constructable]
        public BossNecroticGeneral() : base()
        {
            Name = "Boss NecroticGeneral";
            Title = "the Enforcer";
        ...
        public BossNecroticGeneral(Serial serial) : base(serial)
        {
        }
