...
{
    [CorpseName("a boss SothTheDeathKnight corpse")]
    public class BossSothTheDeathKnight : SothTheDeathKnight
    {
        [Constructable]
        public BossSothTheDeathKnight() : base()
        {
            Name = "Boss SothTheDeathKnight";
            Title = "the Enforcer";
        ...
        public BossSothTheDeathKnight(Serial serial) : base(serial)
        {
        }
