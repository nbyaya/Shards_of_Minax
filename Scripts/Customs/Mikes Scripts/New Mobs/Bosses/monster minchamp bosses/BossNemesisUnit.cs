...
{
    [CorpseName("a boss NemesisUnit corpse")]
    public class BossNemesisUnit : NemesisUnit
    {
        [Constructable]
        public BossNemesisUnit() : base()
        {
            Name = "Boss NemesisUnit";
            Title = "the Enforcer";
        ...
        public BossNemesisUnit(Serial serial) : base(serial)
        {
        }
