...
{
    [CorpseName("a boss ShadowSludge corpse")]
    public class BossShadowSludge : ShadowSludge
    {
        [Constructable]
        public BossShadowSludge() : base()
        {
            Name = "Boss ShadowSludge";
            Title = "the Enforcer";
        ...
        public BossShadowSludge(Serial serial) : base(serial)
        {
        }
