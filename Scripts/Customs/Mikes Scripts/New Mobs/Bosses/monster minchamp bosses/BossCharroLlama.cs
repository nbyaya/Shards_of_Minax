...
{
    [CorpseName("a boss CharroLlama corpse")]
    public class BossCharroLlama : CharroLlama
    {
        [Constructable]
        public BossCharroLlama() : base()
        {
            Name = "Boss CharroLlama";
            Title = "the Enforcer";
        ...
        public BossCharroLlama(Serial serial) : base(serial)
        {
        }
