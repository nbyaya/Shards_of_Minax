...
{
    [CorpseName("a boss VirgoPurityBear corpse")]
    public class BossVirgoPurityBear : VirgoPurityBear
    {
        [Constructable]
        public BossVirgoPurityBear() : base()
        {
            Name = "Boss VirgoPurityBear";
            Title = "the Enforcer";
        ...
        public BossVirgoPurityBear(Serial serial) : base(serial)
        {
        }
