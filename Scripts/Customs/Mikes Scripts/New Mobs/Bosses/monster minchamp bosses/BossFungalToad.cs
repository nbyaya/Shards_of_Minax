...
{
    [CorpseName("a boss FungalToad corpse")]
    public class BossFungalToad : FungalToad
    {
        [Constructable]
        public BossFungalToad() : base()
        {
            Name = "Boss FungalToad";
            Title = "the Enforcer";
        ...
        public BossFungalToad(Serial serial) : base(serial)
        {
        }
