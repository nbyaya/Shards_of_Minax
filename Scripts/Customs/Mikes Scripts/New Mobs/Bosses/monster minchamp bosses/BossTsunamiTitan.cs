...
{
    [CorpseName("a boss TsunamiTitan corpse")]
    public class BossTsunamiTitan : TsunamiTitan
    {
        [Constructable]
        public BossTsunamiTitan() : base()
        {
            Name = "Boss TsunamiTitan";
            Title = "the Enforcer";
        ...
        public BossTsunamiTitan(Serial serial) : base(serial)
        {
        }
