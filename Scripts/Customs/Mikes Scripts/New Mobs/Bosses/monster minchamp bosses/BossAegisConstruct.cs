...
{
    [CorpseName("a boss AegisConstruct corpse")]
    public class BossAegisConstruct : AegisConstruct
    {
        [Constructable]
        public BossAegisConstruct() : base()
        {
            Name = "Boss AegisConstruct";
            Title = "the Enforcer";
        ...
        public BossAegisConstruct(Serial serial) : base(serial)
        {
        }
