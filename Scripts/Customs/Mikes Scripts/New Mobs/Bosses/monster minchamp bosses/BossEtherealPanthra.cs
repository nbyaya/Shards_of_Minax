...
{
    [CorpseName("a boss EtherealPanthra corpse")]
    public class BossEtherealPanthra : EtherealPanthra
    {
        [Constructable]
        public BossEtherealPanthra() : base()
        {
            Name = "Boss EtherealPanthra";
            Title = "the Enforcer";
        ...
        public BossEtherealPanthra(Serial serial) : base(serial)
        {
        }
