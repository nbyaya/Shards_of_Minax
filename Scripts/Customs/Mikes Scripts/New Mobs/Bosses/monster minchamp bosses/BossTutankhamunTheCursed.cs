...
{
    [CorpseName("a boss TutankhamunTheCursed corpse")]
    public class BossTutankhamunTheCursed : TutankhamunTheCursed
    {
        [Constructable]
        public BossTutankhamunTheCursed() : base()
        {
            Name = "Boss TutankhamunTheCursed";
            Title = "the Enforcer";
        ...
        public BossTutankhamunTheCursed(Serial serial) : base(serial)
        {
        }
