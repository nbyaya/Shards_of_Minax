...
{
    [CorpseName("a boss AriesHarpy corpse")]
    public class BossAriesHarpy : AriesHarpy
    {
        [Constructable]
        public BossAriesHarpy() : base()
        {
            Name = "Boss AriesHarpy";
            Title = "the Enforcer";
        ...
        public BossAriesHarpy(Serial serial) : base(serial)
        {
        }
