...
{
    [CorpseName("a boss ShadowToad corpse")]
    public class BossShadowToad : ShadowToad
    {
        [Constructable]
        public BossShadowToad() : base()
        {
            Name = "Boss ShadowToad";
            Title = "the Enforcer";
        ...
        public BossShadowToad(Serial serial) : base(serial)
        {
        }
