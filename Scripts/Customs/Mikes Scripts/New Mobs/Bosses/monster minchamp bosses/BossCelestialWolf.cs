...
{
    [CorpseName("a boss CelestialWolf corpse")]
    public class BossCelestialWolf : CelestialWolf
    {
        [Constructable]
        public BossCelestialWolf() : base()
        {
            Name = "Boss CelestialWolf";
            Title = "the Enforcer";
        ...
        public BossCelestialWolf(Serial serial) : base(serial)
        {
        }
