...
{
    [CorpseName("a boss WoodlandSpiritHorse corpse")]
    public class BossWoodlandSpiritHorse : WoodlandSpiritHorse
    {
        [Constructable]
        public BossWoodlandSpiritHorse() : base()
        {
            Name = "Boss WoodlandSpiritHorse";
            Title = "the Enforcer";
        ...
        public BossWoodlandSpiritHorse(Serial serial) : base(serial)
        {
        }
