...
{
    [CorpseName("a boss ChocolateTruffle corpse")]
    public class BossChocolateTruffle : ChocolateTruffle
    {
        [Constructable]
        public BossChocolateTruffle() : base()
        {
            Name = "Boss ChocolateTruffle";
            Title = "the Enforcer";
        ...
        public BossChocolateTruffle(Serial serial) : base(serial)
        {
        }
