...
{
    [CorpseName("a boss EnigmaticSatyr corpse")]
    public class BossEnigmaticSatyr : EnigmaticSatyr
    {
        [Constructable]
        public BossEnigmaticSatyr() : base()
        {
            Name = "Boss EnigmaticSatyr";
            Title = "the Enforcer";
        ...
        public BossEnigmaticSatyr(Serial serial) : base(serial)
        {
        }
