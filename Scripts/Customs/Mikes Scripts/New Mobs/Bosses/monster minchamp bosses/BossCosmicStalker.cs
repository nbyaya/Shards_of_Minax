...
{
    [CorpseName("a boss CosmicStalker corpse")]
    public class BossCosmicStalker : CosmicStalker
    {
        [Constructable]
        public BossCosmicStalker() : base()
        {
            Name = "Boss CosmicStalker";
            Title = "the Enforcer";
        ...
        public BossCosmicStalker(Serial serial) : base(serial)
        {
        }
