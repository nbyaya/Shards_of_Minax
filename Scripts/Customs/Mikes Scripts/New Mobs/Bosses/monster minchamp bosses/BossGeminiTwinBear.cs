...
{
    [CorpseName("a boss GeminiTwinBear corpse")]
    public class BossGeminiTwinBear : GeminiTwinBear
    {
        [Constructable]
        public BossGeminiTwinBear() : base()
        {
            Name = "Boss GeminiTwinBear";
            Title = "the Enforcer";
        ...
        public BossGeminiTwinBear(Serial serial) : base(serial)
        {
        }
