...
{
    [CorpseName("a boss PeppermintPuff corpse")]
    public class BossPeppermintPuff : PeppermintPuff
    {
        [Constructable]
        public BossPeppermintPuff() : base()
        {
            Name = "Boss PeppermintPuff";
            Title = "the Enforcer";
        ...
        public BossPeppermintPuff(Serial serial) : base(serial)
        {
        }
