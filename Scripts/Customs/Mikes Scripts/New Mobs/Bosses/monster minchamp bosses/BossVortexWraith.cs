...
{
    [CorpseName("a boss VortexWraith corpse")]
    public class BossVortexWraith : VortexWraith
    {
        [Constructable]
        public BossVortexWraith() : base()
        {
            Name = "Boss VortexWraith";
            Title = "the Enforcer";
        ...
        public BossVortexWraith(Serial serial) : base(serial)
        {
        }
