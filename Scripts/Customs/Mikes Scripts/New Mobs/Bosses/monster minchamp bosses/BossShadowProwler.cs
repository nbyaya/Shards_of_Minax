...
{
    [CorpseName("a boss ShadowProwler corpse")]
    public class BossShadowProwler : ShadowProwler
    {
        [Constructable]
        public BossShadowProwler() : base()
        {
            Name = "Boss ShadowProwler";
            Title = "the Enforcer";
        ...
        public BossShadowProwler(Serial serial) : base(serial)
        {
        }
