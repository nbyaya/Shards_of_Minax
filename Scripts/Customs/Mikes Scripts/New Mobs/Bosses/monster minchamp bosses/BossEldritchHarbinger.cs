...
{
    [CorpseName("a boss EldritchHarbinger corpse")]
    public class BossEldritchHarbinger : EldritchHarbinger
    {
        [Constructable]
        public BossEldritchHarbinger() : base()
        {
            Name = "Boss EldritchHarbinger";
            Title = "the Enforcer";
        ...
        public BossEldritchHarbinger(Serial serial) : base(serial)
        {
        }
