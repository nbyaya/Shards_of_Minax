...
{
    [CorpseName("a boss ChromaticOgre corpse")]
    public class BossChromaticOgre : ChromaticOgre
    {
        [Constructable]
        public BossChromaticOgre() : base()
        {
            Name = "Boss ChromaticOgre";
            Title = "the Enforcer";
        ...
        public BossChromaticOgre(Serial serial) : base(serial)
        {
        }
