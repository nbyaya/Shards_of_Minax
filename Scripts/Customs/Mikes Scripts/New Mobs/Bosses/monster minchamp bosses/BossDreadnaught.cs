...
{
    [CorpseName("a boss Dreadnaught corpse")]
    public class BossDreadnaught : Dreadnaught
    {
        [Constructable]
        public BossDreadnaught() : base()
        {
            Name = "Boss Dreadnaught";
            Title = "the Enforcer";
        ...
        public BossDreadnaught(Serial serial) : base(serial)
        {
        }
