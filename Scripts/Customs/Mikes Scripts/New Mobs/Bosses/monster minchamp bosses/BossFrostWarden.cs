...
{
    [CorpseName("a boss FrostWarden corpse")]
    public class BossFrostWarden : FrostWarden
    {
        [Constructable]
        public BossFrostWarden() : base()
        {
            Name = "Boss FrostWarden";
            Title = "the Enforcer";
        ...
        public BossFrostWarden(Serial serial) : base(serial)
        {
        }
