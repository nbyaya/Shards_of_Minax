...
{
    [CorpseName("a boss EasternGraySquirrel corpse")]
    public class BossEasternGraySquirrel : EasternGraySquirrel
    {
        [Constructable]
        public BossEasternGraySquirrel() : base()
        {
            Name = "Boss EasternGraySquirrel";
            Title = "the Enforcer";
        ...
        public BossEasternGraySquirrel(Serial serial) : base(serial)
        {
        }
