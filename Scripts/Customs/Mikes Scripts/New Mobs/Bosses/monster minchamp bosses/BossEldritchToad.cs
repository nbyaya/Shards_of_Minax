...
{
    [CorpseName("a boss EldritchToad corpse")]
    public class BossEldritchToad : EldritchToad
    {
        [Constructable]
        public BossEldritchToad() : base()
        {
            Name = "Boss EldritchToad";
            Title = "the Enforcer";
        ...
        public BossEldritchToad(Serial serial) : base(serial)
        {
        }
