...
{
    [CorpseName("a boss CelestialHorror corpse")]
    public class BossCelestialHorror : CelestialHorror
    {
        [Constructable]
        public BossCelestialHorror() : base()
        {
            Name = "Boss CelestialHorror";
            Title = "the Enforcer";
        ...
        public BossCelestialHorror(Serial serial) : base(serial)
        {
        }
