...
{
    [CorpseName("a boss AkhenatenTheHeretic corpse")]
    public class BossAkhenatenTheHeretic : AkhenatenTheHeretic
    {
        [Constructable]
        public BossAkhenatenTheHeretic() : base()
        {
            Name = "Boss AkhenatenTheHeretic";
            Title = "the Enforcer";
        ...
        public BossAkhenatenTheHeretic(Serial serial) : base(serial)
        {
        }
