...
{
    [CorpseName("a boss RedTailedSquirrel corpse")]
    public class BossRedTailedSquirrel : RedTailedSquirrel
    {
        [Constructable]
        public BossRedTailedSquirrel() : base()
        {
            Name = "Boss RedTailedSquirrel";
            Title = "the Enforcer";
        ...
        public BossRedTailedSquirrel(Serial serial) : base(serial)
        {
        }
