...
{
    [CorpseName("a boss NecroticOgre corpse")]
    public class BossNecroticOgre : NecroticOgre
    {
        [Constructable]
        public BossNecroticOgre() : base()
        {
            Name = "Boss NecroticOgre";
            Title = "the Enforcer";
        ...
        public BossNecroticOgre(Serial serial) : base(serial)
        {
        }
