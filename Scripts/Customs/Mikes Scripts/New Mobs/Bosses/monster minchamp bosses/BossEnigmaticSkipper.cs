...
{
    [CorpseName("a boss EnigmaticSkipper corpse")]
    public class BossEnigmaticSkipper : EnigmaticSkipper
    {
        [Constructable]
        public BossEnigmaticSkipper() : base()
        {
            Name = "Boss EnigmaticSkipper";
            Title = "the Enforcer";
        ...
        public BossEnigmaticSkipper(Serial serial) : base(serial)
        {
        }
