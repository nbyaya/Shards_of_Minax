...
{
    [CorpseName("a boss CursedWolf corpse")]
    public class BossCursedWolf : CursedWolf
    {
        [Constructable]
        public BossCursedWolf() : base()
        {
            Name = "Boss CursedWolf";
            Title = "the Enforcer";
        ...
        public BossCursedWolf(Serial serial) : base(serial)
        {
        }
