...
{
    [CorpseName("a boss SoulEaterLich corpse")]
    public class BossSoulEaterLich : SoulEaterLich
    {
        [Constructable]
        public BossSoulEaterLich() : base()
        {
            Name = "Boss SoulEaterLich";
            Title = "the Enforcer";
        ...
        public BossSoulEaterLich(Serial serial) : base(serial)
        {
        }
