...
{
    [CorpseName("a boss PlagueLich corpse")]
    public class BossPlagueLich : PlagueLich
    {
        [Constructable]
        public BossPlagueLich() : base()
        {
            Name = "Boss PlagueLich";
            Title = "the Enforcer";
        ...
        public BossPlagueLich(Serial serial) : base(serial)
        {
        }
