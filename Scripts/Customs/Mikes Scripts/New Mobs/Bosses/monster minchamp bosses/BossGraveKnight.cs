...
{
    [CorpseName("a boss GraveKnight corpse")]
    public class BossGraveKnight : GraveKnight
    {
        [Constructable]
        public BossGraveKnight() : base()
        {
            Name = "Boss GraveKnight";
            Title = "the Enforcer";
        ...
        public BossGraveKnight(Serial serial) : base(serial)
        {
        }
