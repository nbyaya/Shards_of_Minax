...
{
    [CorpseName("a boss BubblegumBlaster corpse")]
    public class BossBubblegumBlaster : BubblegumBlaster
    {
        [Constructable]
        public BossBubblegumBlaster() : base()
        {
            Name = "Boss BubblegumBlaster";
            Title = "the Enforcer";
        ...
        public BossBubblegumBlaster(Serial serial) : base(serial)
        {
        }
