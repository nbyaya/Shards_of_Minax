...
{
    [CorpseName("a boss LibraBalanceBear corpse")]
    public class BossLibraBalanceBear : LibraBalanceBear
    {
        [Constructable]
        public BossLibraBalanceBear() : base()
        {
            Name = "Boss LibraBalanceBear";
            Title = "the Enforcer";
        ...
        public BossLibraBalanceBear(Serial serial) : base(serial)
        {
        }
