...
{
    [CorpseName("a boss TaurusEarthBear corpse")]
    public class BossTaurusEarthBear : TaurusEarthBear
    {
        [Constructable]
        public BossTaurusEarthBear() : base()
        {
            Name = "Boss TaurusEarthBear";
            Title = "the Enforcer";
        ...
        public BossTaurusEarthBear(Serial serial) : base(serial)
        {
        }
