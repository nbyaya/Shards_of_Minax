...
{
    [CorpseName("a boss TacticalEnforcer corpse")]
    public class BossTacticalEnforcer : TacticalEnforcer
    {
        [Constructable]
        public BossTacticalEnforcer() : base()
        {
            Name = "Boss TacticalEnforcer";
            Title = "the Enforcer";
        ...
        public BossTacticalEnforcer(Serial serial) : base(serial)
        {
        }
