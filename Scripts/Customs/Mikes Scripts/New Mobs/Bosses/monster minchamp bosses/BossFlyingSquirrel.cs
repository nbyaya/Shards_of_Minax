...
{
    [CorpseName("a boss FlyingSquirrel corpse")]
    public class BossFlyingSquirrel : FlyingSquirrel
    {
        [Constructable]
        public BossFlyingSquirrel() : base()
        {
            Name = "Boss FlyingSquirrel";
            Title = "the Enforcer";
        ...
        public BossFlyingSquirrel(Serial serial) : base(serial)
        {
        }
