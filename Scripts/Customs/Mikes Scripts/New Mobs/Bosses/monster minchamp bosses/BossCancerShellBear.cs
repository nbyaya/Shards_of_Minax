...
{
    [CorpseName("a boss CancerShellBear corpse")]
    public class BossCancerShellBear : CancerShellBear
    {
        [Constructable]
        public BossCancerShellBear() : base()
        {
            Name = "Boss CancerShellBear";
            Title = "the Enforcer";
        ...
        public BossCancerShellBear(Serial serial) : base(serial)
        {
        }
