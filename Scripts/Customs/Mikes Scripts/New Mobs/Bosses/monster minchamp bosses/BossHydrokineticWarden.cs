...
{
    [CorpseName("a boss HydrokineticWarden corpse")]
    public class BossHydrokineticWarden : HydrokineticWarden
    {
        [Constructable]
        public BossHydrokineticWarden() : base()
        {
            Name = "Boss HydrokineticWarden";
            Title = "the Enforcer";
        ...
        public BossHydrokineticWarden(Serial serial) : base(serial)
        {
        }
