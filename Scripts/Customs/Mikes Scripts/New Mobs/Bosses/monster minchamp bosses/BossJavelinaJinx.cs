...
{
    [CorpseName("a boss JavelinaJinx corpse")]
    public class BossJavelinaJinx : JavelinaJinx
    {
        [Constructable]
        public BossJavelinaJinx() : base()
        {
            Name = "Boss JavelinaJinx";
            Title = "the Enforcer";
        ...
        public BossJavelinaJinx(Serial serial) : base(serial)
        {
        }
