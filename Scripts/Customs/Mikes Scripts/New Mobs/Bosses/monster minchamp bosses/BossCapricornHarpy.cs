...
{
    [CorpseName("a boss CapricornHarpy corpse")]
    public class BossCapricornHarpy : CapricornHarpy
    {
        [Constructable]
        public BossCapricornHarpy() : base()
        {
            Name = "Boss CapricornHarpy";
            Title = "the Enforcer";
        ...
        public BossCapricornHarpy(Serial serial) : base(serial)
        {
        }
