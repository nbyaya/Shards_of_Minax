...
{
    [CorpseName("a boss SpectralAutomaton corpse")]
    public class BossSpectralAutomaton : SpectralAutomaton
    {
        [Constructable]
        public BossSpectralAutomaton() : base()
        {
            Name = "Boss SpectralAutomaton";
            Title = "the Enforcer";
        ...
        public BossSpectralAutomaton(Serial serial) : base(serial)
        {
        }
