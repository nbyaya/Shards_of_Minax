...
{
    [CorpseName("a boss CorrosiveToad corpse")]
    public class BossCorrosiveToad : CorrosiveToad
    {
        [Constructable]
        public BossCorrosiveToad() : base()
        {
            Name = "Boss CorrosiveToad";
            Title = "the Enforcer";
        ...
        public BossCorrosiveToad(Serial serial) : base(serial)
        {
        }
