...
{
    [CorpseName("a boss TequilaLlama corpse")]
    public class BossTequilaLlama : TequilaLlama
    {
        [Constructable]
        public BossTequilaLlama() : base()
        {
            Name = "Boss TequilaLlama";
            Title = "the Enforcer";
        ...
        public BossTequilaLlama(Serial serial) : base(serial)
        {
        }
