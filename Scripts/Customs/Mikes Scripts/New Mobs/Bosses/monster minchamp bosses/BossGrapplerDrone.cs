...
{
    [CorpseName("a boss GrapplerDrone corpse")]
    public class BossGrapplerDrone : GrapplerDrone
    {
        [Constructable]
        public BossGrapplerDrone() : base()
        {
            Name = "Boss GrapplerDrone";
            Title = "the Enforcer";
        ...
        public BossGrapplerDrone(Serial serial) : base(serial)
        {
        }
