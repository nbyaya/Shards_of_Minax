...
{
    [CorpseName("a boss ShadowOgre corpse")]
    public class BossShadowOgre : ShadowOgre
    {
        [Constructable]
        public BossShadowOgre() : base()
        {
            Name = "Boss ShadowOgre";
            Title = "the Enforcer";
        ...
        public BossShadowOgre(Serial serial) : base(serial)
        {
        }
