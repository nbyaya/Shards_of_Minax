...
{
    [CorpseName("a boss MysticSatyr corpse")]
    public class BossMysticSatyr : MysticSatyr
    {
        [Constructable]
        public BossMysticSatyr() : base()
        {
            Name = "Boss MysticSatyr";
            Title = "the Enforcer";
        ...
        public BossMysticSatyr(Serial serial) : base(serial)
        {
        }
