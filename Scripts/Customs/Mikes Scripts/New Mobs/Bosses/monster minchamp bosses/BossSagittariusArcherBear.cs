...
{
    [CorpseName("a boss SagittariusArcherBear corpse")]
    public class BossSagittariusArcherBear : SagittariusArcherBear
    {
        [Constructable]
        public BossSagittariusArcherBear() : base()
        {
            Name = "Boss SagittariusArcherBear";
            Title = "the Enforcer";
        ...
        public BossSagittariusArcherBear(Serial serial) : base(serial)
        {
        }
