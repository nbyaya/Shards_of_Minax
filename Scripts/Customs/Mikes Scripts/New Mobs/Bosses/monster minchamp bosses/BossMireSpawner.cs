...
{
    [CorpseName("a boss MireSpawner corpse")]
    public class BossMireSpawner : MireSpawner
    {
        [Constructable]
        public BossMireSpawner() : base()
        {
            Name = "Boss MireSpawner";
            Title = "the Enforcer";
        ...
        public BossMireSpawner(Serial serial) : base(serial)
        {
        }
