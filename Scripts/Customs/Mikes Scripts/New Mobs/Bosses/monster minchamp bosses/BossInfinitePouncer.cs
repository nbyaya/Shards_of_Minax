...
{
    [CorpseName("a boss InfinitePouncer corpse")]
    public class BossInfinitePouncer : InfinitePouncer
    {
        [Constructable]
        public BossInfinitePouncer() : base()
        {
            Name = "Boss InfinitePouncer";
            Title = "the Enforcer";
        ...
        public BossInfinitePouncer(Serial serial) : base(serial)
        {
        }
