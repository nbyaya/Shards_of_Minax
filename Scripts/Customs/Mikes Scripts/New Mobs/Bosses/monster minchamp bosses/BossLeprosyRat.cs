...
{
    [CorpseName("a boss LeprosyRat corpse")]
    public class BossLeprosyRat : LeprosyRat
    {
        [Constructable]
        public BossLeprosyRat() : base()
        {
            Name = "Boss LeprosyRat";
            Title = "the Enforcer";
        ...
        public BossLeprosyRat(Serial serial) : base(serial)
        {
        }
