...
{
    [CorpseName("a boss JellybeanJester corpse")]
    public class BossJellybeanJester : JellybeanJester
    {
        [Constructable]
        public BossJellybeanJester() : base()
        {
            Name = "Boss JellybeanJester";
            Title = "the Enforcer";
        ...
        public BossJellybeanJester(Serial serial) : base(serial)
        {
        }
