...
{
    [CorpseName("a boss BeldingsGroundSquirrel corpse")]
    public class BossBeldingsGroundSquirrel : BeldingsGroundSquirrel
    {
        [Constructable]
        public BossBeldingsGroundSquirrel() : base()
        {
            Name = "Boss BeldingsGroundSquirrel";
            Title = "the Enforcer";
            ...
            SetHits(7000); // Boss-level health
        ...
        public BossBeldingsGroundSquirrel(Serial serial) : base(serial)
        {
        }
