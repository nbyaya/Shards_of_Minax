...
{
    [CorpseName("a boss BonecrusherOgre corpse")]
    public class BossBonecrusherOgre : BonecrusherOgre
    {
        [Constructable]
        public BossBonecrusherOgre() : base()
        {
            Name = "Boss BonecrusherOgre";
            Title = "the Enforcer";
        ...
        public BossBonecrusherOgre(Serial serial) : base(serial)
        {
        }
