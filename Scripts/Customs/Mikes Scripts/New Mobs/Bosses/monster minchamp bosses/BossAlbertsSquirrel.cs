...
{
    [CorpseName("a boss AlbertsSquirrel corpse")]
    public class BossAlbertsSquirrel : AlbertsSquirrel
    {
        [Constructable]
        public BossAlbertsSquirrel() : base()
        {
            Name = "Boss AlbertsSquirrel";
            Title = "the Enforcer";
        ...
        public BossAlbertsSquirrel(Serial serial) : base(serial)
        {
        }
