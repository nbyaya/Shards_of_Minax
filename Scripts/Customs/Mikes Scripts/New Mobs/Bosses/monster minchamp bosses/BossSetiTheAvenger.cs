...
{
    [CorpseName("a boss SetiTheAvenger corpse")]
    public class BossSetiTheAvenger : SetiTheAvenger
    {
        [Constructable]
        public BossSetiTheAvenger() : base()
        {
            Name = "Boss SetiTheAvenger";
            Title = "the Enforcer";
        ...
        public BossSetiTheAvenger(Serial serial) : base(serial)
        {
        }
