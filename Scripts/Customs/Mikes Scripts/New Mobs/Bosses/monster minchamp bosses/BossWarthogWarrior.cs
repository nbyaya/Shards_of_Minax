...
{
    [CorpseName("a boss WarthogWarrior corpse")]
    public class BossWarthogWarrior : WarthogWarrior
    {
        [Constructable]
        public BossWarthogWarrior() : base()
        {
            Name = "Boss WarthogWarrior";
            Title = "the Enforcer";
        ...
        public BossWarthogWarrior(Serial serial) : base(serial)
        {
        }
