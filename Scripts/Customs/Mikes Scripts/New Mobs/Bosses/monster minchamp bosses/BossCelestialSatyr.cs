...
{
    [CorpseName("a boss CelestialSatyr corpse")]
    public class BossCelestialSatyr : CelestialSatyr
    {
        [Constructable]
        public BossCelestialSatyr() : base()
        {
            Name = "Boss CelestialSatyr";
            Title = "the Enforcer";
        ...
        public BossCelestialSatyr(Serial serial) : base(serial)
        {
        }
