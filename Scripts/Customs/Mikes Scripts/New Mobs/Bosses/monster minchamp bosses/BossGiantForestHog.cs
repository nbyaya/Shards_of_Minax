...
{
    [CorpseName("a boss GiantForestHog corpse")]
    public class BossGiantForestHog : GiantForestHog
    {
        [Constructable]
        public BossGiantForestHog() : base()
        {
            Name = "Boss GiantForestHog";
            Title = "the Enforcer";
        ...
        public BossGiantForestHog(Serial serial) : base(serial)
        {
        }
