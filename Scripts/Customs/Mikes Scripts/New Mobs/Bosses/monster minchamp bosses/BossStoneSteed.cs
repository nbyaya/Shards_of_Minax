...
{
    [CorpseName("a boss StoneSteed corpse")]
    public class BossStoneSteed : StoneSteed
    {
        [Constructable]
        public BossStoneSteed() : base()
        {
            Name = "Boss StoneSteed";
            Title = "the Enforcer";
        ...
        public BossStoneSteed(Serial serial) : base(serial)
        {
        }
