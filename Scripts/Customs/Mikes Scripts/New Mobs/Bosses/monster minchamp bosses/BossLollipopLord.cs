...
{
    [CorpseName("a boss LollipopLord corpse")]
    public class BossLollipopLord : LollipopLord
    {
        [Constructable]
        public BossLollipopLord() : base()
        {
            Name = "Boss LollipopLord";
            Title = "the Enforcer";
        ...
        public BossLollipopLord(Serial serial) : base(serial)
        {
        }
