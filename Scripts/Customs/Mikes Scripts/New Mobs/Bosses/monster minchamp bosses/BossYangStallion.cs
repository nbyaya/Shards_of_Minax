...
{
    [CorpseName("a boss YangStallion corpse")]
    public class BossYangStallion : YangStallion
    {
        [Constructable]
        public BossYangStallion() : base()
        {
            Name = "Boss YangStallion";
            Title = "the Enforcer";
        ...
        public BossYangStallion(Serial serial) : base(serial)
        {
        }
