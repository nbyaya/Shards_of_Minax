...
{
    [CorpseName("a boss StarbornPredator corpse")]
    public class BossStarbornPredator : StarbornPredator
    {
        [Constructable]
        public BossStarbornPredator() : base()
        {
            Name = "Boss StarbornPredator";
            Title = "the Enforcer";
        ...
        public BossStarbornPredator(Serial serial) : base(serial)
        {
        }
