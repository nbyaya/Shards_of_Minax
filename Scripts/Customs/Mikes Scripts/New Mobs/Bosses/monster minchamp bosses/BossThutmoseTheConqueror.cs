...
{
    [CorpseName("a boss ThutmoseTheConqueror corpse")]
    public class BossThutmoseTheConqueror : ThutmoseTheConqueror
    {
        [Constructable]
        public BossThutmoseTheConqueror() : base()
        {
            Name = "Boss ThutmoseTheConqueror";
            Title = "the Enforcer";
        ...
        public BossThutmoseTheConqueror(Serial serial) : base(serial)
        {
        }
