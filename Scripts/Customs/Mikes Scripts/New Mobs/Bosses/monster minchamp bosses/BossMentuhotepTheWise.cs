...
{
    [CorpseName("a boss MentuhotepTheWise corpse")]
    public class BossMentuhotepTheWise : MentuhotepTheWise
    {
        [Constructable]
        public BossMentuhotepTheWise() : base()
        {
            Name = "Boss MentuhotepTheWise";
            Title = "the Enforcer";
        ...
        public BossMentuhotepTheWise(Serial serial) : base(serial)
        {
        }
