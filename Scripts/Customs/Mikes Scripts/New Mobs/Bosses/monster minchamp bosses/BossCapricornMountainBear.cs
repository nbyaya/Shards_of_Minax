...
{
    [CorpseName("a boss CapricornMountainBear corpse")]
    public class BossCapricornMountainBear : CapricornMountainBear
    {
        [Constructable]
        public BossCapricornMountainBear() : base()
        {
            Name = "Boss CapricornMountainBear";
            Title = "the Enforcer";
        ...
        public BossCapricornMountainBear(Serial serial) : base(serial)
        {
        }
