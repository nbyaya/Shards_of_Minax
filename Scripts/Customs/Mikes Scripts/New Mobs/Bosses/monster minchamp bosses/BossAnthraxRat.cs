...
{
    [CorpseName("a boss AnthraxRat corpse")]
    public class BossAnthraxRat : AnthraxRat
    {
        [Constructable]
        public BossAnthraxRat() : base()
        {
            Name = "Boss AnthraxRat";
            Title = "the Enforcer";
        ...
        public BossAnthraxRat(Serial serial) : base(serial)
        {
        }
