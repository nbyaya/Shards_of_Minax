...
{
    [CorpseName("a boss Stormcaller corpse")]
    public class BossStormcaller : Stormcaller
    {
        [Constructable]
        public BossStormcaller() : base()
        {
            Name = "Boss Stormcaller";
            Title = "the Enforcer";
        ...
        public BossStormcaller(Serial serial) : base(serial)
        {
        }
