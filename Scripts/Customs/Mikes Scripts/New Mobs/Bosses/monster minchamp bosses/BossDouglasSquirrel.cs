...
{
    [CorpseName("a boss DouglasSquirrel corpse")]
    public class BossDouglasSquirrel : DouglasSquirrel
    {
        [Constructable]
        public BossDouglasSquirrel() : base()
        {
            Name = "Boss DouglasSquirrel";
            Title = "the Enforcer";
        ...
        public BossDouglasSquirrel(Serial serial) : base(serial)
        {
        }
