...
{
    [CorpseName("a boss ElectricSlime corpse")]
    public class BossElectricSlime : ElectricSlime
    {
        [Constructable]
        public BossElectricSlime() : base()
        {
            Name = "Boss ElectricSlime";
            Title = "the Enforcer";
        ...
        public BossElectricSlime(Serial serial) : base(serial)
        {
        }
