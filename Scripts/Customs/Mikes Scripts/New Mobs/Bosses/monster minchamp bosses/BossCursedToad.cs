...
{
    [CorpseName("a boss CursedToad corpse")]
    public class BossCursedToad : CursedToad
    {
        [Constructable]
        public BossCursedToad() : base()
        {
            Name = "Boss CursedToad";
            Title = "the Enforcer";
        ...
        public BossCursedToad(Serial serial) : base(serial)
        {
        }
