...
{
    [CorpseName("a boss RhythmicSatyr corpse")]
    public class BossRhythmicSatyr : RhythmicSatyr
    {
        [Constructable]
        public BossRhythmicSatyr() : base()
        {
            Name = "Boss RhythmicSatyr";
            Title = "the Enforcer";
        ...
        public BossRhythmicSatyr(Serial serial) : base(serial)
        {
        }
