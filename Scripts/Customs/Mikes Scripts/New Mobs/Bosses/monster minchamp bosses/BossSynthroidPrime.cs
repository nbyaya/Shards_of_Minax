...
{
    [CorpseName("a boss SynthroidPrime corpse")]
    public class BossSynthroidPrime : SynthroidPrime
    {
        [Constructable]
        public BossSynthroidPrime() : base()
        {
            Name = "Boss SynthroidPrime";
            Title = "the Enforcer";
        ...
        public BossSynthroidPrime(Serial serial) : base(serial)
        {
        }
