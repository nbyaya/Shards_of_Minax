...
{
    [CorpseName("a boss ArcaneSentinel corpse")]
    public class BossArcaneSentinel : ArcaneSentinel
    {
        [Constructable]
        public BossArcaneSentinel() : base()
        {
            Name = "Boss ArcaneSentinel";
            Title = "the Enforcer";
        ...
        public BossArcaneSentinel(Serial serial) : base(serial)
        {
        }
