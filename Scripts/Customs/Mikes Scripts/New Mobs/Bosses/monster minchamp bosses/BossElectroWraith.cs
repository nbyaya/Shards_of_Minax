...
{
    [CorpseName("a boss ElectroWraith corpse")]
    public class BossElectroWraith : ElectroWraith
    {
        [Constructable]
        public BossElectroWraith() : base()
        {
            Name = "Boss ElectroWraith";
            Title = "the Enforcer";
        ...
        public BossElectroWraith(Serial serial) : base(serial)
        {
        }
