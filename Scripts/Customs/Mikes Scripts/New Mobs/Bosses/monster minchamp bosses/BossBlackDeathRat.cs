...
{
    [CorpseName("a boss BlackDeathRat corpse")]
    public class BossBlackDeathRat : BlackDeathRat
    {
        [Constructable]
        public BossBlackDeathRat() : base()
        {
            Name = "Boss BlackDeathRat";
            Title = "the Enforcer";
        ...
        public BossBlackDeathRat(Serial serial) : base(serial)
        {
        }
