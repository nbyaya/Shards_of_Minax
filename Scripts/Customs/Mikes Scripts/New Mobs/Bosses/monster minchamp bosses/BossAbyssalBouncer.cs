...
{
    [CorpseName("a boss AbyssalBouncer corpse")]
    public class BossAbyssalBouncer : AbyssalBouncer
    {
        [Constructable]
        public BossAbyssalBouncer() : base()
        {
            Name = "Boss AbyssalBouncer";
            Title = "the Enforcer";
        ...
        public BossAbyssalBouncer(Serial serial) : base(serial)
        {
        }
