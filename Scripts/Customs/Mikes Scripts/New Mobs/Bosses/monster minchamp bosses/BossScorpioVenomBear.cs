...
{
    [CorpseName("a boss ScorpioVenomBear corpse")]
    public class BossScorpioVenomBear : ScorpioVenomBear
    {
        [Constructable]
        public BossScorpioVenomBear() : base()
        {
            Name = "Boss ScorpioVenomBear";
            Title = "the Enforcer";
        ...
        public BossScorpioVenomBear(Serial serial) : base(serial)
        {
        }
