...
{
    [CorpseName("a boss InfernoStallion corpse")]
    public class BossInfernoStallion : InfernoStallion
    {
        [Constructable]
        public BossInfernoStallion() : base()
        {
            Name = "Boss InfernoStallion";
            Title = "the Enforcer";
        ...
        public BossInfernoStallion(Serial serial) : base(serial)
        {
        }
