...
{
    [CorpseName("a boss RaistlinMajere corpse")]
    public class BossRaistlinMajere : RaistlinMajere
    {
        [Constructable]
        public BossRaistlinMajere() : base()
        {
            Name = "Boss RaistlinMajere";
            Title = "the Enforcer";
        ...
        public BossRaistlinMajere(Serial serial) : base(serial)
        {
        }
