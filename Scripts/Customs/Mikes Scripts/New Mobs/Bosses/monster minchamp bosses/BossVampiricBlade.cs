...
{
    [CorpseName("a boss VampiricBlade corpse")]
    public class BossVampiricBlade : VampiricBlade
    {
        [Constructable]
        public BossVampiricBlade() : base()
        {
            Name = "Boss VampiricBlade";
            Title = "the Enforcer";
        ...
        public BossVampiricBlade(Serial serial) : base(serial)
        {
        }
