...
{
    [CorpseName("a boss SpectralWarden corpse")]
    public class BossSpectralWarden : SpectralWarden
    {
        [Constructable]
        public BossSpectralWarden() : base()
        {
            Name = "Boss SpectralWarden";
            Title = "the Enforcer";
        ...
        public BossSpectralWarden(Serial serial) : base(serial)
        {
        }
