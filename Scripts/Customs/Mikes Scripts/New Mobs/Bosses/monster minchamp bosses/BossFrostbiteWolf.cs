...
{
    [CorpseName("a boss FrostbiteWolf corpse")]
    public class BossFrostbiteWolf : FrostbiteWolf
    {
        [Constructable]
        public BossFrostbiteWolf() : base()
        {
            Name = "Boss FrostbiteWolf";
            Title = "the Enforcer";
        ...
        public BossFrostbiteWolf(Serial serial) : base(serial)
        {
        }
