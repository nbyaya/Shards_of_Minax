...
{
    [CorpseName("a boss FrostDroid corpse")]
    public class BossFrostDroid : FrostDroid
    {
        [Constructable]
        public BossFrostDroid() : base()
        {
            Name = "Boss FrostDroid";
            Title = "the Enforcer";
        ...
        public BossFrostDroid(Serial serial) : base(serial)
        {
        }
