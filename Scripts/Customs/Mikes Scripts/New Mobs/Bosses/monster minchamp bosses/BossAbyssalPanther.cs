...
{
    [CorpseName("a boss AbyssalPanther corpse")]
    public class BossAbyssalPanther : AbyssalPanther
    {
        [Constructable]
        public BossAbyssalPanther() : base()
        {
            Name = "Boss AbyssalPanther";
            Title = "the Enforcer";
        ...
        public BossAbyssalPanther(Serial serial) : base(serial)
        {
        }
