...
{
    [CorpseName("a boss FleshEaterOgre corpse")]
    public class BossFleshEaterOgre : FleshEaterOgre
    {
        [Constructable]
        public BossFleshEaterOgre() : base()
        {
            Name = "Boss FleshEaterOgre";
            Title = "the Enforcer";
        ...
        public BossFleshEaterOgre(Serial serial) : base(serial)
        {
        }
