...
{
    [CorpseName("a boss FlameborneKnight corpse")]
    public class BossFlameborneKnight : FlameborneKnight
    {
        [Constructable]
        public BossFlameborneKnight() : base()
        {
            Name = "Boss FlameborneKnight";
            Title = "the Enforcer";
        ...
        public BossFlameborneKnight(Serial serial) : base(serial)
        {
        }
