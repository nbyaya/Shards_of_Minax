...
{
    [CorpseName("a boss CleopatraTheEnigmatic corpse")]
    public class BossCleopatraTheEnigmatic : CleopatraTheEnigmatic
    {
        [Constructable]
        public BossCleopatraTheEnigmatic() : base()
        {
            Name = "Boss CleopatraTheEnigmatic";
            Title = "the Enforcer";
        ...
        public BossCleopatraTheEnigmatic(Serial serial) : base(serial)
        {
        }
