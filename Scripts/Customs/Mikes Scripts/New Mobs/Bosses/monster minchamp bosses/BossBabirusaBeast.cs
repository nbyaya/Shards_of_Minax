...
{
    [CorpseName("a boss BabirusaBeast corpse")]
    public class BossBabirusaBeast : BabirusaBeast
    {
        [Constructable]
        public BossBabirusaBeast() : base()
        {
            Name = "Boss BabirusaBeast";
            Title = "the Enforcer";
        ...
        public BossBabirusaBeast(Serial serial) : base(serial)
        {
        }
