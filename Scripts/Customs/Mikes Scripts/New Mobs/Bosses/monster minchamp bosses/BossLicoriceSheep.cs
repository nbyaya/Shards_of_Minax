...
{
    [CorpseName("a boss LicoriceSheep corpse")]
    public class BossLicoriceSheep : LicoriceSheep
    {
        [Constructable]
        public BossLicoriceSheep() : base()
        {
            Name = "Boss LicoriceSheep";
            Title = "the Enforcer";
        ...
        public BossLicoriceSheep(Serial serial) : base(serial)
        {
        }
