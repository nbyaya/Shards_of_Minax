...
{
    [CorpseName("a boss OverlordMkII corpse")]
    public class BossOverlordMkII : OverlordMkII
    {
        [Constructable]
        public BossOverlordMkII() : base()
        {
            Name = "Boss OverlordMkII";
            Title = "the Enforcer";
        ...
        public BossOverlordMkII(Serial serial) : base(serial)
        {
        }
