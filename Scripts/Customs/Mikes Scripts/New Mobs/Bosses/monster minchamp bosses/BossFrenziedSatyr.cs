...
{
    [CorpseName("a boss FrenziedSatyr corpse")]
    public class BossFrenziedSatyr : FrenziedSatyr
    {
        [Constructable]
        public BossFrenziedSatyr() : base()
        {
            Name = "Boss FrenziedSatyr";
            Title = "the Enforcer";
        ...
        public BossFrenziedSatyr(Serial serial) : base(serial)
        {
        }
