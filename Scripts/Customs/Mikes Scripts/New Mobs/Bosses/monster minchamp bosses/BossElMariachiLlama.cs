...
{
    [CorpseName("a boss ElMariachiLlama corpse")]
    public class BossElMariachiLlama : ElMariachiLlama
    {
        [Constructable]
        public BossElMariachiLlama() : base()
        {
            Name = "Boss ElMariachiLlama";
            Title = "the Enforcer";
        ...
        public BossElMariachiLlama(Serial serial) : base(serial)
        {
        }
