...
{
    [CorpseName("a boss VenomousWolf corpse")]
    public class BossVenomousWolf : VenomousWolf
    {
        [Constructable]
        public BossVenomousWolf() : base()
        {
            Name = "Boss VenomousWolf";
            Title = "the Enforcer";
        ...
        public BossVenomousWolf(Serial serial) : base(serial)
        {
        }
