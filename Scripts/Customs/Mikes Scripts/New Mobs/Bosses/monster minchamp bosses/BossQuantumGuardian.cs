...
{
    [CorpseName("a boss QuantumGuardian corpse")]
    public class BossQuantumGuardian : QuantumGuardian
    {
        [Constructable]
        public BossQuantumGuardian() : base()
        {
            Name = "Boss QuantumGuardian";
            Title = "the Enforcer";
        ...
        public BossQuantumGuardian(Serial serial) : base(serial)
        {
        }
