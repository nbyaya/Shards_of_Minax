...
{
    [CorpseName("a boss InfernalLich corpse")]
    public class BossInfernalLich : InfernalLich
    {
        [Constructable]
        public BossInfernalLich() : base()
        {
            Name = "Boss InfernalLich";
            Title = "the Enforcer";
        ...
        public BossInfernalLich(Serial serial) : base(serial)
        {
        }
