...
{
    [CorpseName("a boss CosmicBouncer corpse")]
    public class BossCosmicBouncer : CosmicBouncer
    {
        [Constructable]
        public BossCosmicBouncer() : base()
        {
            Name = "Boss CosmicBouncer";
            Title = "the Enforcer";
        ...
        public BossCosmicBouncer(Serial serial) : base(serial)
        {
        }
