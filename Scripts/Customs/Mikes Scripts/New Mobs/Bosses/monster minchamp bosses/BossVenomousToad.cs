...
{
    [CorpseName("a boss VenomousToad corpse")]
    public class BossVenomousToad : VenomousToad
    {
        [Constructable]
        public BossVenomousToad() : base()
        {
            Name = "Boss VenomousToad";
            Title = "the Enforcer";
        ...
        public BossVenomousToad(Serial serial) : base(serial)
        {
        }
