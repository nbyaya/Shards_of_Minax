...
{
    [CorpseName("a boss FoxSquirrel corpse")]
    public class BossFoxSquirrel : FoxSquirrel
    {
        [Constructable]
        public BossFoxSquirrel() : base()
        {
            Name = "Boss FoxSquirrel";
            Title = "the Enforcer";
        ...
        public BossFoxSquirrel(Serial serial) : base(serial)
        {
        }
