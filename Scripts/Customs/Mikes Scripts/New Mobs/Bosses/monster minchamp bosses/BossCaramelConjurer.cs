...
{
    [CorpseName("a boss CaramelConjurer corpse")]
    public class BossCaramelConjurer : CaramelConjurer
    {
        [Constructable]
        public BossCaramelConjurer() : base()
        {
            Name = "Boss CaramelConjurer";
            Title = "the Enforcer";
        ...
        public BossCaramelConjurer(Serial serial) : base(serial)
        {
        }
