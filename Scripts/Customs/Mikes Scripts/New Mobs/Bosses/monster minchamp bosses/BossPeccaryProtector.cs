...
{
    [CorpseName("a boss PeccaryProtector corpse")]
    public class BossPeccaryProtector : PeccaryProtector
    {
        [Constructable]
        public BossPeccaryProtector() : base()
        {
            Name = "Boss PeccaryProtector";
            Title = "the Enforcer";
        ...
        public BossPeccaryProtector(Serial serial) : base(serial)
        {
        }
