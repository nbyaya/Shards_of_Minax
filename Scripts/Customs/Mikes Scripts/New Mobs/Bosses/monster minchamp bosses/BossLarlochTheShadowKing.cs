...
{
    [CorpseName("a boss LarlochTheShadowKing corpse")]
    public class BossLarlochTheShadowKing : LarlochTheShadowKing
    {
        [Constructable]
        public BossLarlochTheShadowKing() : base()
        {
            Name = "Boss LarlochTheShadowKing";
            Title = "the Enforcer";
        ...
        public BossLarlochTheShadowKing(Serial serial) : base(serial)
        {
        }
