...
{
    [CorpseName("a boss AncientWolf corpse")]
    public class BossAncientWolf : AncientWolf
    {
        [Constructable]
        public BossAncientWolf() : base()
        {
            Name = "Boss AncientWolf";
            Title = "the Enforcer";
        ...
        public BossAncientWolf(Serial serial) : base(serial)
        {
        }
