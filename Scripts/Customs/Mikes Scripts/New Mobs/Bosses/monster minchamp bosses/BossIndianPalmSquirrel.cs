...
{
    [CorpseName("a boss IndianPalmSquirrel corpse")]
    public class BossIndianPalmSquirrel : IndianPalmSquirrel
    {
        [Constructable]
        public BossIndianPalmSquirrel() : base()
        {
            Name = "Boss IndianPalmSquirrel";
            Title = "the Enforcer";
        ...
        public BossIndianPalmSquirrel(Serial serial) : base(serial)
        {
        }
