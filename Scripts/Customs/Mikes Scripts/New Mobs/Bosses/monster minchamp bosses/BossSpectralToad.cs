...
{
    [CorpseName("a boss SpectralToad corpse")]
    public class BossSpectralToad : SpectralToad
    {
        [Constructable]
        public BossSpectralToad() : base()
        {
            Name = "Boss SpectralToad";
            Title = "the Enforcer";
        ...
        public BossSpectralToad(Serial serial) : base(serial)
        {
        }
