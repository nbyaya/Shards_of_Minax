...
{
    [CorpseName("a boss AzureMirage corpse")]
    public class BossAzureMirage : AzureMirage
    {
        [Constructable]
        public BossAzureMirage() : base()
        {
            Name = "Boss AzureMirage";
            Title = "the Enforcer";
        ...
        public BossAzureMirage(Serial serial) : base(serial)
        {
        }
