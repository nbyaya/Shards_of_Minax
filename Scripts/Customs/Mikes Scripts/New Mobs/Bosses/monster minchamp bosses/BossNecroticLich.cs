...
{
    [CorpseName("a boss NecroticLich corpse")]
    public class BossNecroticLich : NecroticLich
    {
        [Constructable]
        public BossNecroticLich() : base()
        {
            Name = "Boss NecroticLich";
            Title = "the Enforcer";
        ...
        public BossNecroticLich(Serial serial) : base(serial)
        {
        }
