...
{
    [CorpseName("a boss ArcaneSatyr corpse")]
    public class BossArcaneSatyr : ArcaneSatyr
    {
        [Constructable]
        public BossArcaneSatyr() : base()
        {
            Name = "Boss ArcaneSatyr";
            Title = "the Enforcer";
        ...
        public BossArcaneSatyr(Serial serial) : base(serial)
        {
        }
