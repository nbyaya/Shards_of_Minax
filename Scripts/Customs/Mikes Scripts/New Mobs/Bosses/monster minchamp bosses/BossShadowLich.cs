...
{
    [CorpseName("a boss ShadowLich corpse")]
    public class BossShadowLich : ShadowLich
    {
        [Constructable]
        public BossShadowLich() : base()
        {
            Name = "Boss ShadowLich";
            Title = "the Enforcer";
        ...
        public BossShadowLich(Serial serial) : base(serial)
        {
        }
