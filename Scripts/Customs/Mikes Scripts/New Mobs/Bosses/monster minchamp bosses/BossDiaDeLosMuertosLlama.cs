...
{
    [CorpseName("a boss DiaDeLosMuertosLlama corpse")]
    public class BossDiaDeLosMuertosLlama : DiaDeLosMuertosLlama
    {
        [Constructable]
        public BossDiaDeLosMuertosLlama() : base()
        {
            Name = "Boss DiaDeLosMuertosLlama";
            Title = "the Enforcer";
        ...
        public BossDiaDeLosMuertosLlama(Serial serial) : base(serial)
        {
        }
