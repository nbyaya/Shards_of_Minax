...
{
    [CorpseName("a boss SombreroLlama corpse")]
    public class BossSombreroLlama : SombreroLlama
    {
        [Constructable]
        public BossSombreroLlama() : base()
        {
            Name = "Boss SombreroLlama";
            Title = "the Enforcer";
        ...
        public BossSombreroLlama(Serial serial) : base(serial)
        {
        }
