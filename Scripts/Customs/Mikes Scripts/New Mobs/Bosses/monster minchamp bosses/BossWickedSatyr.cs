...
{
    [CorpseName("a boss WickedSatyr corpse")]
    public class BossWickedSatyr : WickedSatyr
    {
        [Constructable]
        public BossWickedSatyr() : base()
        {
            Name = "Boss WickedSatyr";
            Title = "the Enforcer";
        ...
        public BossWickedSatyr(Serial serial) : base(serial)
        {
        }
