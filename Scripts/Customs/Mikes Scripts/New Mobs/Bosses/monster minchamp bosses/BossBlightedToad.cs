...
{
    [CorpseName("a boss BlightedToad corpse")]
    public class BossBlightedToad : BlightedToad
    {
        [Constructable]
        public BossBlightedToad() : base()
        {
            Name = "Boss BlightedToad";
            Title = "the Enforcer";
        ...
        public BossBlightedToad(Serial serial) : base(serial)
        {
        }
