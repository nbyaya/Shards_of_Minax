...
{
    [CorpseName("a boss ToxicSludge corpse")]
    public class BossToxicSludge : ToxicSludge
    {
        [Constructable]
        public BossToxicSludge() : base()
        {
            Name = "Boss ToxicSludge";
            Title = "the Enforcer";
        ...
        public BossToxicSludge(Serial serial) : base(serial)
        {
        }
