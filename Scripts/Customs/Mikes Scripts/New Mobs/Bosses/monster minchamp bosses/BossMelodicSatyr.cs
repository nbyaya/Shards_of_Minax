...
{
    [CorpseName("a boss MelodicSatyr corpse")]
    public class BossMelodicSatyr : MelodicSatyr
    {
        [Constructable]
        public BossMelodicSatyr() : base()
        {
            Name = "Boss MelodicSatyr";
            Title = "the Enforcer";
        ...
        public BossMelodicSatyr(Serial serial) : base(serial)
        {
        }
