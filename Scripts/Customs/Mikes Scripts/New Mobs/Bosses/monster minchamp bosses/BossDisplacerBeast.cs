...
{
    [CorpseName("a boss DisplacerBeast corpse")]
    public class BossDisplacerBeast : DisplacerBeast
    {
        [Constructable]
        public BossDisplacerBeast() : base()
        {
            Name = "Boss DisplacerBeast";
            Title = "the Enforcer";
        ...
        public BossDisplacerBeast(Serial serial) : base(serial)
        {
        }
