...
{
    [CorpseName("a boss GeminiHarpy corpse")]
    public class BossGeminiHarpy : GeminiHarpy
    {
        [Constructable]
        public BossGeminiHarpy() : base()
        {
            Name = "Boss GeminiHarpy";
            Title = "the Enforcer";
        ...
        public BossGeminiHarpy(Serial serial) : base(serial)
        {
        }
