...
{
    [CorpseName("a boss SmallpoxRat corpse")]
    public class BossSmallpoxRat : SmallpoxRat
    {
        [Constructable]
        public BossSmallpoxRat() : base()
        {
            Name = "Boss SmallpoxRat";
            Title = "the Enforcer";
        ...
        public BossSmallpoxRat(Serial serial) : base(serial)
        {
        }
