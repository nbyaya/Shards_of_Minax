...
{
    [CorpseName("a boss MetallicWindsteed corpse")]
    public class BossMetallicWindsteed : MetallicWindsteed
    {
        [Constructable]
        public BossMetallicWindsteed() : base()
        {
            Name = "Boss MetallicWindsteed";
            Title = "the Enforcer";
        ...
        public BossMetallicWindsteed(Serial serial) : base(serial)
        {
        }
