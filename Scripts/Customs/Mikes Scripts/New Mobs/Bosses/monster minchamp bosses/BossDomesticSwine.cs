...
{
    [CorpseName("a boss DomesticSwine corpse")]
    public class BossDomesticSwine : DomesticSwine
    {
        [Constructable]
        public BossDomesticSwine() : base()
        {
            Name = "Boss DomesticSwine";
            Title = "the Enforcer";
        ...
        public BossDomesticSwine(Serial serial) : base(serial)
        {
        }
