...
{
    [CorpseName("a boss WraithLich corpse")]
    public class BossWraithLich : WraithLich
    {
        [Constructable]
        public BossWraithLich() : base()
        {
            Name = "Boss WraithLich";
            Title = "the Enforcer";
        ...
        public BossWraithLich(Serial serial) : base(serial)
        {
        }
