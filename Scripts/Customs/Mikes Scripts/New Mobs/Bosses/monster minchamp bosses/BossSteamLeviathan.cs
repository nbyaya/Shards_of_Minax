...
{
    [CorpseName("a boss SteamLeviathan corpse")]
    public class BossSteamLeviathan : SteamLeviathan
    {
        [Constructable]
        public BossSteamLeviathan() : base()
        {
            Name = "Boss SteamLeviathan";
            Title = "the Enforcer";
        ...
        public BossSteamLeviathan(Serial serial) : base(serial)
        {
        }
