...
{
    [CorpseName("a boss ShadowbladeAssassin corpse")]
    public class BossShadowbladeAssassin : ShadowbladeAssassin
    {
        [Constructable]
        public BossShadowbladeAssassin() : base()
        {
            Name = "Boss ShadowbladeAssassin";
            Title = "the Enforcer";
        ...
        public BossShadowbladeAssassin(Serial serial) : base(serial)
        {
        }
