...
{
    [CorpseName("a boss CrystalOoze corpse")]
    public class BossCrystalOoze : CrystalOoze
    {
        [Constructable]
        public BossCrystalOoze() : base()
        {
            Name = "Boss CrystalOoze";
            Title = "the Enforcer";
        ...
        public BossCrystalOoze(Serial serial) : base(serial)
        {
        }
