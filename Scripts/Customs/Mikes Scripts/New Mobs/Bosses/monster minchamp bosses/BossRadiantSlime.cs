...
{
    [CorpseName("a boss RadiantSlime corpse")]
    public class BossRadiantSlime : RadiantSlime
    {
        [Constructable]
        public BossRadiantSlime() : base()
        {
            Name = "Boss RadiantSlime";
            Title = "the Enforcer";
        ...
        public BossRadiantSlime(Serial serial) : base(serial)
        {
        }
