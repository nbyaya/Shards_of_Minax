...
{
    [CorpseName("a boss IroncladDefender corpse")]
    public class BossIroncladDefender : IroncladDefender
    {
        [Constructable]
        public BossIroncladDefender() : base()
        {
            Name = "Boss IroncladDefender";
            Title = "the Enforcer";
        ...
        public BossIroncladDefender(Serial serial) : base(serial)
        {
        }
