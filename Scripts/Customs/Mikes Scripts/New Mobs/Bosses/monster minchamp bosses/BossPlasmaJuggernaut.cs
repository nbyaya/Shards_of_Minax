...
{
    [CorpseName("a boss PlasmaJuggernaut corpse")]
    public class BossPlasmaJuggernaut : PlasmaJuggernaut
    {
        [Constructable]
        public BossPlasmaJuggernaut() : base()
        {
            Name = "Boss PlasmaJuggernaut";
            Title = "the Enforcer";
        ...
        public BossPlasmaJuggernaut(Serial serial) : base(serial)
        {
        }
