...
{
    [CorpseName("a boss CactusLlama corpse")]
    public class BossCactusLlama : CactusLlama
    {
        [Constructable]
        public BossCactusLlama() : base()
        {
            Name = "Boss CactusLlama";
            Title = "the Enforcer";
        ...
        public BossCactusLlama(Serial serial) : base(serial)
        {
        }
