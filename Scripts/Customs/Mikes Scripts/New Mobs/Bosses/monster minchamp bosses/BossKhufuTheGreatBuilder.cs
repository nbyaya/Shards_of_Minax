...
{
    [CorpseName("a boss KhufuTheGreatBuilder corpse")]
    public class BossKhufuTheGreatBuilder : KhufuTheGreatBuilder
    {
        [Constructable]
        public BossKhufuTheGreatBuilder() : base()
        {
            Name = "Boss KhufuTheGreatBuilder";
            Title = "the Enforcer";
        ...
        public BossKhufuTheGreatBuilder(Serial serial) : base(serial)
        {
        }
