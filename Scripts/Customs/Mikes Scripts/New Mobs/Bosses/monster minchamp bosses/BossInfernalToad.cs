...
{
    [CorpseName("a boss InfernalToad corpse")]
    public class BossInfernalToad : InfernalToad
    {
        [Constructable]
        public BossInfernalToad() : base()
        {
            Name = "Boss InfernalToad";
            Title = "the Enforcer";
        ...
        public BossInfernalToad(Serial serial) : base(serial)
        {
        }
