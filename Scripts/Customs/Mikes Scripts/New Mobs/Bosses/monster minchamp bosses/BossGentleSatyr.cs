...
{
    [CorpseName("a boss GentleSatyr corpse")]
    public class BossGentleSatyr : GentleSatyr
    {
        [Constructable]
        public BossGentleSatyr() : base()
        {
            Name = "Boss GentleSatyr";
            Title = "the Enforcer";
        ...
        public BossGentleSatyr(Serial serial) : base(serial)
        {
        }
