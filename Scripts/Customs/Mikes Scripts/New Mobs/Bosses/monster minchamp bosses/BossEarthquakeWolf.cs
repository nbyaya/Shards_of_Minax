...
{
    [CorpseName("a boss EarthquakeWolf corpse")]
    public class BossEarthquakeWolf : EarthquakeWolf
    {
        [Constructable]
        public BossEarthquakeWolf() : base()
        {
            Name = "Boss EarthquakeWolf";
            Title = "the Enforcer";
        ...
        public BossEarthquakeWolf(Serial serial) : base(serial)
        {
        }
