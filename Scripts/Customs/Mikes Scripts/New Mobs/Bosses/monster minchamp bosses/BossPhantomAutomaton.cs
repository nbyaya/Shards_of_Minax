...
{
    [CorpseName("a boss PhantomAutomaton corpse")]
    public class BossPhantomAutomaton : PhantomAutomaton
    {
        [Constructable]
        public BossPhantomAutomaton() : base()
        {
            Name = "Boss PhantomAutomaton";
            Title = "the Enforcer";
        ...
        public BossPhantomAutomaton(Serial serial) : base(serial)
        {
        }
