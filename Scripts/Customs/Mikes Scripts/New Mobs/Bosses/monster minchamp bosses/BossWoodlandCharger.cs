...
{
    [CorpseName("a boss WoodlandCharger corpse")]
    public class BossWoodlandCharger : WoodlandCharger
    {
        [Constructable]
        public BossWoodlandCharger() : base()
        {
            Name = "Boss WoodlandCharger";
            Title = "the Enforcer";
        ...
        public BossWoodlandCharger(Serial serial) : base(serial)
        {
        }
