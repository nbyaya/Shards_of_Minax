...
{
    [CorpseName("a boss VortexConstruct corpse")]
    public class BossVortexConstruct : VortexConstruct
    {
        [Constructable]
        public BossVortexConstruct() : base()
        {
            Name = "Boss VortexConstruct";
            Title = "the Enforcer";
        ...
        public BossVortexConstruct(Serial serial) : base(serial)
        {
        }
