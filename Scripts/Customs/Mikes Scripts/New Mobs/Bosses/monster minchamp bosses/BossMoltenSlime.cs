...
{
    [CorpseName("a boss MoltenSlime corpse")]
    public class BossMoltenSlime : MoltenSlime
    {
        [Constructable]
        public BossMoltenSlime() : base()
        {
            Name = "Boss MoltenSlime";
            Title = "the Enforcer";
        ...
        public BossMoltenSlime(Serial serial) : base(serial)
        {
        }
