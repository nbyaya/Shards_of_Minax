...
{
    [CorpseName("a boss MalariaRat corpse")]
    public class BossMalariaRat : MalariaRat
    {
        [Constructable]
        public BossMalariaRat() : base()
        {
            Name = "Boss MalariaRat";
            Title = "the Enforcer";
        ...
        public BossMalariaRat(Serial serial) : base(serial)
        {
        }
