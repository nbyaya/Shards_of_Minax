...
{
    [CorpseName("a boss IroncladOgre corpse")]
    public class BossIroncladOgre : IroncladOgre
    {
        [Constructable]
        public BossIroncladOgre() : base()
        {
            Name = "Boss IroncladOgre";
            Title = "the Enforcer";
        ...
        public BossIroncladOgre(Serial serial) : base(serial)
        {
        }
