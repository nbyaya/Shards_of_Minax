...
{
    [CorpseName("a boss VolcanicCharger corpse")]
    public class BossVolcanicCharger : VolcanicCharger
    {
        [Constructable]
        public BossVolcanicCharger() : base()
        {
            Name = "Boss VolcanicCharger";
            Title = "the Enforcer";
        ...
        public BossVolcanicCharger(Serial serial) : base(serial)
        {
        }
