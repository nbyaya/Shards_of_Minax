...
{
    [CorpseName("a boss LeoSunBear corpse")]
    public class BossLeoSunBear : LeoSunBear
    {
        [Constructable]
        public BossLeoSunBear() : base()
        {
            Name = "Boss LeoSunBear";
            Title = "the Enforcer";
        ...
        public BossLeoSunBear(Serial serial) : base(serial)
        {
        }
