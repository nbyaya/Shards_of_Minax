...
{
    [CorpseName("a boss PhantomPanther corpse")]
    public class BossPhantomPanther : PhantomPanther
    {
        [Constructable]
        public BossPhantomPanther() : base()
        {
            Name = "Boss PhantomPanther";
            Title = "the Enforcer";
        ...
        public BossPhantomPanther(Serial serial) : base(serial)
        {
        }
