...
{
    [CorpseName("a boss OmegaSentinel corpse")]
    public class BossOmegaSentinel : OmegaSentinel
    {
        [Constructable]
        public BossOmegaSentinel() : base()
        {
            Name = "Boss OmegaSentinel";
            Title = "the Enforcer";
        ...
        public BossOmegaSentinel(Serial serial) : base(serial)
        {
        }
