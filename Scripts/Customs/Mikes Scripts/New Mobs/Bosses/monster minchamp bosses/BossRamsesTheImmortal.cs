...
{
    [CorpseName("a boss RamsesTheImmortal corpse")]
    public class BossRamsesTheImmortal : RamsesTheImmortal
    {
        [Constructable]
        public BossRamsesTheImmortal() : base()
        {
            Name = "Boss RamsesTheImmortal";
            Title = "the Enforcer";
        ...
        public BossRamsesTheImmortal(Serial serial) : base(serial)
        {
        }
