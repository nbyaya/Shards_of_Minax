...
{
    [CorpseName("a boss AriesRamBear corpse")]
    public class BossAriesRamBear : AriesRamBear
    {
        [Constructable]
        public BossAriesRamBear() : base()
        {
            Name = "Boss AriesRamBear";
            Title = "the Enforcer";
        ...
        public BossAriesRamBear(Serial serial) : base(serial)
        {
        }
