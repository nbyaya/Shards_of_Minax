...
{
    [CorpseName("a boss ForgottenWarden corpse")]
    public class BossForgottenWarden : ForgottenWarden
    {
        [Constructable]
        public BossForgottenWarden() : base()
        {
            Name = "Boss ForgottenWarden";
            Title = "the Enforcer";
        ...
        public BossForgottenWarden(Serial serial) : base(serial)
        {
        }
