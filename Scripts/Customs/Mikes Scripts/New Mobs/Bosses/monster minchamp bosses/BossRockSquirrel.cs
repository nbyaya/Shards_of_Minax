...
{
    [CorpseName("a boss RockSquirrel corpse")]
    public class BossRockSquirrel : RockSquirrel
    {
        [Constructable]
        public BossRockSquirrel() : base()
        {
            Name = "Boss RockSquirrel";
            Title = "the Enforcer";
        ...
        public BossRockSquirrel(Serial serial) : base(serial)
        {
        }
