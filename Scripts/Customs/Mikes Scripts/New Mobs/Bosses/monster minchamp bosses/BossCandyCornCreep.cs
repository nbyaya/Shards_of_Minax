...
{
    [CorpseName("a boss CandyCornCreep corpse")]
    public class BossCandyCornCreep : CandyCornCreep
    {
        [Constructable]
        public BossCandyCornCreep() : base()
        {
            Name = "Boss CandyCornCreep";
            Title = "the Enforcer";
        ...
        public BossCandyCornCreep(Serial serial) : base(serial)
        {
        }
