...
{
    [CorpseName("a boss GummySheep corpse")]
    public class BossGummySheep : GummySheep
    {
        [Constructable]
        public BossGummySheep() : base()
        {
            Name = "Boss GummySheep";
            Title = "the Enforcer";
        ...
        public BossGummySheep(Serial serial) : base(serial)
        {
        }
