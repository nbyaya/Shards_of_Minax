...
{
    [CorpseName("a boss WhisperingPooka corpse")]
    public class BossWhisperingPooka : WhisperingPooka
    {
        [Constructable]
        public BossWhisperingPooka() : base()
        {
            Name = "Boss WhisperingPooka";
            Title = "the Enforcer";
        ...
        public BossWhisperingPooka(Serial serial) : base(serial)
        {
        }
