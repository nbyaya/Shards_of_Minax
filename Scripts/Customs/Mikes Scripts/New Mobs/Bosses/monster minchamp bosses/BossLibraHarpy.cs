...
{
    [CorpseName("a boss libra harpy corpse")]
    public class BossLibraHarpy : LibraHarpy
    {
        [Constructable]
        public BossLibraHarpy() : base()
        {
            Name = "Boss Libra Harpy";
            Title = "the  Enforcer";
            Hue = 2101; // Unique hue for Boss version
            Body = 30; // Same body, can be adjusted if desired
            ...
            // Initialize 5 MaxxiaScroll drops
            for (int i = 0; i < 5; i++)
            {
        ...
        public BossLibraHarpy(Serial serial) : base(serial)
        {
        }
