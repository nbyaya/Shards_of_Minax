...
{
    [CorpseName("a boss FlamebringerOgre corpse")]
    public class BossFlamebringerOgre : FlamebringerOgre
    {
        [Constructable]
        public BossFlamebringerOgre() : base()
        {
            Name = "Boss FlamebringerOgre";
            Title = "the Enforcer";
        ...
        public BossFlamebringerOgre(Serial serial) : base(serial)
        {
        }
