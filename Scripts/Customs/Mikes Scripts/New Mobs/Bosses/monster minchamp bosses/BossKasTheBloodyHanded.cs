...
{
    [CorpseName("a boss KasTheBloodyHanded corpse")]
    public class BossKasTheBloodyHanded : KasTheBloodyHanded
    {
        [Constructable]
        public BossKasTheBloodyHanded() : base()
        {
            Name = "Boss KasTheBloodyHanded";
            Title = "the Enforcer";
        ...
        public BossKasTheBloodyHanded(Serial serial) : base(serial)
        {
        }
