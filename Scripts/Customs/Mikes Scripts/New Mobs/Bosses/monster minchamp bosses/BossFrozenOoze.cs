...
{
    [CorpseName("a boss FrozenOoze corpse")]
    public class BossFrozenOoze : FrozenOoze
    {
        [Constructable]
        public BossFrozenOoze() : base()
        {
            Name = "Boss FrozenOoze";
            Title = "the Enforcer";
        ...
        public BossFrozenOoze(Serial serial) : base(serial)
        {
        }
