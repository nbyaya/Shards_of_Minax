...
{
    [CorpseName("a boss GlisteningOoze corpse")]
    public class BossGlisteningOoze : GlisteningOoze
    {
        [Constructable]
        public BossGlisteningOoze() : base()
        {
            Name = "Boss GlisteningOoze";
            Title = "the Enforcer";
        ...
        public BossGlisteningOoze(Serial serial) : base(serial)
        {
        }
