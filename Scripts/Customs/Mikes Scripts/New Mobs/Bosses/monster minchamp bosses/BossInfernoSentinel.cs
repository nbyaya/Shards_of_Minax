...
{
    [CorpseName("a boss InfernoSentinel corpse")]
    public class BossInfernoSentinel : InfernoSentinel
    {
        [Constructable]
        public BossInfernoSentinel() : base()
        {
            Name = "Boss InfernoSentinel";
            Title = "the Enforcer";
        ...
        public BossInfernoSentinel(Serial serial) : base(serial)
        {
        }
