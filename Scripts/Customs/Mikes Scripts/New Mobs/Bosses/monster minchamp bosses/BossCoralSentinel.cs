...
{
    [CorpseName("a boss CoralSentinel corpse")]
    public class BossCoralSentinel : CoralSentinel
    {
        [Constructable]
        public BossCoralSentinel() : base()
        {
            Name = "Boss CoralSentinel";
            Title = "the Enforcer";
        ...
        public BossCoralSentinel(Serial serial) : base(serial)
        {
        }
