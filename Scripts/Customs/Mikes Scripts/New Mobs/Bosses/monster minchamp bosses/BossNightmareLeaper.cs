...
{
    [CorpseName("a boss NightmareLeaper corpse")]
    public class BossNightmareLeaper : NightmareLeaper
    {
        [Constructable]
        public BossNightmareLeaper() : base()
        {
            Name = "Boss NightmareLeaper";
            Title = "the Enforcer";
        ...
        public BossNightmareLeaper(Serial serial) : base(serial)
        {
        }
