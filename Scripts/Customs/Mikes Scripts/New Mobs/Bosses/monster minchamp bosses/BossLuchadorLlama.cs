...
{
    [CorpseName("a boss LuchadorLlama corpse")]
    public class BossLuchadorLlama : LuchadorLlama
    {
        [Constructable]
        public BossLuchadorLlama() : base()
        {
            Name = "Boss LuchadorLlama";
            Title = "the Enforcer";
        ...
        public BossLuchadorLlama(Serial serial) : base(serial)
        {
        }
