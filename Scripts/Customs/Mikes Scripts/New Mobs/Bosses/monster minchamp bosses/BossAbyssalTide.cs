...
{
    [CorpseName("a boss AbyssalTide corpse")]
    public class BossAbyssalTide : AbyssalTide
    {
        [Constructable]
        public BossAbyssalTide() : base()
        {
            Name = "Boss AbyssalTide";
            Title = "the Enforcer";
        ...
        public BossAbyssalTide(Serial serial) : base(serial)
        {
        }
