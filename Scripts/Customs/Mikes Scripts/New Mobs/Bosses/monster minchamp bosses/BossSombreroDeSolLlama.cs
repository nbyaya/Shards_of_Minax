...
{
    [CorpseName("a boss SombreroDeSolLlama corpse")]
    public class BossSombreroDeSolLlama : SombreroDeSolLlama
    {
        [Constructable]
        public BossSombreroDeSolLlama() : base()
        {
            Name = "Boss SombreroDeSolLlama";
            Title = "the Enforcer";
        ...
        public BossSombreroDeSolLlama(Serial serial) : base(serial)
        {
        }
