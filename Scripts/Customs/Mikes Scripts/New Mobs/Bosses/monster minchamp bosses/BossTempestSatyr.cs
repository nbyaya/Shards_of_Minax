...
{
    [CorpseName("a boss TempestSatyr corpse")]
    public class BossTempestSatyr : TempestSatyr
    {
        [Constructable]
        public BossTempestSatyr() : base()
        {
            Name = "Boss TempestSatyr";
            Title = "the Enforcer";
        ...
        public BossTempestSatyr(Serial serial) : base(serial)
        {
        }
