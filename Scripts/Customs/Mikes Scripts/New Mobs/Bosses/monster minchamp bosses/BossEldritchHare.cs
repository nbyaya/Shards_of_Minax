...
{
    [CorpseName("a boss EldritchHare corpse")]
    public class BossEldritchHare : EldritchHare
    {
        [Constructable]
        public BossEldritchHare() : base()
        {
            Name = "Boss EldritchHare";
            Title = "the Enforcer";
        ...
        public BossEldritchHare(Serial serial) : base(serial)
        {
        }
