...
{
    [CorpseName("a boss CancerHarpy corpse")]
    public class BossCancerHarpy : CancerHarpy
    {
        [Constructable]
        public BossCancerHarpy() : base()
        {
            Name = "Boss CancerHarpy";
            Title = "the Enforcer";
        ...
        public BossCancerHarpy(Serial serial) : base(serial)
        {
        }
