...
{
    [CorpseName("a boss CholeraRat corpse")]
    public class BossCholeraRat : CholeraRat
    {
        [Constructable]
        public BossCholeraRat() : base()
        {
            Name = "Boss CholeraRat";
            Title = "the Enforcer";
        ...
        public BossCholeraRat(Serial serial) : base(serial)
        {
        }
