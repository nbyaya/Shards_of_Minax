...
{
    [CorpseName("corpse of a trap expert")]
    public class TrapEngineer : BaseCreature
    {
        private TimeSpan m_TrapDelay = TimeSpan.FromSeconds(30.0); // time between setting traps
        public DateTime m_NextTrapTime;

        [Constructable]
        public TrapEngineer() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public TrapEngineer(Serial serial) : base(serial)
        {
        }
