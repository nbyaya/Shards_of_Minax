...
{
    [CorpseName("corpse of a trap maker")]
    public class TrapMaker : BaseCreature
    {
        private TimeSpan m_TrapDelay = TimeSpan.FromSeconds(15.0); // time between trap placements
        public DateTime m_NextTrapTime;

        [Constructable]
        public TrapMaker() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public TrapMaker(Serial serial) : base(serial)
        {
        }
