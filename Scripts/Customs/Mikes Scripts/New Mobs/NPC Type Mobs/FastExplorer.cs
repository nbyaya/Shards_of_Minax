...
{
	[CorpseName("corpse of a Adventurer")]
	public class FastExplorer : BaseCreature
	{
		private DateTime lastDirectionChange;
		private TimeSpan directionChangeInterval = TimeSpan.FromSeconds(20);

		[Constructable]
		public FastExplorer() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
		{
			Name = "Fast Explorer";
		...
		// Correctly defining the AlwaysMurderer property for C# 2.0/3.0
		public override bool AlwaysMurderer
		{
			get { return true; }
		}

		public FastExplorer(Serial serial) : base(serial)
		{
		}
