...
{
    [CorpseName("corpse of a DinoRider")]
    public class DinoRider : BaseCreature
    {
        private TimeSpan m_SpeechDelay = TimeSpan.FromSeconds(10.0);
        public DateTime m_NextSpeechTime;

        [Constructable]
        public DinoRider() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
        ...
        public override void GenerateLoot()
        {
            ...
            switch (phrase)
            {
                case 0: this.Say(true, "The tribe... will remember..."); break;
                case 1: this.Say(true, "The dinosaurs... will avenge me..."); break;
            }
        ...
        public DinoRider(Serial serial) : base(serial)
        {
        }
