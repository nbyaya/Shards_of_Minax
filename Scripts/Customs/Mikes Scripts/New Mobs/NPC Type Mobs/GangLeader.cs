...
{
    [CorpseName("corpse of a gang leader")]
    public class GangLeader : BaseCreature
    {
        ...
        [Constructable]
        public GangLeader() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            {
                Body = 0x191;
                Name = "Gang Leader Lady";
            }
            else
            {
                Body = 0x190;
                Name = "Gang Leader Dude";
            }
        ...
        public GangLeader(Serial serial) : base(serial)
        {
        }
