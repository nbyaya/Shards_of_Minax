...
namespace CustomsFramework.Systems.ShrinkSystem
{
    public class ShrinkSystemCore : BaseCore
    {
        ...
        public override AccessLevel EditLevel { get { return AccessLevel.Administrator; } }
        ...
        public static void Initialize()
        {
            ...
            CommandSystem.Register("SSToggle", AccessLevel.Administrator, new CommandEventHandler(SSToggle_OnCommand));
        }
