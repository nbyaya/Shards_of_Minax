...
{
    public abstract class ArcherySpell : CSpell
    {
        public ArcherySpell(Mobile caster, Item scroll, SpellInfo info)
        ...
        public override SkillName DamageSkill { get { return SkillName.Archery; } }
