...
{
	public class Pie1 : CookingSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Gastronomic Glamour", "Britemus Por Ylemis",
		                                                //SpellCircle.Fifth,
		                                                -1,
		                                                9002
		                                               );
		...
		public Pie1( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		{
			private Pie1 m_Owner;

			public InternalTarget( Pie1 owner ) : base( 12, false, TargetFlags.None )
			{
				m_Owner = owner;
			}
