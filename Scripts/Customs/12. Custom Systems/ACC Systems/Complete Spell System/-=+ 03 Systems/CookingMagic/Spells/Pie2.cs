...
{
	public class Pie2 : CookingSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Culinary Conjure", "Hevs Grav Ohm Sepa",
		                                                //SpellCircle.Fifth,
		                                                -1,
		                                                9002
		                                               );
		...
		public Pie2( Mobile caster, Item scroll ) : this( caster, scroll, null )
		{
		}

		public Pie2( Mobile caster, Item scroll, RunebookEntry entry ) : base( caster, scroll, m_Info )
		{
			m_Entry = entry;
		}
		...
		{
			private Pie2 m_Owner;

			public InternalTarget( Pie2 owner ) : base( 12, false, TargetFlags.None )
			{
				m_Owner = owner;
