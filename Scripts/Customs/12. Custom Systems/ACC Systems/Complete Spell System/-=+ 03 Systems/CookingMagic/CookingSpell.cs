...
{
    public abstract class CookingSpell : CSpell
    {
        public override SkillName CastSkill { get { return SkillName.Cooking; } }
        public override SkillName DamageSkill { get { return SkillName.Alchemy; } }
        ...
        public CookingSpell(Mobile caster, Item scroll, SpellInfo info)
        ...
        public override void DoFizzle()
        {
            ...
            Caster.NextSpellTime = DateTime.Now.Ticks; // Convert DateTime to long
        }
