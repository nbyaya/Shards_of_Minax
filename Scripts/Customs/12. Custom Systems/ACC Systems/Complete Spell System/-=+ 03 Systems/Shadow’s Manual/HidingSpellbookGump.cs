...
{
	public class HidingSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Shadows Manual"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( HidingSpellbookGump ); } }

		public HidingSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}