...
{
	public class LumberjackingSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Woodcutters Journal"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( LumberjackingSpellbookGump ); } }

		public LumberjackingSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}