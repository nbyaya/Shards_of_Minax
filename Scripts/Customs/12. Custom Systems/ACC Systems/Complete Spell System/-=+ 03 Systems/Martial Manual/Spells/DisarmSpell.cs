...
{
    public class DisarmSpell : MartialManualSpell
    {
        ...
        public DisarmSpell(Mobile caster, Item scroll)
        ...
        {
            private DisarmSpell m_Owner;

            public InternalTarget(DisarmSpell owner)
