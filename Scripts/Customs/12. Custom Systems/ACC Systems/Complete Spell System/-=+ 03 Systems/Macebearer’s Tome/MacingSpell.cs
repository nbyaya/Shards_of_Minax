...
{
    public abstract class MacingSpell : CSpell
    {
        public MacingSpell(Mobile caster, Item scroll, SpellInfo info)
        ...
        public override SkillName DamageSkill { get { return SkillName.Macing; } }
