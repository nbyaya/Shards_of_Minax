...
{
	public class MacingSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Macebearers Tome"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( MacingSpellbookGump ); } }

		public MacingSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}