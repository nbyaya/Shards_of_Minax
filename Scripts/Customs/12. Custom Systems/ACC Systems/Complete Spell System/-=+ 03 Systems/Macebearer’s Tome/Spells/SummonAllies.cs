...
{
	public class SummonAllies : MacingSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Summon Allies", "Xel Hor Tum",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public SummonAllies( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		{
			typeof( LeatherWolf ),
			typeof( LightningBearer ),
			typeof( StormConjurer )
		};
