...
{
	public class SummonFlameWraith : SpiritSpeakSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Summon Flame Wraith", "Spirits Come!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public SummonFlameWraith( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
