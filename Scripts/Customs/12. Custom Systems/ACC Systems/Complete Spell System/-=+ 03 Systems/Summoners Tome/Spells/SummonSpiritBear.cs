...
{
	public class SummonSpiritBear : SpiritSpeakSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Summon Spirit Bear", "Spirits Come!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public SummonSpiritBear( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
