...
{
	public class SummonMagmaColossus : SpiritSpeakSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Summon Magma Colossus", "Spirits Come!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public SummonMagmaColossus( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}

		private static Type[] m_Types = new Type[]
		{
			typeof( MagmaColossus ),
			typeof( MagmaColossus )
