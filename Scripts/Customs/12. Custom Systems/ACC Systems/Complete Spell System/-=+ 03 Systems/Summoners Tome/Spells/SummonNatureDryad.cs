...
{
	public class SummonNatureDryad : SpiritSpeakSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Summon Nature Dryad", "Spirits Come!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public SummonNatureDryad( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
