...
{
	public class SummonQuicksilverElemental : SpiritSpeakSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Summon Quicksilver Elemental", "Spirits Come!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public SummonQuicksilverElemental( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}

		private static Type[] m_Types = new Type[]
		{
			typeof( QuicksilverElemental ),
			typeof( QuicksilverElemental )
