...
{
	public class SummonBloodElemental : SpiritSpeakSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Summon Blood Elemental", "Spirits Come!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public SummonBloodElemental( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
