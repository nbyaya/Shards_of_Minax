...
{
	public class SummonVenomSprite : SpiritSpeakSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Summon Venom Sprite", "Spirits Come!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public override int RequiredMana{ get{ return 27; } }

		public SummonVenomSprite( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
