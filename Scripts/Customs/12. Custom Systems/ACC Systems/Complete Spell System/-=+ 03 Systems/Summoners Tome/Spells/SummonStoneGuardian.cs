...
{
	public class SummonStoneGuardian : SpiritSpeakSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Summon Stone Guardian", "Spirits Come!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public SummonStoneGuardian( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}

		private static Type[] m_Types = new Type[]
		{
			typeof( SummonedStoneGuardian ),
			typeof( SummonedStoneGuardian )
