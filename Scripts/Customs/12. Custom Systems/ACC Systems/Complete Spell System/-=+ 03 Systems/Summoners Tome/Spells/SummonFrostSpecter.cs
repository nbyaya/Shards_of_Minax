...
{
	public class SummonFrostSpecter : SpiritSpeakSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Summon Frost Specter", "Spirits Come!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public SummonFrostSpecter( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
