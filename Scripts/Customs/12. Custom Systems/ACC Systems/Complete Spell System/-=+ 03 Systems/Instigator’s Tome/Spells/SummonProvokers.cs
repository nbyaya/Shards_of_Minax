...
{
	public class SummonProvokers : ProvocationSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Summon Provokers", "Come Instigators!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public SummonProvokers( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		{
			typeof( NymphSinger ),
			typeof( NoirDetective ),
			typeof( SkaSkald ),
			typeof( InsaneRoboticist )
