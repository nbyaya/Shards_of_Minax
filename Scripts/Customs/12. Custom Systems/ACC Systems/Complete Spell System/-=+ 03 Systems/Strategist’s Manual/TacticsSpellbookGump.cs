...
{
	public class TacticsSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Strategists Manual"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( TacticsSpellbookGump ); } }

		public TacticsSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}