...
{
	public class FishingSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Fishing Magic"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( FishingSpellbookGump ); } }

		public FishingSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}