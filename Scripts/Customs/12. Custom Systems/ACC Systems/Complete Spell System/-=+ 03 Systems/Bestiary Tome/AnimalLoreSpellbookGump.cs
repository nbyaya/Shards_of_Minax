...
{
	public class AnimalLoreSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Bestiary Tome"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( AnimalLoreSpellbookGump ); } }

		public AnimalLoreSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}