...
{
	public class SwordsSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Swordmasters Codex"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( SwordsSpellbookGump ); } }

		public SwordsSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}