...
{
	public class CallAllies : SwordsSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Call Allies", "Come Allies!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		{
			typeof( FireClanSamurai ),
			typeof( DualWielder ),
			typeof( FencingMaster ),
			typeof( SwordDefender ),
			typeof( GothicNovelist ),
			typeof( DancingFarmerB )
