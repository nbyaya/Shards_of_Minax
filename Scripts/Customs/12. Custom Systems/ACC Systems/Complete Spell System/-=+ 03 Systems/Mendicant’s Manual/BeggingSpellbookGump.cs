...
{
	public class BeggingSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Mendicants Manual"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( BeggingSpellbookGump ); } }

		public BeggingSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}