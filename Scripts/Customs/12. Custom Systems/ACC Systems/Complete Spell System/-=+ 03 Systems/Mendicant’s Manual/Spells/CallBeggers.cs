...
{
	public class CallBeggers : BeggingSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Summon Elementals", "Come Beggers!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public CallBeggers( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
