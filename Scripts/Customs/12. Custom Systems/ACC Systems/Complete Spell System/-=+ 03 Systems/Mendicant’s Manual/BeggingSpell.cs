...
{
    public abstract class BeggingSpell : CSpell
    {
        public BeggingSpell(Mobile caster, Item scroll, SpellInfo info)
        ...
        public override SkillName DamageSkill { get { return SkillName.Begging; } }
