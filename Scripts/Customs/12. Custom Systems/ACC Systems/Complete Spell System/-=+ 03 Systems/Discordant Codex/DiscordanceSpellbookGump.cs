...
{
	public class DiscordanceSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Discordant Codex"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( DiscordanceSpellbookGump ); } }

		public DiscordanceSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}