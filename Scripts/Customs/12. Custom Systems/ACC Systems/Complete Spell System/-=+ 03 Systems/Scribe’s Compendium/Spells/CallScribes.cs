...
{
	public class CallScribes : InscribeSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Call Scribes", "Come Scribes!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public CallScribes( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
