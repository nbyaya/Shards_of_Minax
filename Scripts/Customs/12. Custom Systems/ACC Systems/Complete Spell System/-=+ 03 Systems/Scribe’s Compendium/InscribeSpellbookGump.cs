...
{
	public class InscribeSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Scribes Compendium"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( InscribeSpellbookGump ); } }

		public InscribeSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}