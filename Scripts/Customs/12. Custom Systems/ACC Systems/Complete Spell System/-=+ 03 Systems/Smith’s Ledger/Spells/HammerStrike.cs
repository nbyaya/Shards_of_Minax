...
{
    public class HammerStrike : BlacksmithSpell
    {
        private static SpellInfo m_Info = new SpellInfo(
            "Hammer Strike", "Crush and Stun",
            21007, // Icon ID
            9303,  // Cast animation
            false
        );
        ...
        public HammerStrike(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        {
            private HammerStrike m_Owner;

            public InternalTarget(HammerStrike owner) : base(1, false, TargetFlags.Harmful)
            {
                m_Owner = owner;
            }
