...
{
	public class MagerySpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Archmages Grimoire"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( MagerySpellbookGump ); } }

		public MagerySpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}