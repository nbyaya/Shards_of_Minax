...
{
	public class ParrySpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Guardians Codex"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( ParrySpellbookGump ); } }

		public ParrySpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}