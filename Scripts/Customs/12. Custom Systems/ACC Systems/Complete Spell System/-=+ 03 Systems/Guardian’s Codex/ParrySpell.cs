...
{
    public abstract class ParrySpell : CSpell
    {
        public ParrySpell(Mobile caster, Item scroll, SpellInfo info)
        ...
        public override SkillName DamageSkill { get { return SkillName.Parry; } }
