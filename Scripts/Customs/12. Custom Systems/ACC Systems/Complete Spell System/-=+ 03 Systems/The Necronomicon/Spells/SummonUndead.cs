...
{
	public class SummonUndead : NecromancySpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Summon Undead", "Rise My Minions!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public SummonUndead( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		private static Type[] m_Types = new Type[]
		{
			typeof( GraveDigger ),
			typeof( GhostScout ),
			typeof( NecroSummoner ),
			typeof( SummonedRandomUndead ),
			typeof( SummonedRandomUndead ),
			typeof( SummonedRandomUndead )
