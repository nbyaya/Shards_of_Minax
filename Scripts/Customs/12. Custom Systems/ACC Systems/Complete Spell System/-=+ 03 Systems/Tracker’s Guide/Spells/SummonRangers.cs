...
{
	public class SummonRangers : TrackingSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Summon Rangers", "Come Forest Friends!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public SummonRangers( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}

		private static Type[] m_Types = new Type[]
		{
			typeof( ForestTracker ),
			typeof( UrbanTracker ),
			typeof( BountyHunter ),
			typeof( Lawyer ),
			typeof( DinoRider ),
