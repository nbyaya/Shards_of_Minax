...
{
    public abstract class TrackingSpell : CSpell
    {
        public TrackingSpell(Mobile caster, Item scroll, SpellInfo info)
        ...
        public override SkillName DamageSkill { get { return SkillName.Tracking; } }
