...
{
	public class TrackingSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Trackers Guide"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( TrackingSpellbookGump ); } }

		public TrackingSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}