...
{
	public class MusicianshipSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Virtuosos Folio"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( MusicianshipSpellbookGump ); } }

		public MusicianshipSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}