...
{
	public class CallNinjas : NinjitsuSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Call Ninjas", "Come Ninjas!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public CallNinjas( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		private static Type[] m_Types = new Type[]
		{
			...
			typeof( ScoutNinja ),
			typeof( AirClanNinja ),
			typeof( FireClanNinja ),
			typeof( EarthClanNinja ),
			typeof( WaterClanNinja )
