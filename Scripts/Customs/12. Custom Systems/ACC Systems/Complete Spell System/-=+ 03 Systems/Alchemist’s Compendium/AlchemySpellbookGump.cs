...
{
	public class AlchemySpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Alchemists Compendium"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( AlchemySpellbookGump ); } }

		public AlchemySpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}