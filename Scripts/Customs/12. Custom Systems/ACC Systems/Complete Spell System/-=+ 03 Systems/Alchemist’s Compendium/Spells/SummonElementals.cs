...
{
	public class SummonElementals : AlchemySpell
	{
		...
		public SummonElementals( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		private static Type[] m_Types = new Type[]
		{
			...
			typeof( WaterAlchemist ),
			typeof( EarthAlchemist ),
			typeof( FireAlchemist ),
			typeof( Herbalist ),
			typeof( SummonedRandomElemental )
