...
{
	public class TailoringSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Tailors Workbook"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( TailoringSpellbookGump ); } }

		public TailoringSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}