...
{
    public abstract class StealingSpell : CSpell
    {
        public StealingSpell(Mobile caster, Item scroll, SpellInfo info)
        ...
        public override SkillName DamageSkill { get { return SkillName.Stealing; } }
