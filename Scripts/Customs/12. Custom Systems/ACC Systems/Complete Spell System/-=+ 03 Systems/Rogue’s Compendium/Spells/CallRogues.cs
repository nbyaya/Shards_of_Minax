...
{
	public class CallRogues : StealingSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Call Rogues", "Come Rogues!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public CallRogues( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
