...
{
	public class AnimalTamingSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Beastmasters Codex"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( AnimalTamingSpellbookGump ); } }

		public AnimalTamingSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}