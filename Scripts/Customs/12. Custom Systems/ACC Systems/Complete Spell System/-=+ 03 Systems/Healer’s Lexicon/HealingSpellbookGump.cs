...
{
	public class HealingSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Healers Lexicon"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( HealingSpellbookGump ); } }

		public HealingSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}