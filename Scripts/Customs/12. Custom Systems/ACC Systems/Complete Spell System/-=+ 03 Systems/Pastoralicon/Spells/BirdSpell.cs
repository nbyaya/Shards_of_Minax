...
{
	public class BirdSpell : PastoraliconSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Bird Herd", "Come Birds!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public BirdSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		{
			typeof( Bombhen ),
			typeof( ColossalTurkey ),
			typeof( MysticPhoenix ),
			typeof( RazorwingPhoenix )
