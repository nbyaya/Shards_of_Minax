...
{
	public class DesertSpell : PastoraliconSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Desert Herd", "Come Desert Creatures!",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public DesertSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}

		private static Type[] m_Types = new Type[]
		{
			typeof( SilkwebSpider ),
			typeof( VenomScorpion ),
			typeof( VenomousChorusFrog ),
			typeof( VenomousSerpent ),
			typeof( RandomInsect )
