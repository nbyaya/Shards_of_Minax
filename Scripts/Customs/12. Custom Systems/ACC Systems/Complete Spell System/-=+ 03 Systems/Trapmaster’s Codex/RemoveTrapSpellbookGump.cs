...
{
	public class RemoveTrapSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Trapmasters Codex"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( RemoveTrapSpellbookGump ); } }

		public RemoveTrapSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}