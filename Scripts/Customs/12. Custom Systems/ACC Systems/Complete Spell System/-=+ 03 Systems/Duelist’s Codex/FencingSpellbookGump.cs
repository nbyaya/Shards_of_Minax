...
{
	public class FencingSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Duelists Codex"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( FencingSpellbookGump ); } }

		public FencingSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}