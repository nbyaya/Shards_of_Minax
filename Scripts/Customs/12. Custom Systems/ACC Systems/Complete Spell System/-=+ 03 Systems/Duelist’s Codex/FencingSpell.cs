...
{
    public abstract class FencingSpell : CSpell
    {
        public FencingSpell(Mobile caster, Item scroll, SpellInfo info)
        ...
        public override SkillName DamageSkill { get { return SkillName.Fencing; } }
