...
{
	public class VeterinarySpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Veterinarians Codex"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( VeterinarySpellbookGump ); } }

		public VeterinarySpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}