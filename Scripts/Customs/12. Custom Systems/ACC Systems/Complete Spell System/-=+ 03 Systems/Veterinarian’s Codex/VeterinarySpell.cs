...
{
    public abstract class VeterinarySpell : CSpell
    {
        public VeterinarySpell(Mobile caster, Item scroll, SpellInfo info)
        ...
        public override SkillName CastSkill { get { return SkillName.Veterinary; } }
