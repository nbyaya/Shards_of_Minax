...
{
    public abstract class DetectHiddenSpell : CSpell
    {
        public DetectHiddenSpell(Mobile caster, Item scroll, SpellInfo info)
        ...
        public override SkillName CastSkill { get { return SkillName.DetectHidden; } }
