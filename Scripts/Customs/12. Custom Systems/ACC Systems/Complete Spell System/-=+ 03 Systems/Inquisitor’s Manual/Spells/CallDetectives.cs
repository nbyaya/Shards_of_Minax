...
{
	public class CallDetectives : DetectHiddenSpell
	{
		private static SpellInfo m_Info = new SpellInfo(
		                                                "Call Detectives", "1-800-Privateye",
		                                                //SpellCircle.Third,
		                                                266,
		                                                9040
		                                               );
		...
		public CallDetectives( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}

		private static Type[] m_Types = new Type[]
		{
			typeof( ForensicAnalyst ),
			typeof( DecoyDeployer ),
			typeof( ClueSeeker )
