...
{
	public class WrestlingSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Grapplers Manual"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( WrestlingSpellbookGump ); } }

		public WrestlingSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}