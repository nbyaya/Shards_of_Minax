...
namespace Server.ACC.CSS.Systems.ChivalryMagic
{
	public class CallRighteous : ChivalrySpell
	{
		...
		public CallRighteous( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}

		private static Type[] m_Types = new Type[]
		{
			typeof( KnightOfValor ),
			typeof( KnightOfMercy ),
			typeof( KnightOfJustice ),
			typeof( SummonedRandomAngel )
