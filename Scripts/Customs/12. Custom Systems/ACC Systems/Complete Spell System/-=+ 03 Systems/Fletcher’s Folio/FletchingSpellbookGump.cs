...
{
	public class FletchingSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Fletchers Folio"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( FletchingSpellbookGump ); } }

		public FletchingSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}