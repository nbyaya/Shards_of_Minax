...
{
    public abstract class EvalIntSpell : CSpell
    {
        public EvalIntSpell(Mobile caster, Item scroll, SpellInfo info)
        ...
        public override SkillName DamageSkill { get { return SkillName.Fishing; } }
