...
{
	public class EvalIntSpellbookGump : CSpellbookGump
	{
		...
		public override string Label1   { get{ return "Arcanists Codex"; } }
		public override string Label2   { get{ return "Spells"; } }
		public override Type   GumpType { get{ return typeof( EvalIntSpellbookGump ); } }

		public EvalIntSpellbookGump( CSpellbook book ) : base( book )
		{
		}
	}
}