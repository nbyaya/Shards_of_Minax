...
{
    public class MysticMissile : EvalIntSpell
    {
        ...
        public MysticMissile(Mobile caster, Item scroll) : base(caster, scroll, m_Info)
        {
        }
        ...
        {
            private MysticMissile m_Owner;

            public InternalTarget(MysticMissile owner) : base(12, false, TargetFlags.Harmful)
            {
                m_Owner = owner;
            }
