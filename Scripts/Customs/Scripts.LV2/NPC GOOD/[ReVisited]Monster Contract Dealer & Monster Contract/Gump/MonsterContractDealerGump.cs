...
"<BASEFONT COLOR=YELLOW>There is also a Maxxia Scroll in it for you<BR><BR>Oh, Thank you my friend. The contract will tell you which monsters to purge from the lands." + "</BODY>", false, true);
