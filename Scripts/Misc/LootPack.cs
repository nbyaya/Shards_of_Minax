...
namespace Server
{
	public class LootPack
	{
		...
		public static readonly LootPackItem[] NewFilthyRichItems = new LootPackItem[]
		{
			...
			new LootPackItem(typeof(MahJongTile), 25),
			new LootPackItem(typeof(AlchemyTalisman), 25),
			new LootPackItem(typeof(CartographyTable), 25),
			new LootPackItem(typeof(StrappedBooks), 25),
			new LootPackItem(typeof(CarpentryTalisman), 25),
			new LootPackItem(typeof(CharcuterieBoard), 25),
			new LootPackItem(typeof(BottledPlague), 25),
			new LootPackItem(typeof(NixieStatue), 25),
			new LootPackItem(typeof(GrandmasSpecialRolls), 25),
			new LootPackItem(typeof(ExoticFish), 25),
			new LootPackItem(typeof(HildebrandtShield), 25),
			new LootPackItem(typeof(GarbageBag), 25),
			new LootPackItem(typeof(GlassOfBubbly), 25),
			new LootPackItem(typeof(FishBasket), 25),
			new LootPackItem(typeof(FineSilverWire), 25),
			new LootPackItem(typeof(PlatinumChip), 25),
			new LootPackItem(typeof(TribalHelm), 25),
			new LootPackItem(typeof(GlassTable), 25),
			new LootPackItem(typeof(WaterWell), 25),
			new LootPackItem(typeof(RibbonAward), 25),
			new LootPackItem(typeof(RookStone), 25),
			new LootPackItem(typeof(AlchemistBookcase), 25),
			new LootPackItem(typeof(ElementRegular), 25),
			new LootPackItem(typeof(Satchel), 25),
			new LootPackItem(typeof(LayingChicken), 25),
			new LootPackItem(typeof(EssenceOfToad), 25),
			new LootPackItem(typeof(SalvageMachine), 25),
			new LootPackItem(typeof(TwentyfiveShield), 25),
			new LootPackItem(typeof(DaggerSign), 25),
			new LootPackItem(typeof(MultiPump), 25),
			new LootPackItem(typeof(HeartPillow), 25),
			new LootPackItem(typeof(HydroxFluid), 25),
			new LootPackItem(typeof(MasterCello), 25),
			new LootPackItem(typeof(DressForm), 25),
			new LootPackItem(typeof(LargeWeatheredBook), 25),
			new LootPackItem(typeof(WeddingCandelabra), 25),
			new LootPackItem(typeof(DeckOfMagicCards), 25),
			new LootPackItem(typeof(BrokenBottle), 25),
			new LootPackItem(typeof(FancyHornOfPlenty), 25),
			new LootPackItem(typeof(FineGoldWire), 25),
			new LootPackItem(typeof(WaterRelic), 25),
			new LootPackItem(typeof(EnchantedAnnealer), 25),
			new LootPackItem(typeof(LampPostC), 25),
			new LootPackItem(typeof(BlueSand), 25),
			new LootPackItem(typeof(FunMushroom), 25),
			new LootPackItem(typeof(ReactiveHormones), 25),
			new LootPackItem(typeof(CandleStick), 25),
			new LootPackItem(typeof(LuckyDice), 25),
			new LootPackItem(typeof(JudasCradle), 25),
			new LootPackItem(typeof(GlassFurnace), 25),
			new LootPackItem(typeof(LovelyLilies), 25),
			new LootPackItem(typeof(CupOfSlime), 25),
			new LootPackItem(typeof(GingerbreadCookie), 25),
			new LootPackItem(typeof(CarvingMachine), 25),
			new LootPackItem(typeof(GargoyleLamp), 25),
			new LootPackItem(typeof(AnimalTopiary), 25),
			new LootPackItem(typeof(TinCowbell), 25),
			new LootPackItem(typeof(WoodAlchohol), 25),
			new LootPackItem(typeof(ChocolateFountain), 25),
			new LootPackItem(typeof(PowerGem), 25),
			new LootPackItem(typeof(AtomicRegulator), 25),
			new LootPackItem(typeof(JesterSkull), 25),
			new LootPackItem(typeof(GamerGirlFeet), 25),
			new LootPackItem(typeof(HildebrandtTapestry), 25),
			new LootPackItem(typeof(AnimalBox), 25),
			new LootPackItem(typeof(BakingBoard), 25),
			new LootPackItem(typeof(SatanicTable), 25),
			new LootPackItem(typeof(WaterFountain), 25),
			new LootPackItem(typeof(FountainWall), 25),
			new LootPackItem(typeof(HildebrandtFlag), 25),
			new LootPackItem(typeof(MysteryOrb), 25),
			new LootPackItem(typeof(BlueberryPie), 25),
			new LootPackItem(typeof(BioSamples), 25),
			new LootPackItem(typeof(OldEmbroideryTool), 25),
			new LootPackItem(typeof(DistillationFlask), 25),
			new LootPackItem(typeof(SexWhip), 25),
			new LootPackItem(typeof(FrostToken), 25),
			new LootPackItem(typeof(SoftTowel), 25),
			new LootPackItem(typeof(WeddingDayCake), 25),
			new LootPackItem(typeof(LargeTome), 25),
			new LootPackItem(typeof(GargishTotem), 25),
			new LootPackItem(typeof(InscriptionTalisman), 25),
			new LootPackItem(typeof(HeavyAnchor), 25),
			new LootPackItem(typeof(PunishmentStocks), 25),
			new LootPackItem(typeof(StarMap), 25),
			new LootPackItem(typeof(SkullRing), 25),
			new LootPackItem(typeof(BrandingIron), 25),
			new LootPackItem(typeof(OldBones), 25),
			new LootPackItem(typeof(MillStones), 25),
			new LootPackItem(typeof(Steroids), 25),
			new LootPackItem(typeof(HildebrandtBunting), 25),
			new LootPackItem(typeof(LexxVase), 25),
			new LootPackItem(typeof(OrnateHarp), 25),
			new LootPackItem(typeof(FletchingTalisman), 25),
			new LootPackItem(typeof(TinTub), 25),
			new LootPackItem(typeof(FishingBear), 25),
			new LootPackItem(typeof(WorldShard), 25),
			new LootPackItem(typeof(SheepCarcass), 25),
			new LootPackItem(typeof(TailoringTalisman), 25),
			new LootPackItem(typeof(DecorativeOrchid), 25),
			new LootPackItem(typeof(SubOil), 25),
			new LootPackItem(typeof(FancyPainting), 25),
			new LootPackItem(typeof(MedusaHead), 25),
			new LootPackItem(typeof(PetRock), 25),
			new LootPackItem(typeof(MeatHooks), 25),
			new LootPackItem(typeof(GamerJelly), 25),
			new LootPackItem(typeof(ShardCrest), 25),
			new LootPackItem(typeof(EvilCandle), 25),
			new LootPackItem(typeof(HotFlamingScarecrow), 25),
			new LootPackItem(typeof(AmatureTelescope), 25),
			new LootPackItem(typeof(AnniversaryPainting), 25),
			new LootPackItem(typeof(MagicBookStand), 25),
			new LootPackItem(typeof(SmugglersCrate), 25),
			new LootPackItem(typeof(HolidayPillow), 25),
			new LootPackItem(typeof(UncrackedGeode), 25),
			new LootPackItem(typeof(DrapedBlanket), 25),
			new LootPackItem(typeof(BlacksmithTalisman), 25),
			new LootPackItem(typeof(CityBanner), 25),
			new LootPackItem(typeof(BookTwentyfive), 25),
			new LootPackItem(typeof(WelcomeMat), 25),
			new LootPackItem(typeof(HolidayCandleArran), 25),
			new LootPackItem(typeof(ValentineTeddybear), 25),
			new LootPackItem(typeof(WitchesCauldron), 25),
			new LootPackItem(typeof(FireRelic), 25),
			new LootPackItem(typeof(CartographyDesk), 25),
			new LootPackItem(typeof(BirdStatue), 25),
			new LootPackItem(typeof(Hamburgers), 25),
			new LootPackItem(typeof(SerpantCrest), 25),
			new LootPackItem(typeof(AstroLabe), 25),
			new LootPackItem(typeof(OrganicHeart), 25),
			new LootPackItem(typeof(Birdhouse), 25),
			new LootPackItem(typeof(SabertoothSkull), 25),
			new LootPackItem(typeof(ZebulinVase), 25),
			new LootPackItem(typeof(PineResin), 25),
			new LootPackItem(typeof(SpiderTree), 25),
			new LootPackItem(typeof(RopeSpindle), 25),
			new LootPackItem(typeof(DailyNewspaper), 25),
			new LootPackItem(typeof(FunPumpkinCannon), 25),
			new LootPackItem(typeof(VirtueRune), 25),
			new LootPackItem(typeof(BonFire), 25),
			new LootPackItem(typeof(MiniCherryTree), 25),
			new LootPackItem(typeof(SkullShield), 25),
			new LootPackItem(typeof(UnluckyDice), 25),
			new LootPackItem(typeof(ImportantBooks), 25),
			new LootPackItem(typeof(RareMinerals), 25),
			new LootPackItem(typeof(QuestWineRack), 25),
			new LootPackItem(typeof(FancyCrystalSkull), 25),
			new LootPackItem(typeof(StoneHead), 25),
			new LootPackItem(typeof(FluxCompound), 25),
			new LootPackItem(typeof(ArtisanHolidayTree), 25),
			new LootPackItem(typeof(TinyWizard), 25),
			new LootPackItem(typeof(MiniKeg), 25),
			new LootPackItem(typeof(DemonPlatter), 25),
			new LootPackItem(typeof(Hotdogs), 25),
			new LootPackItem(typeof(PersonalMortor), 25),
			new LootPackItem(typeof(RareWire), 25),
			new LootPackItem(typeof(ForbiddenTome), 25),
			new LootPackItem(typeof(CompoundF), 25),
			new LootPackItem(typeof(MonsterBones), 25),
			new LootPackItem(typeof(MagicOrb), 25),
			new LootPackItem(typeof(RibEye), 25),
			new LootPackItem(typeof(ButterChurn), 25),
			new LootPackItem(typeof(StainedWindow), 25),
			new LootPackItem(typeof(MutantStarfish), 25),
			new LootPackItem(typeof(WatermelonSliced), 25),
			new LootPackItem(typeof(ImperiumCrest), 25),
			new LootPackItem(typeof(ExoticWoods), 25),
			new LootPackItem(typeof(ZombieHand), 25),
			new LootPackItem(typeof(EasterDayEgg), 25),
			new LootPackItem(typeof(FancyXmasTree), 25),
			new LootPackItem(typeof(CrabBushel), 25),
			new LootPackItem(typeof(PersonalCannon), 25),
			new LootPackItem(typeof(GalvanizedTub), 25),
			new LootPackItem(typeof(FixedScales), 25),
			new LootPackItem(typeof(NexusShard), 25),
			new LootPackItem(typeof(RareSausage), 25),
			new LootPackItem(typeof(WatermelonFruit), 25),
			new LootPackItem(typeof(ToolBox), 25),
			new LootPackItem(typeof(HorrodrickCube), 25),
			new LootPackItem(typeof(TrophieAward), 25),
			new LootPackItem(typeof(ClutteredDesk), 25),
			new LootPackItem(typeof(TinkeringTalisman), 25),
			new LootPackItem(typeof(DeathBlowItem), 25),
			new LootPackItem(typeof(DeadBody), 25),
			new LootPackItem(typeof(FairyOil), 25),
			new LootPackItem(typeof(FleshLight), 25),
			new LootPackItem(typeof(EssentialBooks), 25),
			new LootPackItem(typeof(PileOfChains), 25),
			new LootPackItem(typeof(FancyCopperSunflower), 25),
			new LootPackItem(typeof(FineHoochJug), 25),
			new LootPackItem(typeof(SpookyGhost), 25),
			new LootPackItem(typeof(ScentedCandle), 25),
			new LootPackItem(typeof(SnowSculpture), 25),
			new LootPackItem(typeof(MasterShrubbery), 25),
			new LootPackItem(typeof(MilkingPail), 25),
			new LootPackItem(typeof(MonsterTrophy), 25),
			new LootPackItem(typeof(DistilledEssence), 25),
			new LootPackItem(typeof(WigStand), 25),
			new LootPackItem(typeof(BrassFountain), 25),
			new LootPackItem(typeof(HandOfFate), 25),
			new LootPackItem(typeof(NameTapestry), 25),
			new LootPackItem(typeof(OpalBranch), 25),
			new LootPackItem(typeof(SilverMirror), 25),
			new LootPackItem(typeof(MarbleHourglass), 25),
			new LootPackItem(typeof(KnightStone), 25),
			new LootPackItem(typeof(MaxxiaDust), 25),
			new LootPackItem(typeof(TrexSkull), 25),
			new LootPackItem(typeof(RootThrone), 25),
			new LootPackItem(typeof(BabyLavos), 25),
			new LootPackItem(typeof(CowToken), 25),
			new LootPackItem(typeof(WallFlowers), 25),
			new LootPackItem(typeof(ColoredLamppost), 25),
			new LootPackItem(typeof(EarthRelic), 25),
			new LootPackItem(typeof(ExoticWhistle), 25),
			new LootPackItem(typeof(GrandmasKnitting), 25),
			new LootPackItem(typeof(FancyShipWheel), 25),
			new LootPackItem(typeof(ExoticBoots), 25),
			new LootPackItem(typeof(FineIronWire), 25),
			new LootPackItem(typeof(SeaSerpantSteak), 25),
			new LootPackItem(typeof(RareOil), 25),
			new LootPackItem(typeof(SpikedChair), 25),
			new LootPackItem(typeof(KrakenTrophy), 25),
			new LootPackItem(typeof(ZttyCrystal), 25),
			new LootPackItem(typeof(FineCopperWire), 25),
			new LootPackItem(typeof(GraniteHammer), 25),
			new LootPackItem(typeof(StuffedDoll), 25),
			new LootPackItem(typeof(FancyMirror), 25),
			new LootPackItem(typeof(ExoticPlum), 25),
			new LootPackItem(typeof(Shears), 25),
			new LootPackItem(typeof(FillerPowder), 25),
			new LootPackItem(typeof(HorrorPumpkin), 25),
			new LootPackItem(typeof(HumanCarvingKit), 25),
			new LootPackItem(typeof(HangingMask), 25),
			new LootPackItem(typeof(SkullIncense), 25),
			new LootPackItem(typeof(AncientRunes), 25),
			new LootPackItem(typeof(WeddingChest), 25),
			new LootPackItem(typeof(ExoticShipInABottle), 25),
			new LootPackItem(typeof(FancySewingMachine), 25),
			new LootPackItem(typeof(CowPoo), 25),
			new LootPackItem(typeof(FeedingTrough), 25),
			new LootPackItem(typeof(SkullBottle), 25),
			new LootPackItem(typeof(AncientDrum), 25),
			new LootPackItem(typeof(BrassBell), 25),
			new LootPackItem(typeof(PlagueBanner), 25),
			new LootPackItem(typeof(BeeHive), 25),
			new LootPackItem(typeof(FestiveChampagne), 25),
			new LootPackItem(typeof(DecorativeFishTank), 25),
			new LootPackItem(typeof(SkullsStack), 25),
			new LootPackItem(typeof(VenusFlytrap), 25),
			new LootPackItem(typeof(HorribleMask), 25),
			new LootPackItem(typeof(Meteorite), 25),
			new LootPackItem(typeof(TotumPole), 25),
			new LootPackItem(typeof(ExcitingTome), 25),
			new LootPackItem(typeof(WindRelic), 25),
			new LootPackItem(typeof(FancyCopperWings), 25),
			new LootPackItem(typeof(RareGrease), 25),
			new LootPackItem(typeof(EnchantedRose), 25),
			new LootPackItem(typeof(HeartChair), 25),
			new LootPackItem(typeof(PicnicDayBasket), 25),
			new LootPackItem(typeof(HorseToken), 25),
			new LootPackItem(typeof(AutoPounder), 25),
			new LootPackItem(typeof(WatermelonTray), 25),
			new LootPackItem(typeof(MasterTrumpet), 25),
			new LootPackItem(typeof(WeaponBottle), 25),
			new LootPackItem(typeof(LeatherStrapBelt), 25),
			new LootPackItem(typeof(JackPumpkin), 25),
			new LootPackItem(typeof(MiniYew), 25),
			new LootPackItem(typeof(ImportantFlag), 25),
			new LootPackItem(typeof(HutFlower), 25),
			new LootPackItem(typeof(CookingTalisman), 25),
			new LootPackItem(typeof(LampPostA), 25),
			new LootPackItem(typeof(LampPostB), 25),
			new LootPackItem(typeof(MasterGyro), 25),
			new LootPackItem(typeof(MemorialStone), 25),
			new LootPackItem(typeof(MemorialCopper), 25),
			new LootPackItem(typeof(LargeVat), 25),
			new LootPackItem(typeof(YardCupid), 25),
			new LootPackItem(typeof(FieldPlow), 25),
			new LootPackItem(typeof(ChaliceOfPilfering), 25),
			new LootPackItem(typeof(Jet), 25),
			new LootPackItem(typeof(InfinitySymbol), 25),
			new LootPackItem(typeof(AbyssalCrownOfCommand), 25),
			new LootPackItem(typeof(AcidlordsCrown), 25),
			new LootPackItem(typeof(AcidSlugRing), 25),
			new LootPackItem(typeof(AlchemistsExperimentalBracers), 25),
			new LootPackItem(typeof(AmuletOfCorrosion), 25),
			new LootPackItem(typeof(AmuletOfCorruption), 25),
			new LootPackItem(typeof(AmuletOfTheCrystalDepths), 25),
			new LootPackItem(typeof(AmuletOfTheMeerCaptain), 25),
			new LootPackItem(typeof(AntLionsEmbraceLeggings), 25),
			new LootPackItem(typeof(ArachnidQueensVeil), 25),
			new LootPackItem(typeof(ArchmageMantle), 25),
			new LootPackItem(typeof(BeastmastersMantle), 25),
			new LootPackItem(typeof(BeastmastersSaddle), 25),
			new LootPackItem(typeof(BeetlemastersCarapace), 25),
			new LootPackItem(typeof(BetrayersShroud), 25),
			new LootPackItem(typeof(BirdmastersPlume), 25),
			new LootPackItem(typeof(BlackBearSummoningAmulet), 25),
			new LootPackItem(typeof(BloodFoxCloak), 25),
			new LootPackItem(typeof(BloodmastersRobes), 25),
			new LootPackItem(typeof(BloodwormBreastplate), 25),
			new LootPackItem(typeof(BoglingsEmbrace), 25),
			new LootPackItem(typeof(BogThingsEmbrace), 25),
			new LootPackItem(typeof(BoneAmulet), 25),
			new LootPackItem(typeof(BoneKnightArmor), 25),
			new LootPackItem(typeof(BootsofHaste), 25),
			new LootPackItem(typeof(BrigandLordCloak), 25),
			new LootPackItem(typeof(BrigandsBand), 25),
			new LootPackItem(typeof(BrigandsCloak), 25),
			new LootPackItem(typeof(BronzeGauntlets), 25),
			new LootPackItem(typeof(BullmastersHelm), 25),
			new LootPackItem(typeof(CapybaraWhispererSash), 25),
			new LootPackItem(typeof(CelestialMantle), 25),
			new LootPackItem(typeof(CentaurianCloak), 25),
			new LootPackItem(typeof(ChangelingsEmbrace), 25),
			new LootPackItem(typeof(ChaosbringerShroud), 25),
			new LootPackItem(typeof(ChaosDragoonArmor), 25),
			new LootPackItem(typeof(ChaosDragoonChestplate), 25),
			new LootPackItem(typeof(ChaoslordsMantle), 25),
			new LootPackItem(typeof(ChestOfTheHiveLord), 25),
			new LootPackItem(typeof(ChickenWranglerSash), 25),
			new LootPackItem(typeof(ChitinousCloak), 25),
			new LootPackItem(typeof(ChitinousHelm), 25),
			new LootPackItem(typeof(CloakOfEffervescentMantra), 25),
			new LootPackItem(typeof(CloakOfEtherealWings), 25),
			new LootPackItem(typeof(CloakOfMoltenSerpents), 25),
			new LootPackItem(typeof(CloakOfTheGargoylesVengeance), 25),
			new LootPackItem(typeof(CloakOfTheHellCat), 25),
			new LootPackItem(typeof(CloakOfTheHerd), 25),
			new LootPackItem(typeof(CloakOfTheNightborn), 25),
			new LootPackItem(typeof(CloakOfTheWailingBanshee), 25),
			new LootPackItem(typeof(CloakOfTwistingVines), 25),
			new LootPackItem(typeof(CloakOfViscera), 25),
			new LootPackItem(typeof(CloakOfWinds), 25),
			new LootPackItem(typeof(CluckmasterCloak), 25),
			new LootPackItem(typeof(CoconutCrabCharm), 25),
			new LootPackItem(typeof(CopperCrown), 25),
			new LootPackItem(typeof(CraneMastersRobe), 25),
			new LootPackItem(typeof(CrimsonDragonEmbrace), 25),
			new LootPackItem(typeof(CrownOfMaddeningWhispers), 25),
			new LootPackItem(typeof(CrownOfTheInfernalKing), 25),
			new LootPackItem(typeof(CrownOfTheLichKing), 25),
			new LootPackItem(typeof(CrystalDaemonAmulet), 25),
			new LootPackItem(typeof(CrystalElementalistRobes), 25),
			new LootPackItem(typeof(CrystalSummonersCirclet), 25),
			new LootPackItem(typeof(CyclopeanWarriorHelm), 25),
			new LootPackItem(typeof(DancerRobes), 25),
			new LootPackItem(typeof(DarkArchmagesShroud), 25),
			new LootPackItem(typeof(DarkGuardianAmulet), 25),
			new LootPackItem(typeof(DeathWatchCarapace), 25),
			new LootPackItem(typeof(DecayedBoneHelm), 25),
			new LootPackItem(typeof(DeepSeaSurgeCrown), 25),
			new LootPackItem(typeof(DemonicOniMask), 25),
			new LootPackItem(typeof(DesertWanderersSandals), 25),
			new LootPackItem(typeof(DestroyersAegis), 25),
			new LootPackItem(typeof(DevourerCloak), 25),
			new LootPackItem(typeof(DolphinsGuardianAmulet), 25),
			new LootPackItem(typeof(DoomcallersMantle), 25),
			new LootPackItem(typeof(DragonheartSamuraiChest), 25),
			new LootPackItem(typeof(DragonlordsHelm), 25),
			new LootPackItem(typeof(DragonmasterAmulet), 25),
			new LootPackItem(typeof(DragonmastersRobe), 25),
			new LootPackItem(typeof(DragonsFlameGrandMageStaff), 25),
			new LootPackItem(typeof(DragonsHeartBreastplate), 25),
			new LootPackItem(typeof(DragonWolfAmulet), 25),
			new LootPackItem(typeof(DrakeCommandersBreastplate), 25),
			new LootPackItem(typeof(DrakescaleCloak), 25),
			new LootPackItem(typeof(DreamWraithCloak), 25),
			new LootPackItem(typeof(DullCopperAegis), 25),
			new LootPackItem(typeof(EarthWardensPlateChest), 25),
			new LootPackItem(typeof(ElderGazerAmulet), 25),
			new LootPackItem(typeof(EldersGauntlets), 25),
			new LootPackItem(typeof(ElementalCommandCrown), 25),
			new LootPackItem(typeof(ElementalistsCrown), 25),
			new LootPackItem(typeof(EternalWisdomRobe), 25),
			new LootPackItem(typeof(EttinSummonerHelm), 25),
			new LootPackItem(typeof(ExecutionersCloak), 25),
			new LootPackItem(typeof(ExodusVanguardPlate), 25),
			new LootPackItem(typeof(FeatheredFarmersApron), 25),
			new LootPackItem(typeof(FerretSummonersCloak), 25),
			new LootPackItem(typeof(FireAntAmulet), 25),
			new LootPackItem(typeof(FlamecallersCrown), 25),
			new LootPackItem(typeof(FlamesoulShroud), 25),
			new LootPackItem(typeof(FlamingVeilOfTheFireRabbit), 25),
			new LootPackItem(typeof(FleshRenderersCloak), 25),
			new LootPackItem(typeof(ForgottenMantle), 25),
			new LootPackItem(typeof(FrostbindAmulet), 25),
			new LootPackItem(typeof(FrostbindersCloak), 25),
			new LootPackItem(typeof(FrostboundWarhelm), 25),
			new LootPackItem(typeof(FrostcallersCape), 25),
			new LootPackItem(typeof(FrostcallersCloak), 25),
			new LootPackItem(typeof(FrostcallersShard), 25),
			new LootPackItem(typeof(FrostDrakeCloak), 25),
			new LootPackItem(typeof(FrostlaceCloak), 25),
			new LootPackItem(typeof(FrostLordsCape), 25),
			new LootPackItem(typeof(FrostMantleOfTheGlacier), 25),
			new LootPackItem(typeof(FrostTrollCrown), 25),
			new LootPackItem(typeof(FrostwardCape), 25),
			new LootPackItem(typeof(FrostweaverCloak), 25),
			new LootPackItem(typeof(FrostwraithCloak), 25),
			new LootPackItem(typeof(FrostwyrmDominionStaff), 25),
			new LootPackItem(typeof(GargishStoneChestOfTheHiveLord), 25),
			new LootPackItem(typeof(GargoyleMastersRobes), 25),
			new LootPackItem(typeof(GargoylesEmbrace), 25),
			new LootPackItem(typeof(GargoyleShadesShroud), 25),
			new LootPackItem(typeof(GargoyleSummonerHelm), 25),
			new LootPackItem(typeof(GargoyleSummonerSash), 25),
			new LootPackItem(typeof(GargoylesVeil), 25),
			new LootPackItem(typeof(GazerLordAmulet), 25),
			new LootPackItem(typeof(GazersEmbrace), 25),
			new LootPackItem(typeof(GibberlingSummonersHood), 25),
			new LootPackItem(typeof(GlacialCommandersPlate), 25),
			new LootPackItem(typeof(GoblinsCloakOfMischief), 25),
			new LootPackItem(typeof(GoblinShamansMantle), 25),
			new LootPackItem(typeof(GoblinWardAmulet), 25),
			new LootPackItem(typeof(GoldenAegis), 25),
			new LootPackItem(typeof(GolemControllerBracers), 25),
			new LootPackItem(typeof(GolemforgeChestplate), 25),
			new LootPackItem(typeof(GravekeepersMantle), 25),
			new LootPackItem(typeof(GrayGoblinShamanMask), 25),
			new LootPackItem(typeof(GregoriosMantle), 25),
			new LootPackItem(typeof(GremlinSummonerCap), 25),
			new LootPackItem(typeof(GreyWolfSummonerCloak), 25),
			new LootPackItem(typeof(GrizzledRingOfDread), 25),
			new LootPackItem(typeof(GrizzlyGuardiansHelm), 25),
			new LootPackItem(typeof(HarpyQueensCrown), 25),
			new LootPackItem(typeof(HeadlessHorrorHelm), 25),
			new LootPackItem(typeof(HeartOfTheSlith), 25),
			new LootPackItem(typeof(HellfireCrown), 25),
			new LootPackItem(typeof(HellfireGreaves), 25),
			new LootPackItem(typeof(HelmOfThePlagueLord), 25),
			new LootPackItem(typeof(HelmOfTheUndeadMaster), 25),
			new LootPackItem(typeof(HordeMastersMask), 25),
			new LootPackItem(typeof(HornedCrownOfTheLabyrinth), 25),
			new LootPackItem(typeof(HornOfTheLabyrinth), 25),
			new LootPackItem(typeof(HydraSummonerHelm), 25),
			new LootPackItem(typeof(InfernalCloakOfHounds), 25),
			new LootPackItem(typeof(InfernalGrasp), 25),
			new LootPackItem(typeof(InfernalPactBracelet), 25),
			new LootPackItem(typeof(InfernalPactCloak), 25),
			new LootPackItem(typeof(InfernalPactRobe), 25),
			new LootPackItem(typeof(InfernalRiderCloak), 25),
			new LootPackItem(typeof(InfernalSummonerRobe), 25),
			new LootPackItem(typeof(InfernalSummonersBand), 25),
			new LootPackItem(typeof(InfernosEmbraceCloak), 25),
			new LootPackItem(typeof(InfiltratorsCloak), 25),
			new LootPackItem(typeof(InsectlordsGauntlets), 25),
			new LootPackItem(typeof(IronSentinelPlate), 25),
			new LootPackItem(typeof(JackRabbitCharm), 25),
			new LootPackItem(typeof(JuggernautsMightyGirdle), 25),
			new LootPackItem(typeof(JukaWarlordsCloak), 25),
			new LootPackItem(typeof(KepetchShroudOfShadows), 25),
			new LootPackItem(typeof(KepetchSummonerHelm), 25),
			new LootPackItem(typeof(KhaldunAcolyteRobe), 25),
			new LootPackItem(typeof(KhaldunNecromancersShroud), 25),
			new LootPackItem(typeof(KitsuneSummonerKimono), 25),
			new LootPackItem(typeof(KrakenlordsShroud), 25),
			new LootPackItem(typeof(LabyrinthMastersHelm), 25),
			new LootPackItem(typeof(LatticeAmulet), 25),
			new LootPackItem(typeof(LavaforgedGauntlets), 25),
			new LootPackItem(typeof(LavaLordsEmbrace), 25),
			new LootPackItem(typeof(LeafWovenCirclet), 25),
			new LootPackItem(typeof(LeatherWolfsCowl), 25),
			new LootPackItem(typeof(LeviathansEmbraceShield), 25),
			new LootPackItem(typeof(LichKingsCloak), 25),
			new LootPackItem(typeof(LionheartMantle), 25),
			new LootPackItem(typeof(LizardlordMantle), 25),
			new LootPackItem(typeof(LlamamastersRobes), 25),
			new LootPackItem(typeof(LlamaPackMasterBelt), 25),
			new LootPackItem(typeof(LuminaCrystalRobe), 25),
			new LootPackItem(typeof(MaggotmastersCloak), 25),
			new LootPackItem(typeof(MarshwalkersBoots), 25),
			new LootPackItem(typeof(MechanistsGloves), 25),
			new LootPackItem(typeof(MimicsChestplate), 25),
			new LootPackItem(typeof(MimicsShroud), 25),
			new LootPackItem(typeof(MinotaurLordHornedHelm), 25),
			new LootPackItem(typeof(MistshaperCloak), 25),
			new LootPackItem(typeof(MoltenCoreChestplate), 25),
			new LootPackItem(typeof(MongbatCloak), 25),
			new LootPackItem(typeof(MongbatSummoningCloak), 25),
			new LootPackItem(typeof(NatureGuardiansTalisman), 25),
			new LootPackItem(typeof(NaturesSentinelChestplate), 25),
			new LootPackItem(typeof(NaturesWrathPlateChest), 25),
			new LootPackItem(typeof(NecklaceOfTheEquineLord), 25),
			new LootPackItem(typeof(NecromancerApron), 25),
			new LootPackItem(typeof(NecromancerKiteShield), 25),
			new LootPackItem(typeof(NecromancersBoneChest), 25),
			new LootPackItem(typeof(NecromancersMantle), 25),
			new LootPackItem(typeof(NecroticSash), 25),
			new LootPackItem(typeof(NightmaresMantle), 25),
			new LootPackItem(typeof(NiporailemsShroud), 25),
			new LootPackItem(typeof(OceanmastersRobes), 25),
			new LootPackItem(typeof(OgresGauntlets), 25),
			new LootPackItem(typeof(OphidianKnightRelic), 25),
			new LootPackItem(typeof(OphidianMatriarchSash), 25),
			new LootPackItem(typeof(OphidiansArcaneSash), 25),
			new LootPackItem(typeof(OphidianSerpentineHelm), 25),
			new LootPackItem(typeof(OrcBombersGauntlets), 25),
			new LootPackItem(typeof(OrcishMageRobe), 25),
			new LootPackItem(typeof(OrcishWarchiefsCloak), 25),
			new LootPackItem(typeof(OrcWarchiefsBattleHelm), 25),
			new LootPackItem(typeof(OrcWarlordsPlateChest), 25),
			new LootPackItem(typeof(OrtanordsCrownOfFrost), 25),
			new LootPackItem(typeof(OsseinSummonersHorn), 25),
			new LootPackItem(typeof(OverseerControlCirclet), 25),
			new LootPackItem(typeof(PackmastersCloak), 25),
			new LootPackItem(typeof(ParoxysmusBreastplate), 25),
			new LootPackItem(typeof(PharaohsGoldenCrown), 25),
			new LootPackItem(typeof(PigWhisperersTalisman), 25),
			new LootPackItem(typeof(PixieWhisperRobes), 25),
			new LootPackItem(typeof(PlaguebearersCloak), 25),
			new LootPackItem(typeof(PlaguebearersShroud), 25),
			new LootPackItem(typeof(PlagueBringersHood), 25),
			new LootPackItem(typeof(PlaguebringersTalisman), 25),
			new LootPackItem(typeof(PlaguelordShroud), 25),
			new LootPackItem(typeof(PlagueweaversShroud), 25),
			new LootPackItem(typeof(PredatorClawMantle), 25),
			new LootPackItem(typeof(PredatorsAmulet), 25),
			new LootPackItem(typeof(PrimalStalkerBoots), 25),
			new LootPackItem(typeof(PrimalWardensHelm), 25),
			new LootPackItem(typeof(ProtectorsGuardianShield), 25),
			new LootPackItem(typeof(PutridGuardianRobe), 25),
			new LootPackItem(typeof(PyromancerCuirass), 25),
			new LootPackItem(typeof(QuagmiresMantle), 25),
			new LootPackItem(typeof(QueensGuardRobes), 25),
			new LootPackItem(typeof(QueensSummonerRobe), 25),
			new LootPackItem(typeof(RabbitmastersRobes), 25),
			new LootPackItem(typeof(RaijusEmbrace), 25),
			new LootPackItem(typeof(RancherHat), 25),
			new LootPackItem(typeof(RaptorLordCloak), 25),
			new LootPackItem(typeof(RatcatchersSash), 25),
			new LootPackItem(typeof(RatmanArchersRobes), 25),
			new LootPackItem(typeof(RatmanArchmageRobe), 25),
			new LootPackItem(typeof(RatmastersRobes), 25),
			new LootPackItem(typeof(RatmastersSash), 25),
			new LootPackItem(typeof(RatsMastersRobes), 25),
			new LootPackItem(typeof(RavagersRobes), 25),
			new LootPackItem(typeof(ReaperlordsMantle), 25),
			new LootPackItem(typeof(RedSolenWarriorRobes), 25),
			new LootPackItem(typeof(RedSolenWorkerRobes), 25),
			new LootPackItem(typeof(RenegadeMastersCloak), 25),
			new LootPackItem(typeof(ReptalonMastersRobes), 25),
			new LootPackItem(typeof(RevenantLionCrown), 25),
			new LootPackItem(typeof(RevenantmastersRobes), 25),
			new LootPackItem(typeof(RidersGoldenCloak), 25),
			new LootPackItem(typeof(RidgebackMasterSash), 25),
			new LootPackItem(typeof(RingOfTheJukanCommander), 25),
			new LootPackItem(typeof(RobeOfTheEvilArchmage), 25),
			new LootPackItem(typeof(RobeOfTheMeerCommander), 25),
			new LootPackItem(typeof(RobesOfThePhoenix), 25),
			new LootPackItem(typeof(RoninBlade), 25),
			new LootPackItem(typeof(RoninMastersRobe), 25),
			new LootPackItem(typeof(RotweaversCloak), 25),
			new LootPackItem(typeof(RotwormMastersRobes), 25),
			new LootPackItem(typeof(RousingWingArmor), 25),
			new LootPackItem(typeof(RuddyBouraMastersRobes), 25),
			new LootPackItem(typeof(RunemastersRobes), 25),
			new LootPackItem(typeof(SabertoothMantle), 25),
			new LootPackItem(typeof(SandmastersRobes), 25),
			new LootPackItem(typeof(SashOfTheCatacombs), 25),
			new LootPackItem(typeof(SashOfTheHiryu), 25),
			new LootPackItem(typeof(SashOfTheMilitiaCommander), 25),
			new LootPackItem(typeof(SatyrsEmbrace), 25),
			new LootPackItem(typeof(SavageLordRobes), 25),
			new LootPackItem(typeof(SavageMastersRobe), 25),
			new LootPackItem(typeof(SavageShamansRegalia), 25),
			new LootPackItem(typeof(SavageWardenBoots), 25),
			new LootPackItem(typeof(SavageWarlordsCloak), 25),
			new LootPackItem(typeof(ScelestusDarkMantle), 25),
			new LootPackItem(typeof(ScepterOfTheEternalWail), 25),
			new LootPackItem(typeof(ScepterOfTheUndyingHorde), 25),
			new LootPackItem(typeof(ScepterOfTheVoidWanderer), 25),
			new LootPackItem(typeof(ScepterOfTheWraithLord), 25),
			new LootPackItem(typeof(ScorpionLordsSash), 25),
			new LootPackItem(typeof(ScoutmastersCunningApron), 25),
			new LootPackItem(typeof(SeductressApron), 25),
			new LootPackItem(typeof(SentinelsAegis), 25),
			new LootPackItem(typeof(SentinelsAegisRobes), 25),
			new LootPackItem(typeof(SerpentcallerAmulet), 25),
			new LootPackItem(typeof(SerpentineWarlordsRobe), 25),
			new LootPackItem(typeof(SerpentLordSash), 25),
			new LootPackItem(typeof(SerpentmastersGauntlets), 25),
			new LootPackItem(typeof(SerpentmastersRing), 25),
			new LootPackItem(typeof(SerpentsFangShroud), 25),
			new LootPackItem(typeof(SerpentsStride), 25),
			new LootPackItem(typeof(ShaadowmastersRobes), 25),
			new LootPackItem(typeof(ShadecloakOfTheAbyss), 25),
			new LootPackItem(typeof(ShadowcloakOfTheImpaler), 25),
			new LootPackItem(typeof(ShadowlordsCloak), 25),
			new LootPackItem(typeof(ShadowlordsPlateChest), 25),
			new LootPackItem(typeof(ShadowmastersRobes), 25),
			new LootPackItem(typeof(ShadowNinjasCloak), 25),
			new LootPackItem(typeof(ShadowPantherCloak), 25),
			new LootPackItem(typeof(ShadowweaversRobes), 25),
			new LootPackItem(typeof(ShadowWispRobes), 25),
			new LootPackItem(typeof(ShardmastersDiadem), 25),
			new LootPackItem(typeof(ShepherdsCloak), 25),
			new LootPackItem(typeof(ShepherdsHartCloak), 25),
			new LootPackItem(typeof(ShepherdsHat), 25),
			new LootPackItem(typeof(ShepherdsMantle), 25),
			new LootPackItem(typeof(ShepherdsRobe), 25),
			new LootPackItem(typeof(ShieldOfTheWightLord), 25),
			new LootPackItem(typeof(ShroudOfTheLifestealer), 25),
			new LootPackItem(typeof(ShroudOfTheYomotsuPriest), 25),
			new LootPackItem(typeof(SilverSerpentsEmbrace), 25),
			new LootPackItem(typeof(SkeletalDrakeBreastplate), 25),
			new LootPackItem(typeof(SkeletalReapersBardiche), 25),
			new LootPackItem(typeof(SkitteringSash), 25),
			new LootPackItem(typeof(SkreeSummonersHat), 25),
			new LootPackItem(typeof(SkullLordsHelm), 25),
			new LootPackItem(typeof(SkywatcherCloak), 25),
			new LootPackItem(typeof(SlimeboundSash), 25),
			new LootPackItem(typeof(SlithlordsStoneChest), 25),
			new LootPackItem(typeof(SnowmastersBearMask), 25),
			new LootPackItem(typeof(SnowStalkersCape), 25),
			new LootPackItem(typeof(SolenHiveMasterSash), 25),
			new LootPackItem(typeof(SolenInfiltratorTunic), 25),
			new LootPackItem(typeof(SolenQueenHiveBand), 25),
			new LootPackItem(typeof(SoulbindersRobe), 25),
			new LootPackItem(typeof(SpectralGuardPlate), 25),
			new LootPackItem(typeof(SpectralShroud), 25),
			new LootPackItem(typeof(SpellbindersOrb), 25),
			new LootPackItem(typeof(SpiderlordsWebcloak), 25),
			new LootPackItem(typeof(SpiderWeaverApron), 25),
			new LootPackItem(typeof(SquirrelWhisperersSash), 25),
			new LootPackItem(typeof(StaffOfBoneSummoning), 25),
			new LootPackItem(typeof(StaffOfJukaMagi), 25),
			new LootPackItem(typeof(StaffOfOphidianDomination), 25),
			new LootPackItem(typeof(StaffOfTheAncientGrove), 25),
			new LootPackItem(typeof(StaffOfTheArcaneDaemon), 25),
			new LootPackItem(typeof(StaffOfTheArcaneMeer), 25),
			new LootPackItem(typeof(StaffOfTheHive), 25),
			new LootPackItem(typeof(StaffOfTheLichKing), 25),
			new LootPackItem(typeof(SteedmastersApron), 25),
			new LootPackItem(typeof(StoneguardsAegis), 25),
			new LootPackItem(typeof(StoneHarpyWingArmor), 25),
			new LootPackItem(typeof(StoneTitansHelm), 25),
			new LootPackItem(typeof(StormlordsCloak), 25),
			new LootPackItem(typeof(StygianDrakeSash), 25),
			new LootPackItem(typeof(SummonersMacawBandana), 25),
			new LootPackItem(typeof(SummonersRingOfTheGoreFiend), 25),
			new LootPackItem(typeof(SwamplardsSash), 25),
			new LootPackItem(typeof(SwampLordsCloak), 25),
			new LootPackItem(typeof(SwamplordsCrown), 25),
			new LootPackItem(typeof(SwamplordsSash), 25),
			new LootPackItem(typeof(SwampwardenGreaves), 25),
			new LootPackItem(typeof(SylvanWardenBoots), 25),
			new LootPackItem(typeof(TerathanMatriarchsScepter), 25),
			new LootPackItem(typeof(TidecallersPendant), 25),
			new LootPackItem(typeof(TidecallersRobes), 25),
			new LootPackItem(typeof(TigersClawHarness), 25),
			new LootPackItem(typeof(TigersClawSash), 25),
			new LootPackItem(typeof(TitanforgedStoneChest), 25),
			new LootPackItem(typeof(ToxicDefenderShield), 25),
			new LootPackItem(typeof(ToxicMantleOfCorrosion), 25),
			new LootPackItem(typeof(ToxicWardensSash), 25),
			new LootPackItem(typeof(TrapdoorWeaversWings), 25),
			new LootPackItem(typeof(TriceratopsBoneHelm), 25),
			new LootPackItem(typeof(TritonsTempestTrident), 25),
			new LootPackItem(typeof(TroglodyteSummonerKryss), 25),
			new LootPackItem(typeof(TrollKingsWarHammer), 25),
			new LootPackItem(typeof(TropicsCallRobe), 25),
			new LootPackItem(typeof(TsukiWolfsGaze), 25),
			new LootPackItem(typeof(TurkeySummonersSash), 25),
			new LootPackItem(typeof(TurkeyTamerSash), 25),
			new LootPackItem(typeof(UnicornsGraceSash), 25),
			new LootPackItem(typeof(VenomlordsShroud), 25),
			new LootPackItem(typeof(VenomousMantle), 25),
			new LootPackItem(typeof(VerdantGuardianPlate), 25),
			new LootPackItem(typeof(VineweaversSash), 25),
			new LootPackItem(typeof(VirulentWarlordsSash), 25),
			new LootPackItem(typeof(VoidcallersStoneChest), 25),
			new LootPackItem(typeof(VolcanicKasa), 25),
			new LootPackItem(typeof(VorpalBunnyHeaddress), 25),
			new LootPackItem(typeof(WalrusSummonerBoots), 25),
			new LootPackItem(typeof(WarbossHelm), 25),
			new LootPackItem(typeof(WarbringersGirdle), 25),
			new LootPackItem(typeof(WarchiefHelm), 25),
			new LootPackItem(typeof(WarChiefsBattleCrown), 25),
			new LootPackItem(typeof(WardensGargoyleAmulet), 25),
			new LootPackItem(typeof(WardensRobeOfTheForest), 25),
			new LootPackItem(typeof(WatercallersKimono), 25),
			new LootPackItem(typeof(WhiskersCloak), 25),
			new LootPackItem(typeof(WhisperingOrb), 25),
			new LootPackItem(typeof(WhiteWolfsHowl), 25),
			new LootPackItem(typeof(WidowsVeil), 25),
			new LootPackItem(typeof(WildBoarGirdle), 25),
			new LootPackItem(typeof(WildkeeperSash), 25),
			new LootPackItem(typeof(WildSpiritsAmulet), 25),
			new LootPackItem(typeof(WildTigerSash), 25),
			new LootPackItem(typeof(WildwoodMantle), 25),
			new LootPackItem(typeof(WindrunnersBulwark), 25),
			new LootPackItem(typeof(WintersEmbraceCloak), 25),
			new LootPackItem(typeof(WispcallerScepter), 25),
			new LootPackItem(typeof(WispsOfShadowCloak), 25),
			new LootPackItem(typeof(WolfmastersPelt), 25),
			new LootPackItem(typeof(WolfsbaneCloak), 25),
			new LootPackItem(typeof(WraithboundMantle), 25),
			new LootPackItem(typeof(WraithlordsAmulet), 25),
			new LootPackItem(typeof(WyrmcallersCloak), 25),
			...
			new LootPackItem(typeof(AbbadonTheAbyssalMap), 100),
			new LootPackItem(typeof(AbyssalWardenMap), 100),
			new LootPackItem(typeof(AbyssinianTrackerMap), 100),
			new LootPackItem(typeof(AcidicAlligatorMap), 100),
			new LootPackItem(typeof(AlchemicalLabMap), 100),
			new LootPackItem(typeof(AncientAlligatorMap), 100),
			new LootPackItem(typeof(AncientDragonsLairMap), 100),
			new LootPackItem(typeof(AngusBerserkersCampMap), 100),
			new LootPackItem(typeof(BloodstainedFieldsMap), 100),
			new LootPackItem(typeof(CorruptedOrchardMap), 100),
			new LootPackItem(typeof(DogTheBountyHuntersDenMap), 100),
			new LootPackItem(typeof(DuelistPoetArenaMap), 100),
			new LootPackItem(typeof(EarthClanNinjaLairMap), 100),
			new LootPackItem(typeof(EarthClanSamuraiEncampmentMap), 100),
			new LootPackItem(typeof(EvilAlchemistLaboratoryMap), 100),
			new LootPackItem(typeof(EvilClownCarnivalMap), 100),
			new LootPackItem(typeof(FairyQueenGladeMap), 100),
			new LootPackItem(typeof(FastExplorerExpeditionMap), 100),
			new LootPackItem(typeof(FireClanNinjaHideoutMap), 100),
			new LootPackItem(typeof(FireClanSamuraiDojoMap), 100),
			new LootPackItem(typeof(FlapperElementalistAltarMap), 100),
			new LootPackItem(typeof(FloridaMansCarnivalMap), 100),
			new LootPackItem(typeof(ForestRangerOutpostMap), 100),
			new LootPackItem(typeof(FunkFungiFamiliarGardenMap), 100),
			new LootPackItem(typeof(GangLeadersHideoutMap), 100),
			new LootPackItem(typeof(GlamRockMageConcertMap), 100),
			new LootPackItem(typeof(GothicNovelistCryptMap), 100),
			new LootPackItem(typeof(GraffitiGargoyleAlleyMap), 100),
			new LootPackItem(typeof(GreaserGryphonRidersArenaMap), 100),
			new LootPackItem(typeof(GreenHagsSwampMap), 100),
			new LootPackItem(typeof(GreenNinjasHiddenLairMap), 100),
			new LootPackItem(typeof(HippieHoplitesGroveMap), 100),
			new LootPackItem(typeof(HolyKnightsCathedralMap), 100),
			new LootPackItem(typeof(HostileDruidsGladeMap), 100),
			new LootPackItem(typeof(HostilePrincessCourtMap), 100),
			new LootPackItem(typeof(IceKingsDomainMap), 100),
			new LootPackItem(typeof(InfernoDragonsLairMap), 100),
			new LootPackItem(typeof(InsaneRoboticistWorkshopMap), 100),
			new LootPackItem(typeof(JazzAgeBrawlMap), 100),
			new LootPackItem(typeof(JestersCourtMap), 100),
			new LootPackItem(typeof(LawyersTribunalMap), 100),
			new LootPackItem(typeof(LineDragonsAscentMap), 100),
			new LootPackItem(typeof(LordBlackthornsDominionMap), 100),
			new LootPackItem(typeof(LordBritishsSummoningCircleMap), 100),
			new LootPackItem(typeof(MagmaElementalRiftMap), 100),
			new LootPackItem(typeof(MedievalMeteorologistsObservatoryMap), 100),
			new LootPackItem(typeof(MegaDragonsLairMap), 100),
			new LootPackItem(typeof(MinaxSorceressSanctumMap), 100),
			new LootPackItem(typeof(MischievousWitchCovenMap), 100),
			new LootPackItem(typeof(MotownMermaidLagoonMap), 100),
			new LootPackItem(typeof(MushroomWitchGroveMap), 100),
			new LootPackItem(typeof(MusketeerHallMap), 100),
			new LootPackItem(typeof(MysticGroveMap), 100),
			new LootPackItem(typeof(NeovictorianVampireCourtMap), 100),
			new LootPackItem(typeof(NinjaLibrarianSanctumMap), 100),
			new LootPackItem(typeof(NoirDetectiveHideoutMap), 100),
			new LootPackItem(typeof(OgreMastersDomainMap), 100),
			new LootPackItem(typeof(PhoenixStyleMastersArenaMap), 100),
			new LootPackItem(typeof(PigFarmersPenMap), 100),
			new LootPackItem(typeof(PinupPandemoniumParlorMap), 100),
			new LootPackItem(typeof(PirateOfTheStarsOutpostMap), 100),
			new LootPackItem(typeof(PiratesCoveMap), 100),
			new LootPackItem(typeof(PkMurderersHideoutMap), 100),
			new LootPackItem(typeof(RaKingsPyramidMap), 100),
			new LootPackItem(typeof(RanchMastersPrairieMap), 100),
			new LootPackItem(typeof(RapRangersJungleMap), 100),
			new LootPackItem(typeof(RaveRoguesUndergroundMap), 100),
			new LootPackItem(typeof(RebelCathedralMap), 100),
			new LootPackItem(typeof(RedQueensCourtMap), 100),
			new LootPackItem(typeof(ReggaeRunesmithWorkshopMap), 100),
			new LootPackItem(typeof(RenaissanceMechanicFactoryMap), 100),
			new LootPackItem(typeof(RetroAndroidWorkshopMap), 100),
			new LootPackItem(typeof(RetroFuturistDomeMap), 100),
			new LootPackItem(typeof(RetroRobotRomancersLairMap), 100),
			new LootPackItem(typeof(RingmastersCircusMap), 100),
			new LootPackItem(typeof(RockabillyRevenantsStageMap), 100),
			new LootPackItem(typeof(SanctuaryOfTheHolyKnightMap), 100),
			new LootPackItem(typeof(ScorpomancersDomainMap), 100),
			new LootPackItem(typeof(SilentMovieStudioMap), 100),
			new LootPackItem(typeof(SilverSlimeCavernsMap), 100),
			new LootPackItem(typeof(SithAcademyMap), 100),
			new LootPackItem(typeof(SkaSkaldConcertHallMap), 100),
			new LootPackItem(typeof(SkeletonLordCryptMap), 100),
			new LootPackItem(typeof(SlimeMageSwampMap), 100),
			new LootPackItem(typeof(SneakyNinjaClanMap), 100),
			new LootPackItem(typeof(StarCitizenOutpostMap), 100),
			new LootPackItem(typeof(StarfleetCaptainsCommandMap), 100),
			new LootPackItem(typeof(StarfleetCommandCenterMap), 100),
			new LootPackItem(typeof(SteampunkSamuraiForgeMap), 100),
			new LootPackItem(typeof(StormtrooperAcademyMap), 100),
			new LootPackItem(typeof(SurferSummonerCoveMap), 100),
			new LootPackItem(typeof(SwampThingLairMap), 100),
			new LootPackItem(typeof(SwinginSorceressBallroomMap), 100),
			new LootPackItem(typeof(TexanRancherPrairieMap), 100),
			new LootPackItem(typeof(TwistedCultistHideoutMap), 100),
			new LootPackItem(typeof(VaudevilleValkyrieStageMap), 100),
			new LootPackItem(typeof(WastelandBikerCompoundMap), 100),
			new LootPackItem(typeof(WaterClanNinjaHideoutMap), 100),
			new LootPackItem(typeof(WaterClanSamuraiFortressMap), 100),
			new LootPackItem(typeof(WildWestWizardCanyonMap), 100),
			new LootPackItem(typeof(FleshEaterOgreTombMap), 100),
			new LootPackItem(typeof(FlyingSquirrelHollowMap), 100),
			new LootPackItem(typeof(ForgottenWardenCryptMap), 100),
			new LootPackItem(typeof(FoxSquirrelGlenMap), 100),
			new LootPackItem(typeof(FrenziedSatyrsForestMap), 100),
			new LootPackItem(typeof(FrostbiteWolfsDomainMap), 100),
			new LootPackItem(typeof(FrostboundChampionsHallMap), 100),
			new LootPackItem(typeof(FrostDroidFactoryMap), 100),
			new LootPackItem(typeof(FrostLichsCryptMap), 100),
			new LootPackItem(typeof(FrostOgreLairMap), 100),
			new LootPackItem(typeof(FrostWapitiGroundsMap), 100),
			new LootPackItem(typeof(FrostWardenWatchMap), 100),
			new LootPackItem(typeof(FrozenOozeCaveMap), 100),
			new LootPackItem(typeof(FungalToadSwampMap), 100),
			new LootPackItem(typeof(GeminiHarpysLairMap), 100),
			new LootPackItem(typeof(GeminiTwinBearsDenMap), 100),
			new LootPackItem(typeof(GentleSatyrsGroveMap), 100),
			new LootPackItem(typeof(GiantForestHogsNestMap), 100),
			new LootPackItem(typeof(GiantWolfSpidersWebMap), 100),
			new LootPackItem(typeof(GoliathBirdeatersLairMap), 100),
			new LootPackItem(typeof(GoralsDomainMap), 100),
			new LootPackItem(typeof(GrapplerDronesArenaMap), 100),
			new LootPackItem(typeof(GraveKnightsCryptMap), 100),
			new LootPackItem(typeof(GummySheepsPastureMap), 100),
			new LootPackItem(typeof(InfernoStallionArenaMap), 100),
			new LootPackItem(typeof(InfinitePouncersDenMap), 100),
			new LootPackItem(typeof(IroncladDefendersFortressMap), 100),
			new LootPackItem(typeof(IroncladOgresDomainMap), 100),
			new LootPackItem(typeof(IronGolemsWorkshopMap), 100),
			new LootPackItem(typeof(IronSteedStablesMap), 100),
			new LootPackItem(typeof(JavelinaJinxHuntMap), 100),
			new LootPackItem(typeof(JellybeanJestersCarnivalMap), 100),
			new LootPackItem(typeof(KasTheBloodyhandedCryptMap), 100),
			new LootPackItem(typeof(KelthuzadsFrozenCitadelMap), 100),
			new LootPackItem(typeof(KhufuTheGreatBuildersTombMap), 100),
			new LootPackItem(typeof(LairOfTheGibbonMysticsGroveMap), 100),
			new LootPackItem(typeof(LairOfTheGlisteningOozesCavernMap), 100),
			new LootPackItem(typeof(LairOfTheGloomOgresFortressMap), 100),
			new LootPackItem(typeof(LairOfTheGloomWolfsDenMap), 100),
			new LootPackItem(typeof(LairOfTheGoldenOrbWeaversWebMap), 100),
			new LootPackItem(typeof(LairOfTheHatshepsutTheQueensTombMap), 100),
			new LootPackItem(typeof(LairOfTheHogWildsSwinePenMap), 100),
			new LootPackItem(typeof(LairOfTheHowlerMonkeysJungleMap), 100),
			new LootPackItem(typeof(LairOfTheHuntsmanSpidersLairMap), 100),
			new LootPackItem(typeof(LairOfTheHydrokineticWardensWaterShrineMap), 100),
			new LootPackItem(typeof(LairOfTheIbexHighlandMap), 100),
			new LootPackItem(typeof(LairOfTheIndianPalmSquirrelGroveMap), 100),
			new LootPackItem(typeof(LairOfTheInfernalLichCitadelMap), 100),
			new LootPackItem(typeof(LairOfTheInfernalToadSwampMap), 100),
			new LootPackItem(typeof(LairOfTheInfernoSentinelFortressMap), 100),
			new LootPackItem(typeof(LairOfTheLibraBalanceBearMap), 100),
			new LootPackItem(typeof(LairOfTheLibraHarpyMap), 100),
			new LootPackItem(typeof(LairOfTheLicoriceSheepMap), 100),
			new LootPackItem(typeof(LairOfTheLollipopLordMap), 100),
			new LootPackItem(typeof(LairOfTheLuchadorLlamaMap), 100),
			new LootPackItem(typeof(LairOfTheMalariaratDenMap), 100),
			new LootPackItem(typeof(LairOfTheMandrillshamanJungleMap), 100),
			new LootPackItem(typeof(LairOfTheMarkhorPeaksMap), 100),
			new LootPackItem(typeof(LairOfTheMeatgolemLaboratoryMap), 100),
			new LootPackItem(typeof(LairOfTheMelodicsatyrGroveMap), 100),
			new LootPackItem(typeof(LairOfTheMountainGorillaMap), 100),
			new LootPackItem(typeof(LairOfTheMuckGolemMap), 100),
			new LootPackItem(typeof(LairOfTheMysticFallowMap), 100),
			new LootPackItem(typeof(LairOfTheMysticSatyrMap), 100),
			new LootPackItem(typeof(LairOfTheNagashMap), 100),
			new LootPackItem(typeof(LairOfTheNefertitisTombMap), 100),
			new LootPackItem(typeof(LarlochTheShadowKingsCryptMap), 100),
			new LootPackItem(typeof(LeoTheHarpysLairMap), 100),
			new LootPackItem(typeof(LeoTheSunBearsDenMap), 100),
			new LootPackItem(typeof(LeprosyRatNestMap), 100),
			new LootPackItem(typeof(MentuhotepTheWiseTombMap), 100),
			new LootPackItem(typeof(MetallicWindsteedPeaksMap), 100),
			new LootPackItem(typeof(MimicronsLairMap), 100),
			new LootPackItem(typeof(MireSpawnerMarshMap), 100),
			new LootPackItem(typeof(MoltenSlimePitMap), 100),
			new LootPackItem(typeof(NanoSwarmLabMap), 100),
			new LootPackItem(typeof(NebulaCatsCelestialRealmMap), 100),
			new LootPackItem(typeof(NecroticGeneralsBattlefieldMap), 100),
			new LootPackItem(typeof(NecroticLichsTombMap), 100),
			new LootPackItem(typeof(NecroticOgresDomainMap), 100),
			new LootPackItem(typeof(NemesisUnitFacilityMap), 100),
			new LootPackItem(typeof(NightmareLeaperAbyssMap), 100),
			new LootPackItem(typeof(NightmarePanthersDomainMap), 100),
			new LootPackItem(typeof(OmegaSentinelsFortressMap), 100),
			new LootPackItem(typeof(OrangutanSageGroveMap), 100),
			new LootPackItem(typeof(OverlordMkiiStrongholdMap), 100),
			new LootPackItem(typeof(PeccaryProtectorForestMap), 100),
			new LootPackItem(typeof(PeppermintPuffDomainMap), 100),
			new LootPackItem(typeof(PhantomAutomatonVaultMap), 100),
			new LootPackItem(typeof(PhantomPanthersDomainMap), 100),
			new LootPackItem(typeof(PlagueLichsCryptMap), 100),
			new LootPackItem(typeof(PlasmaJuggernautsForgeMap), 100),
			new LootPackItem(typeof(PurseSpidersLairMap), 100),
			new LootPackItem(typeof(QuantumGuardiansRealmMap), 100),
			new LootPackItem(typeof(RabidRatLairMap), 100),
			new LootPackItem(typeof(RadiantSlimeCavernMap), 100),
			new LootPackItem(typeof(RaistlinMajeresTowerMap), 100),
			new LootPackItem(typeof(RamsesTheImmortalTombMap), 100),
			new LootPackItem(typeof(RedSquirrelNestMap), 100),
			new LootPackItem(typeof(RedtailedSquirrelGroveMap), 100),
			new LootPackItem(typeof(BreezePhantomAbyssMap), 100),
			new LootPackItem(typeof(BubbleFerretForestMap), 100),
			new LootPackItem(typeof(CelestialDragonShrineMap), 100),
			new LootPackItem(typeof(CerebralEttinCavernMap), 100),
			new LootPackItem(typeof(ChanequeGroveMap), 100),
			new LootPackItem(typeof(ChimereonSwampMap), 100),
			new LootPackItem(typeof(CinderWraithRuinsMap), 100),
			new LootPackItem(typeof(CorruptingCreeperForestMap), 100),
			new LootPackItem(typeof(CrystalDragonCavernMap), 100),
			new LootPackItem(typeof(CrystalWardenTempleMap), 100),
			new LootPackItem(typeof(CursedHarbingerCryptMap), 100),
			new LootPackItem(typeof(CycloneDemonPlainsMap), 100),
			new LootPackItem(typeof(DairyWraithFieldMap), 100),
			new LootPackItem(typeof(DeadlordFortressMap), 100),
			new LootPackItem(typeof(DreadedCreeperHollowMap), 100),
			new LootPackItem(typeof(DreamyFerretHollowMap), 100),
			new LootPackItem(typeof(DrolaticWastesMap), 100),
			new LootPackItem(typeof(DryadGroveMap), 100),
			new LootPackItem(typeof(EarthquakeEttinDenMap), 100),
			new LootPackItem(typeof(ElderTendrilSwampMap), 100),
			new LootPackItem(typeof(EmberSerpentLairMap), 100),
			new LootPackItem(typeof(EmberSpiritDomainMap), 100),
			new LootPackItem(typeof(EtherealCrabNestMap), 100),
			new LootPackItem(typeof(EtherealDragonsKeepMap), 100),
			new LootPackItem(typeof(FirebreathAlligatorSwampMap), 100),
			new LootPackItem(typeof(FireRoosterCavernMap), 100),
			new LootPackItem(typeof(FlameBearerCaveMap), 100),
			new LootPackItem(typeof(FlameWardenEttinFortressMap), 100),
			new LootPackItem(typeof(FlareImpNestMap), 100),
			new LootPackItem(typeof(FossilElementalCavernMap), 100),
			new LootPackItem(typeof(FrostBearDomainMap), 100),
			new LootPackItem(typeof(FrostbiteAlligatorSwampMap), 100),
			new LootPackItem(typeof(FrostboundBehemothCaveMap), 100),
			new LootPackItem(typeof(FrostDrakonKeepMap), 100),
			new LootPackItem(typeof(FrostHensPerchMap), 100),
			new LootPackItem(typeof(FrostSerpentLairMap), 100),
			new LootPackItem(typeof(FrostWardenEttinStrongholdMap), 100),
			new LootPackItem(typeof(FrostyFerretsBurrowMap), 100),
			new LootPackItem(typeof(GaleWispsDomainMap), 100),
			new LootPackItem(typeof(GiantTrapdoorSpiderLairMap), 100),
			new LootPackItem(typeof(GiantWolfSpiderNestMap), 100),
			new LootPackItem(typeof(GlimmeringFerretBurrowMap), 100),
			new LootPackItem(typeof(GoldenOrbWeaverCavernMap), 100),
			new LootPackItem(typeof(GoliathBirdeaterJungleMap), 100),
			new LootPackItem(typeof(GorgonVipersLairMap), 100),
			new LootPackItem(typeof(GraniteColossusCavernMap), 100),
			new LootPackItem(typeof(GrimoriesTomeMap), 100),
			new LootPackItem(typeof(GrotesqueOfRouensCryptMap), 100),
			new LootPackItem(typeof(GrymalkinTheWatchersDomainMap), 100),
			new LootPackItem(typeof(GuernseyGuardianKeepMap), 100),
			new LootPackItem(typeof(HarmonyFerretGroveMap), 100),
			new LootPackItem(typeof(HellfireJuggernautForgeMap), 100),
			new LootPackItem(typeof(HerefordWarlockTowerMap), 100),
			new LootPackItem(typeof(HighlandBullHerdMap), 100),
			new LootPackItem(typeof(HuntsmanSpidersLairMap), 100),
			new LootPackItem(typeof(IceCrabCavernMap), 100),
			new LootPackItem(typeof(IllusionarySwampMap), 100),
			new LootPackItem(typeof(IllusionHensParadiseMap), 100),
			new LootPackItem(typeof(IllusionistEttinsDomainMap), 100),
			new LootPackItem(typeof(InfernalDukesCitadelMap), 100),
			new LootPackItem(typeof(InfernalIncineratorForgeMap), 100),
			new LootPackItem(typeof(InfernoDrakonsRoostMap), 100),
			new LootPackItem(typeof(InfernoPythonPitMap), 100),
			new LootPackItem(typeof(InfernoWardensFortressMap), 100),
			new LootPackItem(typeof(IshKarTheForgottenLairMap), 100),
			new LootPackItem(typeof(JerseyEnchantressCovenMap), 100),
			new LootPackItem(typeof(LairOfTheShadowogresDomainMap), 100),
			new LootPackItem(typeof(LairOfTheShadowprowlersHuntMap), 100),
			new LootPackItem(typeof(LairOfTheShadowsludgesSwampMap), 100),
			new LootPackItem(typeof(LairOfTheShadowtoadsBogMap), 100),
			new LootPackItem(typeof(LairOfTheSifakawarriorsJungleMap), 100),
			new LootPackItem(typeof(LairOfTheSmallpoxRatLairMap), 100),
			new LootPackItem(typeof(LairOfTheSombreroDeSolLlamaMap), 100),
			new LootPackItem(typeof(LairOfTheSombreroLlamaMap), 100),
			new LootPackItem(typeof(LairOfTheSothTheDeathKnightMap), 100),
			new LootPackItem(typeof(LairOfTheSoulEaterLichMap), 100),
			new LootPackItem(typeof(LairOfTheTahrsWildHordeMap), 100),
			new LootPackItem(typeof(LairOfTheTalonmachinesForgeMap), 100),
			new LootPackItem(typeof(LairOfTheTaurusearthbearsDominionMap), 100),
			new LootPackItem(typeof(LairOfTheTaurusharpysSkiesMap), 100),
			new LootPackItem(typeof(LairOfTheTempestsatyrsStormMap), 100),
			new LootPackItem(typeof(LairOfTheVietnamesePigMap), 100),
			new LootPackItem(typeof(LairOfTheVileToadMap), 100),
			new LootPackItem(typeof(LairOfTheVirgoHarpyMap), 100),
			new LootPackItem(typeof(LairOfTheVirgoPurityBearMap), 100),
			new LootPackItem(typeof(LairOfTheVoidCatMap), 100),
			new LootPackItem(typeof(LairOfTheVoidSlimeMap), 100),
			new LootPackItem(typeof(LairOfTheVolcaniccHargerMap), 100),
			new LootPackItem(typeof(LairOfTheVortexConstructMap), 100),
			new LootPackItem(typeof(LairOfTheVortexWraithMap), 100),
			new LootPackItem(typeof(LairOfTheWarthogWarriorMap), 100),
			new LootPackItem(typeof(LairOfTheWraithlichCryptMap), 100),
			new LootPackItem(typeof(LairOfTheYangstallionPlainsMap), 100),
			new LootPackItem(typeof(LairOfTheYinsteedForestMap), 100),
			new LootPackItem(typeof(LavaCrabCavernMap), 100),
			new LootPackItem(typeof(LavaFiendFortressMap), 100),
			new LootPackItem(typeof(LeafBearGroveMap), 100),
			new LootPackItem(typeof(LeprechaunsLairMap), 100),
			new LootPackItem(typeof(LightBearersSanctuaryMap), 100),
			new LootPackItem(typeof(MagmaGolemForgeMap), 100),
			new LootPackItem(typeof(MagneticCrabCavernMap), 100),
			new LootPackItem(typeof(MaineCoonTitansRoostMap), 100),
			new LootPackItem(typeof(MilkingDemonStablesMap), 100),
			new LootPackItem(typeof(RhythmicSatyrsGladeMap), 100),
			new LootPackItem(typeof(RockSquirrelCavernMap), 100),
			new LootPackItem(typeof(SableAntelopeSavannaMap), 100),
			new LootPackItem(typeof(SagittariusArcherBearForestMap), 100),
			new LootPackItem(typeof(SagittariusHarpysPerchMap), 100),
			new LootPackItem(typeof(SandGolemsTombMap), 100),
			new LootPackItem(typeof(ScorpioHarpysLairMap), 100),
			new LootPackItem(typeof(ScorpionSpidersHollowMap), 100),
			new LootPackItem(typeof(ScorpioVenomBearsDenMap), 100),
			new LootPackItem(typeof(SetiTheAvengersCryptMap), 100),
			new LootPackItem(typeof(ShadowbladeAssassinsLairMap), 100),
			new LootPackItem(typeof(ShadowGolemsAbyssMap), 100),
			new LootPackItem(typeof(ShadowLichsNecropolisMap), 100),
			new LootPackItem(typeof(ShadowMuntjacsDomainMap), 100),
			new LootPackItem(typeof(SpectralAutomatonForgeMap), 100),
			new LootPackItem(typeof(SpectralToadSwampMap), 100),
			new LootPackItem(typeof(SpectralWardenCryptMap), 100),
			new LootPackItem(typeof(SpiderlingMinionBroodmotherMap), 100),
			new LootPackItem(typeof(SpiderMonkeyJungleMap), 100),
			new LootPackItem(typeof(StarbornPredatorNestMap), 100),
			new LootPackItem(typeof(SteamLeviathanAbyssMap), 100),
			new LootPackItem(typeof(StoneGolemCavernMap), 100),
			new LootPackItem(typeof(StoneSteedStablesMap), 100),
			new LootPackItem(typeof(StormBoneFortressMap), 100),
			new LootPackItem(typeof(SynthroidPrimeFactoryMap), 100),
			new LootPackItem(typeof(SzassTamsNecropolisMap), 100),
			new LootPackItem(typeof(TacoLlamaFestivalMap), 100),
			new LootPackItem(typeof(TacticalEnforcerOperationsMap), 100),
			new LootPackItem(typeof(TaffyTitansArenaMap), 100),
			new LootPackItem(typeof(TequilaLlamaTavernMap), 100),
			new LootPackItem(typeof(TheForestTempestMap), 100),
			new LootPackItem(typeof(TheStormOfDeathMap), 100),
			new LootPackItem(typeof(TheTempestsFuryMap), 100),
			new LootPackItem(typeof(TheTempestsWrathMap), 100),
			new LootPackItem(typeof(TheWrathOfTheThunderKingMap), 100),
			new LootPackItem(typeof(ThutmoseTheConquerorsTombMap), 100),
			new LootPackItem(typeof(TidalMaresDeepMap), 100),
			new LootPackItem(typeof(ToxicLichsLairMap), 100),
			new LootPackItem(typeof(ToxicOgresStrongholdMap), 100),
			new LootPackItem(typeof(ToxicSludgeSwampMap), 100),
			new LootPackItem(typeof(TrapdoorSpiderNestMap), 100),
			new LootPackItem(typeof(TsunamiTitansDeepMap), 100),
			new LootPackItem(typeof(TutankhamunTheCursedTombMap), 100),
			new LootPackItem(typeof(TyphusRatInfestationMap), 100),
			new LootPackItem(typeof(VampiricBladesLairMap), 100),
			new LootPackItem(typeof(VecnasSanctumMap), 100),
			new LootPackItem(typeof(VenomousRoesMarshMap), 100),
			new LootPackItem(typeof(VenomousToadsSwampMap), 100),
			new LootPackItem(typeof(VenomousWolfsLairMap), 100),
			new LootPackItem(typeof(WhisperingPookaGroveMap), 100),
			new LootPackItem(typeof(WickedSatyrsForestMap), 100),
			new LootPackItem(typeof(WoodGolemsHollowMap), 100),
			new LootPackItem(typeof(WoodlandChargerDomainMap), 100),
			new LootPackItem(typeof(WoodlandSpiritHorseMeadowMap), 100),
			new LootPackItem(typeof(MoltenGolemCavernMap), 100),
			new LootPackItem(typeof(MordrakesManorMap), 100),
			new LootPackItem(typeof(MudGolemSwampMap), 100),
			new LootPackItem(typeof(MysticFerretSanctuaryMap), 100),
			new LootPackItem(typeof(MysticFowlSanctuaryMap), 100),
			new LootPackItem(typeof(MysticWispRealmMap), 100),
			new LootPackItem(typeof(NatureDragonsLairMap), 100),
			new LootPackItem(typeof(NecroEttinCryptMap), 100),
			new LootPackItem(typeof(NecroRoosterTombMap), 100),
			new LootPackItem(typeof(NightshadeBrambleGroveMap), 100),
			new LootPackItem(typeof(NymphsSanctuaryMap), 100),
			new LootPackItem(typeof(NyxRithRuinsMap), 100),
			new LootPackItem(typeof(PersianShadeTombMap), 100),
			new LootPackItem(typeof(PhantomVinesOvergrowthMap), 100),
			new LootPackItem(typeof(PoisonousCrabCoveMap), 100),
			new LootPackItem(typeof(PoisonPulletFarmMap), 100),
			new LootPackItem(typeof(PucksMischiefMap), 100),
			new LootPackItem(typeof(PuffyFerretHollowMap), 100),
			new LootPackItem(typeof(PurseSpiderNestMap), 100),
			new LootPackItem(typeof(PyroclasticGolemForgeMap), 100),
			new LootPackItem(typeof(QuakeBringerCavernMap), 100),
			new LootPackItem(typeof(QuorZaelsDomainMap), 100),
			new LootPackItem(typeof(RagdollGuardianCitadelMap), 100),
			new LootPackItem(typeof(RagingAlligatorSwampMap), 100),
			new LootPackItem(typeof(RathzorTheShatteredsLairMap), 100),
			new LootPackItem(typeof(RiptideCrabCoveMap), 100),
			new LootPackItem(typeof(RockBearCavernMap), 100),
			new LootPackItem(typeof(SahiwalShamansGroveMap), 100),
			new LootPackItem(typeof(SandstormElementalDesertMap), 100),
			new LootPackItem(typeof(ScorpionSpiderPitMap), 100),
			new LootPackItem(typeof(ScottishFoldSentinelDenMap), 100),
			new LootPackItem(typeof(SelkieCavernMap), 100),
			new LootPackItem(typeof(ShadowAlligatorSwampMap), 100),
			new LootPackItem(typeof(ShadowAnacondaJungleMap), 100),
			new LootPackItem(typeof(ShadowBearsLairMap), 100),
			new LootPackItem(typeof(ShadowChicksNestMap), 100),
			new LootPackItem(typeof(ShadowCrabsTidepoolMap), 100),
			new LootPackItem(typeof(ShadowDragonsRoostMap), 100),
			new LootPackItem(typeof(ShadowDriftersMistsMap), 100),
			new LootPackItem(typeof(SiameseIllusionistChamberMap), 100),
			new LootPackItem(typeof(SiberianFrostclawsDomainMap), 100),
			new LootPackItem(typeof(SidheFaeRealmMap), 100),
			new LootPackItem(typeof(SinisterRootHollowMap), 100),
			new LootPackItem(typeof(SkeletonEttinStrongholdMap), 100),
			new LootPackItem(typeof(SkySeraphsAerieMap), 100),
			new LootPackItem(typeof(SolarElementalSummitMap), 100),
			new LootPackItem(typeof(SparkFerretWildsMap), 100),
			new LootPackItem(typeof(SphinxCatsRiddleMap), 100),
			new LootPackItem(typeof(SpiderlingOverlordBroodmotherMap), 100),
			new LootPackItem(typeof(StarryFerretsCelestialRealmMap), 100),
			new LootPackItem(typeof(SteelBearDenMap), 100),
			new LootPackItem(typeof(StoneGuardianFortressMap), 100),
			new LootPackItem(typeof(StoneRoosterCryptMap), 100),
			new LootPackItem(typeof(StormAlligatorSwampMap), 100),
			new LootPackItem(typeof(StormCrabsLairMap), 100),
			new LootPackItem(typeof(StormDaemonsDomainMap), 100),
			new LootPackItem(typeof(StormDragonsPeakMap), 100),
			new LootPackItem(typeof(StormHeraldsSanctuaryMap), 100),
			new LootPackItem(typeof(StrixsPerchMap), 100),
			new LootPackItem(typeof(SunbeamFerretHollowMap), 100),
			new LootPackItem(typeof(TarantulaWarriorLairMap), 100),
			new LootPackItem(typeof(TarantulaWorriorCavernMap), 100),
			new LootPackItem(typeof(TempestSpiritDomainMap), 100),
			new LootPackItem(typeof(TempestWyrmSpireMap), 100),
			new LootPackItem(typeof(TerraWispGroveMap), 100),
			new LootPackItem(typeof(ThornedHorrorSwampMap), 100),
			new LootPackItem(typeof(ThulGorTheForsakenLairMap), 100),
			new LootPackItem(typeof(ThunderBearHighlandsMap), 100),
			new LootPackItem(typeof(ThunderbirdMountainMap), 100),
			new LootPackItem(typeof(ThunderSerpentCavernMap), 100),
			new LootPackItem(typeof(TidalEttinMarshMap), 100),
			new LootPackItem(typeof(TitanBoaSwampMap), 100),
			new LootPackItem(typeof(ToxicAlligatorSwampsMap), 100),
			new LootPackItem(typeof(ToxicReaverNecropolisMap), 100),
			new LootPackItem(typeof(TurkishAngoraEnchantersDomainMap), 100),
			new LootPackItem(typeof(TwinTerrorEttinsFortressMap), 100),
			new LootPackItem(typeof(UruKothsLairMap), 100),
			new LootPackItem(typeof(VengefulPitVipersPitMap), 100),
			new LootPackItem(typeof(VenomBearsDenMap), 100),
			new LootPackItem(typeof(VenomousAlligatorSwampMap), 100),
			new LootPackItem(typeof(VenomousDragonLairMap), 100),
			new LootPackItem(typeof(VenomousEttinCaveMap), 100),
			new LootPackItem(typeof(VenomousIvyGroveMap), 100),
			new LootPackItem(typeof(VespaHiveMap), 100),
			new LootPackItem(typeof(VileBlossomGroveMap), 100),
			new LootPackItem(typeof(VitrailTheMosaicMap), 100),
			new LootPackItem(typeof(VoidStalkerAbyssMap), 100),
			new LootPackItem(typeof(VolcanicTitanCraterMap), 100),
			new LootPackItem(typeof(VorgathTheDestroyerMap), 100),
			new LootPackItem(typeof(VortexCrabReefMap), 100),
			new LootPackItem(typeof(VortexGuardianKeepMap), 100),
			new LootPackItem(typeof(WhirlwindFiendAbyssMap), 100),
			new LootPackItem(typeof(WillothewispEnclaveMap), 100),
			new LootPackItem(typeof(WindBearGroveMap), 100),
			new LootPackItem(typeof(WindChickenNestMap), 100),
			new LootPackItem(typeof(XalrathCultMap), 100),
			new LootPackItem(typeof(ZebuZealotRuinsMap), 100),
			new LootPackItem(typeof(ZelvrakStrongholdMap), 100),
			new LootPackItem(typeof(ZephyrWardensDomainMap), 100),
			new LootPackItem(typeof(EasternMagicMap), 100),
			new LootPackItem(typeof(FarEasternMagicMap), 100),
			new LootPackItem(typeof(FeluccaMagicMap), 100),
			new LootPackItem(typeof(IlshenarMagicMap), 100),
			new LootPackItem(typeof(NorthernMagicMap), 100),
			new LootPackItem(typeof(SouthernMagicMap), 100),
			new LootPackItem(typeof(TerMurMagicMap), 100),
			new LootPackItem(typeof(TokunoMagicMap), 100),
			new LootPackItem(typeof(TrammelMagicMap), 100),
			new LootPackItem(typeof(WesternMagicMap), 100),
			new LootPackItem(typeof(AirClanNinjaCampMap), 100),
			new LootPackItem(typeof(AirClanSamuraiDojoMap), 100),
			new LootPackItem(typeof(AlienWarriorNestMap), 100),
			new LootPackItem(typeof(AppleGroveElementalMap), 100),
			new LootPackItem(typeof(AssassinGuildHallMap), 100),
			new LootPackItem(typeof(AstralTravelerRealmMap), 100),
			new LootPackItem(typeof(AvatarOfElementsShrineMap), 100),
			new LootPackItem(typeof(BaroqueBarbarianCampMap), 100),
			new LootPackItem(typeof(BeetleJuiceSummoningCircleMap), 100),
			new LootPackItem(typeof(BiomancersGroveMap), 100),
			new LootPackItem(typeof(BluesSingingGorgonAmphitheaterMap), 100),
			new LootPackItem(typeof(BMovieBeastmasterArenaMap), 100),
			new LootPackItem(typeof(BountyHunterOutpostMap), 100),
			new LootPackItem(typeof(CabaretKrakenStageMap), 100),
			new LootPackItem(typeof(CannibalTribeCampMap), 100),
			new LootPackItem(typeof(CavemanScientistExperimentSiteMap), 100),
			new LootPackItem(typeof(CelestialSamuraiDojoMap), 100),
			new LootPackItem(typeof(ChrisRobertsGalacticArenaMap), 100),
			new LootPackItem(typeof(CorporateExecutiveTowerMap), 100),
			new LootPackItem(typeof(CountryCowgirlCyclopsRanchMap), 100),
			new LootPackItem(typeof(CyberpunkNexusMap), 100),
			new LootPackItem(typeof(DarkElfCitadelMap), 100),
			new LootPackItem(typeof(DinoRiderExpeditionMap), 100),
			new LootPackItem(typeof(DiscoDruidFestivalMap), 100),
			new LootPackItem(typeof(HarvestFestivalFrenzyMap), 100),
			new LootPackItem(typeof(LongbowSniperOutpostMap), 100),
			new LootPackItem(typeof(LuchadorTrainingGroundsMap), 100),
			new LootPackItem(typeof(MagiciansArcaneHallMap), 100),
			new LootPackItem(typeof(MartialMonkDojoMap), 100),
			new LootPackItem(typeof(MasterFlutistsConcertMap), 100),
			new LootPackItem(typeof(MechanicsWorkshopMap), 100),
			new LootPackItem(typeof(MusclePitMap), 100),
			new LootPackItem(typeof(NecromancersHollowMap), 100),
			new LootPackItem(typeof(NetCasterReefMap), 100),
			new LootPackItem(typeof(NinjaShadowHideoutMap), 100),
			new LootPackItem(typeof(NymphSingerGladeMap), 100),
			new LootPackItem(typeof(OraclesSanctumMap), 100),
			new LootPackItem(typeof(PastryChefsBakeryMap), 100),
			new LootPackItem(typeof(PatchworkMonsterLaboratoryMap), 100),
			new LootPackItem(typeof(PathologistsLairMap), 100),
			new LootPackItem(typeof(PhantomAssassinsHideoutMap), 100),
			new LootPackItem(typeof(PickpocketsDenMap), 100),
			new LootPackItem(typeof(PocketPickersRefugeMap), 100),
			new LootPackItem(typeof(ProtestersCampMap), 100),
			new LootPackItem(typeof(QiGongHealerSanctuaryMap), 100),
			new LootPackItem(typeof(QuantumPhysicistResearchFacilityMap), 100),
			new LootPackItem(typeof(RamRiderOutpostMap), 100),
			new LootPackItem(typeof(RapierDuelistArenaMap), 100),
			new LootPackItem(typeof(RelativistObservatoryMap), 100),
			new LootPackItem(typeof(RelicHunterExpeditionMap), 100),
			new LootPackItem(typeof(RuneCasterSanctumMap), 100),
			new LootPackItem(typeof(RuneKeeperChamberMap), 100),
			new LootPackItem(typeof(SaboteurHideoutMap), 100),
			new LootPackItem(typeof(SabreFighterArenaMap), 100),
			new LootPackItem(typeof(SafecrackersDenMap), 100),
			new LootPackItem(typeof(SamuraiMastersDojoMap), 100),
			new LootPackItem(typeof(SatyrPipersGlenMap), 100),
			new LootPackItem(typeof(SawmillWorkersDomainMap), 100),
			new LootPackItem(typeof(ScoutArchersRefugeMap), 100),
			new LootPackItem(typeof(ScoutLeaderEncampmentMap), 100),
			new LootPackItem(typeof(ScrollMagesTowerMap), 100),
			new LootPackItem(typeof(SerpentHandlerPitMap), 100),
			new LootPackItem(typeof(ShadowLordsDomainMap), 100),
			new LootPackItem(typeof(ShadowLurkerCavernMap), 100),
			new LootPackItem(typeof(ShadowPriestLairMap), 100),
			new LootPackItem(typeof(SheepdogHandlersPenMap), 100),
			new LootPackItem(typeof(ShieldBearersBastionMap), 100),
			new LootPackItem(typeof(ShieldMaidensCitadelMap), 100),
			new LootPackItem(typeof(SlyStorytellersTheatreMap), 100),
			new LootPackItem(typeof(SousChefsKitchenMap), 100),
			new LootPackItem(typeof(SpearFishersCoveMap), 100),
			new LootPackItem(typeof(SpearSentryKeepMap), 100),
			new LootPackItem(typeof(SpellbreakersTrialMap), 100),
			new LootPackItem(typeof(SpiritMediumsSeanceMap), 100),
			new LootPackItem(typeof(SpyHideoutMap), 100),
			new LootPackItem(typeof(StarReaderObservatoryMap), 100),
			new LootPackItem(typeof(StormConjurerSummitMap), 100),
			new LootPackItem(typeof(StrategistsWarTableMap), 100),
			new LootPackItem(typeof(SumoWrestlerArenaMap), 100),
			new LootPackItem(typeof(SwordDefenderCitadelMap), 100),
			new LootPackItem(typeof(TaekwondoDojoMap), 100),
			new LootPackItem(typeof(TerrainScoutEncampmentMap), 100),
			new LootPackItem(typeof(ThievesGuildHideoutMap), 100),
			new LootPackItem(typeof(ToxicLaboratoryMap), 100),
			new LootPackItem(typeof(ToxicologistsKitchenMap), 100),
			new LootPackItem(typeof(TrapEngineerWorkshopMap), 100),
			new LootPackItem(typeof(TrapMakersWorkshopMap), 100),
			new LootPackItem(typeof(TrapMastersWorkshopMap), 100),
			new LootPackItem(typeof(TrapSettersHideoutMap), 100),
			new LootPackItem(typeof(TreeFellersGroveMap), 100),
			new LootPackItem(typeof(TrickShotArtistsArenaMap), 100),
			new LootPackItem(typeof(UrbanTrackersOutpostMap), 100),
			new LootPackItem(typeof(VenomousAssassinsLairMap), 100),
			new LootPackItem(typeof(ViolinistsOrchestraMap), 100),
			new LootPackItem(typeof(WardCastersKeepMap), 100),
			new LootPackItem(typeof(WaterAlchemistsLaboratoryMap), 100),
			new LootPackItem(typeof(WeaponEnchantersSanctumMap), 100),
			new LootPackItem(typeof(WildWestOutpostMap), 100),
			new LootPackItem(typeof(WoolWeaversLoomMap), 100),
			new LootPackItem(typeof(ZenMonksSanctuaryMap), 100),
			new LootPackItem(typeof(AnvilHurlerForgeMap), 100),
			new LootPackItem(typeof(AquaticTamerLagoonMap), 100),
			new LootPackItem(typeof(ArcaneScribeEnclaveMap), 100),
			new LootPackItem(typeof(ArcticNaturalistDenMap), 100),
			new LootPackItem(typeof(ArmorCurerLaboratoryMap), 100),
			new LootPackItem(typeof(ArrowFletchersRoostMap), 100),
			new LootPackItem(typeof(AsceticHermitsRefugeMap), 100),
			new LootPackItem(typeof(AstrologersObservatoryMap), 100),
			new LootPackItem(typeof(BanneretsBastionMap), 100),
			new LootPackItem(typeof(BattleDressmakersWorkshopMap), 100),
			new LootPackItem(typeof(BattlefieldHealersSanctuaryMap), 100),
			new LootPackItem(typeof(BattleHerbalistGroveMap), 100),
			new LootPackItem(typeof(BattleStormCallersEyeMap), 100),
			new LootPackItem(typeof(BattleWeaverLoomMap), 100),
			new LootPackItem(typeof(BeastmastersDomainMap), 100),
			new LootPackItem(typeof(BigCatTamerJungleMap), 100),
			new LootPackItem(typeof(BiologistsLaboratoryMap), 100),
			new LootPackItem(typeof(BirdTrainersAviaryMap), 100),
			new LootPackItem(typeof(BoneShielderCryptMap), 100),
			new LootPackItem(typeof(BoomerangThrowerCampMap), 100),
			new LootPackItem(typeof(CabinetMakersWorkshopMap), 100),
			new LootPackItem(typeof(CarversAtelier), 100),
			new LootPackItem(typeof(ChemistsLaboratory), 100),
			new LootPackItem(typeof(ChoirSingersHallMap), 100),
			new LootPackItem(typeof(ClockworkEngineersWorkshopMap), 100),
			new LootPackItem(typeof(ClueSeekersPuzzleGroundsMap), 100),
			new LootPackItem(typeof(CombatMedicsSanctuaryMap), 100),
			new LootPackItem(typeof(CombatNursesRecoveryWardMap), 100),
			new LootPackItem(typeof(ConArtistsDenMap), 100),
			new LootPackItem(typeof(ContortionistsCircusMap), 100),
			new LootPackItem(typeof(CrimeSceneTechInvestigationMap), 100),
			new LootPackItem(typeof(CrossbowMarksmanOutpostMap), 100),
			new LootPackItem(typeof(CryingOrphanRefugeMap), 100),
			new LootPackItem(typeof(CryptologistsChamberMap), 100),
			new LootPackItem(typeof(DarkSorcererDomainMap), 100),
			new LootPackItem(typeof(DeathCultistCryptMap), 100),
			new LootPackItem(typeof(DecoyDeployerOutpostMap), 100),
			new LootPackItem(typeof(DeepMinerExcavationMap), 100),
			new LootPackItem(typeof(DemolitionExpertQuarryMap), 100),
			new LootPackItem(typeof(DesertNaturalistOasisMap), 100),
			new LootPackItem(typeof(DesertTrackersOasisMap), 100),
			new LootPackItem(typeof(DiplomatsParleyMap), 100),
			new LootPackItem(typeof(DisguiseMastersHavenMap), 100),
			new LootPackItem(typeof(DivinersPeakMap), 100),
			new LootPackItem(typeof(DrumBoysSpectacleMap), 100),
			new LootPackItem(typeof(DrummersArenaMap), 100),
			new LootPackItem(typeof(DualWielderDojoMap), 100),
			new LootPackItem(typeof(EarthAlchemistsLairMap), 100),
			new LootPackItem(typeof(ElectriciansWorkshopMap), 100),
			new LootPackItem(typeof(ElementalWizardsKeepMap), 100),
			new LootPackItem(typeof(EnchantersLabyrinthMap), 100),
			new LootPackItem(typeof(EpeeSpecialistArenaMap), 100),
			new LootPackItem(typeof(EscapeArtistHideoutMap), 100),
			new LootPackItem(typeof(EvidenceAnalystsBureauMap), 100),
			new LootPackItem(typeof(EvilMapMakersWorkshopMap), 100),
			new LootPackItem(typeof(ExplorersExpeditionMap), 100),
			new LootPackItem(typeof(ExplosiveDemolitionistsFoundryMap), 100),
			new LootPackItem(typeof(FeastMastersBanquetMap), 100),
			new LootPackItem(typeof(FencingMastersArenaMap), 100),
			new LootPackItem(typeof(FieldCommanderOutpostMap), 100),
			new LootPackItem(typeof(FieldMedicCampMap), 100),
			new LootPackItem(typeof(FireAlchemistLaboratoryMap), 100),
			new LootPackItem(typeof(FireMageConclaveMap), 100),
			new LootPackItem(typeof(FirestarterPyreMap), 100),
			new LootPackItem(typeof(FlameWelderForgeMap), 100),
			new LootPackItem(typeof(ForagersHollowMap), 100),
			new LootPackItem(typeof(ForensicAnalystsLairMap), 100),
			new LootPackItem(typeof(ForestMinstrelsGlenMap), 100),
			new LootPackItem(typeof(ForestScoutOutpostMap), 100),
			new LootPackItem(typeof(ForestTrackerCampMap), 100),
			new LootPackItem(typeof(GemCutterCavernMap), 100),
			new LootPackItem(typeof(GhostScoutOutpostMap), 100),
			new LootPackItem(typeof(GhostWarriorBattlefieldMap), 100),
			new LootPackItem(typeof(GourmetChefKitchenMap), 100),
			new LootPackItem(typeof(GraveDiggerCryptMap), 100),
			new LootPackItem(typeof(GrecoRomanArenaMap), 100),
			new LootPackItem(typeof(GrillMasterPitMap), 100),
			new LootPackItem(typeof(HammerGuardArmoryMap), 100),
			new LootPackItem(typeof(HarpistsGroveMap), 100),
			new LootPackItem(typeof(HerbalistPoisonerGroveMap), 100),
			new LootPackItem(typeof(IceSorcererCitadelMap), 100),
			new LootPackItem(typeof(IllusionistsLabyrinthMap), 100),
			new LootPackItem(typeof(InfiltratorsHideoutMap), 100),
			new LootPackItem(typeof(InvisibleSaboteursWorkshopMap), 100),
			new LootPackItem(typeof(IronSmithForgeMap), 100),
			new LootPackItem(typeof(JavelinAthleteArenaMap), 100),
			new LootPackItem(typeof(JoinerWorkshopMap), 100),
			new LootPackItem(typeof(JungleNaturalistGroveMap), 100),
			new LootPackItem(typeof(KarateExpertDojoMap), 100),
			new LootPackItem(typeof(KatanaDuelistDojoMap), 100),
			new LootPackItem(typeof(KnifeThrowersArenaMap), 100),
			new LootPackItem(typeof(KnightOfJusticeCitadelMap), 100),
			new LootPackItem(typeof(KnightOfMercyChapelMap), 100),
			new LootPackItem(typeof(KnightOfValorFortressMap), 100),
			new LootPackItem(typeof(KunoichiHideoutMap), 100),
			new LootPackItem(typeof(LibrarianCustodiansArchiveMap), 100),
			new LootPackItem(typeof(LightningBearersStormNexusMap), 100),
			new LootPackItem(typeof(LocksmithsWorkshopMap), 100),
			new LootPackItem(typeof(LogiciansPuzzleHallMap), 100),
			new LootPackItem(typeof(MeraktusTheTormentedMap), 100),
			new LootPackItem(typeof(AbyssalBouncersArenaMap), 100),
			new LootPackItem(typeof(AbyssalPanthersProwlMap), 100),
			new LootPackItem(typeof(AbyssalTidesSurgeMap), 100),
			new LootPackItem(typeof(AcereraksNecropolisMap), 100),
			new LootPackItem(typeof(AcidicSlimesLairMap), 100),
			new LootPackItem(typeof(AegisConstructForgeMap), 100),
			new LootPackItem(typeof(AkhenatensHereticShrineMap), 100),
			new LootPackItem(typeof(AkhenatensTombMap), 100),
			new LootPackItem(typeof(AlbertsSquirrelGladeMap), 100),
			new LootPackItem(typeof(AlphaBaboonTroopMap), 100),
			new LootPackItem(typeof(AncientWolfDenMap), 100),
			new LootPackItem(typeof(AnthraxRatNestMap), 100),
			new LootPackItem(typeof(ArbiterDroneHiveMap), 100),
			new LootPackItem(typeof(ArcaneSatyrGladeMap), 100),
			new LootPackItem(typeof(ArcaneSentinelBastionMap), 100),
			new LootPackItem(typeof(AriesHarpyAerieMap), 100),
			new LootPackItem(typeof(AriesRamBearPlateauMap), 100),
			new LootPackItem(typeof(AzalinRexsCryptMap), 100),
			new LootPackItem(typeof(AzureMiragesRealmMap), 100),
			new LootPackItem(typeof(AzureMooseGroveMap), 100),
			new LootPackItem(typeof(BabirusaBeastsBogMap), 100),
			new LootPackItem(typeof(BansheeCrabsNestMap), 100),
			new LootPackItem(typeof(BansheesWailMap), 100),
			new LootPackItem(typeof(BeardedGoatPasturesMap), 100),
			new LootPackItem(typeof(BeldingsGroundSquirrelBurrowMap), 100),
			new LootPackItem(typeof(BengalStormsJungleMap), 100),
			new LootPackItem(typeof(BisonBrutePlateauMap), 100),
			new LootPackItem(typeof(BlackDeathRatSewersMap), 100),
			new LootPackItem(typeof(BlackWidowQueenLairMap), 100),
			new LootPackItem(typeof(BlackWidowsLairMap), 100),
			new LootPackItem(typeof(BlightDemonFissureMap), 100),
			new LootPackItem(typeof(BlightedToadSwampMap), 100),
			new LootPackItem(typeof(BloodDragonRoostMap), 100),
			new LootPackItem(typeof(BloodLichsCryptMap), 100),
			new LootPackItem(typeof(BloodSerpentsNestMap), 100),
			new LootPackItem(typeof(BloodthirstyVinesThicketMap), 100),
			new LootPackItem(typeof(BonecrusherOgresDomainMap), 100),
			new LootPackItem(typeof(BoneGolemsWorkshopMap), 100),
			new LootPackItem(typeof(BorneoPigstyMap), 100),
			new LootPackItem(typeof(BubblegumBlasterFactoryMap), 100),
			new LootPackItem(typeof(BushPigEncampmentMap), 100),
			new LootPackItem(typeof(CactusLlamaGroveMap), 100),
			new LootPackItem(typeof(CancerHarpyAerieMap), 100),
			new LootPackItem(typeof(CancerShellBearDenMap), 100),
			new LootPackItem(typeof(CandyCornCreepsLairMap), 100),
			new LootPackItem(typeof(CapricornHarpysNestMap), 100),
			new LootPackItem(typeof(CapricornMountainBearsDomainMap), 100),
			new LootPackItem(typeof(CapuchinTrickstersPlaygroundMap), 100),
			new LootPackItem(typeof(CaramelConjurersWorkshopMap), 100),
			new LootPackItem(typeof(CelestialHorrorRealmMap), 100),
			new LootPackItem(typeof(CelestialPythonDomainMap), 100),
			new LootPackItem(typeof(CelestialSatyrGroveMap), 100),
			new LootPackItem(typeof(CelestialWolfDenMap), 100),
			new LootPackItem(typeof(ChamoisHillMap), 100),
			new LootPackItem(typeof(CholeraRatInfestationMap), 100),
			new LootPackItem(typeof(ChromaticOgreClanMap), 100),
			new LootPackItem(typeof(CleopatraTheEnigmaticMap), 100),
			new LootPackItem(typeof(CliffGoatDominionMap), 100),
			new LootPackItem(typeof(CoralSentinelsReefMap), 100),
			new LootPackItem(typeof(CorrosiveToadSwampMap), 100),
			new LootPackItem(typeof(CosmicBouncerArenaMap), 100),
			new LootPackItem(typeof(CosmicStalkerVoidMap), 100),
			new LootPackItem(typeof(CrimsonMuleValleyMap), 100),
			new LootPackItem(typeof(CrystalGolemForgeMap), 100),
			new LootPackItem(typeof(CrystalOozeCavernMap), 100),
			new LootPackItem(typeof(CursedToadSwampMap), 100),
			new LootPackItem(typeof(CursedWhiteTailForestMap), 100),
			new LootPackItem(typeof(CursedWolfsDenMap), 100),
			new LootPackItem(typeof(DallSheepHighlandMap), 100),
			new LootPackItem(typeof(DeathRatCavernMap), 100),
			new LootPackItem(typeof(DiaDeLosMuertosLlamaMap), 100),
			new LootPackItem(typeof(DisplacerBeastDomainMap), 100),
			new LootPackItem(typeof(DomesticSwineRetreatMap), 100),
			new LootPackItem(typeof(DouglasSquirrelForestMap), 100),
			new LootPackItem(typeof(DreadnaughtFortressMap), 100),
			new LootPackItem(typeof(EarthquakeWolfCavernMap), 100),
			new LootPackItem(typeof(EasternGraySquirrelGroveMap), 100),
			new LootPackItem(typeof(EclipseReindeerGladeMap), 100),
			new LootPackItem(typeof(EldritchHarbingerRealmMap), 100),
			new LootPackItem(typeof(EtherealPanthrasLairMap), 100),
			new LootPackItem(typeof(FaintingGoatsPastureMap), 100),
			new LootPackItem(typeof(FeverRatsDenMap), 100),
			new LootPackItem(typeof(FiestaLlamasCelebrationMap), 100),
			new LootPackItem(typeof(FlameborneKnightsFortressMap), 100),
			new LootPackItem(typeof(FlamebringerOgreLairMap), 100),
			new LootPackItem(typeof(LairOfTheChaosHareMap), 100),
			new LootPackItem(typeof(LairOfTheCharroLlamaMap), 100),
			new LootPackItem(typeof(LairOfTheCheeseGolemMap), 100),
			new LootPackItem(typeof(LairOfTheChimpanzeeBerserkerMap), 100),
			new LootPackItem(typeof(LairOfTheChocolateTruffleMap), 100),
			new LootPackItem(typeof(LairOfTheEldritchHaresWarrenMap), 100),
			new LootPackItem(typeof(LairOfTheEldritchToadsSwampMap), 100),
			new LootPackItem(typeof(LairOfTheElectricSlimesLabyrinthMap), 100),
			new LootPackItem(typeof(LairOfTheElectroWraithsRealmMap), 100),
			new LootPackItem(typeof(LairOfTheElMariachiLlamasFiestaMap), 100),
			new LootPackItem(typeof(LairOfTheEmberAxisForgeMap), 100),
			new LootPackItem(typeof(LairOfTheEmberWolfDenMap), 100),
			new LootPackItem(typeof(LairOfTheEmperorCobraTempleMap), 100),
			new LootPackItem(typeof(LairOfTheEnigmaticSatyrGroveMap), 100),
			new LootPackItem(typeof(LairOfTheEnigmaticSkipperReefMap), 100),			
			new LootPackItem(typeof(TeleportToIlshenarItem), 100),
			new LootPackItem(typeof(TeleportToMalasItem), 100),
			new LootPackItem(typeof(AlchemistsWax), 100),
			new LootPackItem(typeof(ArcaneHourglass), 100),
			new LootPackItem(typeof(BlacksmithingCatalyst), 100),
			new LootPackItem(typeof(CartographersPen), 100),
			new LootPackItem(typeof(CartographersPin), 100),
			new LootPackItem(typeof(ChaosGlyph), 100),
			new LootPackItem(typeof(CompassRose), 100),
			new LootPackItem(typeof(DiamondLootScroll), 100),
			new LootPackItem(typeof(EasternBrand), 100),
			new LootPackItem(typeof(ErasureScroll), 100),
			new LootPackItem(typeof(ExaltedOrb), 100),
			new LootPackItem(typeof(FarEasternBrand), 100),
			new LootPackItem(typeof(FeluccanBrand), 100),
			new LootPackItem(typeof(FeluccaPortalPrism), 100),
			new LootPackItem(typeof(FirestormGlyph), 100),
			new LootPackItem(typeof(FletchingCatalyst), 100),
			new LootPackItem(typeof(GoldenSeal), 100),
			new LootPackItem(typeof(GlyphOfBounty), 100),
			new LootPackItem(typeof(IlshenarBrand), 100),
			new LootPackItem(typeof(InkOfRegression), 100),
			new LootPackItem(typeof(MalasBrand), 100),
			new LootPackItem(typeof(MonsterMixMedallion), 100),
			new LootPackItem(typeof(NorthernBrand), 100),
			new LootPackItem(typeof(OrbOfAnnulment), 100),
			new LootPackItem(typeof(PlanarCompass), 100),
			new LootPackItem(typeof(RadiusRune), 100),
			new LootPackItem(typeof(ScrollOfIntensification), 100),
			new LootPackItem(typeof(SingularityRune), 100),
			new LootPackItem(typeof(SosariaBrand), 100),
			new LootPackItem(typeof(SouthernBrand), 100),
			new LootPackItem(typeof(StabilizerRune), 100),
			new LootPackItem(typeof(SurveyorsCompass), 100),
			new LootPackItem(typeof(TailoringCatalyst), 100),
			new LootPackItem(typeof(TemporalSundial), 100),
			new LootPackItem(typeof(TerMurBrand), 100),
			new LootPackItem(typeof(TimeTurnToken), 100),
			new LootPackItem(typeof(TinkeringCatalyst), 100),
			new LootPackItem(typeof(TokunoBrand), 100),
			new LootPackItem(typeof(TrammelBrand), 100),
			new LootPackItem(typeof(WesternBrand), 100),			
