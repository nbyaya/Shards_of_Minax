...
namespace Server.Mobiles
{
    ...
    public class TestCreature3 : BaseCreature
    {
        [Constructable]
        public TestCreature3() : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            Body = 0x2E0; // Set a standard creature body
            Hue = 0; // Default hue
        ...
        public TestCreature3(Serial serial) : base(serial)
        {
        }
