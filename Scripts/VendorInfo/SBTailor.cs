    ...
    public class SBTailor : SBInfo
    {
        ...
        public class InternalBuyInfo : List<GenericBuyInfo>
        {
            public InternalBuyInfo()
            {
				...
				Add(new GenericBuyInfo(typeof(WhiteClothDyeTub), 50000, 10, 0xFAB, 0));
				Add(new GenericBuyInfo(typeof(StatuetteDyeTub), 50000, 10, 0xFAB, 0));
				Add(new GenericBuyInfo(typeof(SpecialDyeTub), 50000, 10, 0xFAB, 0));
				Add(new GenericBuyInfo(typeof(RunebookDyeTub), 50000, 10, 0xFAB, 0));
				Add(new GenericBuyInfo(typeof(MetallicLeatherDyeTub), 50000, 10, 0xFAB, 0));
				Add(new GenericBuyInfo(typeof(MetallicDyeTub), 50000, 10, 0xFAB, 0));
				Add(new GenericBuyInfo(typeof(MetallicClothDyeTub), 50000, 10, 0xFAB, 0));
				Add(new GenericBuyInfo(typeof(LeatherDyeTub), 50000, 10, 0xFAB, 0));
				Add(new GenericBuyInfo(typeof(FurnitureDyeTub), 50000, 10, 0xFAB, 0));
				Add(new GenericBuyInfo(typeof(BlazeDyeTub), 50000, 10, 0xFAB, 0));
				Add(new GenericBuyInfo(typeof(BlackDyeTub), 50000, 10, 0xFAB, 0));
				Add(new GenericBuyInfo(typeof(UltimateDyeTub), 500000, 10, 0xFAB, 0));
				Add(new GenericBuyInfo(typeof(UniversalAbsorbingDyeTub), 5000000, 10, 0xFAB, 0));				
