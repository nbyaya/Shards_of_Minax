...
namespace Server.Items
{
    ...
    public class SOS : Item
    {
        ...
        private bool m_HasBeenDoubleClicked;
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            writer.Write(m_HasBeenDoubleClicked);
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            {
                case 5:
                    m_HasBeenDoubleClicked = reader.ReadBool();
                    goto case 4;
                case 4:
                case 3:
                case 2:
        ...
        public override void OnDoubleClick(Mobile from)
        {
            if (IsChildOf(from.Backpack))
            {
                ...
                if (!m_HasBeenDoubleClicked)
                {
                    m_HasBeenDoubleClicked = true;
                    InvalidateProperties(); // Updates the tooltip
                }
            }
            else
            {
        ...
        public override void AddNameProperty(ObjectPropertyList list)
        {
            ...
            if (m_HasBeenDoubleClicked)
            {
                list.Add(1060658, "{0}\t{1}", m_TargetLocation.X, m_TargetLocation.Y); // X: ~1_val~ Y: ~2_val~
            }
        }
