...
namespace Server.Engines.Craft
{
    ...
    public class DefCartography : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
			...
			index = AddCraft(typeof(TreasureMap1Scroll), "Treasure Maps", "Treasure Map 1", 60.0, 60.0, typeof(ScoutingReport), "Scouting Report", 10, 1044037);
            AddRes(index, typeof(Leather), "Leather", 10, 1044253);
			index = AddCraft(typeof(TreasureMap2Scroll), "Treasure Maps", "Treasure Maps 2", 75.0, 75.0, typeof(ScoutingReport), "Scouting Report", 20, 1044037);
            AddRes(index, typeof(Leather), "Leather", 10, 1044253);
			index = AddCraft(typeof(TreasureMap3Scroll), "Treasure Maps", "Treasure Maps 3", 90.0, 90.0, typeof(ScoutingReport), "Scouting Report", 30, 1044037);
            AddRes(index, typeof(Leather), "Leather", 20, 1044253);
			index = AddCraft(typeof(TreasureMap4Scroll), "Treasure Maps", "Treasure Maps 4", 90.0, 90.0, typeof(AdvancedReport), "Advanced Scouting Report", 5, 1044037);
            AddRes(index, typeof(Leather), "Leather", 20, 1044253);
			index = AddCraft(typeof(TreasureMap5Scroll), "Treasure Maps", "Treasure Maps 5", 90.0, 90.0, typeof(ExceptionalReport), "Exceptional Scouting Report", 5, 1044037);
            AddRes(index, typeof(Leather), "Leather", 20, 1044253);

			index = AddCraft(typeof(TradeRouteContract), "Treasure Maps", "Trade Route Contract", 60.0, 60.0, typeof(ScoutingReport), "Scouting Report", 10, 1044037);
            AddRes(index, typeof(Leather), "Leather", 10, 1044253);
			index = AddCraft(typeof(LumberContract), "Treasure Maps", "Lumber Contract", 60.0, 60.0, typeof(ScoutingReport), "Scouting Report", 10, 1044037);
            AddRes(index, typeof(Leather), "Leather", 10, 1044253);
			index = AddCraft(typeof(OreContract), "Treasure Maps", "Ore Contract", 60.0, 60.0, typeof(ScoutingReport), "Scouting Report", 10, 1044037);
            AddRes(index, typeof(Leather), "Leather", 10, 1044253);
			index = AddCraft(typeof(ArchaeologyCharter), "Treasure Maps", "Archaeology Charter", 60.0, 60.0, typeof(ArchaeologicalReport), "Archaeological Report", 10, 1044037);
            AddRes(index, typeof(Leather), "Leather", 10, 1044253);
			index = AddCraft(typeof(BurglaryMission), "Treasure Maps", "Burglary Mission", 60.0, 60.0, typeof(UrbanReport), "Urban Report", 10, 1044037);
            AddRes(index, typeof(Leather), "Leather", 10, 1044253);
        }
