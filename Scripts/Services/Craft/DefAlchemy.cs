...
namespace Server.Engines.Craft
{
    ...
    public class DefAlchemy : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
			...
			index = AddCraft(typeof(TacticalBomb), 1116351, "Tactical Bomb", 50.0, 115.0, typeof(SulfurousAsh), 1044359, 20, 1044367);
            AddRes(index, typeof(Bottle), 1044529, 1, 500315);
			
			index = AddCraft(typeof(StrategicBomb), 1116351, "Strategic Bomb", 75.0, 115.0, typeof(SulfurousAsh), 1044359, 30, 1044367);
            AddRes(index, typeof(Bottle), 1044529, 1, 500315);
			
			index = AddCraft(typeof(MegaBombPotion), 1116351, "Mega Bomb", 100.0, 115.0, typeof(SulfurousAsh), 1044359, 40, 1044367);
            AddRes(index, typeof(Bottle), 1044529, 1, 500315);
			
			index = AddCraft(typeof(MinorPoisonBomb), 1116351, "Minor Poison Bomb", 50.0, 115.0, typeof(Nightshade), 1044358, 20, 1044367);
            AddRes(index, typeof(Bottle), 1044529, 1, 500315);
			
			index = AddCraft(typeof(PoisonBomb), 1116351, "Poison Bomb", 60.0, 115.0, typeof(Nightshade), 1044358, 30, 1044367);
            AddRes(index, typeof(Bottle), 1044529, 1, 500315);
			
			index = AddCraft(typeof(UltraPoisonBomb), 1116351, "Ultra Poison Bomb", 80.0, 115.0, typeof(Nightshade), 1044358, 40, 1044367);
            AddRes(index, typeof(Bottle), 1044529, 1, 500315);
			
			index = AddCraft(typeof(MegaHealthBomb), 1116351, "Mega Health Bomb", 100.0, 115.0, typeof(Garlic), 1044355, 40, 1044367);
            AddRes(index, typeof(Bottle), 1044529, 1, 500315);
            if (Core.ML)
            {
